...
## [1.26.0](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.25.0...ai-assistant-sdk-v1.26.0) (2026-08-10)


### Features

* **instance-ai:** Add activation quota lock for the Instance AI pool ([#540](https://github.com/n8n-io/ai-assistant-service/issues/540)) ([1ce2fc1](https://github.com/n8n-io/ai-assistant-service/commit/1ce2fc19789785b775bde4a28a7d76ff18aad20b))

## [1.25.0](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.24.0...ai-assistant-sdk-v1.25.0) (2026-07-13)


### Features

* Add a machine-readable quota_exhausted code to the credit-pool 403 ([#476](https://github.com/n8n-io/ai-assistant-service/issues/476)) ([206a3cd](https://github.com/n8n-io/ai-assistant-service/commit/206a3cd08a57716b8e108fc0900d094b18590be4))

## [1.24.0](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.23.0...ai-assistant-sdk-v1.24.0) (2026-06-30)


### Features

* add Instance AI credit pool subsystem and SDK methods ([#454](https://github.com/n8n-io/ai-assistant-service/issues/454)) ([9fb465c](https://github.com/n8n-io/ai-assistant-service/commit/9fb465c83b13d6e932b9da5c64629810dd19cdc5))


### Bug Fixes

* **sdk:** surface real error from generateAiCreditsCredentials (ADO-4803) ([#436](https://github.com/n8n-io/ai-assistant-service/issues/436)) ([989c374](https://github.com/n8n-io/ai-assistant-service/commit/989c374e5cb5068365a7558f258dc567306850e4))

## [1.23.0](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.22.0...ai-assistant-sdk-v1.23.0) (2026-06-26)


### Features

* Force a redeployment to move LangSmith to EU ([#445](https://github.com/n8n-io/ai-assistant-service/issues/445)) ([ff0a733](https://github.com/n8n-io/ai-assistant-service/commit/ff0a733ea6ff1ae6d1c921dce8c6c16e4ed2624b))

## [1.22.0](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.21.1...ai-assistant-sdk-v1.22.0) (2026-06-22)


### Features

* **builder:** add token-based per-message credit claims ([#430](https://github.com/n8n-io/ai-assistant-service/issues/430)) ([dd3cfb6](https://github.com/n8n-io/ai-assistant-service/commit/dd3cfb6975994a6de19d51b624dd070953316eb7))

## [1.21.1](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.21.0...ai-assistant-sdk-v1.21.1) (2026-06-11)


### Bug Fixes

* Avoid throwing error when parsing response that is not in JSON format ([#363](https://github.com/n8n-io/ai-assistant-service/issues/363)) ([7c3f52b](https://github.com/n8n-io/ai-assistant-service/commit/7c3f52b0b37e7aaf71bba7f7c36b0b4183989c1b))
* Send parseable JSON errors from chat streaming endpoints ([#415](https://github.com/n8n-io/ai-assistant-service/issues/415)) ([b935506](https://github.com/n8n-io/ai-assistant-service/commit/b9355067a566bc5ac42ce685f033629b79c33bc6))

## [1.21.0](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.20.0...ai-assistant-sdk-v1.21.0) (2026-03-30)


### Features

* Add SDK methods for sandbox proxy configuration ([#344](https://github.com/n8n-io/ai-assistant-service/issues/344)) ([f98c509](https://github.com/n8n-io/ai-assistant-service/commit/f98c5090a7705d73220ca195d35bbae1ced9935d))

## [1.20.0](https://github.com/n8n-io/ai-assistant-service/compare/ai-assistant-sdk-v1.19.1...ai-assistant-sdk-v1.20.0) (2026-01-05)


### Features

* Add instance id to telemetry ([#323](https://github.com/n8n-io/ai-assistant-service/issues/323)) ([3be3b86](https://github.com/n8n-io/ai-assistant-service/commit/3be3b86f6f09282d294f773c12420418ee1426d5))
