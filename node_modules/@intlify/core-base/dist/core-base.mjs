/*!
  ...
  */
import { getGlobalThis, isObject, hasOwn, isNumber, create, isString, isBoolean, warn, format as format$1, friendlyJSONstringify, isArray, isPlainObject, isFunction, isPromise, assign, isRegExp, warnOnce, isEmptyObject, isDate, toDisplayString, join, sanitizeTranslatedHtml, escapeHtml, inBrowser, mark, measure, generateFormatCacheKey, generateCodeFrame } from '@intlify/shared';
