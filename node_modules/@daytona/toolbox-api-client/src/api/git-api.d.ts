...
export declare const GitApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    deleteBranch: (request: GitDeleteBranchRequest, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const GitApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    deleteBranch(request: GitDeleteBranchRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Get the commit history of the Git repository
     * @summary Get commit history
     * @param {string} path Repository path
...
export declare class GitApi extends BaseAPI {
     ...
     * @throws {RequiredError}
     */
    deleteBranch(request: GitDeleteBranchRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<void, any, {}>>;
    /**
     * Get the commit history of the Git repository
     * @summary Get commit history
     * @param {string} path Repository path
