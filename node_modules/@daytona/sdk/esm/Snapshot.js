...
let SnapshotService = (() => {
    ...
    return class SnapshotService {
        static {
            ...
            _activate_decorators = [WithInstrumentation()];
            _static_processImageContext_decorators = [WithInstrumentation()];
            __esDecorate(this, null, _static_processImageContext_decorators, { kind: "method", name: "processImageContext", static: true, private: false, access: { has: obj => "processImageContext" in obj, get: obj => obj.processImageContext }, metadata: _metadata }, null, _staticExtraInitializers);
