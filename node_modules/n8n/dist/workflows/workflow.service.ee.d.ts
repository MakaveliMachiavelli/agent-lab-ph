...
export declare class EnterpriseWorkflowService {
    ...
    getNodesWithInaccessibleCreds(workflow: IWorkflowBase, userCredIds: string[]): INode[];
    private getNodeCredentialRefs;
    private getInlineWorkflowNodes;
