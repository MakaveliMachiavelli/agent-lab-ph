...
let WorkerServer = class WorkerServer {
    ...
    mountEndpoints() {
        ...
        if (health) {
            const healthPath = (0, health_endpoint_util_1.resolveBackendHealthEndpointPath)(this.globalConfig);
...
exports.WorkerServer = WorkerServer = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [config_1.GlobalConfig, backend_common_1.Logger, db_1.DbConnection, credentials_overwrites_1.CredentialsOverwrites, external_hooks_1.ExternalHooks, n8n_core_1.InstanceSettings, prometheus_1.PrometheusMetricsService, redis_client_service_1.RedisClientService])
], WorkerServer);
