...
let Subscriber = class Subscriber {
    constructor(logger, instanceSettings, pubsubEventBus, redisClientService, executionsConfig, globalConfig) {
        ...
        this.client.on('message', (channel, str) => {
            ...
            if (!handler) {
                handler = (0, debounce_1.default)(handlerFn, 300);
...
exports.Subscriber = Subscriber = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [backend_common_1.Logger, n8n_core_1.InstanceSettings, pubsub_eventbus_1.PubSubEventBus, redis_client_service_1.RedisClientService, config_1.ExecutionsConfig, config_1.GlobalConfig])
], Subscriber);
