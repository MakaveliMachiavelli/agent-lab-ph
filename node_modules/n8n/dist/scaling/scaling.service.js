...
const webhook_response_relay_1 = require("./webhook-response-relay");
let ScalingService = class ScalingService {
    constructor(logger, errorReporter, activeExecutions, jobProcessor, globalConfig, executionRepository, executionPersistence, instanceSettings, eventService, webhookResponseRelay) {
        this.logger = logger;
        ...
        this.webhookResponseRelay = webhookResponseRelay;
    ...
    async setupQueue() {
        ...
        const { McpServer, QueuedExecutionStrategy, RedisSessionStore } = await import('@n8n/n8n-nodes-langchain/mcp/core');
    ...
    setupWorker(concurrency) {
        ...
        void this.queue.process(constants_3.JOB_TYPE_NAME, concurrency, async (job) => {
            try {
                ...
                await this.reportJobProcessingError((0, ensure_error_1.ensureError)(error), job);
            }
        });
        ...
        this.queue.on('global:progress', (jobId, msg) => {
            ...
            switch (msg.kind) {
                ...
                case 'respond-to-webhook': {
                    const decodedResponse = (0, webhook_response_relay_1.decodeRelayedWebhookResponse)(msg.response);
    ...
    async handleMcpResponse(executionId, mcpType, sessionId, messageId, response) {
        try {
            if (mcpType === 'service') {
                ...
                const mcpServer = McpServer.instance(this.logger);
                const holdsResponse = mcpServer.hasSession(sessionId) || mcpServer.hasPendingResponse(sessionId, messageId);
                if (holdsResponse) {
                    const decoded = (0, webhook_response_relay_1.decodeRelayedWebhookResponse)(response);
...
exports.ScalingService = ScalingService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [backend_common_1.Logger, n8n_core_1.ErrorReporter, active_executions_1.ActiveExecutions, job_processor_1.JobProcessor, config_1.GlobalConfig, db_1.ExecutionRepository, execution_persistence_1.ExecutionPersistence, n8n_core_1.InstanceSettings, event_service_1.EventService, webhook_response_relay_1.WebhookResponseRelay])
], ScalingService);
