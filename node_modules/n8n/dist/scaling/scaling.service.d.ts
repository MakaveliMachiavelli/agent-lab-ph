...
export declare class ScalingService {
    ...
    private readonly webhookResponseRelay;
    private queue;
    private jobResults;
    constructor(logger: Logger, errorReporter: ErrorReporter, activeExecutions: ActiveExecutions, jobProcessor: JobProcessor, globalConfig: GlobalConfig, executionRepository: ExecutionRepository, executionPersistence: ExecutionPersistence, instanceSettings: InstanceSettings, eventService: EventService, webhookResponseRelay: WebhookResponseRelay);
