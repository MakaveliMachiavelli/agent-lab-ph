...
exports.STREAM_SEPARATOR = exports.FREE_AI_CREDITS_CREDENTIAL_NAME = exports.WsStatusCodes = exports.HIGHEST_SHUTDOWN_PRIORITY = exports.DEFAULT_SHUTDOWN_PRIORITY = exports.LOWEST_SHUTDOWN_PRIORITY = exports.TRIMMED_TASK_DATA_CONNECTIONS = exports.ARTIFICIAL_TASK_DATA = exports.GENERIC_OAUTH2_CREDENTIALS_WITH_EDITABLE_SCOPE = exports.TEST_WEBHOOK_TIMEOUT_BUFFER = exports.TEST_WEBHOOK_TIMEOUT = exports.UM_FIX_INSTRUCTION = exports.SETTINGS_LICENSE_CERT_KEY = exports.TRIGGER_ACTIVATION_MAX_ATTEMPTS = exports.WORKFLOW_REACTIVATE_MAX_TIMEOUT = exports.WORKFLOW_REACTIVATE_INITIAL_TIMEOUT = exports.UNKNOWN_FAILURE_REASON = exports.NPM_PACKAGE_STATUS_GOOD = exports.NPM_COMMAND_TOKENS = exports.OIDC_NONCE_COOKIE_NAME = exports.OIDC_STATE_COOKIE_NAME = exports.AUTH_COOKIE_NAME = exports.RESPONSE_ERROR_MESSAGES = exports.STARTER_TEMPLATE_NAME = exports.NODE_PACKAGE_PREFIX = exports.MCP_TRIGGER_NODE_TYPE = exports.TRIGGER_COUNT_EXCLUDED_NODES = exports.STARTING_NODES = exports.N8N_RELEASE_DATE = exports.WORKFLOW_SDK_VERSION = exports.AI_ASSISTANT_SDK_VERSION = exports.N8N_VERSION = exports.EDITOR_UI_DIST_DIR = exports.NODES_BASE_DIR = exports.TEMPLATES_DIR = exports.AI_ASSISTANT_SDK_DIR = exports.CLI_DIR = exports.CUSTOM_API_CALL_KEY = exports.CUSTOM_API_CALL_NAME = exports.inE2ETests = void 0;
...
exports.AI_ASSISTANT_SDK_DIR = (0, path_1.dirname)((0, path_1.dirname)(require.resolve('@n8n_io/ai-assistant-sdk')));
...
const aiAssistantPackageJsonPath = (0, path_1.join)(exports.AI_ASSISTANT_SDK_DIR, 'package.json');
...
const aiAssistantPackageJson = (0, n8n_workflow_1.jsonParse)((0, fs_1.readFileSync)(aiAssistantPackageJsonPath, 'utf8'));
const workflowSdkPackageJson = (0, n8n_workflow_1.jsonParse)((0, fs_1.readFileSync)(workflowSdkPackageJsonPath, 'utf8'));
exports.N8N_VERSION = n8nPackageJson.version;
exports.AI_ASSISTANT_SDK_VERSION = aiAssistantPackageJson.version;
exports.WORKFLOW_SDK_VERSION = workflowSdkPackageJson.version;
...
exports.TRIGGER_ACTIVATION_MAX_ATTEMPTS = 5;
