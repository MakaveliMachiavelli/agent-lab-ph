...
export declare class SamlService {
    ...
    constructor(logger: Logger, urlService: UrlService, validator: SamlValidator, userRepository: UserRepository, settingsRepository: SettingsRepository, instanceSettings: InstanceSettings, provisioningService: ProvisioningService, cipher: Cipher, cacheService: CacheService, outboundHttp: OutboundHttp);
    ...
    private applySamlPreferenceFields;
    private applyIdpMetadataPreferences;
