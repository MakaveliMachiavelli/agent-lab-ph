...
export declare const saveLdapSynchronization: (data: Omit<AuthProviderSyncHistory, 'id' | 'providerType'>) => Promise<AuthProviderSyncHistory>;
export declare const getLdapSynchronizations: (page: number, perPage: number) => Promise<AuthProviderSyncHistory[]>;
export declare const getLdapSynchronizationsWithCount: (offset: number, limit: number) => Promise<[AuthProviderSyncHistory[], number]>;
