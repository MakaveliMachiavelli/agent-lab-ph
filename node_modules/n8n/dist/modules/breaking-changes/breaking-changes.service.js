...
const breaking_changes_migration_registry_service_1 = require("./breaking-changes.migration-registry.service");
const breaking_changes_rule_registry_service_1 = require("./breaking-changes.rule-registry.service");
const group_nodes_by_type_1 = require("./group-nodes-by-type");
const constants_2 = require("../../constants");
let BreakingChangeService = BreakingChangeService_1 = class BreakingChangeService {
    constructor(ruleRegistry, migrationRegistry, workflowRepository, workflowStatisticsRepository, cacheService, logger, errorReporter) {
    ...
    async getAllWorkflowRulesResults(workflowLevelRules, batchRules, totalWorkflows) {
        ...
        for (let skip = 0; skip < totalWorkflows; skip += this.batchSize) {
            ...
            for (const workflow of workflows) {
                const nodesGroupedByType = (0, group_nodes_by_type_1.groupNodesByType)(workflow.nodes);
...
exports.BreakingChangeService = BreakingChangeService = BreakingChangeService_1 = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [breaking_changes_rule_registry_service_1.RuleRegistry, breaking_changes_migration_registry_service_1.MigrationRegistry, db_1.WorkflowRepository, db_1.WorkflowStatisticsRepository, cache_service_1.CacheService, backend_common_1.Logger, n8n_core_1.ErrorReporter])
