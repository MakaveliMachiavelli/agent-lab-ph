...
export declare class BreakingChangeService {
    ...
    constructor(ruleRegistry: RuleRegistry, migrationRegistry: MigrationRegistry, workflowRepository: WorkflowRepository, workflowStatisticsRepository: WorkflowStatisticsRepository, cacheService: CacheService, logger: Logger, errorReporter: ErrorReporter);
    registerRules(): void;
