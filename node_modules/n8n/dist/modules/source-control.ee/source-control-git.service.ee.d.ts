...
export declare class SourceControlGitService {
    ...
    private hasRemote;
    initRepository(sourceControlPreferences: Pick<SourceControlPreferences, 'repositoryUrl' | 'branchName' | 'initRepo' | 'connectionType'>, user: User, options?: {
        tolerateTrackingFetchFailure?: boolean;
    }): Promise<void>;
