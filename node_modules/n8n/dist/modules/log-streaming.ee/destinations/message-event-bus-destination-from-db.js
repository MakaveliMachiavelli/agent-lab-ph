...
function messageEventBusDestinationFromDb(eventBusInstance, dbData, outboundHttp) {
    ...
    if ('__type' in destinationData) {
        switch (destinationData.__type) {
            ...
            case "$$MessageEventBusDestinationWebhook":
                return message_event_bus_destination_webhook_ee_1.MessageEventBusDestinationWebhook.deserialize(eventBusInstance, destinationData, outboundHttp);
            default:
