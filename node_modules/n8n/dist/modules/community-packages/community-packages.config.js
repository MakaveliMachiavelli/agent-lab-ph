...
let CommunityPackagesConfig = class CommunityPackagesConfig {
    constructor() {
        ...
        this.authToken = '';
        this.aiNodeSdkVersion = AI_NODE_SDK_VERSION;
...
__decorate([
    (0, config_1.Env)('N8N_COMMUNITY_PACKAGES_AUTH_TOKEN'),
    __metadata("design:type", String)
], CommunityPackagesConfig.prototype, "authToken", void 0);
__decorate([
    (0, config_1.Env)('N8N_DISABLED_MODULES'),
    __metadata("design:type", config_1.CommaSeparatedStringArray)
], CommunityPackagesConfig.prototype, "disabledModules", void 0);
