...
let InstalledPackagesRepository = class InstalledPackagesRepository extends typeorm_1.Repository {
    ...
    async replaceInstalledPackageWithNodes(previousInstalledPackage, packageLoader) {
        return await this.persistPackageWithNodes(packageLoader, previousInstalledPackage);
    }
    async persistPackageWithNodes(packageLoader, previousInstalledPackage) {
...
exports.InstalledPackagesRepository = InstalledPackagesRepository = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [typeorm_1.DataSource, installed_nodes_repository_1.InstalledNodesRepository])
