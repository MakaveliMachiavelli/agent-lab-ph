...
export declare function isValidVersionSpecifier(version: string): boolean;
export declare class CommunityPackagesService {
    ...
    constructor(instanceSettings: InstanceSettings, logger: Logger, installedPackageRepository: InstalledPackagesRepository, loadNodesAndCredentials: LoadNodesAndCredentials, publisher: Publisher, license: License, config: CommunityPackagesConfig, outboundHttp: OutboundHttp);
    init(): Promise<void>;
    ...
    private replaceInstalledPackage;
    ...
    private packageDirectoryExists;
    private backupPackageDirectory;
    private restoreFailedPackageInstallation;
    ...
    private removePackageJsonDependency;
    private mutatePackageJsonDependencies;
}
