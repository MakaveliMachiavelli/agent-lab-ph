...
export declare function searchWorkflows(user: User, workflowService: WorkflowService, { limit, query, projectId, tags, sortBy }: SearchWorkflowsParams): Promise<SearchWorkflowsResult>;
export {};
