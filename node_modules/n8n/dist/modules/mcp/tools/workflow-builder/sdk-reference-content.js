...
function getSdkReferenceContent(section, options = {}) {
    ...
    return [
        ...
        SECTIONS.import,
        '',
        (0, sdk_reference_1.buildSdkLanguageReference)({ includeGroups }),
        '',
        SECTIONS.patterns,
        '',
