...
export declare function isValidDataTableId(id: string): boolean;
...
export declare function renameTableQuery(oldTableName: DataTableUserTableName, newTableName: DataTableUserTableName, dbType: DataSourceOptions['type']): string;
...
export declare function normalizeDate(value: unknown): Date | null;
...
export declare function normalizeUserRowValueForDatabase(value: unknown, columnType: string | undefined, dbType?: DataSourceOptions['type']): unknown;
