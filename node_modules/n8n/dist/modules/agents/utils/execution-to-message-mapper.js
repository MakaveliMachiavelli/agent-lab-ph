...
function executionsToMessagesDto(executions) {
    ...
    const duplicatePartIndexesByMessage = new Map();
    for (const message of messages) {
        for (const [partIndex, part] of message.content.entries()) {
            if (!isToolCallWithId(part))
                continue;
