...
exports.resourceLocatorsSkill = resourceLocatorsSkill;
const initial_build_prompt_1 = require("../prompts/initial-build.prompt");
function resourceLocatorsSkill() {
    return {
...
${initial_build_prompt_1.INITIAL_BUILD_NOTE} If the tool needs a credential to resolve a stable
...
//# sourceMappingURL=resource-locators.skill.js.map