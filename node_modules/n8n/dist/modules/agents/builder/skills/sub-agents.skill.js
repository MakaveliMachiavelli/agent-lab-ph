...
exports.subAgentsSkill = subAgentsSkill;
const api_types_1 = require("@n8n/api-types");
function subAgentsSkill() {
    return {
...
- \`subAgents.maxChildren\` must be an integer from ${api_types_1.SUB_AGENT_MAX_CHILDREN_MIN} to ${api_types_1.SUB_AGENT_MAX_CHILDREN_MAX}. When unset, it defaults to ${api_types_1.SUB_AGENT_MAX_CHILDREN_DEFAULT}.
...
//# sourceMappingURL=sub-agents.skill.js.map