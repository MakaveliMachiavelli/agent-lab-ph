...
exports.customToolsSkill = customToolsSkill;
function customToolsSkill() {
    return {
        id: 'agent-builder-custom-tools',
        name: 'Agent Builder Custom Tools',
        description: 'Use when building, updating, or registering a pure computation, validation, formatting, or planning tool with build_custom_tool. Not for HTTP, API, crawling, filesystem, or other live integrations — use node or workflow tools for those.',
...
//# sourceMappingURL=custom-tools.skill.js.map