...
function memorySkill() {
    return {
        ...
        description: 'Use for explicit memory changes: Episodic/long-term/cross-session memory, observer/reflector/extractor worker models, threshold/budget tuning, or disabling memory. Not for ordinary fresh-agent creation, which uses the default memory config in Memory Guidance.',
        recommendedTools: [
...
//# sourceMappingURL=memory.skill.js.map