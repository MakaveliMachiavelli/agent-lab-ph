...
let ChatHubService = class ChatHubService {
    constructor(logger, errorReporter, executionPersistence, workflowFinderService, sessionRepository, messageRepository, chatHubAgentService, chatHubModelsService, chatHubAttachmentService, chatStreamService, chatHubExecutionService, chatHubTitleService, chatHubToolService, chatHubWorkflowService, globalConfig) {
        this.logger = logger;
    ...
    async tryResumeWaitingExecution(opts) {
        ...
        const execution = await this.executionPersistence.findSingleExecution(previousMessage.executionId.toString(), {
            includeData: true,
            unflattenData: true,
        });
        if (!execution) {
