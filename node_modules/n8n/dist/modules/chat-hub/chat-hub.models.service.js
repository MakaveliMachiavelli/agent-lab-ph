...
let ChatHubModelsService = class ChatHubModelsService {
    ...
    async fetchNvidiaModels(credentials, additionalData) {
        return await this.nodeParametersService.getOptionsViaLoadOptions({
            routing: {
                request: {
                    method: 'GET',
        ...
        }, additionalData, chat_hub_constants_1.PROVIDER_NODE_TYPE_MAP.nvidia, {}, credentials);
    }
...
exports.ChatHubModelsService = ChatHubModelsService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [dynamic_node_parameters_service_1.DynamicNodeParametersService, workflow_service_1.WorkflowService, db_1.WorkflowRepository, credentials_finder_service_1.CredentialsFinderService, chat_hub_agent_service_1.ChatHubAgentService, chat_hub_workflow_service_1.ChatHubWorkflowService])
