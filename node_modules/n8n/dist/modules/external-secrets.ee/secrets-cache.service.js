...
let ExternalSecretsSecretsCache = class ExternalSecretsSecretsCache {
    ...
    async refreshProviderWithTimeout(provider) {
        let timeoutId;
        const timeoutPromise = new Promise((_, reject) => {
            timeoutId = setTimeout(() => {
                reject(new n8n_workflow_1.OperationalError(`Timed out refreshing secrets after ${constants_1.EXTERNAL_SECRETS_REFRESH_TIMEOUT_MS}ms`));
            }, constants_1.EXTERNAL_SECRETS_REFRESH_TIMEOUT_MS);
        });
        try {
...
exports.ExternalSecretsSecretsCache = ExternalSecretsSecretsCache = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [backend_common_1.Logger, provider_registry_service_1.ExternalSecretsProviderRegistry])
