...
let InsightsSettings = class InsightsSettings {
    constructor(licenseState, insightsByPeriodRepository) {
...
exports.InsightsSettings = InsightsSettings = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [backend_common_1.LicenseState, insights_by_period_repository_1.InsightsByPeriodRepository])
], InsightsSettings);
