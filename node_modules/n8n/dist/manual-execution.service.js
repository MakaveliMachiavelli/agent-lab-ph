        ...
        if (data.triggerToStartFrom?.data && data.startNodes?.length) {
            ...
            if (data.destinationNode) {
                ...
                if (n8n_workflow_1.NodeHelpers.isTool(destinationNodeType.description, destinationNode.parameters)) {
                    ...
                    if (!workflow.getNode(constants_1.TOOL_EXECUTOR_NODE_NAME)) {
                        throw new n8n_workflow_1.UserError(`The tool "${destinationNode.name}" cannot be executed on its own. Connect it to an AI Agent and try again.`);
                    }
