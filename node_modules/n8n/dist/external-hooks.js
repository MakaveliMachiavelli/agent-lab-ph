...
exports.toWorkflowLifecycleHookActor = toWorkflowLifecycleHookActor;
...
function toWorkflowLifecycleHookActor(user) {
    if (!user) {
        return undefined;
    }
    return {
...
exports.ExternalHooks = ExternalHooks = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [backend_common_1.Logger, n8n_core_1.ErrorReporter, config_1.GlobalConfig, db_1.UserRepository, db_1.SettingsRepository, db_1.CredentialsRepository, db_1.WorkflowRepository])
], ExternalHooks);
