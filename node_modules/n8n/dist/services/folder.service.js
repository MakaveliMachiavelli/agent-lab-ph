...
let FolderService = class FolderService {
    constructor(folderRepository, folderTagMappingRepository, workflowRepository, workflowService, eventService) {
    ...
    async createFolder({ parentFolderId, name }, projectId, id) {
    ...
    async getFoldersByIds(folderIds) {
    ...
    async findFolderWithContentCounts(folderId, projectId) {
...
exports.FolderService = FolderService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [db_1.FolderRepository, db_1.FolderTagMappingRepository, db_1.WorkflowRepository, workflow_service_1.WorkflowService, event_service_1.EventService])
], FolderService);
