    ...
    async compactHistories(startDeltaMs, endDeltaMs, rules, skipRules, metaData = {}) {
        ...
        for (const [index, workflowId] of workflowIds.entries()) {
            try {
                ...
                await (0, sleep_1.sleep)(this.config.batchDelayMs);
            }
...
exports.WorkflowHistoryCompactionService = WorkflowHistoryCompactionService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [config_1.WorkflowHistoryCompactionConfig, config_1.GlobalConfig, backend_common_1.Logger, n8n_core_1.InstanceSettings, db_1.DbConnection, db_1.WorkflowHistoryRepository, event_service_1.EventService])
