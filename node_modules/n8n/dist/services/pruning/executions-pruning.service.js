    ...
    scheduleNextHardDeletion(rateMs = this.rates.hardDeletion) {
        this.hardDeletionTimeout = setTimeout(() => {
            this.hardDelete()
                ...
                this.logger.error('Failed to hard-delete executions', { error: (0, ensure_error_1.ensureError)(error) });
            });
        }, rateMs);
...
exports.ExecutionsPruningService = ExecutionsPruningService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [backend_common_1.Logger, n8n_core_1.InstanceSettings, db_1.DbConnection, db_1.ExecutionRepository, execution_persistence_1.ExecutionPersistence, config_1.ExecutionsConfig])
