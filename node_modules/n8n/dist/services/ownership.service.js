...
let OwnershipService = class OwnershipService {
    ...
    async invalidateWorkflowProjectCacheByIds(workflowIds) {
        await Promise.all(workflowIds.map(async (workflowId) => await this.cacheService.deleteFromHash('workflow-project', workflowId)));
    }
...
exports.OwnershipService = OwnershipService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [cache_service_1.CacheService, event_service_1.EventService, backend_common_1.Logger, password_utility_1.PasswordUtility, db_1.ProjectRelationRepository, db_1.ProjectRepository, db_1.SharedWorkflowRepository, db_1.UserRepository, db_1.SettingsRepository])
], OwnershipService);
