...
let CacheService = class CacheService extends backend_common_1.TypedEmitter {
    constructor(globalConfig) {
        super();
        this.globalConfig = globalConfig;
        this.takingKeys = new Set();
    }
    async init() {
    ...
    async take(key) {
        ...
        if (!key)
            return undefined;
        if (this.cache.kind === 'redis') {
            return await this.cache.store.getdel(key);
        }
        if (this.takingKeys.has(key))
            return undefined;
