...
export declare function stripToolSuffix(nodeType: string): string;
export declare function satisfiesToolCapability(syntheticToolName: string, nodeType: INodeType): boolean;
...
export declare function withExpressionIsolate<T>(workflow: Workflow, fn: () => Promise<T>): Promise<T>;
