...
import { CredentialsRepository, DbConnection, ProjectRelationRepository, SharedWorkflowRepository, WorkflowRepository } from '@n8n/db';
...
export declare class TelemetryEventRelay extends EventRelay {
    ...
    private getPrivateCredentialUsage;
    ...
    private customRoleUpdated;
    private customRoleDeleted;
