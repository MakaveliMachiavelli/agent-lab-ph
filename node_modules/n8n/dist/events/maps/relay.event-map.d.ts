...
import type { CancellationReason, HitlResponseTelemetryPayload, IPersonalizationSurveyAnswersV4, IRun, IWorkflowBase, IWorkflowExecutionDataProcess, JsonValue, WorkflowExecuteMode, WorkflowSettings } from 'n8n-workflow';
import type { ConcurrencyQueueType } from '../../concurrency/concurrency-control.service';
import type { CredentialAuthProbeOutcome } from '../../services/credentials-tester.service';
import type { ExportPackageEventCounts, ImportAuditCredentialIds, ImportPackageEventCounts, ImportPackageEventOptions, PackageFailureReason } from '../../modules/n8n-packages/n8n-packages.types';
...
export type WorkflowActionSource = 'ui' | 'api' | 'n8n-mcp' | 'n8n-ai' | 'import' | 'review-approval';
...
export type RelayEventMap = {
    ...
    'instance-policies-updated': {
        ...
        settingName: '2fa_enforcement' | 'workflow_publishing' | 'workflow_sharing' | 'workflow_reviews';
        value: boolean;
    } | {
