...
import type { IN8nHttpFullResponse, INode, IPinData, IRunExecutionData, IWebhookData, IWebhookResponseData, IWorkflowExecuteAdditionalData, WebhookResponseMode, Workflow, WorkflowExecuteMode, IWorkflowBase, IDestinationNode } from 'n8n-workflow';
import type { WebhookResponse } from '../webhooks/webhook-response';
import type { IWebhookResponseCallbackData, WebhookRequest } from './webhook.types';
export declare function handleHostedChatResponse(res: express.Response, responseMode: WebhookResponseMode, didSendResponse: boolean, executionId: string, resumeToken?: string): boolean;
...
export declare function prepareExecutionData(executionMode: WorkflowExecuteMode, workflowStartNode: INode, webhookResultData: IWebhookResponseData, runExecutionData: IRunExecutionData | undefined, runExecutionDataMerge?: object, destinationNode?: IDestinationNode, executionId?: string, workflowData?: IWorkflowBase, userId?: string): {
    runExecutionData: IRunExecutionData;
