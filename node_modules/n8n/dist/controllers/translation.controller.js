...
exports.NODE_HEADERS_PATH = (0, backend_common_1.safeJoinPath)(constants_1.NODES_BASE_DIR, 'dist/nodes/headers');
let TranslationController = class TranslationController {
    ...
    async getCredentialTranslation(req) {
        ...
        const translationPath = (0, backend_common_1.safeJoinPath)(exports.CREDENTIAL_TRANSLATIONS_DIR, defaultLocale, `${credentialType}.json`);
        try {
