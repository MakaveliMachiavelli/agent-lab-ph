...
let ProjectController = class ProjectController {
    constructor(projectsService, projectRepository, eventService, userManagementMailer, provisioningService) {
    ...
    async getAllProjects(req, res, payload) {
        const [data, count] = await this.projectsService.getAccessibleProjectsAndCount(req.user, payload);
    ...
    async getSharingCandidates(req, res, payload) {
        const [data, count] = await this.projectsService.getShareableProjectsAndCount(req.user, payload);
        const enriched = await this.projectsService.addUserScopes(req.user, data);
        return res.json({ count, data: enriched });
    }
    ...
    async getProject(req, _res, projectId) {
        const [{ id, name, icon, type, description, customTelemetryTags }, relations, rolesManaged] = await Promise.all([
    ...
    async assertProjectRolesNotManaged() {
        if (await this.provisioningService.isProjectRoleManaged()) {
            throw new forbidden_error_1.ForbiddenError('Project roles are managed automatically and cannot be changed manually');
        }
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, api_types_1.ListProjectsQueryDto]),
...
__decorate([
    (0, decorators_1.Get)('/sharing-candidates'),
    (0, decorators_1.GlobalScope)('user:list'),
    __param(2, decorators_1.Query),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, api_types_1.ListProjectsQueryDto]),
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "getSharingCandidates", null);
__decorate([
    (0, decorators_1.Post)('/'),
...
exports.ProjectController = ProjectController = __decorate([
    ...
    __metadata("design:paramtypes", [project_service_ee_1.ProjectService, db_1.ProjectRepository, event_service_1.EventService, email_1.UserManagementMailer, provisioning_service_ee_1.ProvisioningService])
], ProjectController);
