...
let MFAController = class MFAController {
    constructor(mfaService, externalHooks, authService, userRepository, eventService, instanceSettingsLoaderConfig) {
    ...
    async enforceMFA(req) {
        if (this.instanceSettingsLoaderConfig.securityPolicyManagedByEnv) {
            throw new forbidden_error_1.ForbiddenError('MFA enforcement is managed via environment variables and cannot be modified through the API');
        }
...
exports.MFAController = MFAController = __decorate([
    ...
    __metadata("design:paramtypes", [mfa_service_1.MfaService, external_hooks_1.ExternalHooks, auth_service_1.AuthService, db_1.UserRepository, event_service_1.EventService, config_1.InstanceSettingsLoaderConfig])
], MFAController);
