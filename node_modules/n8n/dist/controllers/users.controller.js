...
const ownership_transfer_service_1 = require("../services/ownership-transfer/ownership-transfer.service");
const url_service_1 = require("../services/url.service");
const user_service_1 = require("../services/user.service");
const workflow_service_1 = require("../workflows/workflow.service");
let UsersController = UsersController_1 = class UsersController {
    constructor(logger, externalHooks, sharedCredentialsRepository, sharedWorkflowRepository, userRepository, authService, userService, projectRepository, workflowService, credentialsService, eventService, jwtService, urlService, provisioningService, ownershipTransferService) {
        this.logger = logger;
    ...
    async deleteUser(req) {
        ...
        if (transferId) {
            ...
            await this.ownershipTransferService.transferAllResources([personalProjectToDelete.id], transfereeProjectId);
        }
    ...
    async changeGlobalRole(req, _, payload, id) {
        if (await this.provisioningService.isInstanceRoleManaged()) {
            throw new forbidden_error_1.ForbiddenError('Instance roles are managed automatically and cannot be changed manually');
        }
        const { NO_ADMIN_ON_OWNER, NO_USER, NO_OWNER_ON_OWNER, CANNOT_CHANGE_OWN_ROLE } = UsersController_1.ERROR_MESSAGES.CHANGE_ROLE;
        if (req.user.id === id) {
            throw new forbidden_error_1.ForbiddenError(CANNOT_CHANGE_OWN_ROLE);
        }
...
exports.UsersController = UsersController = UsersController_1 = __decorate([
    ...
    __metadata("design:paramtypes", [backend_common_1.Logger, external_hooks_1.ExternalHooks, db_1.SharedCredentialsRepository, db_1.SharedWorkflowRepository, db_1.UserRepository, auth_service_1.AuthService, user_service_1.UserService, db_1.ProjectRepository, workflow_service_1.WorkflowService, credentials_service_1.CredentialsService, event_service_1.EventService, jwt_service_1.JwtService, url_service_1.UrlService, provisioning_service_ee_1.ProvisioningService, ownership_transfer_service_1.OwnershipTransferService])
], UsersController);
