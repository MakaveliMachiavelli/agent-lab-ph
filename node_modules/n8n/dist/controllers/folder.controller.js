...
let ProjectController = class ProjectController {
    constructor(folderService, enterpriseWorkflowService, projectService) {
    ...
    async getFolderUsedCredentials(req, _res) {
        const { projectId, folderId } = req.params;
        try {
            const credentials = await this.enterpriseWorkflowService.getFolderUsedCredentials(req.user, folderId, projectId);
            return credentials;
        }
        catch (e) {
            if (e instanceof folder_not_found_error_1.FolderNotFoundError) {
    ...
    async getFolderContent(req) {
        const { projectId, folderId } = req.params;
        try {
            const { totalSubFolders, totalWorkflows } = await this.folderService.findFolderWithContentCounts(folderId, projectId);
            return {
                totalSubFolders,
                totalWorkflows,
            };
    ...
    async transferFolderToProject(req, _res, sourceFolderId, sourceProjectId, body) {
        return await this.enterpriseWorkflowService.transferFolder(req.user, sourceProjectId, sourceFolderId, body.destinationProjectId, body.destinationParentFolderId, body.shareCredentials);
    }
};
...
], ProjectController.prototype, "validateProjectExists", null);
__decorate([
    (0, decorators_1.Post)('/'),
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "createFolder", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "getFolderTree", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "getFolderUsedCredentials", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "updateFolder", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "deleteFolder", null);
__decorate([
    (0, decorators_1.Get)('/'),
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "listFolders", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "getFolderContent", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, String, String, api_types_1.TransferFolderBodyDto]),
    __metadata("design:returntype", Promise)
], ProjectController.prototype, "transferFolderToProject", null);
exports.ProjectController = ProjectController = __decorate([
    (0, decorators_1.RestController)('/projects/:projectId/folders'),
    __metadata("design:paramtypes", [folder_service_1.FolderService, workflow_service_ee_1.EnterpriseWorkflowService, project_service_ee_1.ProjectService])
], ProjectController);
