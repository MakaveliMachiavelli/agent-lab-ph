...
export declare const AI_ASSISTANT_SDK_DIR: string;
...
export declare const AI_ASSISTANT_SDK_VERSION: string;
export declare const WORKFLOW_SDK_VERSION: string;
...
export declare const TRIGGER_ACTIVATION_MAX_ATTEMPTS = 5;
