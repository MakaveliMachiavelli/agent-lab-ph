...
import type { ExecutionError, IExecuteResponsePromiseData, WorkflowExecuteMode, IWorkflowExecutionDataProcess } from 'n8n-workflow';
...
export declare class WorkflowRunner {
    ...
    constructor(logger: Logger, errorReporter: ErrorReporter, activeExecutions: ActiveExecutions, executionRepository: ExecutionRepository, executionPersistence: ExecutionPersistence, workflowStaticDataService: WorkflowStaticDataService, nodeTypes: NodeTypes, credentialsPermissionChecker: CredentialsPermissionChecker, instanceSettings: InstanceSettings, manualExecutionService: ManualExecutionService, failedRunFactory: FailedRunFactory, eventService: EventService, executionsConfig: ExecutionsConfig, storageConfig: StorageConfig, externalHooks: ExternalHooks);
    ...
    run(data: IWorkflowExecutionDataProcess, loadStaticData?: boolean, realtime?: boolean, existingExecution?: ResumableExecution, responsePromise?: IDeferredPromise<IExecuteResponsePromiseData>): Promise<string>;
