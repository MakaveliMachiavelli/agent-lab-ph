...
let ChatService = class ChatService {
    ...
    async startSession(req) {
        const { ws, query: { sessionId, executionId, isPublic, token }, } = req;
        if (!ws) {
        ...
        if (execution.data?.resumeToken) {
            ...
            if (!token || tokenBuf.length !== storedBuf.length || !(0, crypto_1.timingSafeEqual)(tokenBuf, storedBuf)) {
                ws.send('Connection rejected');
                ws.close(1008);
                return;
            }
...
exports.ChatService = ChatService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [chat_execution_manager_1.ChatExecutionManager, backend_common_1.Logger, n8n_core_1.ErrorReporter])
], ChatService);
