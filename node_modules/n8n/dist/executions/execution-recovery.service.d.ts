...
export declare class ExecutionRecoveryService {
    ...
    constructor(logger: Logger, instanceSettings: InstanceSettings, push: Push, executionRepository: ExecutionRepository, executionPersistence: ExecutionPersistence, executionsConfig: ExecutionsConfig, workflowRepository: WorkflowRepository, userManagementMailer: UserManagementMailer, ownershipService: OwnershipService, projectRelationRepository: ProjectRelationRepository);
