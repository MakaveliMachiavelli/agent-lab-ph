...
let ExecutionRecoveryService = class ExecutionRecoveryService {
    constructor(logger, instanceSettings, push, executionRepository, executionPersistence, executionsConfig, workflowRepository, userManagementMailer, ownershipService, projectRelationRepository) {
        this.logger = logger;
            ...
            if (lastExecutions.length >= maxLastExecutions &&
                ...
                if (workflow.activeVersionId !== null) {
                    try {
                        ...
                        await di_1.Container.get(WorkflowService).deactivateWorkflowAsSystem(workflowId);
    ...
    async amend(executionId, messages) {
        ...
        if (Object.keys(nodeMessagesByName).length === 0)
            return null;
    ...
    toRelevantMessages(messages) {
        return messages.reduce((acc, cur) => {
            if ((0, event_message_classes_1.isNodeEventMessage)(cur)) {
...
exports.ExecutionRecoveryService = ExecutionRecoveryService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [backend_common_1.Logger, n8n_core_1.InstanceSettings, push_1.Push, db_2.ExecutionRepository, execution_persistence_1.ExecutionPersistence, config_1.ExecutionsConfig, db_2.WorkflowRepository, user_management_mailer_1.UserManagementMailer, ownership_service_1.OwnershipService, db_1.ProjectRelationRepository])
