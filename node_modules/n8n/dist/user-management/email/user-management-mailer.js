...
let UserManagementMailer = class UserManagementMailer {
    ...
    async notifyMcpClientRevoked({ clientName, owner, revoker, }) {
        if (!this.mailer)
            return { emailSent: false };
        const baseUrl = this.urlService.getInstanceBaseUrl();
...
exports.UserManagementMailer = UserManagementMailer = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [config_1.GlobalConfig, backend_common_1.Logger, db_1.UserRepository, url_service_1.UrlService, event_service_1.EventService])
