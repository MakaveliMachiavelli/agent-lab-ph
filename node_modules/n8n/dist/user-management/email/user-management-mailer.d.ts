...
type TemplateName = 'user-invited' | 'password-reset-requested' | 'workflow-deactivated' | 'workflow-shared' | 'credentials-shared' | 'project-shared' | 'workflow-failure' | 'api-key-revoked' | 'mcp-client-revoked';
export declare class UserManagementMailer {
    ...
    notifyApiKeyRevoked({ apiKey, revoker, }: {
        apiKey: ApiKey;
        revoker: User;
    }): Promise<SendEmailResult>;
    notifyMcpClientRevoked({ clientName, owner, revoker, }: {
        clientName: string;
        owner: {
            email: string;
