...
import type { IExecuteResponsePromiseData, IRun, ExecutionStatus, IWorkflowExecutionDataProcess, StructuredChunk, WebhookResponseMode } from 'n8n-workflow';
import { ExecutionCancelledError } from 'n8n-workflow';
import type PCancelable from 'p-cancelable';
import { ExecutionPersistence } from './executions/execution-persistence';
import type { IExecutingWorkflowData, IExecutionsCurrentSummary, ResumableExecution } from './interfaces';
...
export declare class ActiveExecutions {
    ...
    add(executionData: IWorkflowExecutionDataProcess, existingExecution?: ResumableExecution): Promise<string>;
