...
declare const GetSnapshotsCommand_base: {
    new (input: GetSnapshotsCommandInput): import("@smithy/core/client").CommandImpl<GetSnapshotsCommandInput, GetSnapshotsCommandOutput, import("..").KendraClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSnapshotsCommandInput): import("@smithy/core/client").CommandImpl<GetSnapshotsCommandInput, GetSnapshotsCommandOutput, import("..").KendraClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
