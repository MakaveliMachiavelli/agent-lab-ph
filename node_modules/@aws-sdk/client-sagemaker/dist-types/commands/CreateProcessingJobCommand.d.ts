...
declare const CreateProcessingJobCommand_base: {
    new (input: CreateProcessingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateProcessingJobCommandInput, CreateProcessingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateProcessingJobCommandInput): import("@smithy/core/client").CommandImpl<CreateProcessingJobCommandInput, CreateProcessingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
