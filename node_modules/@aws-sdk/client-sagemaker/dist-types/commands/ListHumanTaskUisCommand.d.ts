...
declare const ListHumanTaskUisCommand_base: {
    new (input: ListHumanTaskUisCommandInput): import("@smithy/core/client").CommandImpl<ListHumanTaskUisCommandInput, ListHumanTaskUisCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListHumanTaskUisCommandInput]): import("@smithy/core/client").CommandImpl<ListHumanTaskUisCommandInput, ListHumanTaskUisCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
