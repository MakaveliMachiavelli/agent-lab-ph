...
declare const DescribeProcessingJobCommand_base: {
    new (input: DescribeProcessingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeProcessingJobCommandInput, DescribeProcessingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeProcessingJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeProcessingJobCommandInput, DescribeProcessingJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
