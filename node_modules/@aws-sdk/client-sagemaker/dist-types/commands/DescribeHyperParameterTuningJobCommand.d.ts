...
import type { DescribeHyperParameterTuningJobRequest, DescribeHyperParameterTuningJobResponse } from "../models/models_3";
/**
 * @public
 */
...
declare const DescribeHyperParameterTuningJobCommand_base: {
    new (input: DescribeHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeHyperParameterTuningJobCommandInput, DescribeHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeHyperParameterTuningJobCommandInput): import("@smithy/core/client").CommandImpl<DescribeHyperParameterTuningJobCommandInput, DescribeHyperParameterTuningJobCommandOutput, import("..").SageMakerClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
