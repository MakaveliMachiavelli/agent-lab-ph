import type { _InstanceType, AccountDefaultStatus, BooleanOperator, CrossAccountFilterOption, IPAddressType, ModelApprovalStatus, ModelCardStatus, ModelPackageRegistrationType, ModelRegistrationMode, NotebookInstanceAcceleratorType, PartnerAppAuthType, ResourceType, RootAccess, SearchSortOrder, TrackingServerSize, WorkforceIpAddressType } from "./enums";
import type { AdditionalInferenceSpecificationDefinition, CfnUpdateTemplateProvider, InferenceSpecification, Tag } from "./models_0";
import type { InstanceMetadataServiceConfiguration, ModelLifeCycle, ModelPackageModelCard, MonitoringScheduleConfig, UserSettings } from "./models_1";
import type { IdcConfigInput, MemberDefinition, NotebookInstanceLifecycleHook, NotificationConfiguration, OidcConfig, ParallelismConfiguration, PartnerAppConfig, PartnerAppMaintenanceConfig, PipelineDefinitionS3Location, ProfilerRuleConfiguration, ProvisioningParameter, SourceIpConfig, SpaceSettings, TrialComponentArtifact, TrialComponentParameterValue, TrialComponentStatus, WorkerAccessConfiguration, WorkforceVpcConfigRequest } from "./models_2";
