...
var mistralEmbeddingModelOptions = z4.object({
  /**
   ...
   */
  outputDimension: z4.number().int().positive().optional(),
  /**
   * The data type of the output embeddings when supported by the model.
   */
  outputDtype: z4.enum(["float", "int8", "uint8", "binary", "ubinary"]).optional()
});
...
var MistralTextEmbeddingResponseSchema = z5.object({
