...
export declare const RETRIEVER_WORKFLOW_LANGCHAIN_NODE_TYPE = "@n8n/n8n-nodes-langchain.retrieverWorkflow";
...
export declare const MANUAL_TRIGGER_NODE_TYPES: readonly string[];
