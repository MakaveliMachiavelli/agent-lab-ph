 ...
 */
export declare function findDisplayedProperty(parameterPath: string, properties: INodeProperties[], nodeValues: INodeParameters, node: Pick<INode, 'typeVersion'> | null, nodeTypeDescription: INodeTypeDescription | null): INodePropertyOptions | INodeProperties | INodePropertyCollection | undefined;
/**
 ...
 */
export declare function getToolDescriptionForNode(node: INode, nodeType: INodeType, resolveToolDescription?: () => string): string;
/**
 ...
 */
export declare function getCredentialActivationParameters(displayOptions: ICredentialsDisplayOptions | undefined): INodeParameters;
/**
 ...
 */
export declare function resolveSupportedCredentialActivation(nodeTypeDescription: INodeTypeDescription, node: Pick<INode, 'typeVersion' | 'parameters'>, isSupported: (credentialType: string) => boolean, preferredType?: string): {
