 ...
 * same reference.
 */
export function fromParameter(path, fallback) {
 ...
 */
export function webhookDescriptionFields(fields) {
    const templates = {};
    const resolvers = {};
 ...
 */
export function resolveWebhookDescriptionField(node, description, field) {
 ...
 */
export function webhookDescriptionIsNativelyResolvable(description) {
 ...
 */
export function nodeParametersAreStatic(node) {
