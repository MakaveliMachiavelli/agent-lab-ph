 ...
 */
export function runDataUsedDynamicCredentials(runData) {
 ...
 */
export function runDataAttemptedDynamicCredentials(runData) {
    return Object.values(runData ?? {}).some((tasks) => tasks.some((task) => task?.attemptedDynamicCredentials === true));
}
/**
 ...
 */
export function summarizeDynamicCredentialsUsage(executionData) {
 ...
 */
export function applyDynamicCredentialsUsage(target, usage) {
 ...
 */
export function attachDynamicCredentialsUsage(error, usage) {
 ...
 */
export function takeAttachedDynamicCredentialsUsage(error) {
    ...
    if ('dynamicCredentialsResolvedUserId' in attached &&
...
//# sourceMappingURL=dynamic-credentials-helpers.js.map