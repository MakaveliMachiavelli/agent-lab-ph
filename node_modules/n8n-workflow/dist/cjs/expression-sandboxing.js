...
exports.sanitizer = exports.expressionSandboxHooks = exports.PrototypeSanitizer = exports.DollarSignValidator = exports.ThisSanitizer = exports.ClassExtensionValidator = exports.DOLLAR_SIGN_ERROR = exports.sanitizerName = void 0;
 ...
 */
const ClassExtensionValidator = (ast, _dataNode) => {
    const validate = (superClass) => {
        if (isAstNode(superClass)) {
            ...
            if (typeof superClass.name === 'string' && blockedBaseClasses.has(superClass.name)) {
                throw new errors_1.ExpressionClassExtensionError(superClass.name);
            }
        }
    };
...
exports.ClassExtensionValidator = ClassExtensionValidator;
/**
 ...
 */
exports.expressionSandboxHooks = {
    before: [exports.ClassExtensionValidator, exports.ThisSanitizer],
    after: [exports.PrototypeSanitizer, exports.DollarSignValidator],
};
