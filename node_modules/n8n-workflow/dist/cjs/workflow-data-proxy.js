...
class WorkflowDataProxy {
            ...
            get(target, name) {
                ...
                if ((0, type_guards_1.isResourceLocatorValue)(returnValue)) {
                    if (returnValue.__regex && typeof returnValue.value === 'string') {
                        const extracted = safe_regex_1.safeRegex.exec(returnValue.__regex, returnValue.value);
    ...
    getDataProxy(opts) {
        ...
        const handleFromAi = (name, _description, _type = 'string', defaultValue) => {
            ...
            if (!(0, utils_1.isSafeObjectProperty)(name)) {
                throw new expression_error_1.ExpressionError('Invalid parameter key', {
                    runIndex,
                    itemIndex,
                });
            }
