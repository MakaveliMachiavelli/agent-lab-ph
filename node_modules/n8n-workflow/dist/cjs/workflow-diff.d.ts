import type { IConnections, INode, INodeParameters, IWorkflowBase, IWorkflowGroup, NodeParameterValueType } from '.';
...
declare function mergeAdditiveChanges<N extends DiffableNode = DiffableNode>(prev: DiffableWorkflow<N>, next: DiffableWorkflow<N>, diff: WorkflowChangeSet<N>): boolean;
declare const makeSkipTimeDifference: (timeDiffMs: number) => <N extends DiffableNode = DiffableNode>(prev: DiffableWorkflow<N>, next: DiffableWorkflow<N>) => boolean;
...
export declare const SKIP_RULES: {
    makeSkipTimeDifference: typeof makeSkipTimeDifference;
