...
(function (EventMessageTypeNames) {
    ...
    EventMessageTypeNames["mcp"] = "$$EventMessageMcp";
...
exports.circuitBreakerSchema = zod_1.z
    .object({
...
exports.webhookParameterOptionsSchema = zod_1.z
    .object({
    batch: zod_1.z
        .object({
...
exports.MessageEventBusDestinationOptionsSchema = zod_1.z.object({
    ...
    circuitBreaker: exports.circuitBreakerSchema,
});
...
exports.MessageEventBusDestinationWebhookOptionsSchema = exports.MessageEventBusDestinationOptionsSchema.extend({
    ...
    options: exports.webhookParameterOptionsSchema,
});
