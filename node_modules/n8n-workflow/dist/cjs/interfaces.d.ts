...
export interface FileSystemHelperFunctions {
     ...
     */
    pinDirectory(directoryPath: string, options: {
        create: boolean;
...
export type ISupplyDataFunctions = ExecuteFunctions.GetNodeParameterFn & FunctionsBaseWithRequiredKeys<'getMode'> & Pick<IExecuteFunctions, 'addInputData' | 'addOutputData' | 'getInputConnectionData' | 'getInputData' | 'getNodeOutputs' | 'executeWorkflow' | 'sendMessageToUI' | 'isConsoleOutputRedacted' | 'startJob' | 'helpers' | 'isToolExecution'> & {
...
export type NodePropertyTypes = 'boolean' | 'button' | 'collection' | 'color' | 'dateTime' | 'fixedCollection' | 'hidden' | 'icon' | 'json' | 'callout' | 'notice' | 'multiOptions' | 'number' | 'options' | 'string' | 'credentialsSelect' | 'resourceLocator' | 'curlImport' | 'resourceMapper' | 'filter' | 'assignmentCollection' | 'credentials' | 'workflowSelector' | 'agentSelector';
 ...
 */
declare const NODE_CLASS_TAG: unique symbol;
/**
 ...
 */
export declare function isNodeClassInstance(nodeType: unknown): nodeType is Node;
 ...
 */
export declare const WEBHOOK_RESOLVERS: unique symbol;
/**
 ...
 */
export type NativeParameterResolvers = Record<string, {
    template: string;
...
export type WorkflowExecutionMockDataSource = 'trigger_input' | 'verification_pin_data' | 'workflow_pin_data';
...
export interface IWorkflowExecuteAdditionalData {
    ...
    executeAgent?: (source: ExecuteAgentSource, message: string, executionId: string, threadId: string, additionalData: IWorkflowExecuteAdditionalData, executionMode: WorkflowExecuteMode, outputSchema?: JSONSchema7, workflowContext?: ExecuteAgentWorkflowContext) => Promise<ExecuteAgentData>;
