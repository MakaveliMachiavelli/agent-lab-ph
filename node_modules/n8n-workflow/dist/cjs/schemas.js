...
exports.normalizeNodeShape = normalizeNodeShape;
...
exports.IDisplayOptionsSchema = zod_1.z.object({
    ...
    showOnDeployment: zod_1.z.enum(['cloud', 'hosted']).optional(),
...
const iNodeSchemaObject = zod_1.z.object({
    id: zod_1.z.string(),
    name: zod_1.z.string(),
...
exports.INodeSchema = iNodeSchemaObject;
...
const optionalNonNullableINodeKeys = new Set(Object.entries(iNodeSchemaObject.shape)
