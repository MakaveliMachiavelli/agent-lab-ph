...
exports.classifyTriggerIdentity = classifyTriggerIdentity;
const constants_1 = require("./constants");
const execution_context_establishment_hooks_1 = require("./execution-context-establishment-hooks");
const NO_IDENTITY = {
...
function hasContextEstablishmentHook(parameters) {
    const hookParams = (0, execution_context_establishment_hooks_1.toExecutionContextEstablishmentHookParameter)(parameters);
 ...
 */
function classifyTriggerIdentity(nodeType, parameters, options = {}) {
    ...
    const isSubWorkflowTrigger = nodeType === constants_1.EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE;
    const isChatHubTrigger = nodeType === constants_1.CHAT_TRIGGER_NODE_TYPE && parameters?.availableInChat === true;
    const isMcpTrigger = nodeType === constants_1.MCP_TRIGGER_NODE_TYPE && parameters?.authentication === 'n8nOAuth2';
    ...
    const isOAuth2Webhook = nodeType === constants_1.WEBHOOK_NODE_TYPE &&
    ...
    const isFormTrigger = nodeType === constants_1.FORM_TRIGGER_NODE_TYPE &&
        parameters?.authentication === 'n8nUserAuth' &&
        options.isFormOAuth2Enabled === true;
    if (isSubWorkflowTrigger ||
        isChatHubTrigger ||
        isMcpTrigger ||
        isFormTrigger ||
        isOAuth2Webhook) {
    ...
    if (constants_1.MANUAL_TRIGGER_NODE_TYPES.includes(nodeType)) {
...
//# sourceMappingURL=trigger-identity.js.map