...
exports.removeCircularRefs = exports.isTraversableObject = exports.sleep = exports.jsonStringify = exports.replaceCircularReferences = exports.base64DecodeUTF8 = exports.jsonParse = exports.deepCopy = exports.isObjectEmpty = void 0;
...
const jsonParse = (jsonString, options) => {
    try {
        ...
        if (options?.fallbackValue !== undefined) {
            ...
            throw new user_error_1.UserError(options.errorMessage);
        }
        throw error;
    }
};
...
var sleep_1 = require("@n8n/utils/sleep");
