export declare const RUNTIME_SKILL_REGISTRY_SCHEMA_VERSION: 1;
export declare const RUNTIME_SKILL_FILE_NAME = "SKILL.md";
export declare const SKILL_LOAD_TOOL_NAME = "load_skill";
export declare const RUNTIME_SKILL_LINKED_FILE_GROUPS: readonly ['references', 'templates', 'scripts', 'assets', 'examples'];
export interface RuntimeSkillLinkedFile {
    path: string;
    bytes: number;
    sha256: string;
}
export type RuntimeSkillLinkedFileGroup = (typeof RUNTIME_SKILL_LINKED_FILE_GROUPS)[number] | 'other';
...
export type RuntimeSkillFileLoader = (skillId: string, filePath: string) => Promise<RuntimeSkillFileContent | null>;
