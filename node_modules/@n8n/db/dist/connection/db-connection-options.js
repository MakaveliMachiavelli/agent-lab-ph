        ...
        return {
            ...
            extra: {
                ...
                ...(postgresConfig.maxConnectionLifetimeMs > 0
                    ? {
                        maxLifetimeSeconds: Math.max(1, Math.round(postgresConfig.maxConnectionLifetimeMs / 1000)),
                    }
                    : {}),
...
exports.DbConnectionOptions = DbConnectionOptions = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [config_1.DatabaseConfig, config_1.InstanceSettingsConfig, backend_common_1.ModuleRegistry])
], DbConnectionOptions);
