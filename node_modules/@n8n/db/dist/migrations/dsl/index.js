...
const createSchemaBuilder = (tablePrefix, queryRunner) => ({
    ...
    addColumns: (tableName, columns, _opts) => new table_1.AddColumns(tableName, columns, tablePrefix, queryRunner),
    dropColumns: (tableName, columnNames, _opts) => new table_1.DropColumns(tableName, columnNames, tablePrefix, queryRunner),
    ...
    addNotNull: (tableName, columnName, _opts) => new table_1.AddNotNull(tableName, columnName, tablePrefix, queryRunner),
    dropNotNull: (tableName, columnName, _opts) => new table_1.DropNotNull(tableName, columnName, tablePrefix, queryRunner),
    addEnumCheck: (tableName, columnName, values, _opts) => new table_1.AddEnumCheck(tableName, columnName, values, tablePrefix, queryRunner),
    dropEnumCheck: (tableName, columnName, _opts) => new table_1.DropEnumCheck(tableName, columnName, tablePrefix, queryRunner),
});
