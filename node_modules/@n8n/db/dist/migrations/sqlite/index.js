...
const _1774854660000_CreateInstanceVersionHistoryTable_1 = require("../common/1774854660000-CreateInstanceVersionHistoryTable");
const _1775000000000_CreateInstanceAiTables_1 = require("../common/1775000000000-CreateInstanceAiTables");
const _1775116241000_CreateTokenExchangeJtiTable_1 = require("../common/1775116241000-CreateTokenExchangeJtiTable");
const _1775740765000_ChangeWorkflowPublishHistoryVersionIdToSetNull_1 = require("../common/1775740765000-ChangeWorkflowPublishHistoryVersionIdToSetNull");
...
const _1777023444000_AddJweKeyIndexesToDeploymentKey_1 = require("../common/1777023444000-AddJweKeyIndexesToDeploymentKey");
...
const _1778100001000_AddWorkflowVersionToTestRun_1 = require("../common/1778100001000-AddWorkflowVersionToTestRun");
const _1778100002000_AddEvaluationConfigColumnsToTestRun_1 = require("../common/1778100002000-AddEvaluationConfigColumnsToTestRun");
const _1778496086558_CreateEvaluationCollection_1 = require("../common/1778496086558-CreateEvaluationCollection");
const _1783000000000_CreateAgentTables_1 = require("../common/1783000000000-CreateAgentTables");
const _1783000000001_CreateAgentExecutionTables_1 = require("../common/1783000000001-CreateAgentExecutionTables");
...
const _1784000000007_CreateInstanceAiCheckpointTable_1 = require("../common/1784000000007-CreateInstanceAiCheckpointTable");
const _1784000000008_ResetInstanceAiNativePersistence_1 = require("../common/1784000000008-ResetInstanceAiNativePersistence");
const _1784000000009_CreateAgentMemoryEntryTables_1 = require("../common/1784000000009-CreateAgentMemoryEntryTables");
const _1784000000010_RefactorAgentObservationScope_1 = require("../common/1784000000010-RefactorAgentObservationScope");
const _1784000000011_CreateAgentHistoryTable_1 = require("./1784000000011-CreateAgentHistoryTable");
const _1784000000012_CreateInstanceAiObservationTables_1 = require("../common/1784000000012-CreateInstanceAiObservationTables");
const _1784000000013_SplitRedactionScopeInCustomRoles_1 = require("../common/1784000000013-SplitRedactionScopeInCustomRoles");
const _1784000000014_PersistInstanceAiPendingConfirmations_1 = require("../common/1784000000014-PersistInstanceAiPendingConfirmations");
const _1784000000015_AddSourceWorkflowIdToWorkflow_1 = require("../common/1784000000015-AddSourceWorkflowIdToWorkflow");
const _1784000000016_UseSlugAsPrimaryKeyInMcpRegistryServer_1 = require("../common/1784000000016-UseSlugAsPrimaryKeyInMcpRegistryServer");
const _1784000000017_AddLastUsedAtToApiKey_1 = require("../common/1784000000017-AddLastUsedAtToApiKey");
const _1784000000018_CreateAgentFilesTable_1 = require("../common/1784000000018-CreateAgentFilesTable");
const _1784000000019_AddCustomTelemetryTagsToProject_1 = require("../common/1784000000019-AddCustomTelemetryTagsToProject");
const _1784000000021_CreateAgentTaskDefinitionTable_1 = require("./1784000000021-CreateAgentTaskDefinitionTable");
const _1784000000022_AddSubAgentLinkageToAgentExecutionThreads_1 = require("../common/1784000000022-AddSubAgentLinkageToAgentExecutionThreads");
const _1784000000023_CreateInstanceAiMcpRegistryConnectionTable_1 = require("../common/1784000000023-CreateInstanceAiMcpRegistryConnectionTable");
const _1784000000024_AddResourceToOAuthAuthorizationCodes_1 = require("../common/1784000000024-AddResourceToOAuthAuthorizationCodes");
...
const _1784000000026_AddScopeColumnToOAuthTables_1 = require("./1784000000026-AddScopeColumnToOAuthTables");
...
const _1784000000034_AllowAzureStoredAt_1 = require("./1784000000034-AllowAzureStoredAt");
const _1784000000035_AddUniqueAgentFileNames_1 = require("../common/1784000000035-AddUniqueAgentFileNames");
const _1784000000036_CreateInstanceAiThreadGrantTable_1 = require("../common/1784000000036-CreateInstanceAiThreadGrantTable");
const _1784000000037_DropAgentDescriptionFromAgents_1 = require("./1784000000037-DropAgentDescriptionFromAgents");
const _1784000000038_SetChatHubEnabledFromUsage_1 = require("../common/1784000000038-SetChatHubEnabledFromUsage");
const _1784000000039_DropAgentExecutionFallbackColumns_1 = require("../common/1784000000039-DropAgentExecutionFallbackColumns");
...
const _1784000000045_AddRecurringCronScheduleKind_1 = require("./1784000000045-AddRecurringCronScheduleKind");
const _1784000000046_CreateInstanceAiEventsTable_1 = require("../common/1784000000046-CreateInstanceAiEventsTable");
const _1784000000047_BackfillPreScopingOAuthGrantScopes_1 = require("../common/1784000000047-BackfillPreScopingOAuthGrantScopes");
const _1784000000048_AddTriggerKindToWorkflowPublicationTriggerStatus_1 = require("../common/1784000000048-AddTriggerKindToWorkflowPublicationTriggerStatus");
const _1784000000049_AddScheduledTaskDispatchedAt_1 = require("../common/1784000000049-AddScheduledTaskDispatchedAt");
const _1784000000050_AddHostRunIdToInstanceAiCheckpoints_1 = require("../common/1784000000050-AddHostRunIdToInstanceAiCheckpoints");
const _1784000000051_BackfillInstanceAiEventLog_1 = require("../common/1784000000051-BackfillInstanceAiEventLog");
const _1784000000052_CreateWorkflowReviewRequestTables_1 = require("../common/1784000000052-CreateWorkflowReviewRequestTables");
const _1784815940110_AddStoredAtToAgentExecution_1 = require("../common/1784815940110-AddStoredAtToAgentExecution");
...
const _1784897791636_AddAvailableInMcpToAgents_1 = require("./1784897791636-AddAvailableInMcpToAgents");
const _1785162364000_ChangeInstalledNodeVersionType_1 = require("./1785162364000-ChangeInstalledNodeVersionType");
const _1785162364001_AddIsFirstPartyToOAuthClients_1 = require("./1785162364001-AddIsFirstPartyToOAuthClients");
...
const _1785247194307_AddMisfirePolicyToScheduler_1 = require("./1785247194307-AddMisfirePolicyToScheduler");
const _1785255306000_CreateAgentChatAttachmentsTable_1 = require("../common/1785255306000-CreateAgentChatAttachmentsTable");
const _1785500832626_AddSetupCompletedAtToAgents_1 = require("./1785500832626-AddSetupCompletedAtToAgents");
...
const _1786519946974_AddReasonToWorkflowPublicationOutbox_1 = require("../common/1786519946974-AddReasonToWorkflowPublicationOutbox");
const migration_index_sync_1 = require("../migration-index-sync");
(0, migration_index_sync_1.assertMigrationIndexInSync)(__dirname, 'd5e84c228870b5bd2a8c537e1e5e969d1409e386d5136484a3b0c56e41f89f5b');
exports.sqliteMigrations = [
    ...
    _1774854660000_CreateInstanceVersionHistoryTable_1.CreateInstanceVersionHistoryTable1774854660000,
    _1775000000000_CreateInstanceAiTables_1.CreateInstanceAiTables1775000000000,
    _1775116241000_CreateTokenExchangeJtiTable_1.CreateTokenExchangeJtiTable1775116241000,
    _1775740765000_ChangeWorkflowPublishHistoryVersionIdToSetNull_1.ChangeWorkflowPublishHistoryVersionIdToSetNull1775740765000,
    ...
    _1777023444000_AddJweKeyIndexesToDeploymentKey_1.AddJweKeyIndexesToDeploymentKey1777023444000,
    ...
    _1777996709110_AddRunIndexToTestCaseExecution_1.AddRunIndexToTestCaseExecution1777996709110,
    _1778000000000_AddExecutionDeduplicationKey_1.AddExecutionDeduplicationKey1778000000000,
    _1778100000000_CreateEvaluationConfig_1.CreateEvaluationConfig1778100000000,
    _1778100001000_AddWorkflowVersionToTestRun_1.AddWorkflowVersionToTestRun1778100001000,
    _1778100002000_AddEvaluationConfigColumnsToTestRun_1.AddEvaluationConfigColumnsToTestRun1778100002000,
    _1778496086558_CreateEvaluationCollection_1.CreateEvaluationCollection1778496086558,
    _1783000000000_CreateAgentTables_1.CreateAgentTables1783000000000,
    _1783000000001_CreateAgentExecutionTables_1.CreateAgentExecutionTables1783000000001,
    _1784000000000_CreateAgentObservationTables_1.CreateAgentObservationTables1784000000000,
    _1784000000001_ReplaceAgentObservationTables_1.ReplaceAgentObservationTables1784000000001,
    _1784000000002_DropAgentExecutionWorkingMemory_1.DropAgentExecutionWorkingMemory1784000000002,
    _1784000000003_LimitWorkflowVersionTriggerToContent_1.LimitWorkflowVersionTriggerToContent1784000000003,
    _1784000000004_AddInsightsRawTimestampIdIndex_1.AddInsightsRawTimestampIdIndex1784000000004,
    _1784000000005_CreateMcpRegistryServerTable_1.CreateMcpRegistryServerTable1784000000005,
    _1784000000006_AddNodeGroupsColumnToWorkflowAndHistory_1.AddNodeGroupsColumnToWorkflowAndHistory1784000000006,
    _1784000000007_CreateInstanceAiCheckpointTable_1.CreateInstanceAiCheckpointTable1784000000007,
    _1784000000008_ResetInstanceAiNativePersistence_1.ResetInstanceAiNativePersistence1784000000008,
    _1784000000009_CreateAgentMemoryEntryTables_1.CreateAgentMemoryEntryTables1784000000009,
    _1784000000010_RefactorAgentObservationScope_1.RefactorAgentObservationScope1784000000010,
    _1784000000011_CreateAgentHistoryTable_1.CreateAgentHistoryTable1784000000011,
    _1784000000012_CreateInstanceAiObservationTables_1.CreateInstanceAiObservationTables1784000000012,
    _1784000000013_SplitRedactionScopeInCustomRoles_1.SplitRedactionScopeInCustomRoles1784000000013,
    _1784000000014_PersistInstanceAiPendingConfirmations_1.PersistInstanceAiPendingConfirmations1784000000014,
    _1784000000015_AddSourceWorkflowIdToWorkflow_1.AddSourceWorkflowIdToWorkflow1784000000015,
    _1784000000016_UseSlugAsPrimaryKeyInMcpRegistryServer_1.UseSlugAsPrimaryKeyInMcpRegistryServer1784000000016,
    _1784000000017_AddLastUsedAtToApiKey_1.AddLastUsedAtToApiKey1784000000017,
    _1784000000018_CreateAgentFilesTable_1.CreateAgentFilesTable1784000000018,
    _1784000000019_AddCustomTelemetryTagsToProject_1.AddCustomTelemetryTagsToProject1784000000019,
    _1784000000021_CreateAgentTaskDefinitionTable_1.CreateAgentTaskDefinitionTable1784000000021,
    _1784000000022_AddSubAgentLinkageToAgentExecutionThreads_1.AddSubAgentLinkageToAgentExecutionThreads1784000000022,
    _1784000000023_CreateInstanceAiMcpRegistryConnectionTable_1.CreateInstanceAiMcpRegistryConnectionTable1784000000023,
    _1784000000024_AddResourceToOAuthAuthorizationCodes_1.AddResourceToOAuthAuthorizationCodes1784000000024,
    _1784000000025_MigrateRedactionEnforcementToFloor_1.MigrateRedactionEnforcementToFloor1784000000025,
    _1784000000026_AddScopeColumnToOAuthTables_1.AddScopeColumnToOAuthTables1784000000026,
    _1784000000027_CreateWorkflowPublicationOutboxTable_1.CreateWorkflowPublicationOutboxTable1784000000027,
    _1784000000028_AddProjectIdToInstanceAiThread_1.AddProjectIdToInstanceAiThread1784000000028,
    _1784000000029_AddJsonSizeBytesAndWorkflowVersionIdToExecutionEntity_1.AddJsonSizeBytesAndWorkflowVersionIdToExecutionEntity1784000000029,
    _1784000000030_CreateAgentChatSubscriptions_1.CreateAgentChatSubscriptions1784000000030,
    _1784000000033_AddBinaryDataSizeBytesToExecutionEntity_1.AddBinaryDataSizeBytesToExecutionEntity1784000000033,
    _1784000000034_AllowAzureStoredAt_1.AllowAzureStoredAt1784000000034,
    _1784000000035_AddUniqueAgentFileNames_1.AddUniqueAgentFileNames1784000000035,
    _1784000000036_CreateInstanceAiThreadGrantTable_1.CreateInstanceAiThreadGrantTable1784000000036,
    _1784000000037_DropAgentDescriptionFromAgents_1.DropAgentDescriptionFromAgents1784000000037,
    _1784000000038_SetChatHubEnabledFromUsage_1.SetChatHubEnabledFromUsage1784000000038,
    _1784000000039_DropAgentExecutionFallbackColumns_1.DropAgentExecutionFallbackColumns1784000000039,
    _1784000000040_CreateWorkflowPublicationTriggerStatusTable_1.CreateWorkflowPublicationTriggerStatusTable1784000000040,
    _1784000000041_AddUsedPrivateCredentialsToExecutionEntity_1.AddUsedPrivateCredentialsToExecutionEntity1784000000041,
    _1784000000042_CreateSchedulerTables_1.CreateSchedulerTables1784000000042,
    _1784000000044_AddPartialIndexForGlobalCredentials_1.AddPartialIndexForGlobalCredentials1784000000044,
    _1784000000045_AddRecurringCronScheduleKind_1.AddRecurringCronScheduleKind1784000000045,
    _1784000000046_CreateInstanceAiEventsTable_1.CreateInstanceAiEventsTable1784000000046,
    _1784000000047_BackfillPreScopingOAuthGrantScopes_1.BackfillPreScopingOAuthGrantScopes1784000000047,
    _1784000000048_AddTriggerKindToWorkflowPublicationTriggerStatus_1.AddTriggerKindToWorkflowPublicationTriggerStatus1784000000048,
    _1784000000049_AddScheduledTaskDispatchedAt_1.AddScheduledTaskDispatchedAt1784000000049,
    _1784000000050_AddHostRunIdToInstanceAiCheckpoints_1.AddHostRunIdToInstanceAiCheckpoints1784000000050,
    _1784000000051_BackfillInstanceAiEventLog_1.BackfillInstanceAiEventLog1784000000051,
    _1784000000052_CreateWorkflowReviewRequestTables_1.CreateWorkflowReviewRequestTables1784000000052,
    _1784815940110_AddStoredAtToAgentExecution_1.AddStoredAtToAgentExecution1784815940110,
    _1784815940111_AddInstanceCredentials_1.AddInstanceCredentials1784815940111,
    _1784815940112_CreateAgentEvalTables_1.CreateAgentEvalTables1784815940112,
    _1784897791636_AddAvailableInMcpToAgents_1.AddAvailableInMcpToAgents1784897791636,
    _1785162364000_ChangeInstalledNodeVersionType_1.ChangeInstalledNodeVersionType1785162364000,
    _1785162364001_AddIsFirstPartyToOAuthClients_1.AddIsFirstPartyToOAuthClients1785162364001,
    _1785186578138_AddAgentFileStorageColumns_1.AddAgentFileStorageColumns1785186578138,
    _1785247194306_CrashStaleEnqueuedExecutions_1.CrashStaleEnqueuedExecutions1785247194306,
    ...
    _1786519946974_AddReasonToWorkflowPublicationOutbox_1.AddReasonToWorkflowPublicationOutbox1786519946974,
];
