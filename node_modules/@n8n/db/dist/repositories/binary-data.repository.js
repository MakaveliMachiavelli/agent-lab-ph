...
let BinaryDataRepository = class BinaryDataRepository extends typeorm_1.Repository {
    ...
    async findContentByFileId(fileId) {
    ...
    async deleteByFileIds(fileIds) {
        if (fileIds.length === 0)
            return;
        await this.delete({ fileId: (0, typeorm_1.In)(fileIds) });
    }
