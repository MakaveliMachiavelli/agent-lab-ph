...
export declare class ExecutionRepository extends Repository<ExecutionEntity> {
    ...
    countInWorkflows(workflowIds: string[], options: {
        limit: number;
        lastId?: string;
        status?: ExecutionStatus;
    ...
    getFindManyInWorkflowsCondition(workflowIds: string[], options?: {
        lastId?: string;
        status?: ExecutionStatus;
        excludedExecutionsIds?: string[];
    ...
    getWorkflowIdsWithExecutionsSince(date: Date): Promise<string[]>;
    getDistinctVersionIds(workflowId: string): Promise<string[]>;
