...
let Folder = Folder_1 = class Folder extends abstract_entity_1.WithTimestampsAndStringId {
};
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Folder_1, { nullable: true, onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'parentFolderId' }),
    __metadata("design:type", Object)
], Folder.prototype, "parentFolder", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Folder_1, (folder) => folder.parentFolder),
