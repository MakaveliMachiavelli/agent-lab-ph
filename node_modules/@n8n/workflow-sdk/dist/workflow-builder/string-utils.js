...
exports.generateDeterministicGroupId = generateDeterministicGroupId;
...
function deterministicUuidFromSeed(seed) {
    const hash = (0, crypto_1.createHash)('sha256').update(seed).digest('hex').slice(0, 32);
    return [
        hash.slice(0, 8),
        hash.slice(8, 12),
        '4' + hash.slice(13, 16),
...
function generateDeterministicGroupId(workflowId, groupName) {
