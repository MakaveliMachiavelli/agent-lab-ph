...
exports.memorySessionKeyValidator = {
    ...
    validateNode(node, _graphNode, _ctx) {
        ...
        if (!(0, is_record_1.isRecord)(parameters) || usesFromInputSessionId(parameters)) {
            return [];
        }
