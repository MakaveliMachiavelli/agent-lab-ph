...
function realPathWithin(parent, child) {
    const realParent = (0, fs_1.realpathSync)(parent);
    const realChild = (0, fs_1.realpathSync)(child);
...
function tryLoadSchemaModule(schemaPath, nodesRoot) {
    try {
...
function tryLoadSchemaForNodeType(nodeType, version) {
    ...
    for (const baseDir of schemaBaseDirs) {
        ...
        const schemaModule = tryLoadSchemaModule(flatSchemaPath, nodesRoot) ??
