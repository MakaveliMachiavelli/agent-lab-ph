...
export declare function collectDeclarationsByName(properties: NodeProperty[]): Map<string, NodeProperty[]>;
...
export declare function generateOneOfSchemaLine(variants: SchemaVariant[], allProperties?: NodeProperty[]): string;
export declare function generateMergedSchemaLine(mergedProp: NodeProperty, declarations: NodeProperty[], allProperties: NodeProperty[], keysToStrip: string[]): string;
