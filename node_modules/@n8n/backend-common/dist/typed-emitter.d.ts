...
export declare class TypedEmitter<ListenerMap extends Payloads<ListenerMap>> extends EventEmitter {
    private readonly debounceWait;
    private debouncedEmitTimer;
    ...
    protected debouncedEmit<EventName extends keyof ListenerMap & string>(eventName: EventName, payload?: ListenerMap[EventName]): void;
}
export {};
