...
let LicenseState = class LicenseState {
    ...
    isWorkflowReviewsLicensed() {
        return this.isLicensed(constants_1.LICENSE_FEATURES.WORKFLOW_REVIEWS);
    }
    isSharingLicensed() {
    ...
    isDataRedactionLicensed() {
        return this.isLicensed(constants_1.LICENSE_FEATURES.DATA_REDACTION);
    }
    isProvisioningLicensed() {
        return this.isLicensed(['feat:saml', 'feat:oidc']);
    }
    isOtelCustomSpanAttributesLicensed() {
        return this.isLicensed(constants_1.LICENSE_FEATURES.OTEL_CUSTOM_SPAN_ATTRIBUTES);
    }
    getMaxUsers() {
    ...
    isTeamProjectsLicensed() {
        ...
        return quota === constants_1.UNLIMITED_LICENSE_QUOTA || quota > 0;
    }
