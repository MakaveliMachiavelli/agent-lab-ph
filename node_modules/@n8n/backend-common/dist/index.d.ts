...
export { isContainedWithin, safeJoinPath, pathComponents, pathSegmentsBetween, containsSymlinkedComponent, } from './utils/path-util';
...
export { type ILockService, LockNamespace, LockAcquisitionTimeoutError, } from './locking/lock-service.interface';
