...
class PostgresQueryRunner extends BaseQueryRunner_1.BaseQueryRunner {
    ...
    async loadViews(viewNames) {
        ...
        return dbViews.map((dbView) => {
            ...
            const schema = dbView['schema'] === currentSchema && !this.driver.options.schema
                ? undefined
                : dbView['schema'];
        ...
        return Promise.all(dbTables.map(async (dbTable) => {
            ...
            table.columns = await Promise.all(dbColumns
                ...
                if (tableColumn.type === 'interval' ||
                    ...
                    tableColumn.precision = !this.isDefaultColumnPrecision(table, tableColumn, dbColumn['datetime_precision'])
                ...
                if (primaryConstraint) {
                    ...
                    const anotherPrimaryConstraints = dbConstraints.filter((constraint) => constraint['table_name'] === dbColumn['table_name'] &&
                ...
                if (dbColumn.is_identity === 'YES') {
                    ...
                    if (defaultWithoutQuotes === serialDefaultName ||
