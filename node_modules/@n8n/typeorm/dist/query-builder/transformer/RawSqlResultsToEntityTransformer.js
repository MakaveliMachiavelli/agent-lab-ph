    ...
    transformRelationCounts(rawSqlResults, alias, entity) {
        ...
        this.rawRelationCountResults
            ...
            if (relation.isOneToMany) {
                referenceColumnName =
                    relation.inverseRelation.joinColumns[0].referencedColumn.databaseName; // todo: fix joinColumns[0]
            }
            else {
            ...
            if (referenceColumnValue !== undefined && referenceColumnValue !== null) {
                ...
                rawRelationCountResult.results
                    ...
                    .forEach((result) => {
                    entity[rawRelationCountResult.relationCountAttribute.mapToPropertyPropertyName] =
                        parseInt(result['cnt']);
                    hasData = true;
                });
            }
    ...
    createValueMapFromJoinColumns(relation, parentAlias, rawSqlResults) {
        ...
        return columns.reduce((valueMap, column) => {
            rawSqlResults.forEach((rawSqlResult) => {
                if (relation.isManyToOne || relation.isOneToOneOwner) {
                    valueMap[column.databaseName] = this.driver.prepareHydratedValue(rawSqlResult[DriverUtils_1.DriverUtils.buildAlias(this.driver, undefined, parentAlias, column.databaseName)], column);
                }
                else {
                    valueMap[column.databaseName] = this.driver.prepareHydratedValue(rawSqlResult[DriverUtils_1.DriverUtils.buildAlias(this.driver, undefined, parentAlias, column.referencedColumn.databaseName)], column.referencedColumn);
                }
            });
            return valueMap;
        }, {});
