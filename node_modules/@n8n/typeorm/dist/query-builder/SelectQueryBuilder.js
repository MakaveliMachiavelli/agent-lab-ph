...
class SelectQueryBuilder extends QueryBuilder_1.QueryBuilder {
    ...
    createSelectExpression() {
        ...
        const selection = allSelects
            .map((select) => select.selection + (select.aliasName ? ' AS ' + this.escape(select.aliasName) : ''))
            .join(', ');
        ...
        const joins = this.expressionMap.joinAttributes.map((joinAttr) => {
            ...
            if (relation.isManyToOne || relation.isOneToOneOwner) {
                ...
                const condition = relation
                    ...
                    if (relation.inverseEntityMetadata.tableType === 'entity-child' &&
                ...
                if (relationValue === true || typeof relationValue === 'object') {
                    if (this.expressionMap.relationLoadStrategy === 'query') {
                        ...
                        this.joins.push({
                            type: 'left',
                            select: true,
                            selection: selection && typeof selection[relationName] === 'object'
