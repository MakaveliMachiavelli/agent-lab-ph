...
type _QueryDeepPartialEntity<T, Depth extends number = 10> = [Depth] extends [never] ? T : {
    [P in keyof T]?: (T[P] extends Array<infer U> ? Array<_QueryDeepPartialEntity<U, _QueryDeepPartialEntityDecr[Depth]>> : T[P] extends ReadonlyArray<infer U> ? ReadonlyArray<_QueryDeepPartialEntity<U, _QueryDeepPartialEntityDecr[Depth]>> : _QueryDeepPartialEntity<T[P], _QueryDeepPartialEntityDecr[Depth]>) | (() => string);
};
/**
