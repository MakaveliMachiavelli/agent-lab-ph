...
function getMcpRegistrySection(mcpRegistrySearchEnabled) {
    if (!mcpRegistrySearchEnabled)
        return '';
    return `
...
function getSystemPrompt(options = {}) {
    const { webhookBaseUrl, formBaseUrl, localGateway, toolSearchEnabled, mcpToolSearchEnabled, mcpRegistrySearchEnabled, licenseHints, browserAvailable, branchReadOnly, projectId, workspaceRoot, } = options;
