        ...
        switch (localGateway.status) {
            case 'connected':
                if (localGateway.capabilities.length > 0) {
                    promptParts.push(`Computer Use is connected, the user has enabled following capabilities: ${localGateway.capabilities.join(',')}`);
...
//# sourceMappingURL=computer-use-prompt.js.map