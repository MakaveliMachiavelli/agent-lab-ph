import { FlattenedItem, TreeRootEmits, TreeRootProps } from 'reka-ui';
...
export type TreeGetNodeProps<T extends TreeItem = TreeBranch, P extends Record<string, unknown> = TreeDefaultNodeProps> = (context: TreeNodeContext<T>) => P;
export type TreeProps = Omit<TreeRootProps<TreeBranch, TreeBranch, boolean>, 'asChild' | 'as' | 'getKey' | 'getChildren' | 'modelValue' | 'defaultValue'> & {
    items: TreeBranch[];
