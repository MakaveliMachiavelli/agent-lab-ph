...
export declare const LICENSE_FEATURES: {
    ...
    readonly BINARY_DATA_AZURE: 'feat:binaryDataAz';
    readonly EXECUTION_DATA_S3: 'feat:executionDataS3';
    readonly EXECUTION_DATA_AZURE: 'feat:executionDataAz';
    ...
    readonly AI_GATEWAY: 'feat:aiGateway';
    ...
    readonly TOKEN_EXCHANGE: 'feat:tokenExchange';
    readonly DATA_REDACTION: 'feat:dataRedaction';
    readonly OTEL_CUSTOM_SPAN_ATTRIBUTES: 'feat:otel:customSpanAttributes';
    readonly WORKFLOW_REVIEWS: 'feat:workflowReviews';
};
export declare const LICENSE_QUOTAS: {
    ...
    readonly AI_GATEWAY_BUDGET: 'quota:aiGatewayBudget';
    ...
    readonly EVALUATION_CONCURRENCY_LIMIT: 'quota:evaluations:concurrencyLimit';
};
...
export declare const MAX_INTEGER_32BITS_SIGNED: number;
