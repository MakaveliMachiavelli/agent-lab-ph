...
exports.EndpointsConfig = exports.PrometheusMetricsConfig = void 0;
...
let PrometheusMetricsConfig = class PrometheusMetricsConfig {
    constructor() {
        ...
        this.includeSchedulerMetrics = false;
        this.schedulerMetricsInterval = 20;
        ...
        this.includeExecutionDataMetrics = false;
        this.includeSsrfMetrics = false;
        this.includeDnsCacheMetrics = false;
        this.includeWebhookMetrics = false;
        this.includeFormMetrics = false;
        this.includeWorkflowInfoMetrics = false;
        this.workflowInfoMetricInterval = 60;
        this.includeDbPoolMetrics = false;
        this.includeWorkflowPublicationMetrics = false;
        this.workflowPublicationMetricInterval = 60;
    }
};
exports.PrometheusMetricsConfig = PrometheusMetricsConfig;
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_SCHEDULER_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeSchedulerMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_SCHEDULER_INTERVAL'),
    __metadata("design:type", Number)
], PrometheusMetricsConfig.prototype, "schedulerMetricsInterval", void 0);
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_EXECUTION_DATA_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeExecutionDataMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_SSRF_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeSsrfMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_DNS_CACHE_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeDnsCacheMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_WEBHOOK_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeWebhookMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_FORM_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeFormMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_WORKFLOW_INFO'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeWorkflowInfoMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_WORKFLOW_INFO_METRIC_INTERVAL'),
    __metadata("design:type", Number)
], PrometheusMetricsConfig.prototype, "workflowInfoMetricInterval", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_DB_POOL_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeDbPoolMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_INCLUDE_WORKFLOW_PUBLICATION_METRICS'),
    __metadata("design:type", Boolean)
], PrometheusMetricsConfig.prototype, "includeWorkflowPublicationMetrics", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_METRICS_WORKFLOW_PUBLICATION_METRIC_INTERVAL'),
    __metadata("design:type", Number)
], PrometheusMetricsConfig.prototype, "workflowPublicationMetricInterval", void 0);
exports.PrometheusMetricsConfig = PrometheusMetricsConfig = __decorate([
    decorators_1.Config
...
let EndpointsConfig = class EndpointsConfig {
    constructor() {
        ...
        this.mcpAppsEnabled = false;
        this.mcpCanvasGroupsEnabled = false;
...
__decorate([
    (0, decorators_1.Env)('N8N_MCP_APPS_ENABLED'),
    __metadata("design:type", Boolean)
], EndpointsConfig.prototype, "mcpAppsEnabled", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_MCP_CANVAS_GROUPS_ENABLED'),
    __metadata("design:type", Boolean)
], EndpointsConfig.prototype, "mcpCanvasGroupsEnabled", void 0);
__decorate([
