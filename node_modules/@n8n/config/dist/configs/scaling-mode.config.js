...
let RedisTlsConfig = class RedisTlsConfig {
    constructor() {
        this.serverName = '';
...
__decorate([
    (0, decorators_1.Env)('QUEUE_BULL_REDIS_TLS_SERVERNAME'),
    __metadata("design:type", String)
], RedisTlsConfig.prototype, "serverName", void 0);
__decorate([
    (0, decorators_1.Env)('QUEUE_BULL_REDIS_TLS_VALIDATE_CERTIFICATE'),
    __metadata("design:type", Boolean)
], RedisTlsConfig.prototype, "rejectUnauthorized", void 0);
RedisTlsConfig = __decorate([
    decorators_1.Config
], RedisTlsConfig);
let RedisConfig = class RedisConfig {
    constructor() {
        ...
        this.password = '';
        this.port = 6379;
        this.timeoutThreshold = 10 * constants_1.Time.seconds.toMilliseconds;
        this.slotsRefreshTimeout = 1 * constants_1.Time.seconds.toMilliseconds;
        this.slotsRefreshInterval = 5 * constants_1.Time.seconds.toMilliseconds;
        this.username = '';
        this.clusterNodes = '';
        this.tls = false;
        ...
        this.keepAliveDelay = 5 * constants_1.Time.seconds.toMilliseconds;
        this.keepAliveInterval = 5 * constants_1.Time.seconds.toMilliseconds;
...
__decorate([
    decorators_1.Nested,
    __metadata("design:type", RedisTlsConfig)
], RedisConfig.prototype, "tlsConfig", void 0);
__decorate([
...
let SettingsConfig = class SettingsConfig {
    constructor() {
        this.lockDuration = 1 * constants_1.Time.minutes.toMilliseconds;
        this.lockRenewTime = 10 * constants_1.Time.seconds.toMilliseconds;
        this.stalledInterval = 30 * constants_1.Time.seconds.toMilliseconds;
    }
};
__decorate([
