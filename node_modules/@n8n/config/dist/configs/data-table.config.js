...
let DataTableConfig = class DataTableConfig {
    constructor() {
        ...
        this.sizeCheckCacheDuration = 5 * constants_1.Time.seconds.toMilliseconds;
        this.cleanupIntervalMs = 1 * constants_1.Time.minutes.toMilliseconds;
        this.fileMaxAgeMs = 2 * constants_1.Time.minutes.toMilliseconds;
