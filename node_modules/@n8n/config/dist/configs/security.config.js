...
const crossOriginOpenerPolicySchema = zod_1.default.enum(['same-origin', 'same-origin-allow-popups']);
...
const awsSystemCredentialsSdkSourcesSchema = zod_1.default.string().refine((value) => {
    ...
    return raw
        ...
        .every((source) => awsSystemCredentialSources.includes(source));
}, {
...
__decorate([
    (0, decorators_1.Env)('N8N_CROSS_ORIGIN_OPENER_POLICY', crossOriginOpenerPolicySchema),
    __metadata("design:type", void 0)
], SecurityConfig.prototype, "crossOriginOpenerPolicy", void 0);
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_INSECURE_DISABLE_FORM_HTML_SANDBOX'),
    __metadata("design:type", Boolean)
], SecurityConfig.prototype, "disableFormHtmlSandboxing", void 0);
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_AWS_SYSTEM_CREDENTIALS_SDK_SOURCES', awsSystemCredentialsSdkSourcesSchema),
    __metadata("design:type", String)
], SecurityConfig.prototype, "awsSystemCredentialsSdkSources", void 0);
__decorate([
...
__decorate([
    (0, decorators_1.Env)('N8N_POSTMESSAGE_ALLOWED_ORIGINS'),
    __metadata("design:type", String)
], SecurityConfig.prototype, "postMessageAllowedOrigins", void 0);
