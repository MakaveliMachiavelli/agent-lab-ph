...
let SentryConfig = class SentryConfig {
    constructor() {
        ...
        this.tracesSlowSpanThresholdMs = 1000;
        this.webhookTracesSampleRate = 0.05;
        this.eventLoopBlockDetectionEnabled = false;
        this.eventLoopBlockThreshold = 500;
        this.eventLoopBlockMaxEventsPerHour = 5;
        this.environment = '';
        this.deploymentName = '';
    }
};
...
__decorate([
    (0, decorators_1.Env)('N8N_SENTRY_TRACES_SLOW_SPAN_THRESHOLD_MS', zod_1.z.number({ coerce: true }).int().positive()),
    __metadata("design:type", Number)
], SentryConfig.prototype, "tracesSlowSpanThresholdMs", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_SENTRY_WEBHOOK_TRACES_SAMPLE_RATE', exports.sampleRateSchema),
    __metadata("design:type", Number)
], SentryConfig.prototype, "webhookTracesSampleRate", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_SENTRY_EVENT_LOOP_BLOCK_DETECTION_ENABLED'),
    __metadata("design:type", Boolean)
], SentryConfig.prototype, "eventLoopBlockDetectionEnabled", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_SENTRY_EVENT_LOOP_BLOCK_THRESHOLD', schemas_1.positiveIntSchema),
    __metadata("design:type", Number)
], SentryConfig.prototype, "eventLoopBlockThreshold", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_SENTRY_EVENT_LOOP_BLOCK_MAX_EVENTS_PER_HOUR', schemas_1.positiveIntSchema),
    __metadata("design:type", Number)
], SentryConfig.prototype, "eventLoopBlockMaxEventsPerHour", void 0);
__decorate([
