...
const nonNegativeIntSchema = zod_1.default.coerce.number().int().nonnegative();
let QueueRetentionConfig = class QueueRetentionConfig {
    constructor() {
        this.keepLastCompleted = 0;
        this.keepLastFailed = 0;
    }
};
__decorate([
    (0, decorators_1.Env)('N8N_EXECUTIONS_QUEUE_KEEP_LAST_COMPLETED', nonNegativeIntSchema),
    __metadata("design:type", Number)
], QueueRetentionConfig.prototype, "keepLastCompleted", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_EXECUTIONS_QUEUE_KEEP_LAST_FAILED', nonNegativeIntSchema),
    __metadata("design:type", Number)
], QueueRetentionConfig.prototype, "keepLastFailed", void 0);
QueueRetentionConfig = __decorate([
    decorators_1.Config
...
let ExecutionsConfig = class ExecutionsConfig {
    constructor() {
        this.mode = 'regular';
        this.timeout = -1;
        this.maxTimeout = 1 * constants_1.Time.hours.toSeconds;
        this.pruneData = true;
        ...
        this.maxDisplaySize = 100 * 1024 * 1024;
        this.webhookResponseRelaySizeMaxMiB = 64;
        this.webhookResponseRelayOffloadEnabled = false;
    }
};
...
__decorate([
    decorators_1.Nested,
    __metadata("design:type", QueueRetentionConfig)
], ExecutionsConfig.prototype, "queueRetention", void 0);
__decorate([
    decorators_1.Nested,
...
__decorate([
    (0, decorators_1.Env)('EXECUTIONS_DATA_MAX_DISPLAY_SIZE'),
    __metadata("design:type", Number)
], ExecutionsConfig.prototype, "maxDisplaySize", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_WEBHOOK_RESPONSE_RELAY_SIZE_MAX', schemas_1.positiveIntSchema),
    __metadata("design:type", Number)
], ExecutionsConfig.prototype, "webhookResponseRelaySizeMaxMiB", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_WEBHOOK_RESPONSE_RELAY_OFFLOAD_ENABLED'),
    __metadata("design:type", Boolean)
], ExecutionsConfig.prototype, "webhookResponseRelayOffloadEnabled", void 0);
