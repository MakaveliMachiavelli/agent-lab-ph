...
let TaskRunnersConfig = class TaskRunnersConfig {
    constructor() {
        ...
        this.taskTimeout = 5 * constants_1.Time.minutes.toSeconds;
        this.taskRequestTimeout = 60;
        this.taskAcceptTimeout = 2;
...
__decorate([
    (0, decorators_1.Env)('N8N_RUNNERS_TASK_ACCEPT_TIMEOUT'),
    __metadata("design:type", Number)
], TaskRunnersConfig.prototype, "taskAcceptTimeout", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_RUNNERS_HEARTBEAT_INTERVAL'),
    __metadata("design:type", Number)
], TaskRunnersConfig.prototype, "heartbeatInterval", void 0);
__decorate([
    (0, decorators_1.Env)('N8N_RUNNERS_GRANT_TOKEN_TTL', schemas_1.positiveIntSchema),
    __metadata("design:type", Number)
