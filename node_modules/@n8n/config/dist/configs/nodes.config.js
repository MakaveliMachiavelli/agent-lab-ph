...
let NodesConfig = class NodesConfig {
    constructor() {
        ...
        this.mergeSqlSandboxMemoryLimitMb = 64;
    }
};
...
__decorate([
    (0, decorators_1.Env)('NODES_MERGE_SQL_SANDBOX_MEMORY_LIMIT_MB', zod_1.z.coerce.number().int().positive()),
    __metadata("design:type", Number)
], NodesConfig.prototype, "mergeSqlSandboxMemoryLimitMb", void 0);
