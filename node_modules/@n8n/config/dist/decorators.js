...
const readEnv = (envName) => {
    ...
    if (filePath) {
        ...
        if (value !== trimmed) {
            console.warn(`[n8n] Warning: The file specified by ${envName}_FILE contained leading or trailing whitespace; the value was trimmed.`);
        }
        return trimmed;
    }
    return undefined;
};
const normalizeEnvValue = (value) => value.trim().replace(/^(['"])(.*)\1$/, '$2');
