    ...
    getUri(opts) {
        ...
        for (const [key, value] of Object.entries(queryParams)) {
            ...
            if (FLOW_OWNED_PARAMS.has(key)) {
                if (param === '' && url.searchParams.has(key))
                    continue;
