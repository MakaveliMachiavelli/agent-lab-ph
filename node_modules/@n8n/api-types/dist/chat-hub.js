...
exports.ChatHubUpdateToolRequest = exports.ChatHubCreateToolRequest = exports.CHAT_USER_BLOCKED_CHAT_HUB_TOOL_TYPES = exports.ALWAYS_BLOCKED_CHAT_HUB_TOOL_TYPES = exports.chatHubMessageWithButtonsSchema = exports.chatHubMessageButtonSchema = exports.ChatReconnectRequest = exports.ChatHubSemanticSearchSettings = exports.UpdateChatEnabledRequest = exports.UpdateChatSettingsRequest = exports.ChatHubUpdateAgentRequest = exports.ChatHubCreateAgentRequest = exports.suggestedPromptsSchema = exports.suggestedPromptSchema = exports.ChatHubConversationsRequest = exports.ChatHubUpdateConversationRequest = exports.ChatHubManualEditMessageRequest = exports.ChatHubEditMessageRequest = exports.ChatHubManualRegenerateMessageRequest = exports.ChatHubRegenerateMessageRequest = exports.ChatHubManualSendMessageRequest = exports.ChatHubSendMessageRequest = exports.chatAttachmentSchema = exports.emptyChatModelsResponse = exports.chatModelsRequestSchema = exports.chatHubConversationModelSchema = exports.VECTOR_STORE_PROVIDER_CREDENTIAL_TYPE_MAP = exports.PROVIDER_CREDENTIAL_TYPE_MAP = exports.chatHubSessionTypeSchema = exports.chatHubProviderSchema = exports.agentIconOrEmojiSchema = exports.chatHubVectorStoreProviderSchema = exports.chatHubLLMProviderSchema = exports.TimeZoneSchema = exports.StrictTimeZoneSchema = exports.isValidTimeZone = void 0;
const n8n_workflow_1 = require("n8n-workflow");
const zod_1 = require("zod");
const timezone_schema_1 = require("./schemas/timezone.schema");
const zod_class_1 = require("./zod-class");
var timezone_schema_2 = require("./schemas/timezone.schema");
Object.defineProperty(exports, "isValidTimeZone", { enumerable: true, get: function () { return timezone_schema_2.isValidTimeZone; } });
Object.defineProperty(exports, "StrictTimeZoneSchema", { enumerable: true, get: function () { return timezone_schema_2.StrictTimeZoneSchema; } });
Object.defineProperty(exports, "TimeZoneSchema", { enumerable: true, get: function () { return timezone_schema_2.TimeZoneSchema; } });
...
exports.chatHubSessionTypeSchema = zod_1.z.enum(['production', 'manual']);
...
const nvidiaModelSchema = zod_1.z.object({
    provider: zod_1.z.literal('nvidia'),
    model: zod_1.z.string(),
});
...
class ChatHubManualSendMessageRequest extends zod_class_1.Z.class({
    messageId: zod_1.z.string().uuid(),
    sessionId: zod_1.z.string().uuid(),
    message: zod_1.z.string(),
    previousMessageId: zod_1.z.string().uuid().nullable(),
...
exports.ChatHubManualSendMessageRequest = ChatHubManualSendMessageRequest;
...
class ChatHubManualRegenerateMessageRequest extends zod_class_1.Z.class({
    timeZone: timezone_schema_1.TimeZoneSchema,
}) {
}
exports.ChatHubManualRegenerateMessageRequest = ChatHubManualRegenerateMessageRequest;
...
class ChatHubManualEditMessageRequest extends zod_class_1.Z.class({
    message: zod_1.z.string(),
    messageId: zod_1.z.string().uuid(),
    newAttachments: zod_1.z.array(exports.chatAttachmentSchema),
    keepAttachmentIndices: zod_1.z.array(zod_1.z.number()),
...
exports.ChatHubManualEditMessageRequest = ChatHubManualEditMessageRequest;
...
class ChatHubConversationsRequest extends zod_class_1.Z.class({
    ...
    type: exports.chatHubSessionTypeSchema.optional(),
}) {
}
...
const chatProviderSettingsSchema = zod_1.z.object({
    ...
    responsesApiEnabled: zod_1.z.boolean().optional(),
    contextWindowLength: zod_1.z.number().int().min(1).max(256).optional(),
...
class UpdateChatEnabledRequest extends zod_class_1.Z.class({
    enabled: zod_1.z.boolean(),
}) {
}
exports.UpdateChatEnabledRequest = UpdateChatEnabledRequest;
