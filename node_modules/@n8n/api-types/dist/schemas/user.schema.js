...
exports.roleSchema = zod_1.z.string().regex(/^(global:.+|default)$/);
exports.userProjectSchema = zod_1.z.object({
    id: zod_1.z.string(),
    role: permissions_1.projectRoleSchema,
    name: zod_1.z.string(),
    icon: project_schema_1.projectIconSchema.nullable().optional(),
});
...
exports.userDetailSchema = exports.userBaseSchema.extend({
    ...
    isManagedByEnv: zod_1.z.boolean().optional(),
});
