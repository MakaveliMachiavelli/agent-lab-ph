...
const workflow_publish_blocked_details_1 = require("../workflow-publish-blocked-details");
...
exports.SourceControlledFileSchema = zod_1.z.object({
    ...
    folderPath: zod_1.z.array(zod_1.z.string()).optional(),
    owner: ResourceOwnerSchema.optional(),
    publishingError: zod_1.z.string().optional(),
    publishingErrorDetails: workflow_publish_blocked_details_1.workflowPublishBlockedDetailsSchema.optional(),
});
