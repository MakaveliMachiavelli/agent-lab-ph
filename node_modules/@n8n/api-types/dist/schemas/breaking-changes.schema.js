...
const workflowMigrationResultSchema = zod_1.z.object({
    workflowId: zod_1.z.string(),
    newVersionId: zod_1.z.string(),
    migratedNodeIds: zod_1.z.array(zod_1.z.string()),
    unmapped: zod_1.z.array(zod_1.z.string()),
    notes: zod_1.z.array(zod_1.z.string()),
    republishable: zod_1.z.boolean(),
});
