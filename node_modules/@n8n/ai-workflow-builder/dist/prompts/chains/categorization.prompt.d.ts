...
export declare const examplePrompts: ({
    prompt: string;
    techniques: ("chatbot" | "content_generation" | "monitoring")[];
} | {
    prompt: string;
    techniques: ("form_input" | "human_in_the_loop")[];
} | {
    prompt: string;
    techniques: ("data_analysis" | "data_extraction" | "data_persistence" | "scheduling" | "scraping_and_research")[];
} | {
    prompt: string;
    techniques: ("data_extraction" | "data_transformation" | "document_processing" | "enrichment")[];
} | {
    prompt: string;
    techniques: ("data_analysis" | "data_transformation" | "knowledge_base")[];
} | {
    prompt: string;
    techniques: ("data_persistence" | "form_input" | "notification")[];
})[];
