...
export declare const CODE_BUILDER_VALIDATE_NODE_TOOL: BuilderToolBase;
...
export declare const MCP_EXPLORE_NODE_RESOURCES_TOOL: BuilderToolBase;
export declare const MCP_GET_WORKFLOW_BEST_PRACTICES_TOOL: BuilderToolBase;
