...
function isPlanInterruptValue(value) {
    if (!(0, is_record_1.isRecord)(value))
        return false;
    return value.type === 'plan' && (0, is_record_1.isRecord)(value.plan);
}
function isWebFetchApprovalInterruptValue(value) {
    if (!(0, is_record_1.isRecord)(value))
        return false;
    return (value.type === 'web_fetch_approval' &&
        typeof value.requestId === 'string' &&
        typeof value.url === 'string' &&
        typeof value.domain === 'string');
}
function extractInterruptPayload(update) {
    if (!(0, is_record_1.isRecord)(update))
        return null;
    ...
    if (!(0, is_record_1.isRecord)(first))
        return null;
    const value = first.value;
    if (!(0, is_record_1.isRecord)(value))
        return null;
    const id = typeof first.id === 'string' ? first.id : undefined;
    if (isQuestionsInterruptValue(value) ||
...
function isUserAnswersPayload(value) {
    if (!Array.isArray(value))
        return false;
    return value.every((item) => (0, is_record_1.isRecord)(item) &&
...
function tryFormatHitlMessage(msg) {
    ...
    if (!(0, is_record_1.isRecord)(parsed) || parsed.type !== messageType)
        return null;
    ...
    if (!(0, is_record_1.isRecord)(plan))
        return null;
    return {
        role: 'assistant',
        type: 'plan',
