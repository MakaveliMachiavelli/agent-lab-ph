...
class TokenUsageTrackingHandler extends base_1.BaseCallbackHandler {
    ...
    async handleLLMEnd(output) {
        if ((0, is_record_1.isRecord)(output.llmOutput) && (0, is_record_1.isRecord)(output.llmOutput.usage)) {
        ...
        for (const generation of output.generations.flat()) {
            if ((0, is_record_1.isRecord)(generation.generationInfo) && (0, is_record_1.isRecord)(generation.generationInfo.usage)) {
