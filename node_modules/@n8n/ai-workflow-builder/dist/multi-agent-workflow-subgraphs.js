...
function createMultiAgentWorkflowWithSubgraphs(config) {
    const { parsedNodeTypes, stageLLMs, logger, checkpointer, autoCompactThresholdTokens = constants_1.DEFAULT_AUTO_COMPACT_THRESHOLD_TOKENS, featureFlags, assistantHandler, ssrf, } = config;
