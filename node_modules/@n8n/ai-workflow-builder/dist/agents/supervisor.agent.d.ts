...
declare function createSupervisorRoutingSchema(mergeAskBuild: boolean): z.ZodObject<{
    ...
    next: z.ZodEnum<z.Writeable<readonly ["responder", "discovery", "builder"] | readonly ["responder", "discovery", "builder", "assistant"]>>;
}, "strip", z.ZodTypeAny, {
    reasoning: string;
    next: "assistant" | "builder" | "discovery" | "responder";
}, {
    reasoning: string;
    next: "assistant" | "builder" | "discovery" | "responder";
}>;
