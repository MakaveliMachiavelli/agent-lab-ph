...
export declare function createResponderAgent(config: ResponderAgentConfig): import("langchain").ReactAgent<import("langchain").AgentTypeConfig<import("langchain").ResponseFormatUndefined, undefined, z.ZodObject<{
    ...
    previousSummary?: string | undefined;
    workflowContext?: any;
}, readonly (import("@langchain/core/tools").ServerTool | import("@langchain/core/tools").ClientTool)[]>], readonly (import("langchain").DynamicStructuredTool<z.ZodObject<{
    issue: z.ZodString;
    category: z.ZodEnum<["conflicting_instructions", "missing_guidance", "unclear_node_description", "incomplete_example", "other"]>;
    source: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    issue: string;
    category: "conflicting_instructions" | "incomplete_example" | "missing_guidance" | "other" | "unclear_node_description";
    ...
    category: "conflicting_instructions" | "incomplete_example" | "missing_guidance" | "other" | "unclear_node_description";
    source?: string | undefined;
}, import("@langchain/langgraph").Command<unknown, Record<string, unknown>, string>, unknown, string> | import("@langchain/core/tools").ServerTool | import("@langchain/core/tools").ClientTool)[]>>;
