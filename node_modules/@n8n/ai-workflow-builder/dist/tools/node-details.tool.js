...
function formatNodeDetails(details, withParameters = false, withConnections = true, examples = [], resourceOperationInfo) {
    ...
    if (resourceOperationInfo) {
        parts.push((0, node_catalog_1.formatResourceOperationsForPrompt)(resourceOperationInfo));
    }
...
function createNodeDetailsTool(nodeTypes, logger) {
    const dynamicTool = (0, tools_1.tool)(async (input, config) => {
        ...
        try {
            ...
            const resourceOperationInfo = (0, node_catalog_1.extractResourceOperations)(nodeType, nodeVersion, logger);
            ...
            const cacheKey = (0, node_catalog_1.createResourceCacheKey)(nodeName, nodeVersion);
            const stateUpdates = {
