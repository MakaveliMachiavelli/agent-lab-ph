...
function createWebFetchTool(createSecurity, ssrf) {
    const dynamicTool = (0, tools_1.tool)(async (input, config) => {
        ...
        try {
            ...
            const fetchResult = await (0, web_fetch_utils_1.fetchUrl)(url, ssrf);
            ...
            if (fetchResult.status === 'redirect_new_host' && fetchResult.finalUrl) {
                ...
                const finalResult = await (0, web_fetch_utils_1.fetchUrl)(fetchResult.finalUrl, ssrf);
