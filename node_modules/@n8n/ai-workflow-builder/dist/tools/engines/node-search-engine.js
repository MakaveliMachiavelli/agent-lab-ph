...
class NodeSearchEngine {
    ...
    searchByName(query, limit = 20) {
        const searchResults = (0, sublime_search_1.sublimeSearch)(query, this.nodeTypes, NODE_SEARCH_KEYS);
    ...
    searchByConnectionType(connectionType, limit = 20, nameFilter) {
        ...
        const nameFilteredResults = (0, sublime_search_1.sublimeSearch)(nameFilter, nodeTypesOnly, NODE_SEARCH_KEYS);
