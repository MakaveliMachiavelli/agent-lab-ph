...
export type LcVectorStoreMongoDBAtlasV12RetrieveAsToolNode = {
  ...
  version: 1.2;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV12RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreMongoDBAtlasV12RetrieveAsToolSubnodeConfig };
};