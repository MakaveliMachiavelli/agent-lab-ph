...
export type LcVectorStoreMongoDBAtlasV11RetrieveAsToolNode = {
  ...
  version: 1.1;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV11RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreMongoDBAtlasV11RetrieveAsToolSubnodeConfig };
};