...
export type LcVectorStoreMongoDBAtlasV1RetrieveAsToolNode = {
  ...
  version: 1;
  config: NodeConfig<LcVectorStoreMongoDBAtlasV1RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreMongoDBAtlasV1RetrieveAsToolSubnodeConfig };
};