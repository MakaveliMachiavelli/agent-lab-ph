...
export type LcGoogleGeminiV11FileSearchUploadToStoreNode = {
  ...
  version: 1.1;
  isTrigger: true;
  config: NodeConfig<LcGoogleGeminiV11FileSearchUploadToStoreParams> & { credentials?: Credentials } & { subnodes?: LcGoogleGeminiV11FileSearchUploadToStoreSubnodeConfig };
};