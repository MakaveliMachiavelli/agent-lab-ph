...
export type LcVectorStoreOracleDBVectorV11InsertParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV11InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreOracleDBVectorV11InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV11InsertParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV11InsertSubnodeConfig };
};