...
export type LcVectorStoreOracleDBVectorV1RetrieveParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV1RetrieveSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV1RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV1RetrieveParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV1RetrieveSubnodeConfig };
};