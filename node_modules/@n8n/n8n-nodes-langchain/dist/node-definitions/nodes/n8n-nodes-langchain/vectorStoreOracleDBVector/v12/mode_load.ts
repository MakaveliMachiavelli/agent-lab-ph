...
export type LcVectorStoreOracleDBVectorV12LoadParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV12LoadSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV12LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.2;
  config: NodeConfig<LcVectorStoreOracleDBVectorV12LoadParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV12LoadSubnodeConfig };
};