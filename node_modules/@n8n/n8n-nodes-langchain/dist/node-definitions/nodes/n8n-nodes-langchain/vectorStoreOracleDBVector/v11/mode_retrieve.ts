...
export type LcVectorStoreOracleDBVectorV11RetrieveParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV11RetrieveSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV11RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV11RetrieveParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV11RetrieveSubnodeConfig };
};