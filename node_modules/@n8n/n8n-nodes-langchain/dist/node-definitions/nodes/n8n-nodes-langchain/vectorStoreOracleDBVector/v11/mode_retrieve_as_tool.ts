/**
 * Oracle Database Vector Store Node - Version 1.1
...
export type LcVectorStoreOracleDBVectorV11RetrieveAsToolParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV11RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV11RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV11RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV11RetrieveAsToolSubnodeConfig };
};