/**
 * Oracle Database Vector Store Node - Version 1
...
export type LcVectorStoreOracleDBVectorV1RetrieveAsToolParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV1RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV1RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV1RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV1RetrieveAsToolSubnodeConfig };
};