...
export type LcVectorStoreOracleDBVectorV1LoadParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV1LoadSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV1LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV1LoadParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV1LoadSubnodeConfig };
};