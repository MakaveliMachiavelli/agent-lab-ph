...
export type LcVectorStoreOracleDBVectorV12InsertParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV12InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreOracleDBVectorV12InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.2;
  config: NodeConfig<LcVectorStoreOracleDBVectorV12InsertParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV12InsertSubnodeConfig };
};