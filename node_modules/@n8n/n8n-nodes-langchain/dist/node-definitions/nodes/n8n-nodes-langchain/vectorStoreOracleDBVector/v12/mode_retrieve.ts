...
export type LcVectorStoreOracleDBVectorV12RetrieveParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV12RetrieveSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV12RetrieveNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.2;
  config: NodeConfig<LcVectorStoreOracleDBVectorV12RetrieveParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV12RetrieveSubnodeConfig };
};