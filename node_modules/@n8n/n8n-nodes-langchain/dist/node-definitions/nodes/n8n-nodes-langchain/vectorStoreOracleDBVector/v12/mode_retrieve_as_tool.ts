/**
 * Oracle Database Vector Store Node - Version 1.2
...
export type LcVectorStoreOracleDBVectorV12RetrieveAsToolParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV12RetrieveAsToolSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV12RetrieveAsToolNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.2;
  config: NodeConfig<LcVectorStoreOracleDBVectorV12RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV12RetrieveAsToolSubnodeConfig };
};