...
export type LcVectorStoreOracleDBVectorV1InsertParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV1InsertSubnodeConfig {
  embedding: EmbeddingInstance | EmbeddingInstance[];
  documentLoader: DocumentLoaderInstance | DocumentLoaderInstance[];
}

export type LcVectorStoreOracleDBVectorV1InsertNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV1InsertParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV1InsertSubnodeConfig };
};