...
export type LcVectorStoreOracleDBVectorV11LoadParams = {
  /**
...
export interface LcVectorStoreOracleDBVectorV11LoadSubnodeConfig {
...
export type LcVectorStoreOracleDBVectorV11LoadNode = {
  type: '@n8n/n8n-nodes-langchain.vectorStoreOracleDBVector';
  version: 1.1;
  config: NodeConfig<LcVectorStoreOracleDBVectorV11LoadParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreOracleDBVectorV11LoadSubnodeConfig };
};