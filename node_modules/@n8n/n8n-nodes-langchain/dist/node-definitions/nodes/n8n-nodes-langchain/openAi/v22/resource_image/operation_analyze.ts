...
export type LcOpenAiV22ImageAnalyzeParams = {
  resource: 'image';
  operation: 'analyze';
/**
 * Model
...
export interface LcOpenAiV22ImageAnalyzeSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV22ImageAnalyzeNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2.2;
  isTrigger: true;
  config: NodeConfig<LcOpenAiV22ImageAnalyzeParams> & { credentials?: Credentials } & { subnodes?: LcOpenAiV22ImageAnalyzeSubnodeConfig };
};