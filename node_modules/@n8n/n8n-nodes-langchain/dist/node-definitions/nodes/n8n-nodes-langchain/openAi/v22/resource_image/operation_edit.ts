...
/** Edit an image */
export type LcOpenAiV22ImageEditParams = {
  resource: 'image';
  operation: 'edit';
/**
...
export interface LcOpenAiV22ImageEditSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV22ImageEditNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2.2;
  isTrigger: true;
  config: NodeConfig<LcOpenAiV22ImageEditParams> & { credentials?: Credentials } & { subnodes?: LcOpenAiV22ImageEditSubnodeConfig };
};