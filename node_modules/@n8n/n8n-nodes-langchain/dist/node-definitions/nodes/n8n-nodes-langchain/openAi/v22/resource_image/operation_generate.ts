...
export type LcOpenAiV22ImageGenerateParams = {
  resource: 'image';
  operation: 'generate';
/**
 * Model
...
export interface LcOpenAiV22ImageGenerateSubnodeConfig {
  tools?: ToolInstance[];
  memory?: MemoryInstance;
}

export type LcOpenAiV22ImageGenerateNode = {
  type: '@n8n/n8n-nodes-langchain.openAi';
  version: 2.2;
  isTrigger: true;
  config: NodeConfig<LcOpenAiV22ImageGenerateParams> & { credentials?: Credentials } & { subnodes?: LcOpenAiV22ImageGenerateSubnodeConfig };
};