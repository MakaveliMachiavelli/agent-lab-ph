...
export type LcVectorStoreAzureAISearchV1RetrieveAsToolNode = {
  ...
  version: 1;
  config: NodeConfig<LcVectorStoreAzureAISearchV1RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreAzureAISearchV1RetrieveAsToolSubnodeConfig };
};