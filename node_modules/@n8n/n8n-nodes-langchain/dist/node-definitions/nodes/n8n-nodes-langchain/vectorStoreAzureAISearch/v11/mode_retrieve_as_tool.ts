...
export type LcVectorStoreAzureAISearchV11RetrieveAsToolNode = {
  ...
  version: 1.1;
  config: NodeConfig<LcVectorStoreAzureAISearchV11RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreAzureAISearchV11RetrieveAsToolSubnodeConfig };
};