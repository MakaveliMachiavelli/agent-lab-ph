...
export type LcVectorStoreAzureAISearchV12RetrieveAsToolNode = {
  ...
  version: 1.2;
  config: NodeConfig<LcVectorStoreAzureAISearchV12RetrieveAsToolParams> & { credentials?: Credentials } & { subnodes: LcVectorStoreAzureAISearchV12RetrieveAsToolSubnodeConfig };
};