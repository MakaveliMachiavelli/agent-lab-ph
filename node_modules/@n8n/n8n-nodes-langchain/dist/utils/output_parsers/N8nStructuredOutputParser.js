...
const langchainParserError_1 = require("./langchainParserError");
...
class N8nStructuredOutputParser extends output_parsers_1.StructuredOutputParser {
    ...
    async parse(text, _callbacks, errorMapper) {
        ...
        try {
            ...
            const isEmptyOutput = (typeof text === 'string' && text.trim() === '{}') ||
            ...
            const nodeError = new n8n_workflow_1.NodeOperationError(this.context.getNode(), isEmptyOutput
                ? 'The AI model returned an empty response to the Structured Output Parser'
                : langchainParserError_1.MODEL_OUTPUT_PARSER_ERROR_MESSAGE, {
                description: isEmptyOutput
                    ...
                    : langchainParserError_1.MODEL_OUTPUT_PARSER_ERROR_DESCRIPTION,
            });
