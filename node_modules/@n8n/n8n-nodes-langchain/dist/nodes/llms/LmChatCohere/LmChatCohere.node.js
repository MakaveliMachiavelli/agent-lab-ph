...
const chatModelMessageWrapper_1 = require("../../../utils/chatModelMessageWrapper");
const cohereV2Client_1 = require("./cohereV2Client");
...
class LmChatCohere {
    ...
    async supplyData(itemIndex) {
        ...
        const model = new cohere_1.ChatCohere({
            client: (0, cohereV2Client_1.createCohereV2ChatClient)({ apiKey: credentials.apiKey }),
            model: modelName,
        ...
        return {
            response: (0, chatModelMessageWrapper_1.wrapChatModelMessageInput)(model),
        };
    }
}
