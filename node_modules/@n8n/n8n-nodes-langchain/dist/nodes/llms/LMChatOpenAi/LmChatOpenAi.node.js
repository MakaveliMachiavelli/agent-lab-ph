...
class LmChatOpenAi {
                ...
                },
                {
                    ...
                    options: [
                        ...
                        },
                        {
                            ...
                            type: 'json',
                            default: '{}',
                            description: 'Optional additional JSON properties to include in the request body when making requests to OpenAI-compatible APIs',
                        },
                        {
    ...
    async supplyData(itemIndex) {
        ...
        if (options.extraBody) {
            let extraBody;
            try {
                extraBody = (0, n8n_workflow_1.jsonParse)(options.extraBody);
            }
            catch (error) {
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'The value in the "Extra Body" field is not valid JSON', { itemIndex, description: error instanceof Error ? error.message : String(error) });
            }
            if (!(0, isPlainObject_1.default)(extraBody)) {
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'The value in the "Extra Body" field must be a JSON object', { itemIndex });
            }
        ...
        const fields = {
            ...
            configuration,
            callbacks: [
                new ai_utilities_1.N8nLlmTracing(this, { redactedHeaders: customHeader ? [customHeader.name] : [] }),
            ],
            modelKwargs,
