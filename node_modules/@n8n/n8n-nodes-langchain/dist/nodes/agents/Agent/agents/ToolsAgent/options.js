...
exports.commonOptions = [
    ...
    },
    {
        ...
        type: 'boolean',
        default: false,
        description: 'Whether or not binary PDF documents should be automatically passed through to the agent. Useful for models that natively support PDF input (e.g. Google Gemini).',
    },
    {
