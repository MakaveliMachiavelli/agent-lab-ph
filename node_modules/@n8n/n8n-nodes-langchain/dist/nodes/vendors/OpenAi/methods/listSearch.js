...
exports.imageGenerateModelSearch = imageGenerateModelSearch;
...
async function imageModelSearch(filter) {
    return await getModelSearch((model) => {
        if (model.id.includes('-transcribe') ||
...
async function imageGenerateModelSearch(filter) {
    return await getModelSearch((model) => model.id.includes('dall-e') || model.id.includes('gpt-image'))(this, filter);
}
