...
async function execute(i) {
    ...
    const hasTextContent = messages.some((m) => (m.type === 'text' || !m.type) && typeof m.content === 'string' && m.content.trim() !== '');
    if (!hasTextContent) {
    ...
    if (!response)
        return [];
    if (response.usage) {
        (0, n8n_workflow_1.accumulateTokenUsage)(this, response.usage.input_tokens, response.usage.output_tokens);
    }
