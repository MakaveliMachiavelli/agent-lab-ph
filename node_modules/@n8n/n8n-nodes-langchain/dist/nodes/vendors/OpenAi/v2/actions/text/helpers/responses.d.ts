...
export declare function formatInputMessages(this: IExecuteFunctions, i: number, messages: IDataObject[]): Promise<(Omit<OpenAIClient.Responses.ResponseInputItem.Message, "content" | "role"> & {
