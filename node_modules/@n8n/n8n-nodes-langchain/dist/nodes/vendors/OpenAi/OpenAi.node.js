...
class OpenAi extends n8n_workflow_1.VersionedNodeType {
    constructor() {
        const baseDescription = {
            ...
            builderHint: {
                searchHint: 'For text generation, reasoning and tools, use AI Agent with OpenAI Chat Model. This OpenAI node is for specialized operations: image generation (DALL-E), audio (Whisper, TTS), and video generation (Sora).',
                relatedNodes: [
                    {
        ...
        const nodeVersions = {
            ...
            2.2: new OpenAiV2_node_1.OpenAiV2(baseDescription),
            2.3: new OpenAiV2_node_1.OpenAiV2(baseDescription),
        };
