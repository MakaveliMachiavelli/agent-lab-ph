...
exports.MicrosoftAgent365Trigger = void 0;
const n8n_workflow_1 = require("n8n-workflow");
const agents_hosting_1 = require("@microsoft/agents-hosting");
const utils_1 = require("../../agents/Agent/V2/utils");
const microsoft_utils_1 = require("./microsoft-utils");
class MicrosoftAgent365Trigger {
    constructor() {
        this.description = {
            ...
            properties: [
                {
                    displayName: 'This is an early preview for building Agents with Microsoft Agent 365 and n8n. You need to be part of the <a href="https://adoption.microsoft.com/copilot/frontier-program/" target="_blank">Frontier preview program</a> to get early access to Microsoft Agent 365. <a href="https://github.com/microsoft/Agent365-Samples/tree/main/nodejs/n8n/sample-agent" target="_blank">Learn more</a>',
                    name: 'previewNotice',
                    type: 'notice',
                    default: '',
                },
                ...
                },
                {
                    ...
                    default: [],
                    noDataExpression: true,
                    options: microsoft_utils_1.microsoftMcpServers,
                    displayOptions: {
                        show: {
                            useMcpTools: [true],
                            include: ['selected'],
    ...
    async webhook() {
        ...
        try {
            const credentials = (await this.getCredentials('microsoftAgent365Api'));
            const { agent, authConfig } = (0, microsoft_utils_1.createMicrosoftAgentApplication)(credentials);
            const activityCapture = {
                input: '',
                output: [],
                activity: {},
            };
            const callback = (0, microsoft_utils_1.configureAdapterProcessCallback)(this, agent, credentials, activityCapture);
            let authorized = false;
            await (0, agents_hosting_1.authorizeJWT)(authConfig)(req, res, (err) => {
                if (!err)
                    authorized = true;
            });
            if (!authorized) {
            ...
            if (activityCapture.activity.type === 'event' ||
            ...
            if (node.typeVersion === 1) {
                ...
                const { conversationId, ...activity } = activityCapture.activity;
            ...
            if (typeof errorData === 'object' && 'error' in errorData) {
                ...
                const description = errorData.error_description ?? error.message;
                throw new n8n_workflow_1.NodeOperationError(node, message, { description });
            }
            throw new n8n_workflow_1.NodeOperationError(node, error.message);
        }
    }
}
exports.MicrosoftAgent365Trigger = MicrosoftAgent365Trigger;
//# sourceMappingURL=MicrosoftAgent365Trigger.node.js.map