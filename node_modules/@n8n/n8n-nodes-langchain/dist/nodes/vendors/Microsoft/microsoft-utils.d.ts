import type { AuthConfiguration, Authorization, DefaultConversationState, DefaultUserState, TurnContext, TurnState } from '@microsoft/agents-hosting';
...
import { buildMcpToolName } from '../../mcp/McpClientTool/utils';
...
export declare function createMicrosoftAgentApplication(credentials: MicrosoftAgent365Credentials): {
