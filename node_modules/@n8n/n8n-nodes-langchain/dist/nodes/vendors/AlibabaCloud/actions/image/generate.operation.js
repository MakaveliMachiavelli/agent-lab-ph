...
async function execute(itemIndex) {
    ...
    const imageOptions = this.getNodeParameter('imageOptions', itemIndex, {});
    const downloadImage = this.getNodeParameter('downloadImage', itemIndex, true);
    const body = {
        model,
        input: {
            messages: [
    ...
    const response = await transport_1.apiRequest.call(this, 'POST', '/api/v1/services/aigc/multimodal-generation/generation', {
        body,
    });
