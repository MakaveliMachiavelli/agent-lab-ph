...
const properties = [
    { ...(0, descriptions_1.modelRLC)('modelSearch'), displayOptions: { show: { '@version': [{ _cnd: { lt: 1.2 } }] } } },
    {
...
async function execute(i) {
    ...
    if (!nonEmptyMessages.length) {
        throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'A non-empty prompt is required.', {
            itemIndex: i,
        });
    }
    const contents = nonEmptyMessages.map((m) => ({
    ...
    const captureUsage = () => {
        ...
        if (usageMetadata) {
            (0, n8n_workflow_1.accumulateTokenUsage)(this, usageMetadata.promptTokenCount, usageMetadata.candidatesTokenCount);
        }
    };
    captureUsage();
