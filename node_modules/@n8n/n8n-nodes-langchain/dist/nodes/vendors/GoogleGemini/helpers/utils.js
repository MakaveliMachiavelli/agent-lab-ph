...
exports.getFilenameFromMimeType = getFilenameFromMimeType;
...
function getFilenameFromMimeType(mimeType, baseName, fallbackExtension) {
    if (!mimeType) {
        return `${baseName}.${fallbackExtension}`;
    }
    return `${baseName}.${(0, mime_types_1.extension)(mimeType) || fallbackExtension}`;
}
