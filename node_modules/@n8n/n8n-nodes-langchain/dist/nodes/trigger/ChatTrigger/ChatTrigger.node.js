...
const highlightedData_1 = require("n8n-nodes-base/dist/utils/highlightedData");
...
const isPublicChatTriggerDisabled = () => di_1.Container.get(config_1.ChatTriggerConfig).disablePublicChat;
...
class ChatTrigger extends n8n_workflow_1.Node {
            ...
            properties: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        highlightedData_1.autoSaveHighlightedDataProperty,
                    ],
                },
                {
                    displayName: 'Options',
    ...
    async webhook(ctx) {
        ...
        (0, n8n_workflow_1.validateNodeParameters)(options, {
            ...
            [highlightedData_1.autoSaveHighlightedDataProperty.name]: { type: 'boolean' },
        }, ctx.getNode());
        ...
        if (ctx.getNodeParameter('options.autoSaveHighlightedData', true) !== false) {
            if (typeof bodyData.chatInput === 'string') {
                ctx.customData.set((0, n8n_workflow_1.getHighlightedInputKey)(ctx.getNode().name), bodyData.chatInput);
            }
            if (typeof bodyData.sessionId === 'string') {
                ctx.customData.set(n8n_workflow_1.HIGHLIGHTED_SESSION_KEY, bodyData.sessionId);
            }
        }
        let returnData;
