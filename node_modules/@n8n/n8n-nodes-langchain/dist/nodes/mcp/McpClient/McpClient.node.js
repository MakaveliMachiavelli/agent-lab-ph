...
class McpClient {
    ...
    async execute() {
        ...
        const client = await (0, utils_1.connectMcpClientForCredential)(this, {
            authentication,
            serverTransport,
            endpointUrl,
            surface: 'MCP Client',
            ...
            for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
                try {
                    ...
                    if (node.typeVersion >= 1.1 && result.isError) {
                        ...
                        const errorMessage = textContent && 'text' in textContent
                            ? textContent.text
                    ...
                    const outputJson = {};
                    if ((0, utils_1.isStructuredContent)(result.structuredContent)) {
