...
export declare function createMockResponse(): Mocked<CompressionResponse>;
...
export declare function createMockRequestWithSessionId(sessionId: string, rawBody: string): Mocked<Request> & {
    rawBody: Buffer;
};
...
export declare function createMockRequestWithHeaderSessionId(sessionId: string, rawBody?: string): Mocked<Request> & {
    rawBody: Buffer;
};
