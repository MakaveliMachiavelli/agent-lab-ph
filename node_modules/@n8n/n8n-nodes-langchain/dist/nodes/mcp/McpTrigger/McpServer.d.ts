...
export declare class McpServer {
    ...
    handlePostMessage(req: express.Request, resp: CompressionResponse, tools: Tool[], serverName?: string, gateResult?: CredentialCheckResult): Promise<HandlePostResult>;
    ...
    private clientSupportsUrlElicitation;
    private handleCredentialGate;
