...
async function runLLM(name, model, prompt, inputText, systemMessage) {
    ...
    try {
        ...
        if ((0, langchainParserError_1.isLangChainParserError)(error)) {
            throw new types_1.GuardrailError(name, 'Failed to parse output', langchainParserError_1.MODEL_OUTPUT_PARSER_ERROR_MESSAGE);
        }
