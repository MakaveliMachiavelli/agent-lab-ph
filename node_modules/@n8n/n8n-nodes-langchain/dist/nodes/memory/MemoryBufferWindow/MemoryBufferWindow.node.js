...
class MemoryBufferWindow {
    constructor() {
        this.description = {
            ...
            builderHint: {
                searchHint: 'Reuse with multiple agents in the same workflow by connecting to multiple agent nodes so agents have a shared context.',
            },
            inputs: [],
            ...
            properties: [
                ...
                (0, descriptions_1.scopedSessionHint)(1.4),
