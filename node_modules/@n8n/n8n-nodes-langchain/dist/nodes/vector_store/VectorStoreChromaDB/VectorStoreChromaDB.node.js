    ...
    async ensureCollection() {
        if (!this.collection) {
            ...
            try {
                ...
                throw new n8n_workflow_1.OperationalError(`Chroma getOrCreateCollection error: ${message}`);
            }
        }
        if (!this.collection) {
            throw new n8n_workflow_1.OperationalError('Failed to initialize Chroma collection');
        }
