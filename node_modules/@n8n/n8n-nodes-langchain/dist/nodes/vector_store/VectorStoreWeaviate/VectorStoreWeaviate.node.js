...
class ExtendedWeaviateVectorStore extends weaviate_1.WeaviateStore {
    static async fromExistingCollection(embeddings, args, defaultFilter) {
        ...
        if (!(baseCandidate instanceof ExtendedWeaviateVectorStore)) {
            throw new n8n_workflow_1.UnexpectedError('Weaviate store factory did not return an ExtendedWeaviateVectorStore instance');
        }
        ...
        if (args.hybridQuery) {
            ...
            return content.map((doc) => {
                ...
                if (typeof score !== 'number') {
                    throw new n8n_workflow_1.UnexpectedError(`Unexpected score type: ${typeof score}`);
                }
                return [
