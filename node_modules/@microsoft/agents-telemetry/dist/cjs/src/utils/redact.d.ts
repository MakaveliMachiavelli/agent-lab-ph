 ...
 */
export declare function redactString(value: string | undefined, peek?: boolean): string | undefined;
/**
 ...
 */
export declare function redactScopes(scopes: string[] | undefined): string | undefined;
