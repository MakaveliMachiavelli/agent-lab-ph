...
class SpanProcessor {
    ...
    onStart(span, parentContext) {
        ...
        if (!existingAttrs.has(constants_1.OpenTelemetryConstants.TELEMETRY_SDK_NAME_KEY)) {
            span.setAttribute(constants_1.OpenTelemetryConstants.TELEMETRY_SDK_NAME_KEY, constants_1.OpenTelemetryConstants.TELEMETRY_SDK_NAME_VALUE);
        }
        if (!existingAttrs.has(constants_1.OpenTelemetryConstants.TELEMETRY_SDK_LANGUAGE_KEY)) {
            span.setAttribute(constants_1.OpenTelemetryConstants.TELEMETRY_SDK_LANGUAGE_KEY, constants_1.OpenTelemetryConstants.TELEMETRY_SDK_LANGUAGE_VALUE);
        }
        if (!existingAttrs.has(constants_1.OpenTelemetryConstants.TELEMETRY_SDK_VERSION_KEY)) {
            span.setAttribute(constants_1.OpenTelemetryConstants.TELEMETRY_SDK_VERSION_KEY, constants_1.OpenTelemetryConstants.TELEMETRY_SDK_VERSION_VALUE);
        }
