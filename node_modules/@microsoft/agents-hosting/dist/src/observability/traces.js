    ...
    createConnectorClient: agents_telemetry_1.trace.define({
        ...
        record: {
            ...
            span.setAttributes({
                ...
                'auth.scopes': (_b = record.scopes) !== null && _b !== void 0 ? _b : 'unknown',
            });
...
exports.ProactiveTraceDefinitions = {
    storeConversation: agents_telemetry_1.trace.define({
        ...
        actions: ({ span }) => ({
            async link(storage, key) {
                var _a, _b;
                const item = (_b = (_a = (await storage.read([key]))) === null || _a === void 0 ? void 0 : _a[key]) !== null && _b !== void 0 ? _b : {};
 ...
 */
function link(span, item) {
    if (item === null || item === void 0 ? void 0 : item.__link) {
