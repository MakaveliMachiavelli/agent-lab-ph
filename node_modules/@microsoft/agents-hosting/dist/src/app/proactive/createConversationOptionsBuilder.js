...
class CreateConversationOptionsBuilder {
    ...
    build() {
        ...
        const isTeamsChannel = this._channelId === agents_activity_1.Channels.Msteams &&
            Boolean((_c = (_b = this._parameters.channelData) === null || _b === void 0 ? void 0 : _b.channel) === null || _c === void 0 ? void 0 : _c.id);
        if (isTeamsChannel && !this._activity) {
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.CreateConversationBuilderChannelActivityRequired);
        }
        return {
            ...
            parameters: {
                ...this._parameters,
                activity: this._activity ? { type: 'message', ...this._activity } : undefined,
            },
        };
    }
}
