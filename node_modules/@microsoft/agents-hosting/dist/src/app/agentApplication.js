...
const logger = (0, agents_telemetry_1.debug)('agents:app');
...
class AgentApplication {
    ...
    constructor(options) {
        ...
        this._options = {
            ...
            typing: (options === null || options === void 0 ? void 0 : options.typing) || undefined,
        ...
        if (this._options.proactive !== undefined || this._options.storage !== undefined) {
            const proactiveOpts = (_a = this._options.proactive) !== null && _a !== void 0 ? _a : {};
            const proactiveStorage = (_b = proactiveOpts.storage) !== null && _b !== void 0 ? _b : this._options.storage;
            this._proactive = new proactive_1.Proactive(this, { ...proactiveOpts, storage: proactiveStorage });
        }
        ...
        if (this._options.transcriptLogger) {
            if (!this._options.adapter) {
                ...
                (_c = this._adapter) === null || _c === void 0 ? void 0 : _c.use(new transcript_1.TranscriptLoggerMiddleware(this._options.transcriptLogger));
            }
        }
        ...
        logger.info('AgentApplication settings loaded', {
            agentAppId: (0, agents_telemetry_1.redactString)(this._options.agentAppId, true),
            adapter: {
            ...
            proactive: {
                ...
                storage: className((_e = (_d = this._options.proactive) === null || _d === void 0 ? void 0 : _d.storage) !== null && _e !== void 0 ? _e : this._options.storage),
            ...
            turnStateFactory: (options === null || options === void 0 ? void 0 : options.turnStateFactory) ? 'custom' : 'default',
    ...
    get proactive() {
        if (!this._proactive) {
            throw agents_activity_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.ProactivePropertyUnavailable);
        }
    ...
    async runInternal(turnContext) {
        ...
        if (!authorized) {
            const managed = (0, agents_telemetry_1.trace)(observability_1.AgentApplicationTraceDefinitions.run);
        ...
        const isLongRunning = (turnContext.activity.type === agents_activity_1.ActivityTypes.Invoke && turnContext.activity.name === 'signin/tokenExchange') ||
            (this._options.longRunningMessages && turnContext.activity.type === agents_activity_1.ActivityTypes.Message);
        if (isLongRunning) {
     ...
     */
    async handleAuthorization(context) {
        var _a, _b;
        if (context.activity.type === agents_activity_1.ActivityTypes.Typing) {
            return { authorized: true, context };
        }
        return (_b = (_a = this._authorizationManager) === null || _a === void 0 ? void 0 : _a.process(context, async (activity) => {
            var _a;
            ...
            const route = await this.getRoute(new turnContext_1.TurnContext(context.adapter, activity, context.identity));
            return (_a = route === null || route === void 0 ? void 0 : route.authHandlers) !== null && _a !== void 0 ? _a : [];
        })) !== null && _b !== void 0 ? _b : { authorized: true, context }; // If no authorization manager is configured, we assume the activity is authorized.
    }
    /**
     * Executes the turn processing logic for the given context, including routing and handler execution.
     */
    async runTurn(context) {
        return (0, agents_telemetry_1.trace)(observability_1.AgentApplicationTraceDefinitions.run, async ({ record }) => {
            ...
            try {
                ...
                if (Array.isArray(fileDownloaders) && fileDownloaders.length > 0) {
                    await (0, agents_telemetry_1.trace)(observability_1.AgentApplicationTraceDefinitions.downloadFiles, async ({ record }) => {
                        var _a;
                        record({ attachmentsCount: (_a = context.activity.attachments) === null || _a === void 0 ? void 0 : _a.length });
                ...
                if (this._beforeTurn.length > 0) {
                    await (0, agents_telemetry_1.trace)(observability_1.AgentApplicationTraceDefinitions.beforeTurn, async () => {
                ...
                await (0, agents_telemetry_1.trace)(observability_1.AgentApplicationTraceDefinitions.routeHandler, async ({ record }) => {
                    record({ isInvoke: route.isInvokeRoute, isAgentic: route.isAgenticRoute });
                    await route.handler(context, state);
                });
                if (this._afterTurn.length > 0) {
                    await (0, agents_telemetry_1.trace)(observability_1.AgentApplicationTraceDefinitions.afterTurn, async () => {
    ...
    startTypingTimer(context) {
        ...
        const currentState = () => turnState.get(TYPING_TIMER_STATE_KEY);
        if (context.activity.type !== agents_activity_1.ActivityTypes.Message || currentState()) {
            return;
        }
        const state = {
        ...
        context.onSendActivities(async (context, activities, next) => {
            ...
            if (activities.some(activity => activity.type === agents_activity_1.ActivityTypes.Message || this.getStreamType(activity) !== undefined)) {
                state.stop();
                // Wait for any in-flight typing send to finish before sending the real response.
                await state.lastSend.catch((err) => {
                    logger.error(err);
                });
            }
            return next();
    ...
    getTypingTimingOptions(context) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        const channelId = context.activity.channelId || context.activity.channelIdChannel || '';
        const channelOptions = channelId ? (_b = (_a = this._options.typing) === null || _a === void 0 ? void 0 : _a.channelStrategies) === null || _b === void 0 ? void 0 : _b[channelId] : undefined;
        return {
            initialDelayMs: (_e = (_c = channelOptions === null || channelOptions === void 0 ? void 0 : channelOptions.initialDelayMs) !== null && _c !== void 0 ? _c : (_d = this._options.typing) === null || _d === void 0 ? void 0 : _d.initialDelayMs) !== null && _e !== void 0 ? _e : DEFAULT_TYPING_INITIAL_DELAY,
            intervalMs: (_h = (_f = channelOptions === null || channelOptions === void 0 ? void 0 : channelOptions.intervalMs) !== null && _f !== void 0 ? _f : (_g = this._options.typing) === null || _g === void 0 ? void 0 : _g.intervalMs) !== null && _h !== void 0 ? _h : DEFAULT_TYPING_INTERVAL
        };
    }
    getStreamType(activity) {
        var _a, _b, _c;
        const streamingEntity = (_a = activity.entities) === null || _a === void 0 ? void 0 : _a.find((entity) => entity.type === 'streaminfo');
        return (_b = streamingEntity === null || streamingEntity === void 0 ? void 0 : streamingEntity.streamType) !== null && _b !== void 0 ? _b : (_c = activity.channelData) === null || _c === void 0 ? void 0 : _c.streamType;
    }
    async sendTypingActivity(context) {
        const conversationReference = context.activity.getConversationReference();
        const typingActivity = agents_activity_1.Activity.fromObject({ type: agents_activity_1.ActivityTypes.Typing }).applyConversationReference(conversationReference);
    ...
    startLongRunningCall(context, handler) {
        const activity = agents_activity_1.Activity.fromObject(context.activity);
