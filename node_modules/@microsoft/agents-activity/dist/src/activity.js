...
const activityTreatments_1 = require("./activityTreatments");
/**
...
class Activity {
    ...
    static getContinuationActivity(reference) {
        ...
        const continuationActivityObj = {
            ...
            id: (_a = reference.activityId) !== null && _a !== void 0 ? _a : (0, crypto_1.randomUUID)(),
    ...
    getConversationReference(options) {
        ...
        const channelId = (options === null || options === void 0 ? void 0 : options.forceBaseChannel) ? ((_a = this.channelIdChannel) !== null && _a !== void 0 ? _a : this.channelId) : this.channelId;
        return {
    ...
    isTargetedActivity() {
        var _a;
        if (!((_a = this.entities) === null || _a === void 0 ? void 0 : _a.length))
            return false;
        return this.entities.some(e => e.type === 'activityTreatment' && e.treatment === activityTreatments_1.ActivityTreatments.Targeted);
    }
    /**
     * Marks this activity as a targeted activity treatment.
     * Idempotent — has no effect if the activity is already targeted.
     */
    makeTargetedActivity() {
        var _a, _b;
        // only available in group contexts
        if (!((_a = this.conversation) === null || _a === void 0 ? void 0 : _a.isGroup)) {
            throw exceptionHelper_1.ExceptionHelper.generateException(Error, errorHelper_1.Errors.TargetedActivityIsGroupOnly);
        }
        if (this.isTargetedActivity())
            return;
        (_b = this.entities) !== null && _b !== void 0 ? _b : (this.entities = []);
        this.entities.push({ type: 'activityTreatment', treatment: activityTreatments_1.ActivityTreatments.Targeted });
    }
    /**
