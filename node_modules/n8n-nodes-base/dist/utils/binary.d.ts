import type { IBinaryData, IBinaryKeyData, IDataObject, IExecuteFunctions, INodeExecutionData } from 'n8n-workflow';
 ...
 */
export declare function routeBinaryProperties(this: IExecuteFunctions, row: IDataObject, toBuffer?: (value: unknown) => Buffer | undefined): Promise<{
    json: IDataObject;
