 ...
 */
     ...
     */
    company_ids?: string | Expression<string>;
    /** Comma-separated IDs of the customer sources to filter by
     */
    customer_source_ids?: string | Expression<string>;
  };
};
...
export type CopperV1OpportunityGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<CopperV1OpportunityGetAllParams> & { credentials?: Credentials };
};