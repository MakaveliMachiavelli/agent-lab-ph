 ...
 */
     ...
     */
    company_id?: string | Expression<string>;
    /** The email address of the user
     */
    email?: string | Expression<string>;
    /** Segment representing the user
     */
    segment_id?: string | Expression<string>;
    /** Tag representing the user
     */
    tag_id?: string | Expression<string>;
  };
};
...
export type IntercomV1UserGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<IntercomV1UserGetAllParams> & { credentials?: Credentials };
};