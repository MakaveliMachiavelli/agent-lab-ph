 ...
 */
     ...
     */
    avatar?: string | Expression<string>;
     ...
     */
    utmCampaign?: string | Expression<string>;
    /** Identifies what specifically was clicked to bring the user to the site
     */
    utmContent?: string | Expression<string>;
    /** Identifies what type of link was used
     */
    utmMedium?: string | Expression<string>;
    /** An avatar image URL. note: the image URL needs to be https.
     */
    utmSource?: string | Expression<string>;
    /** Identifies search terms
     */
    utmTerm?: string | Expression<string>;
  };
/**
...
export type IntercomV1UserCreateNode = {
  ...
  version: 1;
  config: NodeConfig<IntercomV1UserCreateParams> & { credentials?: Credentials };
};