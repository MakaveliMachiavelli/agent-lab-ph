...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      attributeName: stringOrExpression,
      attributeType: resolveSchema({ parameters, schema: z.union([z.literal('boolean'), z.literal('date'), z.literal('float'), z.literal('text'), expressionSchema]), required: true, displayOptions: {"show":{"attributeCategory":["normal"]}}, defaults: {"attributeCategory":"normal"} }),
      attributeValue: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"attributeCategory":["global","calculated"]}}, defaults: {"attributeCategory":"normal"} }),
      attributeCategoryList: resolveSchema({ parameters, schema: z.object({ categoryEnumeration: z.object({ attributesValues: z.array(z.object({ attributeCategoryValue: numberOrExpression.optional(), attributeCategoryLabel: stringOrExpression.optional() })).optional() }).optional() }), required: false, displayOptions: {"show":{"attributeCategory":["category"]}}, defaults: {"attributeCategory":"normal"} }),
