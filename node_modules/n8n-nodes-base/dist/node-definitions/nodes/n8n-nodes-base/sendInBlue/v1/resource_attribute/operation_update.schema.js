...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      updateAttributeCategoryList: resolveSchema({ parameters, schema: z.object({ updateCategoryEnumeration: z.object({ updateAttributesValues: z.array(z.object({ attributeCategoryValue: numberOrExpression.optional(), attributeCategoryLabel: stringOrExpression.optional() })).optional() }).optional() }), required: false, displayOptions: {"show":{"updateAttributeCategory":["category"]}}, defaults: {"updateAttributeCategory":"calculated"} }),
