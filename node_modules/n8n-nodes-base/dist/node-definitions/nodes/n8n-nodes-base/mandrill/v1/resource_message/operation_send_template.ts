 ...
 */
     ...
     */
    bccAddress?: string | Expression<string>;
     ...
     */
    googleAnalyticsCampaign?: string | Expression<string>;
     ...
     */
    googleAnalyticsDomains?: string | Expression<string>;
     ...
     */
    ipPool?: string | Expression<string>;
     ...
     */
    returnPathDomain?: string | Expression<string>;
     ...
     */
    trackingDomain?: string | Expression<string>;
...
export type MandrillV1MessageSendTemplateNode = {
  ...
  version: 1;
  config: NodeConfig<MandrillV1MessageSendTemplateParams> & { credentials?: Credentials };
