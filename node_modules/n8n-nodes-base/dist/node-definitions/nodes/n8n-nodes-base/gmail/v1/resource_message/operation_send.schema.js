...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      htmlMessage: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"includeHtml":[true]}}, defaults: {"includeHtml":false} }),
      message: stringOrExpression,
      toList: z.array(stringOrExpression).optional(),
      additionalFields: z.object({ attachmentsUi: z.object({ attachmentsBinary: z.array(z.object({ property: stringOrExpression.optional() })).optional() }).optional(), bccList: z.array(stringOrExpression).optional(), ccList: z.array(stringOrExpression).optional(), senderName: stringOrExpression.optional() }).optional(),
    }).optional(),
  });
};