 ...
 * @default []
 */
    toList?: Array<string | Expression<string>>;
/**
 * Additional Fields
 * @default {}
 */
     ...
     * @default []
     */
    bccList?: Array<string | Expression<string>>;
    /** The email addresses of the copy recipients
     * @default []
     */
    ccList?: Array<string | Expression<string>>;
     ...
     */
    senderName?: string | Expression<string>;
  };
};
...
export type GmailV1MessageSendNode = {
  ...
  version: 1;
  config: NodeConfig<GmailV1MessageSendParams> & { credentials?: Credentials };
};