 ...
 */
     ...
     */
    organizationalUnits?: Array<string | Expression<string>>;
 ...
 */
     ...
     * @default P1Y
     */
    validityPeriod?: string | Expression<string>;
  };
};
...
export type VenafiTlsProtectCloudV1CertificateRequestCreateNode = {
  ...
  version: 1;
  config: NodeConfig<VenafiTlsProtectCloudV1CertificateRequestCreateParams> & { credentials?: Credentials };
};