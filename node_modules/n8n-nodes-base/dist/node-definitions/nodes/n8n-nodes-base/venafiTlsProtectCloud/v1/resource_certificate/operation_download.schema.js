...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      certificateId: stringOrExpression,
      ...
      certificateLabel: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"downloadItem":["keystore"]}}, defaults: {"downloadItem":"certificate"} }),
      privateKeyPassphrase: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"downloadItem":["keystore"]}}, defaults: {"downloadItem":"certificate"} }),
      keystorePassphrase: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"downloadItem":["keystore"],"keystoreType":["JKS"]}}, defaults: {"downloadItem":"certificate","keystoreType":"PEM"} }),
