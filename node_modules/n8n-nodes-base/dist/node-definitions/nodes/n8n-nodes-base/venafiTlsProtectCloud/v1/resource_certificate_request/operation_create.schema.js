...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: resolveSchema({ parameters, schema: z.object({ keyType: z.union([z.literal('EC'), z.literal('RSA'), expressionSchema]).optional(), keyCurve: z.union([z.literal('ED25519'), z.literal('P256'), z.literal('P384'), z.literal('P521'), z.literal('UNKNOWN'), expressionSchema]).optional(), keyLength: numberOrExpression.optional(), organization: stringOrExpression.optional(), organizationalUnits: z.array(stringOrExpression).optional(), locality: stringOrExpression.optional(), state: stringOrExpression.optional(), country: stringOrExpression.optional(), SubjectAltNamesUi: z.object({ SubjectAltNamesValues: z.array(z.object({ Typename: z.union([z.literal('dnsNames'), expressionSchema]).optional(), name: stringOrExpression.optional() })).optional() }).optional() }), required: false, displayOptions: {"show":{"generateCsr":[true]}}, defaults: {"generateCsr":false} }),
