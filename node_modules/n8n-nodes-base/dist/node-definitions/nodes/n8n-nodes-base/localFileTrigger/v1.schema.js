...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    triggerOn: z.union([z.literal('file'), z.literal('folder'), expressionSchema]),
    path: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"triggerOn":["file"]}}, defaults: {"triggerOn":""} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"triggerOn":["folder"]}}, defaults: {"triggerOn":""} }] }),
    events: resolveSchema({ parameters, schema: z.array(z.union([z.literal('add'), z.literal('change'), z.literal('unlink'), z.literal('addDir'), z.literal('unlinkDir')])), required: true, displayOptions: {"show":{"triggerOn":["folder"]}}, defaults: {"triggerOn":""} }),
