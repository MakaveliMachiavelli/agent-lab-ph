...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    sqlQuery: resolveOneOfSchemas({ parameters, variants: [{ schema: z.string(), required: false, displayOptions: {"show":{"resource":["database"],"operation":["executeQuery"]},"hide":{"/options.useLegacySql":[true]}}, defaults: {"resource":"database","operation":"executeQuery"} }, { schema: z.string(), required: false, displayOptions: {"show":{"/options.useLegacySql":[true],"resource":["database"],"operation":["executeQuery"]}}, defaults: {"resource":"database","operation":"executeQuery"} }] }),
    options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ defaultDataset: stringOrExpression.optional(), dryRun: booleanOrExpression.optional(), includeSchema: booleanOrExpression.optional(), location: stringOrExpression.optional(), maximumBytesBilled: stringOrExpression.optional(), maxResults: numberOrExpression.optional(), timeoutMs: numberOrExpression.optional(), rawOutput: booleanOrExpression.optional(), useLegacySql: booleanOrExpression.optional(), returnAsNumbers: booleanOrExpression.optional(), queryParameters: z.object({ namedParameters: z.array(z.object({ name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional() }), required: false, displayOptions: {"show":{"resource":["database"],"operation":["executeQuery"]}}, defaults: {"resource":"database","operation":"executeQuery"} }, { schema: z.object({ batchSize: numberOrExpression.optional(), ignoreUnknownValues: booleanOrExpression.optional(), skipInvalidRows: booleanOrExpression.optional(), templateSuffix: stringOrExpression.optional(), traceId: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"resource":["database"],"operation":["insert"]}}, defaults: {"resource":"database","operation":"executeQuery"} }] }),
