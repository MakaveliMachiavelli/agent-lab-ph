...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      connectorId: stringOrExpression,
      connectorType: z.union([z.literal('.resilient'), z.literal('.jira'), z.literal('.servicenow'), expressionSchema]).optional(),
      issueType: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"connectorType":[".jira"]}}, defaults: {"connectorType":".jira"} }),
      priority: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"connectorType":[".jira"]}}, defaults: {"connectorType":".jira"} }),
      ...
      category: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"connectorType":[".servicenow"]}}, defaults: {"connectorType":".jira"} }),
      issueTypes: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"connectorType":[".resilient"]}}, defaults: {"connectorType":".jira"} }),
