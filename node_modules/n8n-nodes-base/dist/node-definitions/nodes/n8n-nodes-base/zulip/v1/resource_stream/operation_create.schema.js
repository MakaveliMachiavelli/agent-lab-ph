...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: resolveSchema({ parameters, schema: z.object({ announce: booleanOrExpression.optional(), authorizationErrorsFatal: booleanOrExpression.optional(), historyPublicToSubscribers: booleanOrExpression.optional(), inviteOnly: booleanOrExpression.optional(), principals: z.object({ properties: z.array(z.object({ email: stringOrExpression.optional() })).optional() }).optional(), streamPostPolicy: z.union([z.literal(1), z.literal(2), z.literal(3), expressionSchema]).optional() }), required: false, displayOptions: {"show":{"jsonParameters":[false]}}, defaults: {"jsonParameters":false} }),
    }).optional(),
  });
};