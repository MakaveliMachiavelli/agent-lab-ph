...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    fromEmail: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"resource":["email"],"operation":["send"]}}, defaults: {"resource":"email","operation":"send"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"resource":["email"],"operation":["sendAndWait"]}}, defaults: {"resource":"email","operation":"send"} }] }),
    toEmail: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"resource":["email"],"operation":["send"]}}, defaults: {"resource":"email","operation":"send"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"resource":["email"],"operation":["sendAndWait"]}}, defaults: {"resource":"email","operation":"send"} }] }),
    subject: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"resource":["email"],"operation":["send"]}}, defaults: {"resource":"email","operation":"send"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"resource":["email"],"operation":["sendAndWait"]}}, defaults: {"resource":"email","operation":"send"} }] }),
    ...
    options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ appendAttribution: booleanOrExpression.optional(), attachments: stringOrExpression.optional(), fileAttachments: stringOrExpression.optional(), ccEmail: stringOrExpression.optional(), bccEmail: stringOrExpression.optional(), allowUnauthorizedCerts: booleanOrExpression.optional(), replyTo: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"resource":["email"],"operation":["send"]}}, defaults: {"resource":"email","operation":"send"} }, { schema: z.object({ limitWaitTime: z.object({ values: z.object({ limitType: z.union([z.literal('afterTimeInterval'), z.literal('atSpecifiedTime'), expressionSchema]).optional(), resumeAmount: numberOrExpression.optional(), resumeUnit: z.union([z.literal('minutes'), z.literal('hours'), z.literal('days'), expressionSchema]).optional(), maxDateAndTime: stringOrExpression.optional() }).optional() }).optional(), appendAttribution: booleanOrExpression.optional() }), required: false, displayOptions: {"show":{"responseType":["approval"],"resource":["email"],"operation":["sendAndWait"]}}, defaults: {"responseType":"approval","resource":"email","operation":"send"} }, { schema: z.object({ messageButtonLabel: stringOrExpression.optional(), responseFormTitle: stringOrExpression.optional(), responseFormDescription: stringOrExpression.optional(), responseFormButtonLabel: stringOrExpression.optional(), responseFormCustomCss: stringOrExpression.optional(), limitWaitTime: z.object({ values: z.object({ limitType: z.union([z.literal('afterTimeInterval'), z.literal('atSpecifiedTime'), expressionSchema]).optional(), resumeAmount: numberOrExpression.optional(), resumeUnit: z.union([z.literal('minutes'), z.literal('hours'), z.literal('days'), expressionSchema]).optional(), maxDateAndTime: stringOrExpression.optional() }).optional() }).optional(), appendAttribution: booleanOrExpression.optional() }), required: false, displayOptions: {"show":{"responseType":["freeText","customForm"],"resource":["email"],"operation":["sendAndWait"]}}, defaults: {"responseType":"approval","resource":"email","operation":"send"} }] }),
