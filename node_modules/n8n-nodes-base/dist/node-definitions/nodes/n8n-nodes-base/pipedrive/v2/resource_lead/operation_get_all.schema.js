...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      filters: z.object({ archived_status: z.union([z.literal('all'), z.literal('archived'), z.literal('not_archived'), expressionSchema]).optional(), organization_id: numberOrExpression.optional(), owner_id: stringOrExpression.optional(), person_id: numberOrExpression.optional() }).optional(),
    }).optional(),
  });
};