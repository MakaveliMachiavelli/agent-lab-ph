...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: z.object({ currency: stringOrExpression.optional(), customProperties: z.object({ property: z.array(z.object({ name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), label: stringOrExpression.optional(), lost_reason: stringOrExpression.optional(), org_id: numberOrExpression.optional(), person_id: numberOrExpression.optional(), probability: numberOrExpression.optional(), stage_id: stringOrExpression.optional(), status: z.union([z.literal('open'), z.literal('won'), z.literal('lost'), z.literal('deleted'), expressionSchema]).optional(), user_id: stringOrExpression.optional(), value: numberOrExpression.optional(), visible_to: z.union([z.literal('1'), z.literal('3'), expressionSchema]).optional() }).optional(),
    }).optional(),
  });
};