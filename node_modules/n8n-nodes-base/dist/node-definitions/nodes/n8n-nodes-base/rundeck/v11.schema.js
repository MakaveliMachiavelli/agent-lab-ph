/**
 * Rundeck Node - Version 1.1 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    jobid: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["execute"],"resource":["job"]}}, defaults: {"operation":"execute","resource":"job"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["getMetadata"],"resource":["job"]}}, defaults: {"operation":"execute","resource":"job"} }] }),
