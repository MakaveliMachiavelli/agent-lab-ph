/**
 * Microsoft Excel (OneDrive) Node - Version 2.1
...
export type MicrosoftExcelV21WorksheetDeleteWorksheetParams = {
  ...
  authentication?: 'microsoftExcelOAuth2Api' | 'microsoftOAuth2Api' | 'microsoftEntraServicePrincipalApi';
/**
...
export type MicrosoftExcelV21WorksheetDeleteWorksheetNode = {
  ...
  version: 2.1;
  config: NodeConfig<MicrosoftExcelV21WorksheetDeleteWorksheetParams> & { credentials?: Credentials };
};