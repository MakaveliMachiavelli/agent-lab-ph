/**
 * Oracle Database Node - Version 1.1
...
export interface OracleDatabaseV11Params {
  resource?: unknown;
/**
 * Operation
 ...
 */
    ...
    values?: Array<{
       ...
       */
      valueString?: string | Expression<string>;
      /** Value (Number)
     ...
     * @default 4000
     */
    stringOutBindMaxSize?: number | Expression<number>;
...
export interface OracleDatabaseV11Credentials {
  oracleDBApi: CredentialReference;
}

interface OracleDatabaseV11NodeBase {
  type: 'n8n-nodes-base.oracleDatabase';
  version: 1.1;
}

export type OracleDatabaseV11ParamsNode = OracleDatabaseV11NodeBase & {
  config: NodeConfig<OracleDatabaseV11Params> & { credentials?: OracleDatabaseV11Credentials };
};

export type OracleDatabaseV11Node = OracleDatabaseV11ParamsNode;