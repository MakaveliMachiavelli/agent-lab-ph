...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      mailboxId: stringOrExpression,
      status: z.union([z.literal('active'), z.literal('closed'), z.literal('pending'), expressionSchema]),
      subject: stringOrExpression,
      type: z.union([z.literal('chat'), z.literal('email'), z.literal('phone'), expressionSchema]),
