...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      outputDataFrom: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('both'), z.literal('input1'), z.literal('input2'), expressionSchema]), required: false, displayOptions: {"show":{"combinationMode":["mergeByFields"],"joinMode":["keepMatches"]}}, defaults: {"combinationMode":"mergeByFields","joinMode":"keepMatches"} }, { schema: z.union([z.literal('both'), z.literal('input1'), z.literal('input2'), expressionSchema]), required: false, displayOptions: {"show":{"combinationMode":["mergeByFields"],"joinMode":["keepNonMatches"]}}, defaults: {"combinationMode":"mergeByFields","joinMode":"keepMatches"} }] }),
      options: z.object({ clashHandling: z.object({ values: z.object({ resolveClash: z.union([z.literal('addSuffix'), z.literal('preferInput1'), z.literal('preferInput2'), expressionSchema]).optional(), mergeMode: z.union([z.literal('deepMerge'), z.literal('shallowMerge'), expressionSchema]).optional(), overrideEmpty: booleanOrExpression.optional() }).optional() }).optional(), disableDotNotation: booleanOrExpression.optional(), fuzzyCompare: booleanOrExpression.optional(), includeUnpaired: booleanOrExpression.optional(), multipleMatches: z.union([z.literal('all'), z.literal('first'), expressionSchema]).optional() }).optional(),
    }).optional(),
  });
};