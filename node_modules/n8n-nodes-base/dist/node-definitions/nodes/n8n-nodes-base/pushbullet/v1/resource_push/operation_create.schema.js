...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      title: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"type":["note","link"]}}, defaults: {"type":"note"} }),
      body: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"type":["note","link","file"]}}, defaults: {"type":"note"} }),
      url: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"type":["link"]}}, defaults: {"type":"note"} }),
      ...
      value: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"hide":{"target":["default","device_iden"]}}, defaults: {"target":"default"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"target":["device_iden"]}}, defaults: {"target":"default"} }] }),
    }).optional(),
  });
};