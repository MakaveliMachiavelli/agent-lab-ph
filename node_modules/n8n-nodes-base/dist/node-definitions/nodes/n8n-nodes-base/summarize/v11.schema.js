...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    fieldsToSummarize: z.object({ values: z.array(z.object({ aggregation: z.union([z.literal('append'), z.literal('average'), z.literal('concatenate'), z.literal('count'), z.literal('countUnique'), z.literal('max'), z.literal('min'), z.literal('sum'), expressionSchema]).optional(), field: stringOrExpression.optional(), includeEmpty: booleanOrExpression.optional(), separateBy: z.union([z.literal(','), z.literal(', '), z.literal('\n'), z.literal(''), z.literal(' '), z.literal('other'), expressionSchema]).optional(), customSeparator: stringOrExpression.optional() })).optional() }).optional(),
    fieldsToSplitBy: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"hide":{"/options.outputFormat":["singleItem"]}} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"/options.outputFormat":["singleItem"]}} }] }),
