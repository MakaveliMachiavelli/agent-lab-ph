 ...
 */
     ...
     */
    body_html?: string | Expression<string>;
     ...
     */
    variant_ids?: Array<number | Expression<number>>;
     ...
     */
    product_type?: string | Expression<string>;
     ...
     */
    template_suffix?: string | Expression<string>;
...
export type ShopifyV1ProductCreateNode = {
  ...
  version: 1;
  config: NodeConfig<ShopifyV1ProductCreateParams> & { credentials?: Credentials };
