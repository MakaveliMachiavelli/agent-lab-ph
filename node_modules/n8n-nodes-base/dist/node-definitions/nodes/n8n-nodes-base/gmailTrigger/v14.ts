...
export interface GmailTriggerV14Credentials {
  googleApi: CredentialReference;
  gmailOAuth2: CredentialReference;
}

interface GmailTriggerV14NodeBase {
  type: 'n8n-nodes-base.gmailTrigger';
  version: 1.4;
  isTrigger: true;
}

export type GmailTriggerV14ParamsNode = GmailTriggerV14NodeBase & {
  config: NodeConfig<GmailTriggerV14Params> & { credentials?: GmailTriggerV14Credentials };
};

export type GmailTriggerV14Node = GmailTriggerV14ParamsNode;