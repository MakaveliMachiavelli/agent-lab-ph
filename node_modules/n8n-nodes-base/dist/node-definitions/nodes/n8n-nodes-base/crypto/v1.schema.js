...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    type: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('MD5'), z.literal('SHA1'), z.literal('SHA256'), z.literal('SHA3-256'), z.literal('SHA3-384'), z.literal('SHA3-512'), z.literal('SHA384'), z.literal('SHA512'), expressionSchema]), required: false, displayOptions: {"show":{"action":["hash"]}}, defaults: {"action":"hash"} }, { schema: z.union([z.literal('MD5'), z.literal('SHA1'), z.literal('SHA256'), z.literal('SHA3-256'), z.literal('SHA3-384'), z.literal('SHA3-512'), z.literal('SHA384'), z.literal('SHA512'), expressionSchema]), required: false, displayOptions: {"show":{"action":["hmac"]}}, defaults: {"action":"hash"} }] }),
    value: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["hash"],"binaryData":[false]}}, defaults: {"action":"hash","binaryData":false} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["hmac"],"binaryData":[false]}}, defaults: {"action":"hash","binaryData":false} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["sign"]}}, defaults: {"action":"hash"} }] }),
    dataPropertyName: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"action":["hash"]}}, defaults: {"action":"hash"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"action":["hmac"]}}, defaults: {"action":"hash"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"action":["sign"]}}, defaults: {"action":"hash"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"action":["generate"]}}, defaults: {"action":"hash"} }] }),
    encoding: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('base64'), z.literal('hex'), expressionSchema]), required: false, displayOptions: {"show":{"action":["hash"]}}, defaults: {"action":"hash"} }, { schema: z.union([z.literal('base64'), z.literal('hex'), expressionSchema]), required: false, displayOptions: {"show":{"action":["hmac"]}}, defaults: {"action":"hash"} }, { schema: z.union([z.literal('base64'), z.literal('hex'), expressionSchema]), required: false, displayOptions: {"show":{"action":["sign"]}}, defaults: {"action":"hash"} }] }),
    secret: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["hmac"]}}, defaults: {"action":"hash"} }),
    ...
    privateKey: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["sign"]}}, defaults: {"action":"hash"} }),
