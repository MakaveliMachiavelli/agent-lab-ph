...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      host: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"engine":["postgres","redshift","mysql","mongo"]}}, defaults: {"engine":"postgres"} }),
      ...
      user: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"engine":["postgres","redshift","mysql","mongo"]}}, defaults: {"engine":"postgres"} }),
      password: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"engine":["postgres","redshift","mysql","mongo"]}}, defaults: {"engine":"postgres"} }),
      ...
      filePath: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"engine":["h2","sqlite"]}}, defaults: {"engine":"postgres"} }),
