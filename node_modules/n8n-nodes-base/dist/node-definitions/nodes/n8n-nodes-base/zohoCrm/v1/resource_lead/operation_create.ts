 ...
 */
    ...
    address_fields?: {
      ...
      /** Zip Code
       */
      Zip_Code?: string | Expression<string>;
    };
  };
     ...
     */
    Designation?: string | Expression<string>;
    /** Email
     */
     ...
     */
    Industry_Type?: string | Expression<string>;
    /** Source from which the lead was created
     */
    Lead_Source?: string | Expression<string>;
    /** Lead Status
     */
    Lead_Status?: string | Expression<string>;
    /** Mobile
     */
...
export type ZohoCrmV1LeadCreateNode = {
  ...
  version: 1;
  config: NodeConfig<ZohoCrmV1LeadCreateParams> & { credentials?: Credentials };
};