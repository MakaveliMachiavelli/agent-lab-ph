...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    color: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["draw"]}}, defaults: {"operation":"border"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["transparent"]}}, defaults: {"operation":"border"} }] }),
    ...
    positionX: resolveOneOfSchemas({ parameters, variants: [{ schema: numberOrExpression, required: false, displayOptions: {"show":{"operation":["text"]}}, defaults: {"operation":"border"} }, { schema: numberOrExpression, required: false, displayOptions: {"show":{"operation":["composite"]}}, defaults: {"operation":"border"} }, { schema: numberOrExpression, required: false, displayOptions: {"show":{"operation":["crop"]}}, defaults: {"operation":"border"} }] }),
    positionY: resolveOneOfSchemas({ parameters, variants: [{ schema: numberOrExpression, required: false, displayOptions: {"show":{"operation":["text"]}}, defaults: {"operation":"border"} }, { schema: numberOrExpression, required: false, displayOptions: {"show":{"operation":["composite"]}}, defaults: {"operation":"border"} }, { schema: numberOrExpression, required: false, displayOptions: {"show":{"operation":["crop"]}}, defaults: {"operation":"border"} }] }),
