...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      identifier: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"source":["contentApi","adminApi"]}}, defaults: {"source":"contentApi"} }),
      options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ fields: stringOrExpression.optional(), formats: z.array(z.union([z.literal('html'), z.literal('mobiledoc'), z.literal('lexical')])).optional() }), required: false, displayOptions: {"show":{"source":["adminApi"]}}, defaults: {"source":"contentApi"} }, { schema: z.object({ fields: stringOrExpression.optional(), formats: z.array(z.union([z.literal('html'), z.literal('plaintext')])).optional() }), required: false, displayOptions: {"show":{"source":["contentApi"]}}, defaults: {"source":"contentApi"} }] }),
    }).optional(),
  });
};