...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ include: z.array(z.union([z.literal('authors'), z.literal('tags')])).optional(), fields: stringOrExpression.optional(), formats: z.array(z.union([z.literal('html'), z.literal('plaintext'), z.literal('lexical')])).optional() }), required: false, displayOptions: {"show":{"source":["contentApi"]}}, defaults: {"source":"contentApi"} }, { schema: z.object({ include: z.array(z.union([z.literal('authors'), z.literal('tags')])).optional(), fields: stringOrExpression.optional(), formats: z.array(z.union([z.literal('html'), z.literal('mobiledoc'), z.literal('lexical')])).optional() }), required: false, displayOptions: {"show":{"source":["adminApi"]}}, defaults: {"source":"contentApi"} }] }),
    }).optional(),
  });
};