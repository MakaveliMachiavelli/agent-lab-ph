...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      identifier: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"source":["contentApi"]}}, defaults: {"source":"contentApi"} }),
      space: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"source":["managementApi"]}}, defaults: {"source":"contentApi"} }),
      storyId: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"source":["managementApi"]}}, defaults: {"source":"contentApi"} }),
    }).optional(),
  });
};