 ...
 * @default *
 */
    object?: 'activity' | 'activityType' | '*' | 'deal' | 'lead' | 'note' | 'organization' | 'person' | 'pipeline' | 'product' | 'stage' | 'user' | Expression<string>;
}
...
export type PipedriveTriggerV1ParamsNode = PipedriveTriggerV1NodeBase & {
  config: NodeConfig<PipedriveTriggerV1Params> & { credentials?: PipedriveTriggerV1Credentials };
};
