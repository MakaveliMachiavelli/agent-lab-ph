 ...
 * @default *
 */
    entity?: 'activity' | 'activityType' | '*' | 'deal' | 'lead' | 'note' | 'organization' | 'person' | 'pipeline' | 'product' | 'stage' | 'user' | Expression<string>;
}
...
export type PipedriveTriggerV11ParamsNode = PipedriveTriggerV11NodeBase & {
  config: NodeConfig<PipedriveTriggerV11Params> & { credentials?: PipedriveTriggerV11Credentials };
};
