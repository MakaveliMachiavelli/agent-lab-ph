 ...
 */
     ...
     */
    'account-ref'?: string | Expression<string>;
     ...
     */
    callback?: string | Expression<string>;
    /** You can optionally include your own reference of up to 40 characters
     */
    'client-ref'?: string | Expression<string>;
     ...
     */
    'protocol-id'?: string | Expression<string>;
...
export type VonageV1SmsSendNode = {
  ...
  version: 1;
  config: NodeConfig<VonageV1SmsSendParams> & { credentials?: Credentials };
