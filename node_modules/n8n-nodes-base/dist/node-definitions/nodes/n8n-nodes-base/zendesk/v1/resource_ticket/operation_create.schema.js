...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: resolveSchema({ parameters, schema: z.object({ customFieldsUi: z.object({ customFieldsValues: z.array(z.object({ id: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), externalId: stringOrExpression.optional(), group: stringOrExpression.optional(), recipient: stringOrExpression.optional(), status: z.union([z.literal('closed'), z.literal('new'), z.literal('hold'), z.literal('open'), z.literal('pending'), z.literal('solved'), expressionSchema]).optional(), subject: stringOrExpression.optional(), tags: z.array(z.string()).optional(), type: z.union([z.literal('question'), z.literal('incident'), z.literal('problem'), z.literal('task'), expressionSchema]).optional() }), required: false, displayOptions: {"show":{"jsonParameters":[false]}}, defaults: {"jsonParameters":false} }),
