 ...
 */
     ...
     */
    inChannel?: string | Expression<string>;
    /** The ID of the team to get users for
     */
    inTeam?: string | Expression<string>;
    /** The ID of the team to exclude users for
     */
    notInTeam?: string | Expression<string>;
    /** The ID of the channel to exclude users for
     */
    notInChannel?: string | Expression<string>;
    /** The ID of the channel to exclude users for
     * @default username
     */
...
export type MattermostV1UserGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<MattermostV1UserGetAllParams> & { credentials?: Credentials };
};