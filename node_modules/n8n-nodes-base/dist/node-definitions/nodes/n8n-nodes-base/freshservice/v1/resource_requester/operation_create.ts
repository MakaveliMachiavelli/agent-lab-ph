 ...
 */
     ...
     */
    background_information?: string | Expression<string>;
    ...
    /** Mobile Phone
     */
    mobile_phone_number?: string | Expression<string>;
    /** Comma-separated secondary emails associated with the requester
     */
    secondary_emails?: string | Expression<string>;
    /** Time Format
     * @default 12h
     */
    ...
    /** Work Phone
     */
    work_phone_number?: string | Expression<string>;
  };
};
...
export type FreshserviceV1RequesterCreateNode = {
  ...
  version: 1;
  config: NodeConfig<FreshserviceV1RequesterCreateParams> & { credentials?: Credentials };
};