/**
 * E2E Test Polling Trigger Node - Version 1
 * Dummy polling trigger for e2e testing
 */


export interface E2eTestPollingTriggerV1Params {
/**
...
interface E2eTestPollingTriggerV1NodeBase {
  type: 'n8n-nodes-base.e2eTestPollingTrigger';
  version: 1;
  isTrigger: true;
}

export type E2eTestPollingTriggerV1ParamsNode = E2eTestPollingTriggerV1NodeBase & {
  config: NodeConfig<E2eTestPollingTriggerV1Params>;
};

export type E2eTestPollingTriggerV1Node = E2eTestPollingTriggerV1ParamsNode;