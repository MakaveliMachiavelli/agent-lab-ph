 ...
 */
     ...
     * @default []
     */
    countries?: Array<string | Expression<string>>;
    /** IPs
     * @default []
     */
    ips?: Array<string | Expression<string>>;
    /** Subdomains
     * @default []
     */
    subdomains?: Array<string | Expression<string>>;
  };
};
...
export type SecurityScorecardV1ReportGenerateNode = {
  ...
  version: 1;
  config: NodeConfig<SecurityScorecardV1ReportGenerateParams> & { credentials?: Credentials };
};