 ...
 */
     ...
     */
    grade_to_maintain?: string | Expression<string>;
    ...
    /** Issue Description
     */
    issue_desc?: string | Expression<string>;
    /** Issue Title
     */
    issue_title?: string | Expression<string>;
    /** Issue Type
     */
    issue_type?: string | Expression<string>;
     ...
     */
    target_url?: string | Expression<string>;
  };
};
...
export type SecurityScorecardV1InviteCreateNode = {
  ...
  version: 1;
  config: NodeConfig<SecurityScorecardV1InviteCreateParams> & { credentials?: Credentials };
};