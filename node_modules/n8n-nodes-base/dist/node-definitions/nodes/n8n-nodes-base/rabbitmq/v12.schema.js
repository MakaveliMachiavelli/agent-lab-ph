/**
 * RabbitMQ Node - Version 1.2 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    options: resolveSchema({ parameters, schema: z.object({ alternateExchange: stringOrExpression.optional(), arguments: z.object({ argument: z.array(z.object({ key: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), autoDelete: booleanOrExpression.optional(), durable: booleanOrExpression.optional(), exclusive: booleanOrExpression.optional(), headers: z.object({ header: z.array(z.object({ key: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional() }), required: false, displayOptions: {"show":{"operation":["sendMessage"]}}, defaults: {"operation":"sendMessage"} }),
  });
