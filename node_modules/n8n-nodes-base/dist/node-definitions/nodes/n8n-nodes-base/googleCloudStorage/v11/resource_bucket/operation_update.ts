...
export type GoogleCloudStorageV11BucketUpdateParams = {
  resource: 'bucket';
  operation: 'update';
...
export type GoogleCloudStorageV11BucketUpdateOutput = {
  etag?: string;
  generation?: string;
...
export type GoogleCloudStorageV11BucketUpdateNode = {
  type: 'n8n-nodes-base.googleCloudStorage';
  version: 1.1;
  config: NodeConfig<GoogleCloudStorageV11BucketUpdateParams> & { credentials?: Credentials };
  output?: Items<GoogleCloudStorageV11BucketUpdateOutput>;
};