...
/** Create a new Bucket */
export type GoogleCloudStorageV11BucketCreateParams = {
  resource: 'bucket';
  operation: 'create';
 ...
 */
    projectRLC?: { __rl: true; mode: 'list' | 'id'; value: string; cachedResultName?: string };
/**
 * Bucket Name
 */
...
export type GoogleCloudStorageV11BucketCreateOutput = {
  etag?: string;
  generation?: string;
  iamConfiguration?: {
    bucketPolicyOnly?: {
...
export type GoogleCloudStorageV11BucketCreateNode = {
  type: 'n8n-nodes-base.googleCloudStorage';
  version: 1.1;
  config: NodeConfig<GoogleCloudStorageV11BucketCreateParams> & { credentials?: Credentials };
  output?: Items<GoogleCloudStorageV11BucketCreateOutput>;
};