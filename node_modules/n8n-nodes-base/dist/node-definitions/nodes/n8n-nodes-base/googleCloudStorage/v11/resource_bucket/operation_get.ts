...
export type GoogleCloudStorageV11BucketGetParams = {
  resource: 'bucket';
  operation: 'get';
...
export type GoogleCloudStorageV11BucketGetOutput = {
  etag?: string;
  generation?: string;
...
export type GoogleCloudStorageV11BucketGetNode = {
  type: 'n8n-nodes-base.googleCloudStorage';
  version: 1.1;
  config: NodeConfig<GoogleCloudStorageV11BucketGetParams> & { credentials?: Credentials };
  output?: Items<GoogleCloudStorageV11BucketGetOutput>;
};