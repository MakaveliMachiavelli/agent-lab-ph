...
export type GoogleCloudStorageV11ObjectGetParams = {
  resource: 'object';
  operation: 'get';
...
export type GoogleCloudStorageV11ObjectGetOutput = {
  bucket?: string;
  contentType?: string;
  crc32c?: string;
  etag?: string;
...
export type GoogleCloudStorageV11ObjectGetNode = {
  type: 'n8n-nodes-base.googleCloudStorage';
  version: 1.1;
  config: NodeConfig<GoogleCloudStorageV11ObjectGetParams> & { credentials?: Credentials };
  output?: Items<GoogleCloudStorageV11ObjectGetOutput>;
};