...
/** Create a new Bucket */
export type GoogleCloudStorageV11ObjectCreateParams = {
  resource: 'object';
  operation: 'create';
 ...
 */
    ...
    /** Cache Control
     */
    cacheControl?: string | Expression<string>;
    /** Content Disposition
     */
    contentDisposition?: string | Expression<string>;
    /** Content Encoding
     */
    contentEncoding?: string | Expression<string>;
    /** Content Language
     */
    contentLanguage?: string | Expression<string>;
    /** Content Type
     */
    contentType?: string | Expression<string>;
    /** CRC32c Checksum
     */
    crc32c?: string | Expression<string>;
    /** Custom Time
     */
    customTime?: string | Expression<string>;
    /** Event Based Hold
     * @default false
     */
    ...
    /** MD5 Hash
     */
    md5Hash?: string | Expression<string>;
    /** Metadata
     * @default {}
     */
    ...
    /** Storage Class
     */
    storageClass?: string | Expression<string>;
    /** Temporary Hold
     * @default false
     */
 ...
 */
    ...
    /** KMS Key Name
     */
    kmsKeyName?: string | Expression<string>;
    /** Predefined ACL
 ...
 */
    ...
    /** Encryption Key
     */
    'X-Goog-Encryption-Key'?: string | Expression<string>;
    /** Encryption Key Hash
     */
    'X-Goog-Encryption-Key-Sha256'?: string | Expression<string>;
  };
  requestOptions?: {
    /** Batching
     * @default {"batch":{}}
...
export type GoogleCloudStorageV11ObjectCreateOutput = {
  bucket?: string;
  contentType?: string;
  crc32c?: string;
  etag?: string;
...
export type GoogleCloudStorageV11ObjectCreateNode = {
  type: 'n8n-nodes-base.googleCloudStorage';
  version: 1.1;
  config: NodeConfig<GoogleCloudStorageV11ObjectCreateParams> & { credentials?: Credentials };
  output?: Items<GoogleCloudStorageV11ObjectCreateOutput>;
};