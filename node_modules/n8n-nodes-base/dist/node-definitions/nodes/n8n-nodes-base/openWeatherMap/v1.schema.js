...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    cityName: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"locationSelection":["cityName"]}}, defaults: {"locationSelection":"cityName"} }),
    ...
    latitude: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"locationSelection":["coordinates"]}}, defaults: {"locationSelection":"cityName"} }),
    longitude: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"locationSelection":["coordinates"]}}, defaults: {"locationSelection":"cityName"} }),
    zipCode: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"locationSelection":["zipCode"]}}, defaults: {"locationSelection":"cityName"} }),
