...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    redirectURL: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"respondWith":["redirect"]}}, defaults: {"respondWith":"firstIncomingItem"} }),
    responseBody: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([iDataObjectSchema, z.string()]), required: false, displayOptions: {"show":{"respondWith":["json"]}}, defaults: {"respondWith":"firstIncomingItem"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"respondWith":["text"]}}, defaults: {"respondWith":"firstIncomingItem"} }] }),
    ...
    options: z.object({ responseCode: numberOrExpression.optional(), responseHeaders: z.object({ entries: z.array(z.object({ name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), responseKey: stringOrExpression.optional(), enableStreaming: booleanOrExpression.optional() }).optional(),
  });
