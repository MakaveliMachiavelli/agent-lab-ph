...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    domain: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["domainSearch"]}}, defaults: {"operation":"domainSearch"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["emailFinder"]}}, defaults: {"operation":"domainSearch"} }] }),
    ...
    firstname: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["emailFinder"]}}, defaults: {"operation":"domainSearch"} }),
    lastname: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["emailFinder"]}}, defaults: {"operation":"domainSearch"} }),
    email: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["emailVerifier"]}}, defaults: {"operation":"domainSearch"} }),
  });
