...
export type CustomerIoV1SegmentAddOutput = {
  success?: boolean;
};
...
export type CustomerIoV1SegmentAddNode = {
  ...
  version: 1;
  config: NodeConfig<CustomerIoV1SegmentAddParams> & { credentials?: Credentials };
  output?: Items<CustomerIoV1SegmentAddOutput>;
};