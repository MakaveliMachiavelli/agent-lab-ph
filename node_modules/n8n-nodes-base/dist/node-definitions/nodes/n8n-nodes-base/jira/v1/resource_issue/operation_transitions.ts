...
interface Credentials {
  ...
  jiraSoftwareCloudOAuth2Api: CredentialReference;
}
...
export type JiraV1IssueTransitionsParams = {
  ...
  jiraVersion?: 'cloud' | 'cloudOAuth2' | 'server' | 'serverPat' | Expression<string>;
/**
 * Issue Key
 */
 ...
 */
     ...
     */
    expand?: string | Expression<string>;
    /** The ID of the transition
     */
    transitionId?: string | Expression<string>;
...
export type JiraV1IssueTransitionsNode = {
  ...
  version: 1;
  config: NodeConfig<JiraV1IssueTransitionsParams> & { credentials?: Credentials };
