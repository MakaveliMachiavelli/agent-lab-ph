...
export type UnleashedSoftwareV11StockOnHandGetAllParams = {
 ...
 */
     ...
     */
    warehouseCode?: string | Expression<string>;
    /** Returns stock on hand for a specific warehouse name
     */
    warehouseName?: string | Expression<string>;
  };
};

export type UnleashedSoftwareV11StockOnHandGetAllNode = {
  type: 'n8n-nodes-base.unleashedSoftware';
  version: 1.1;
  config: NodeConfig<UnleashedSoftwareV11StockOnHandGetAllParams> & { credentials?: Credentials };
};