/**
 * Unleashed Software Node - Version 1.1
...
export type UnleashedSoftwareV11SalesOrderGetAllParams = {
  resource: 'salesOrder';
  operation: 'getAll';
/**
 ...
 */
     ...
     */
    customerCode?: string | Expression<string>;
     ...
     */
    orderNumber?: string | Expression<string>;
...
export type UnleashedSoftwareV11SalesOrderGetAllOutput = {
...
export type UnleashedSoftwareV11SalesOrderGetAllNode = {
  type: 'n8n-nodes-base.unleashedSoftware';
  version: 1.1;
  config: NodeConfig<UnleashedSoftwareV11SalesOrderGetAllParams> & { credentials?: Credentials };
  output?: Items<UnleashedSoftwareV11SalesOrderGetAllOutput>;
};