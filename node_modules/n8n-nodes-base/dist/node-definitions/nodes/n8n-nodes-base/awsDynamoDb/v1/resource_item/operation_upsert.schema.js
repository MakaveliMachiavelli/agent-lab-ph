...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      autoParseNumbers: booleanOrExpression.optional(),
      ...
      additionalFields: z.object({ eavUi: z.object({ eavValues: z.array(z.object({ attribute: stringOrExpression.optional(), type: z.union([z.literal('N'), z.literal('S'), expressionSchema]).optional(), value: stringOrExpression.optional() })).optional() }).optional(), conditionExpression: stringOrExpression.optional(), eanUi: z.object({ eanValues: z.array(z.object({ key: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional() }).optional(),
