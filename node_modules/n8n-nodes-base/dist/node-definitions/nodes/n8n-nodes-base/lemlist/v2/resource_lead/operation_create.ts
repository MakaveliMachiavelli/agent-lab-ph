 ...
 */
     ...
     */
    companyDomain?: string | Expression<string>;
     ...
     */
    icebreaker?: string | Expression<string>;
     ...
     */
    picture?: string | Expression<string>;
...
export type LemlistV2LeadCreateNode = {
  ...
  version: 2;
  config: NodeConfig<LemlistV2LeadCreateParams> & { credentials?: Credentials };
