 ...
 */
    ...
    actionValues?: Array<{
       ...
       */
      button_text?: string | Expression<string>;
      /** The text for the action button
     ...
     * @default data
     */
    binaryProperties?: string | Expression<string>;
...
export type TwistV1MessageConversationCreateNode = {
  ...
  version: 1;
  config: NodeConfig<TwistV1MessageConversationCreateParams> & { credentials?: Credentials };
};