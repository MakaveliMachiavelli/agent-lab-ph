...
export type UptimeRobotV1MonitorGetAllOutput = {
...
export type UptimeRobotV1MonitorGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<UptimeRobotV1MonitorGetAllParams> & { credentials?: Credentials };
  output?: Items<UptimeRobotV1MonitorGetAllOutput>;
};