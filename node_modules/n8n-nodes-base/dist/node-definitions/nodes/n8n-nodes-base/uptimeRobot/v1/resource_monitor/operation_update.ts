 ...
 */
     ...
     */
    friendly_name?: string | Expression<string>;
     ...
     */
    http_password?: string | Expression<string>;
    /** The username used for password-protected web pages
     */
    http_username?: string | Expression<string>;
...
export type UptimeRobotV1MonitorUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<UptimeRobotV1MonitorUpdateParams> & { credentials?: Credentials };
};