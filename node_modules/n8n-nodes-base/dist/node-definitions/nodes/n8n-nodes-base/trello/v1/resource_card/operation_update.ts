...
interface Credentials {
  ...
  trelloOAuth1Api: CredentialReference;
}
...
export type TrelloV1CardUpdateParams = {
  resource: 'card';
  operation: 'update';
  authentication?: 'apiKey' | 'oAuth1' | Expression<string>;
/**
 * The ID of the card
 ...
 */
     ...
     */
    idAttachmentCover?: string | Expression<string>;
     ...
     */
    idLabels?: string | Expression<string>;
    /** The ID of the list the card should be in
     */
    idList?: string | Expression<string>;
    /** Comma-separated list of member IDs to set on card
     */
    idMembers?: string | Expression<string>;
...
export type TrelloV1CardUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<TrelloV1CardUpdateParams> & { credentials?: Credentials };
