 ...
 */
     ...
     * @default blue
     */
    prefs_background?: string | Expression<string>;
     ...
     * @default none
     */
    keepFromSource?: string | Expression<string>;
     ...
     */
    idOrganization?: string | Expression<string>;
     ...
     */
    idBoardSource?: string | Expression<string>;
...
export type TrelloV1BoardCreateNode = {
  ...
  version: 1;
  config: NodeConfig<TrelloV1BoardCreateParams> & { credentials?: Credentials };
