 ...
 */
     ...
     * @default all
     */
    board_fields?: string | Expression<string>;
     ...
     * @default all
     */
    member_fields?: string | Expression<string>;
     ...
     * @default all
     */
    sticker_fields?: string | Expression<string>;
  };
};
...
export type TrelloV1CardGetNode = {
  ...
  version: 1;
  config: NodeConfig<TrelloV1CardGetParams> & { credentials?: Credentials };
