 ...
 */
    ...
    commitProperties?: Array<{
      ...
      /** Authors email
       */
      authorEmail?: string | Expression<string>;
      /** Name of author
       */
      authorName?: string | Expression<string>;
      /** Message of commit
       */
    ...
    refProperties?: Array<{
       ...
       */
      commit?: string | Expression<string>;
      /** Repository name
       */
      repository?: string | Expression<string>;
      /** The sha of the HEAD of the previous release
       */
      previousCommit?: string | Expression<string>;
    }>;
  };
  };
};
...
export type SentryIoV1ReleaseCreateNode = {
  ...
  version: 1;
  config: NodeConfig<SentryIoV1ReleaseCreateParams> & { credentials?: Credentials };
};