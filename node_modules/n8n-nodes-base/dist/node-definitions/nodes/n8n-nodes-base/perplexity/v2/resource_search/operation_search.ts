...
export type PerplexityV2SearchSearchOutput = {
  id?: string;
  results?: Array<{
    date?: string;
    last_updated?: string;
...
export type PerplexityV2SearchSearchNode = {
  ...
  version: 2;
  config: NodeConfig<PerplexityV2SearchSearchParams> & { credentials?: Credentials };
  output?: Items<PerplexityV2SearchSearchOutput>;
};