 ...
 */
     ...
     */
    searchAfterDate?: string | Expression<string>;
    /** Filter results published before this date (MM/DD/YYYY)
     */
    searchBeforeDate?: string | Expression<string>;
     ...
     */
    searchDomainFilter?: string | Expression<string>;
    /** Comma-separated list of ISO 639-1 language codes to filter results by (max 20)
     */
    searchLanguageFilter?: string | Expression<string>;
...
export type PerplexityV2ChatCompleteNode = {
  ...
  version: 2;
  config: NodeConfig<PerplexityV2ChatCompleteParams> & { credentials?: Credentials };
};