...
export interface HubspotTriggerV1Params {
  eventsUi?: {
    ...
    eventValues?: Array<{
       ...
       * @displayOptions.show { name: ["ticket.propertyChange"] }
       */
      property?: string | Expression<string>;
      /** Choose from the list, or specify an ID using an &lt;a href="https://docs.n8n.io/code/expressions/"&gt;expression&lt;/a&gt;
       * @displayOptions.show { name: ["conversation.propertyChange"] }
       */
      property?: 'assignedTo' | 'isArchived' | 'status' | Expression<string>;
    }>;
  };
  additionalFields?: {
...
export type HubspotTriggerV1ParamsNode = HubspotTriggerV1NodeBase & {
  config: NodeConfig<HubspotTriggerV1Params> & { credentials?: HubspotTriggerV1Credentials };
};
