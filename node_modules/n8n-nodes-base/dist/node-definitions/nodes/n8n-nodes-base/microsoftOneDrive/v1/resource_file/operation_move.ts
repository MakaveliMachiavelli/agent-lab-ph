...
/** Move a file */
export type MicrosoftOneDriveV1FileMoveParams = {
  resource: 'file';
  operation: 'move';
...
export type MicrosoftOneDriveV1FileMoveNode = {
  type: 'n8n-nodes-base.microsoftOneDrive';
  version: 1;
  config: NodeConfig<MicrosoftOneDriveV1FileMoveParams> & { credentials?: Credentials };
};