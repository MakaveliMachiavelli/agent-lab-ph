...
/** Move a file */
export type MicrosoftOneDriveV11FileMoveParams = {
  resource: 'file';
  operation: 'move';
 ...
 */
    additionalFields?: {
    /** A new name for the file. If omitted, the existing name is kept.
     */
    name?: string | Expression<string>;
  };
};

export type MicrosoftOneDriveV11FileMoveNode = {
  type: 'n8n-nodes-base.microsoftOneDrive';
  version: 1.1;
  config: NodeConfig<MicrosoftOneDriveV11FileMoveParams> & { credentials?: Credentials };
};