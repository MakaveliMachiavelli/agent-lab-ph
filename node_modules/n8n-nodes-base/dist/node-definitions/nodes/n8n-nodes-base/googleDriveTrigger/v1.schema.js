...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    triggerOn: z.union([z.literal('specificFile'), z.literal('specificFolder'), expressionSchema]),
    ...
    event: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('fileUpdated'), expressionSchema]), required: false, displayOptions: {"show":{"triggerOn":["specificFile"]}}, defaults: {"triggerOn":""} }, { schema: z.union([z.literal('fileCreated'), z.literal('fileUpdated'), z.literal('folderCreated'), z.literal('folderUpdated'), z.literal('watchFolderUpdated'), expressionSchema]), required: true, displayOptions: {"show":{"triggerOn":["specificFolder"]}}, defaults: {"triggerOn":""} }, { schema: z.union([z.literal('fileCreated'), z.literal('fileUpdated'), z.literal('folderCreated'), z.literal('folderUpdated'), expressionSchema]), required: false, displayOptions: {"show":{"triggerOn":["anyFileFolder"]}}, defaults: {"triggerOn":""} }] }),
