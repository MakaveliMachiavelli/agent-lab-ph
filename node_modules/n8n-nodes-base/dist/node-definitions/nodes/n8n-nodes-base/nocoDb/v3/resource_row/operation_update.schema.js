...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      primaryKey: resolveSchema({ parameters, schema: z.union([z.literal('id'), z.literal('ncRecordId'), z.literal('custom'), expressionSchema]), required: false, displayOptions: {"show":{"version":[1,2]}}, defaults: {"version":3} }),
      customPrimaryKey: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"version":[1,2],"primaryKey":["custom"]}}, defaults: {"version":3,"primaryKey":"id"} }),
      id: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"version":[1,2]}}, defaults: {"version":3} }),
