/**
 * NocoDB Node - Version 4
 * Discriminator: resource=linkrow, operation=link
 */
...
export type NocoDbV4LinkrowLinkParams = {
  resource: 'linkrow';
  operation: 'link';
 ...
 */
    workspaceId?: { __rl: true; mode: 'list' | 'id'; value: string; cachedResultName?: string };
/**
 * Choose from the list, or specify an ID using an &lt;a href="https://docs.n8n.io/code/expressions/"&gt;expression&lt;/a&gt;
 ...
 * @default {"mode":"list","value":""}
 */
    linkFieldName?: { __rl: true; mode: 'list' | 'id'; value: string; cachedResultName?: string };
/**
 * The ID of record in table
 * @default []
 */
    linkId?: Array<string | Expression<string>>;
};

export type NocoDbV4LinkrowLinkNode = {
  type: 'n8n-nodes-base.nocoDb';
  version: 4;
  config: NodeConfig<NocoDbV4LinkrowLinkParams> & { credentials?: Credentials };
};