...
export type NocoDbV4RowUpdateParams = {
  resource: 'row';
  operation: 'update';
 ...
 */
    dataToSend?: 'autoMapInputData' | 'mapWithFields' | Expression<string>;
/**
...
/**
 * Fields to Send
 * @displayOptions.show { dataToSend: ["mapWithFields"] }
 * @default {"mappingMode":"defineBelow","value":null}
 */
    fieldsMapper?: ResourceMapperValue;
};

export type NocoDbV4RowUpdateNode = {
  type: 'n8n-nodes-base.nocoDb';
  version: 4;
  config: NodeConfig<NocoDbV4RowUpdateParams> & { credentials?: Credentials };
};