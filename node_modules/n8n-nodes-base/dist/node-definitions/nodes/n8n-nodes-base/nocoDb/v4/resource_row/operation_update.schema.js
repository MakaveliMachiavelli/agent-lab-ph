...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      dataToSend: z.union([z.literal('autoMapInputData'), z.literal('mapWithFields'), expressionSchema]).optional(),
      id: stringOrExpression,
      inputsToIgnore: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"dataToSend":["autoMapInputData"]}}, defaults: {"dataToSend":"mapWithFields"} }),
      fieldsMapper: resolveSchema({ parameters, schema: resourceMapperValueSchema, required: false, displayOptions: {"show":{"dataToSend":["mapWithFields"]}}, defaults: {"dataToSend":"mapWithFields"} }),
    }).optional(),
  });
};