...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      contractAddress: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"searchBy":["contractAddress"]}}, defaults: {"searchBy":"coinId"} }),
      baseCurrency: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"searchBy":["coinId"]},"hide":{"searchBy":["contractAddress"]}}, defaults: {"searchBy":"coinId"} }),
      quoteCurrency: stringOrExpression,
      days: z.union([z.literal('1'), z.literal('7'), z.literal('14'), z.literal('30'), z.literal('90'), z.literal('180'), z.literal('365'), z.literal('max'), expressionSchema]),
    }).optional(),
  });
};