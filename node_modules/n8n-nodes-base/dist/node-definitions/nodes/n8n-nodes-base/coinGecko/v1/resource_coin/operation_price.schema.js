...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      baseCurrencies: resolveSchema({ parameters, schema: z.array(z.string()), required: true, displayOptions: {"show":{"searchBy":["coinId"]}}, defaults: {"searchBy":"coinId"} }),
      ...
      contractAddresses: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"searchBy":["contractAddress"]}}, defaults: {"searchBy":"coinId"} }),
