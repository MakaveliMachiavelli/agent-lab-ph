...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      additionalFields: z.object({ addressUi: z.object({ addressValues: z.object({ address1: stringOrExpression.optional(), address2: stringOrExpression.optional(), city: stringOrExpression.optional(), state: stringOrExpression.optional(), country: stringOrExpression.optional(), zipCode: stringOrExpression.optional() }).optional() }).optional(), b2bOrb2c: z.union([z.literal('B2B'), z.literal('B2C'), expressionSchema]).optional(), crmId: stringOrExpression.optional(), customFieldsUi: z.object({ customFieldValues: z.array(z.object({ fieldId: stringOrExpression.optional(), fieldValue: stringOrExpression.optional() })).optional() }).optional(), fax: stringOrExpression.optional(), hasPurchased: booleanOrExpression.optional(), ipAddress: stringOrExpression.optional(), lastActive: stringOrExpression.optional(), mobile: stringOrExpression.optional(), ownerId: stringOrExpression.optional(), phone: stringOrExpression.optional(), prospectOrCustomer: z.union([z.literal('Prospect'), z.literal('Customer'), expressionSchema]).optional(), sandbox: booleanOrExpression.optional(), stage: stringOrExpression.optional(), tags: z.array(z.string()).optional(), socialMediaUi: z.object({ socialMediaValues: z.object({ facebook: stringOrExpression.optional(), foursquare: stringOrExpression.optional(), instagram: stringOrExpression.optional(), linkedIn: stringOrExpression.optional(), skype: stringOrExpression.optional(), twitter: stringOrExpression.optional() }).optional() }).optional(), website: stringOrExpression.optional() }).optional(),
