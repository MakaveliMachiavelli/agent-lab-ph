 ...
 */
     ...
     * @displayOptions.show { /jsonParameters: [false] }
     */
    crmId?: string | Expression<string>;
    ...
    socialMediaValues?: {
      /** Facebook
       */
      facebook?: string | Expression<string>;
      /** Foursquare
       */
      foursquare?: string | Expression<string>;
      /** Instagram
       */
      instagram?: string | Expression<string>;
      /** LinkedIn
       */
      linkedIn?: string | Expression<string>;
      /** Skype
       */
      skype?: string | Expression<string>;
      /** Twitter
       */
...
export type MauticV1ContactUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<MauticV1ContactUpdateParams> & { credentials?: Credentials };
};