 ...
 */
    signature: string | Expression<string>;
/**
 ...
 */
     ...
     */
    branches?: string | Expression<string>;
    /** Filter by git authors (comma-separated for multiple)
     */
    authors?: string | Expression<string>;
    /** Filter by groups (comma-separated for multiple)
     */
    groups?: string | Expression<string>;
 ...
 */
     ...
     */
    startingAfter?: string | Expression<string>;
    /** Cursor for backward pagination
     */
    endingBefore?: string | Expression<string>;
  };
  requestOptions?: {
    /** Batching
     * @default {"batch":{}}
...
export type CurrentsV1TestResultGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<CurrentsV1TestResultGetAllParams> & { credentials?: Credentials };
};