...
export type GoogleSheetsV43SheetAppendNode = {
  ...
  version: 4.3;
  config: NodeConfig<GoogleSheetsV43SheetAppendParams> & { credentials?: Credentials };
};