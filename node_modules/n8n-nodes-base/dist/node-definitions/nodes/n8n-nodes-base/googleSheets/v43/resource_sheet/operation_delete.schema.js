...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      startIndex: resolveOneOfSchemas({ parameters, variants: [{ schema: numberOrExpression, required: false, displayOptions: {"show":{"toDelete":["rows"]},"hide":{"sheetName":[""]}}, defaults: {"toDelete":"rows","sheetName":{"mode":"list","value":""}} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"toDelete":["columns"]},"hide":{"sheetName":[""]}}, defaults: {"toDelete":"rows","sheetName":{"mode":"list","value":""}} }] }),
      numberToDelete: resolveOneOfSchemas({ parameters, variants: [{ schema: numberOrExpression, required: false, displayOptions: {"show":{"toDelete":["rows"]},"hide":{"sheetName":[""]}}, defaults: {"toDelete":"rows","sheetName":{"mode":"list","value":""}} }, { schema: numberOrExpression, required: false, displayOptions: {"show":{"toDelete":["columns"]},"hide":{"sheetName":[""]}}, defaults: {"toDelete":"rows","sheetName":{"mode":"list","value":""}} }] }),
    }).optional(),
  });
};