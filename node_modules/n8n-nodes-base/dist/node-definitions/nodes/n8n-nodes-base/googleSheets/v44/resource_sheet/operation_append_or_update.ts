...
export type GoogleSheetsV44SheetAppendOrUpdateNode = {
  ...
  version: 4.4;
  config: NodeConfig<GoogleSheetsV44SheetAppendOrUpdateParams> & { credentials?: Credentials };
};