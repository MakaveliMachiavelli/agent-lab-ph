...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      options: resolveSchema({ parameters, schema: z.object({ cellFormat: z.union([z.literal('USER_ENTERED'), z.literal('RAW'), expressionSchema]).optional(), locationDefine: z.object({ values: z.object({ headerRow: numberOrExpression.optional(), firstDataRow: numberOrExpression.optional() }).optional() }).optional(), handlingExtraData: z.union([z.literal('insertInNewColumn'), z.literal('ignoreIt'), z.literal('error'), expressionSchema]).optional() }), required: false, displayOptions: {"hide":{"sheetName":[""]}}, defaults: {"sheetName":{"mode":"list","value":""}} }),
    }).optional(),
  });
};