...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      options: resolveSchema({ parameters, schema: z.object({ dataLocationOnSheet: z.object({ values: z.object({ rangeDefinition: z.union([z.literal('detectAutomatically'), z.literal('specifyRangeA1'), z.literal('specifyRange'), expressionSchema]).optional(), readRowsUntil: z.union([z.literal('firstEmptyRow'), z.literal('lastRowInSheet'), expressionSchema]).optional(), headerRow: numberOrExpression.optional(), firstDataRow: numberOrExpression.optional(), range: stringOrExpression.optional() }).optional() }).optional(), outputFormatting: z.object({ values: z.object({ general: z.union([z.literal('UNFORMATTED_VALUE'), z.literal('FORMATTED_VALUE'), z.literal('FORMULA'), expressionSchema]).optional(), date: z.union([z.literal('FORMATTED_STRING'), z.literal('SERIAL_NUMBER'), expressionSchema]).optional() }).optional() }).optional(), returnFirstMatch: booleanOrExpression.optional(), returnAllMatches: z.union([z.literal('returnFirstMatch'), z.literal('returnAllMatches'), expressionSchema]).optional() }), required: false, displayOptions: {"hide":{"sheetName":[""]}}, defaults: {"sheetName":{"mode":"list","value":""}} }),
    }).optional(),
  });
};