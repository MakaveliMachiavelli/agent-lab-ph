...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    limitWaitTime: resolveOneOfSchemas({ parameters, variants: [{ schema: booleanOrExpression, required: false, displayOptions: {"show":{"operation":["page"]}}, defaults: {"operation":"page"} }, { schema: booleanOrExpression, required: false, displayOptions: {"show":{"operation":["completion"]}}, defaults: {"operation":"page"} }] }),
    limitType: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('afterTimeInterval'), z.literal('atSpecifiedTime'), expressionSchema]), required: false, displayOptions: {"show":{"limitWaitTime":[true],"operation":["page"]}}, defaults: {"limitWaitTime":false,"operation":"page"} }, { schema: z.union([z.literal('afterTimeInterval'), z.literal('atSpecifiedTime'), expressionSchema]), required: false, displayOptions: {"show":{"limitWaitTime":[true],"operation":["completion"]}}, defaults: {"limitWaitTime":false,"operation":"page"} }] }),
    resumeAmount: resolveOneOfSchemas({ parameters, variants: [{ schema: numberOrExpression, required: false, displayOptions: {"show":{"limitType":["afterTimeInterval"],"limitWaitTime":[true],"operation":["page"]}}, defaults: {"limitType":"afterTimeInterval","limitWaitTime":false,"operation":"page"} }, { schema: numberOrExpression, required: false, displayOptions: {"show":{"limitType":["afterTimeInterval"],"limitWaitTime":[true],"operation":["completion"]}}, defaults: {"limitType":"afterTimeInterval","limitWaitTime":false,"operation":"page"} }] }),
    resumeUnit: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('minutes'), z.literal('hours'), z.literal('days'), expressionSchema]), required: false, displayOptions: {"show":{"limitType":["afterTimeInterval"],"limitWaitTime":[true],"operation":["page"]}}, defaults: {"limitType":"afterTimeInterval","limitWaitTime":false,"operation":"page"} }, { schema: z.union([z.literal('minutes'), z.literal('hours'), z.literal('days'), expressionSchema]), required: false, displayOptions: {"show":{"limitType":["afterTimeInterval"],"limitWaitTime":[true],"operation":["completion"]}}, defaults: {"limitType":"afterTimeInterval","limitWaitTime":false,"operation":"page"} }] }),
    maxDateAndTime: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"limitType":["atSpecifiedTime"],"limitWaitTime":[true],"operation":["page"]}}, defaults: {"limitType":"afterTimeInterval","limitWaitTime":false,"operation":"page"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"limitType":["atSpecifiedTime"],"limitWaitTime":[true],"operation":["completion"]}}, defaults: {"limitType":"afterTimeInterval","limitWaitTime":false,"operation":"page"} }] }),
    options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ formTitle: stringOrExpression.optional(), formDescription: stringOrExpression.optional(), buttonLabel: stringOrExpression.optional(), customCss: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["page"]}}, defaults: {"operation":"page"} }, { schema: z.object({ formTitle: stringOrExpression.optional(), customCss: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"respondWith":["text","returnBinary","redirect"],"operation":["completion"]}}, defaults: {"respondWith":"text","operation":"page"} }] }),
    ...
    redirectUrl: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"respondWith":["redirect"],"operation":["completion"]}}, defaults: {"respondWith":"text","operation":"page"} }),
    completionTitle: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"respondWith":["text","returnBinary"],"operation":["completion"]}}, defaults: {"respondWith":"text","operation":"page"} }),
