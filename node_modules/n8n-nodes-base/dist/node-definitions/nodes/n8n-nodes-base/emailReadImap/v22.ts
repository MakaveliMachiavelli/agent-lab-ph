/**
 * Email Trigger (IMAP) Node - Version 2.2
 * Triggers the workflow when a new email is received
 */


export interface EmailReadImapV22Params {
 ...
 */
  ...
  options?: {
     ...
     * @default ["UNSEEN"]
     */
    customEmailConfig?: string | Expression<string>;
...
export interface EmailReadImapV22Credentials {
  imap: CredentialReference;
}

interface EmailReadImapV22NodeBase {
  type: 'n8n-nodes-base.emailReadImap';
  version: 2.2;
  isTrigger: true;
}

export type EmailReadImapV22ParamsNode = EmailReadImapV22NodeBase & {
  config: NodeConfig<EmailReadImapV22Params> & { credentials?: EmailReadImapV22Credentials };
};

export type EmailReadImapV22Node = EmailReadImapV22ParamsNode;