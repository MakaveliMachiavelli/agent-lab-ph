/**
 * Email Trigger (IMAP) Node - Version 2.2 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    dataPropertyAttachmentsPrefixName: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"format":["resolved"]}}, defaults: {"format":"simple"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"format":["simple"],"downloadAttachments":[true]}}, defaults: {"format":"simple","downloadAttachments":false} }] }),
