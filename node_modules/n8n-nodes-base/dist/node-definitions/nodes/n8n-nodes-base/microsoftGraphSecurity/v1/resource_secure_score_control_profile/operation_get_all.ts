...
export type MicrosoftGraphSecurityV1SecureScoreControlProfileGetAllParams = {
  ...
  operation: 'getAll';
  authentication?: 'microsoftGraphSecurityOAuth2Api' | 'microsoftOAuth2Api';
/**
...
export type MicrosoftGraphSecurityV1SecureScoreControlProfileGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<MicrosoftGraphSecurityV1SecureScoreControlProfileGetAllParams> & { credentials?: Credentials };
};