 ...
 */
    ...
    /** Business Name
     */
    businessName?: string | Expression<string>;
    /** Email
     */
    ...
    /** Invoice Emails
     */
    invoiceCcEmails?: Array<string | Expression<string>>;
    /** Last Name
     */
     ...
     */
    notificationEmail?: string | Expression<string>;
    /** Phone
     */
     ...
     */
    referredBy?: string | Expression<string>;
  };
};
...
export type SyncroMspV1CustomerUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<SyncroMspV1CustomerUpdateParams> & { credentials?: Credentials };
};