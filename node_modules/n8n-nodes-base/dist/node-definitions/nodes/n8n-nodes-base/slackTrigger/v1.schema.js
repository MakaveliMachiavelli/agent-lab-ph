...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    trigger: z.array(z.union([z.literal('any_event'), z.literal('app_home_opened'), z.literal('app_mention'), z.literal('file_public'), z.literal('file_share'), z.literal('message'), z.literal('channel_created'), z.literal('team_join'), z.literal('reaction_added')])).optional(),
    ...
    options: z.object({ resolveIds: booleanOrExpression.optional(), userIds: z.array(z.string()).optional(), reactionEmojis: stringOrExpression.optional() }).optional(),
  });
