...
export interface SlackTriggerV1Params {
  ...
  trigger?: Array<'any_event' | 'app_home_opened' | 'app_mention' | 'file_public' | 'file_share' | 'message' | 'channel_created' | 'team_join' | 'reaction_added'>;
/**
 ...
 */
  ...
  options?: {
     ...
     * @displayOptions.show { /trigger: ["reaction_added"] }
     */
    reactionEmojis?: string | Expression<string>;
  };
}
...
export type SlackTriggerV1ParamsNode = SlackTriggerV1NodeBase & {
  config: NodeConfig<SlackTriggerV1Params> & { credentials?: SlackTriggerV1Credentials };
};
