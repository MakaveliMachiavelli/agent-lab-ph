 ...
 */
     ...
     */
    order?: string | Expression<string>;
...
export type ContentfulV1AssetGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<ContentfulV1AssetGetAllParams> & { credentials?: Credentials };
};