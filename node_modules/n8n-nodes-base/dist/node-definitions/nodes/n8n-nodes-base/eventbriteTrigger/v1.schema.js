...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  const parametersSchema = z.object({
    ...
    organization: stringOrExpression,
    event: stringOrExpression,
    actions: z.array(z.union([z.literal('attendee.checked_in'), z.literal('attendee.checked_out'), z.literal('attendee.updated'), z.literal('event.created'), z.literal('event.published'), z.literal('event.unpublished'), z.literal('event.updated'), z.literal('order.placed'), z.literal('order.refunded'), z.literal('order.updated'), z.literal('organizer.updated'), z.literal('ticket_class.created'), z.literal('ticket_class.deleted'), z.literal('ticket_class.updated'), z.literal('venue.updated')])),
