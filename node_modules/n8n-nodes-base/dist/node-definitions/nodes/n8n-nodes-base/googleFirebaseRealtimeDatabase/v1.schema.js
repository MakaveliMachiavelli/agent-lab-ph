...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    projectId: stringOrExpression,
    operation: z.union([z.literal('create'), z.literal('delete'), z.literal('get'), z.literal('push'), z.literal('update')]).optional(),
    path: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"hide":{"operation":["get"]}}, defaults: {"operation":"create"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["get"]}}, defaults: {"operation":"create"} }] }),
    attributes: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["create","push","update"]}}, defaults: {"operation":"create"} }),
  });
