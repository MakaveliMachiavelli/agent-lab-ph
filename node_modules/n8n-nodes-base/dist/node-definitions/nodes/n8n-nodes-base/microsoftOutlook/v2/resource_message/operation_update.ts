 ...
 */
     ...
     */
    bccRecipients?: string | Expression<string>;
     ...
     */
    ccRecipients?: string | Expression<string>;
    /** Custom Headers
     * @default {}
     */
...
export type MicrosoftOutlookV2MessageUpdateNode = {
  ...
  version: 2;
  config: NodeConfig<MicrosoftOutlookV2MessageUpdateParams> & { credentials?: Credentials };
