...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      includeRecurringInstances: booleanOrExpression.optional(),
      startDateTime: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"includeRecurringInstances":[true]}}, defaults: {"includeRecurringInstances":false} }),
      endDateTime: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"includeRecurringInstances":[true]}}, defaults: {"includeRecurringInstances":false} }),
      ...
      filters: resolveSchema({ parameters, schema: z.object({ custom: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"includeRecurringInstances":[false]}}, defaults: {"includeRecurringInstances":false} }),
    }).optional(),
  });
};