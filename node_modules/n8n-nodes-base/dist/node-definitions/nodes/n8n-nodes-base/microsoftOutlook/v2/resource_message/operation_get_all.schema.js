...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      filtersUI: z.object({ values: z.object({ filterBy: z.union([z.literal('filters'), z.literal('search'), expressionSchema]).optional(), search: stringOrExpression.optional(), filters: z.object({ custom: stringOrExpression.optional(), hasAttachments: booleanOrExpression.optional(), foldersToExclude: z.array(z.string()).optional(), foldersToInclude: z.array(z.string()).optional(), readStatus: z.union([z.literal('both'), z.literal('unread'), z.literal('read'), expressionSchema]).optional(), receivedAfter: stringOrExpression.optional(), receivedBefore: stringOrExpression.optional(), sender: stringOrExpression.optional() }).optional() }).optional() }).optional(),
