...
/**
 * Start
 * @default 2026-08-21T07:23:15.519+00:00
 */
    startDateTime?: string | Expression<string>;
/**
 * End
 * @default 2026-08-21T07:53:15.520+00:00
 */
 ...
 */
    ...
    values?: Array<{
       ...
       * @default required
       */
      type?: 'optional' | 'required' | 'resource' | Expression<string>;
    }>;
  };
    ...
    /** Description Preview
     */
    bodyPreview?: string | Expression<string>;
...
export type MicrosoftOutlookV2EventCreateNode = {
  ...
  version: 2;
  config: NodeConfig<MicrosoftOutlookV2EventCreateParams> & { credentials?: Credentials };
