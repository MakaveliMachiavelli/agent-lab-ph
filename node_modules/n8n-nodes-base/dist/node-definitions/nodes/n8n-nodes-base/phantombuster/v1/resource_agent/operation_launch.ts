 ...
 */
     ...
     * @displayOptions.show { /jsonParameters: [true] }
     */
    bonusArgumentJson?: string | Expression<string>;
     ...
     */
    saveArgument?: string | Expression<string>;
  };
};
...
export type PhantombusterV1AgentLaunchNode = {
  ...
  version: 1;
  config: NodeConfig<PhantombusterV1AgentLaunchParams> & { credentials?: Credentials };
