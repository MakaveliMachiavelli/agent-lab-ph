/**
 * QuestDB Node - Version 1.1 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    table: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["insert"]}}, defaults: {"operation":"insert"} }),
    ...
    additionalFields: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ mode: z.union([z.literal('independently'), z.literal('transaction'), expressionSchema]).optional(), queryParams: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["executeQuery"]}}, defaults: {"operation":"insert"} }, { schema: z.unknown(), required: false, displayOptions: {"show":{"operation":["insert"]}}, defaults: {"operation":"insert"} }] }),
  });
