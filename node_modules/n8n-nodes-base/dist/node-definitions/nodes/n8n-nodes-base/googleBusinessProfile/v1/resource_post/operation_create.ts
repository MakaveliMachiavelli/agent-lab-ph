 ...
 */
     ...
     */
    languageCode?: string | Expression<string>;
     ...
     * @displayOptions.show { /postType: ["OFFER"] }
     */
    redeemOnlineUrl?: string | Expression<string>;
    /** The terms and conditions of the offer
     * @displayOptions.show { /postType: ["OFFER"] }
     */
    termsConditions?: string | Expression<string>;
  };
  requestOptions?: {
    /** Batching
     * @default {"batch":{}}
...
export type GoogleBusinessProfileV1PostCreateNode = {
  ...
  version: 1;
  config: NodeConfig<GoogleBusinessProfileV1PostCreateParams> & { credentials?: Credentials };
};