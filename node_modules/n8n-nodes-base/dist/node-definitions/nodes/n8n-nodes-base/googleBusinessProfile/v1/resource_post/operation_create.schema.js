...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      summary: stringOrExpression,
      title: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"postType":["EVENT"]}}, defaults: {"postType":"STANDARD"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"postType":["OFFER"]}}, defaults: {"postType":"STANDARD"} }] }),
      startDateTime: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"postType":["EVENT"]}}, defaults: {"postType":"STANDARD"} }),
      endDateTime: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"postType":["EVENT"]}}, defaults: {"postType":"STANDARD"} }),
      startDate: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"postType":["OFFER"]}}, defaults: {"postType":"STANDARD"} }),
      endDate: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"postType":["OFFER"]}}, defaults: {"postType":"STANDARD"} }),
