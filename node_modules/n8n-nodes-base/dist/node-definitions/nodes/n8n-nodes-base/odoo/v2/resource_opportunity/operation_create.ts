...
interface Credentials {
  odooApiKeyApi: CredentialReference;
  odooApi: CredentialReference;
}

/** Schedule a new activity */
export type OdooV2OpportunityCreateParams = {
  resource: 'opportunity';
  operation: 'create';
  authentication?: 'odooApiKeyApi' | 'odooApi' | Expression<string>;
/**
 * Fields to Send
 * @default {"mappingMode":"defineBelow","value":null}
 */
    fieldsToSend?: ResourceMapperValue;
};

export type OdooV2OpportunityCreateOutput = {
  id?: number;
};

export type OdooV2OpportunityCreateNode = {
  type: 'n8n-nodes-base.odoo';
  version: 2;
  config: NodeConfig<OdooV2OpportunityCreateParams> & { credentials?: Credentials };
  output?: Items<OdooV2OpportunityCreateOutput>;
};