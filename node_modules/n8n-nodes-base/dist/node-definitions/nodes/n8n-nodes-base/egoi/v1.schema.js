...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    email: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["create"]}}, defaults: {"operation":"create"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"resource":["contact"],"operation":["get"],"by":["email"]}}, defaults: {"resource":"contact","operation":"create","by":"id"} }] }),
    contactId: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"resource":["contact"],"operation":["update"]}}, defaults: {"resource":"contact","operation":"create"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"resource":["contact"],"operation":["get"],"by":["id"]}}, defaults: {"resource":"contact","operation":"create","by":"id"} }] }),
    ...
    additionalFields: resolveSchema({ parameters, schema: z.object({ birth_date: stringOrExpression.optional(), cellphone: stringOrExpression.optional(), extraFieldsUi: z.object({ extraFieldValues: z.array(z.object({ field_id: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), first_name: stringOrExpression.optional(), last_name: stringOrExpression.optional(), status: z.union([z.literal('unconfirmed'), z.literal('active'), z.literal('inactive'), z.literal('removed'), expressionSchema]).optional(), tagIds: z.array(z.string()).optional() }), required: false, displayOptions: {"show":{"operation":["create"],"resource":["contact"]}}, defaults: {"operation":"create","resource":"contact"} }),
    updateFields: resolveSchema({ parameters, schema: z.object({ birth_date: stringOrExpression.optional(), cellphone: stringOrExpression.optional(), email: stringOrExpression.optional(), extraFieldsUi: z.object({ extraFieldValues: z.array(z.object({ field_id: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), first_name: stringOrExpression.optional(), last_name: stringOrExpression.optional(), status: z.union([z.literal('unconfirmed'), z.literal('active'), z.literal('inactive'), z.literal('removed'), expressionSchema]).optional(), tagIds: z.array(z.string()).optional() }), required: false, displayOptions: {"show":{"operation":["update"]}}, defaults: {"operation":"create"} }),
