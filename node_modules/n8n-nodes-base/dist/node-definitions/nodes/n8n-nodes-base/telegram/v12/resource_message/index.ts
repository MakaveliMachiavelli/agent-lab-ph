...
import type { TelegramV12MessageSendMessageDraftNode } from './operation_send_message_draft';
import type { TelegramV12MessageSendPhotoNode } from './operation_send_photo';
import type { TelegramV12MessageSendRichMessageNode } from './operation_send_rich_message';
import type { TelegramV12MessageSendRichMessageDraftNode } from './operation_send_rich_message_draft';
...
export * from './operation_send_message_draft';
export * from './operation_send_photo';
export * from './operation_send_rich_message';
export * from './operation_send_rich_message_draft';
...
export type TelegramV12MessageNode =
  ...
  | TelegramV12MessageSendMessageDraftNode
  | TelegramV12MessageSendPhotoNode
  | TelegramV12MessageSendRichMessageNode
  | TelegramV12MessageSendRichMessageDraftNode
