...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      media: z.object({ media: z.array(z.object({ type: z.union([z.literal('photo'), z.literal('video'), expressionSchema]).optional(), media: stringOrExpression.optional(), additionalFields: z.object({ caption: stringOrExpression.optional(), parse_mode: z.union([z.literal('Markdown'), z.literal('MarkdownV2'), z.literal('HTML'), expressionSchema]).optional() }).optional() })).optional() }).optional(),
