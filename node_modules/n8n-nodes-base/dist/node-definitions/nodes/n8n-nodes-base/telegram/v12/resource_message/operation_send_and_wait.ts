 ...
 * @default false
 */
    chatApproval?: boolean | Expression<boolean>;
/**
 ...
 * @displayOptions.show { responseType: ["approval"], chatApproval: [true] }
 */
    approverIds?: string | Expression<string>;
/**
...
export type TelegramV12MessageSendAndWaitNode = {
  ...
  version: 1.2;
  config: NodeConfig<TelegramV12MessageSendAndWaitParams> & { credentials?: Credentials };
