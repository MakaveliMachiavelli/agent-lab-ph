...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      chatId: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"messageType":["message"]}}, defaults: {"messageType":"message"} }),
      messageId: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"messageType":["message"]}}, defaults: {"messageType":"message"} }),
      inlineMessageId: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"messageType":["inlineMessage"]}}, defaults: {"messageType":"message"} }),
