...
export type TelegramV12ChatSetTitleOutput = {
  ok?: boolean;
  result?: boolean;
};
...
export type TelegramV12ChatSetTitleNode = {
  ...
  version: 1.2;
  config: NodeConfig<TelegramV12ChatSetTitleParams> & { credentials?: Credentials };
  output?: Items<TelegramV12ChatSetTitleOutput>;
};