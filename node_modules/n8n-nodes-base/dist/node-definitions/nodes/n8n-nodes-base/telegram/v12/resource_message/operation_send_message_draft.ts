...
/** Stream a partial message preview while it is being generated */
export type TelegramV12MessageSendMessageDraftParams = {
  resource: 'message';
...
/**
 * Text of the message draft, 0-4096 characters
 */
    text?: string | Expression<string>;
/**
 * Additional Fields
...
export type TelegramV12MessageSendMessageDraftNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  config: NodeConfig<TelegramV12MessageSendMessageDraftParams> & { credentials?: Credentials };
};