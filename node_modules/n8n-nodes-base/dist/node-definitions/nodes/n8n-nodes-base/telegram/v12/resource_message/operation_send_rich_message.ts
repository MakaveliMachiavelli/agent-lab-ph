...
export type TelegramV12MessageSendRichMessageParams = {
  resource: 'message';
...
export type TelegramV12MessageSendRichMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  config: NodeConfig<TelegramV12MessageSendRichMessageParams> & { credentials?: Credentials };
};