...
export type TelegramV12MessageSendRichMessageDraftParams = {
  resource: 'message';
...
export type TelegramV12MessageSendRichMessageDraftNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.2;
  config: NodeConfig<TelegramV12MessageSendRichMessageDraftParams> & { credentials?: Credentials };
};