...
export type TelegramV11ChatSetTitleOutput = {
  ok?: boolean;
  result?: boolean;
};
...
export type TelegramV11ChatSetTitleNode = {
  ...
  version: 1.1;
  config: NodeConfig<TelegramV11ChatSetTitleParams> & { credentials?: Credentials };
  output?: Items<TelegramV11ChatSetTitleOutput>;
};