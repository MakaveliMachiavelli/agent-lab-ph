...
export type TelegramV11MessageSendMessageDraftParams = {
  resource: 'message';
...
export type TelegramV11MessageSendMessageDraftNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  config: NodeConfig<TelegramV11MessageSendMessageDraftParams> & { credentials?: Credentials };
};