...
export type TelegramV11MessageSendRichMessageParams = {
  resource: 'message';
...
export type TelegramV11MessageSendRichMessageNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1.1;
  config: NodeConfig<TelegramV11MessageSendRichMessageParams> & { credentials?: Credentials };
};