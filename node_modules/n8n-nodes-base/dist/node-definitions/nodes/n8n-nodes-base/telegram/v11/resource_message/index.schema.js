...
const getSendMessageDraftSchema = require('./operation_send_message_draft.schema');
const getSendPhotoSchema = require('./operation_send_photo.schema');
const getSendRichMessageSchema = require('./operation_send_rich_message.schema');
const getSendRichMessageDraftSchema = require('./operation_send_rich_message_draft.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getSendMessageDraftSchema({ ...helpers, parameters: effectiveParams }),
    getSendPhotoSchema({ ...helpers, parameters: effectiveParams }),
    getSendRichMessageSchema({ ...helpers, parameters: effectiveParams }),
    getSendRichMessageDraftSchema({ ...helpers, parameters: effectiveParams }),
