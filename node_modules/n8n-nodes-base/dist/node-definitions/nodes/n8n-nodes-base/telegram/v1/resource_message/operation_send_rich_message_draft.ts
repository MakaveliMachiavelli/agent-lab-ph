...
export type TelegramV1MessageSendRichMessageDraftParams = {
  resource: 'message';
...
export type TelegramV1MessageSendRichMessageDraftNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  config: NodeConfig<TelegramV1MessageSendRichMessageDraftParams> & { credentials?: Credentials };
};