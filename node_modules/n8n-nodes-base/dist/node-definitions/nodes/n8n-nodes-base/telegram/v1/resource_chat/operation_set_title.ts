...
export type TelegramV1ChatSetTitleOutput = {
  ok?: boolean;
  result?: boolean;
};
...
export type TelegramV1ChatSetTitleNode = {
  ...
  version: 1;
  config: NodeConfig<TelegramV1ChatSetTitleParams> & { credentials?: Credentials };
  output?: Items<TelegramV1ChatSetTitleOutput>;
};