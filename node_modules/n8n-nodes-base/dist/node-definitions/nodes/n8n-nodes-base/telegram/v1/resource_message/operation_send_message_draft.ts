...
export type TelegramV1MessageSendMessageDraftParams = {
  resource: 'message';
...
export type TelegramV1MessageSendMessageDraftNode = {
  type: 'n8n-nodes-base.telegram';
  version: 1;
  config: NodeConfig<TelegramV1MessageSendMessageDraftParams> & { credentials?: Credentials };
};