 ...
 */
     ...
     */
    budget?: string | Expression<string>;
    /** The email of the user or "none"
     */
    budget_by?: string | Expression<string>;
     ...
     */
    client_id?: string | Expression<string>;
    /** The monetary budget for the project when budgeting by money
     */
    cost_budget?: string | Expression<string>;
     ...
     */
    fee?: string | Expression<string>;
    /** Rate for projects billed by Project Hourly Rate
     */
    hourly_rate?: string | Expression<string>;
     ...
     */
    notes?: string | Expression<string>;
     ...
     */
    over_budget_notification_percentage?: string | Expression<string>;
...
export type HarvestV1ProjectUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<HarvestV1ProjectUpdateParams> & { credentials?: Credentials };
};