 ...
 */
     ...
     */
    expense_category_id?: string | Expression<string>;
...
export type HarvestV1ExpenseUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<HarvestV1ExpenseUpdateParams> & { credentials?: Credentials };
};