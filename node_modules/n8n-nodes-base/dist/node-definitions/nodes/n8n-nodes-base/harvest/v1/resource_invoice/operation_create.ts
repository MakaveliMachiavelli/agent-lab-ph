 ...
 */
     ...
     */
    estimate_id?: string | Expression<string>;
     ...
     */
    payment_term?: string | Expression<string>;
    /** The purchase order number
     */
    purchase_order?: string | Expression<string>;
    /** The ID of the retainer associated with this invoice
     * @default true
     */
     ...
     */
    tax?: string | Expression<string>;
    /** This percentage is applied to the subtotal, including line items and discounts. Example: use 10.0 for 10.0%.
     */
    tax2?: string | Expression<string>;
  };
};
...
export type HarvestV1InvoiceCreateNode = {
  ...
  version: 1;
  config: NodeConfig<HarvestV1InvoiceCreateParams> & { credentials?: Credentials };
};