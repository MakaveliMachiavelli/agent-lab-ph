/**
 * Microsoft Excel (SharePoint) Node - Version 1 - Zod Schema Factory
...
module.exports = function getSchema(helpers) {
  ...
  const effectiveParams = parameters.resource === undefined ? { ...parameters, resource: 'worksheet' } : parameters;
  return z.union([
