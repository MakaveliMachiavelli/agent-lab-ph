/**
 * Microsoft Excel (SharePoint) - Worksheet Resource - Zod Schema Factory
...
module.exports = function getSchema(helpers) {
  ...
  const effectiveParams = parameters.operation === undefined ? { ...parameters, operation: 'readRows' } : parameters;
  return z.union([
