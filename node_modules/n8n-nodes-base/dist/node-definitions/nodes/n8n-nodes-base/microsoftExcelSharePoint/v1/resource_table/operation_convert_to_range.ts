...
/** Convert a table to a plain range of cells */
export type MicrosoftExcelSharePointV1TableConvertToRangeParams = {
  resource: 'table';
...
export type MicrosoftExcelSharePointV1TableConvertToRangeNode = {
  type: 'n8n-nodes-base.microsoftExcelSharePoint';
  version: 1;
  config: NodeConfig<MicrosoftExcelSharePointV1TableConvertToRangeParams> & { credentials?: Credentials };
};