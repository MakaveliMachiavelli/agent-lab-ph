 ...
 */
     ...
     */
    assignee_username?: string | Expression<string>;
    /** Return only issues which were created by a specific user
     */
    author_username?: string | Expression<string>;
...
export type GitlabV1RepositoryGetIssuesNode = {
  ...
  version: 1;
  config: NodeConfig<GitlabV1RepositoryGetIssuesParams> & { credentials?: Credentials };
