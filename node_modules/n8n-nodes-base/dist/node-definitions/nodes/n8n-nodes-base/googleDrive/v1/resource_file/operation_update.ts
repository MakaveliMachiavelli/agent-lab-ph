 ...
 */
     ...
     */
    ocrLanguage?: string | Expression<string>;
...
export type GoogleDriveV1FileUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<GoogleDriveV1FileUpdateParams> & { credentials?: Credentials };
};