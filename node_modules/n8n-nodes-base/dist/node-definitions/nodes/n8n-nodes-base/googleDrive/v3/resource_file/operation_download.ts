 ...
 */
    ...
    conversion?: {
       ...
       * @default text/html
       */
      docsToFormat?: 'text/html' | 'text/markdown' | 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' | 'application/vnd.oasis.opendocument.text' | 'application/pdf' | 'application/rtf' | 'text/plain' | Expression<string>;
...
export type GoogleDriveV3FileDownloadNode = {
  ...
  version: 3;
  config: NodeConfig<GoogleDriveV3FileDownloadParams> & { credentials?: Credentials };
