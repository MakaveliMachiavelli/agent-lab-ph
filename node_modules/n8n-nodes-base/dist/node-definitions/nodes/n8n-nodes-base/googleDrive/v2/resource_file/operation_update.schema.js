...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      options: resolveSchema({ parameters, schema: z.object({ fields: z.array(z.union([z.literal('*'), z.literal('explicitlyTrashed'), z.literal('exportLinks'), z.literal('hasThumbnail'), z.literal('iconLink'), z.literal('id'), z.literal('kind'), z.literal('mimeType'), z.literal('name'), z.literal('permissions'), z.literal('shared'), z.literal('spaces'), z.literal('starred'), z.literal('thumbnailLink'), z.literal('trashed'), z.literal('version'), z.literal('webViewLink')])).optional(), emailMessage: stringOrExpression.optional(), enforceSingleParent: booleanOrExpression.optional(), moveToNewOwnersRoot: booleanOrExpression.optional(), sendNotificationEmail: booleanOrExpression.optional(), supportsAllDrives: booleanOrExpression.optional(), transferOwnership: booleanOrExpression.optional(), useDomainAdminAccess: booleanOrExpression.optional(), name: stringOrExpression.optional(), parents: z.array(stringOrExpression).optional(), spaces: z.array(z.union([z.literal('*'), z.literal('appDataFolder'), z.literal('drive'), z.literal('photos')])).optional(), corpora: z.union([z.literal('user'), z.literal('domain'), z.literal('drive'), z.literal('allDrives'), expressionSchema]).optional(), driveId: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"/operation":["copy","list","share","create"],"/resource":["file","folder"]}} }),
    }).optional(),
  });
};