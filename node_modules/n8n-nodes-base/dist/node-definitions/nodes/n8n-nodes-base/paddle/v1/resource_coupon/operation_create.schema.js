...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      productIds: resolveSchema({ parameters, schema: z.array(z.string()), required: true, displayOptions: {"show":{"couponType":["product"],"jsonParameters":[false]}}, defaults: {"couponType":"checkout","jsonParameters":false} }),
      ...
      discountAmount: resolveOneOfSchemas({ parameters, variants: [{ schema: numberOrExpression, required: false, displayOptions: {"show":{"discountType":["flat"],"jsonParameters":[false]}}, defaults: {"discountType":"flat","jsonParameters":false} }, { schema: numberOrExpression, required: false, displayOptions: {"show":{"discountType":["percentage"],"jsonParameters":[false]}}, defaults: {"discountType":"flat","jsonParameters":false} }] }),
