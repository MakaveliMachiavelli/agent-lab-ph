...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    dataPropertyName: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["extractHtmlContent"],"sourceData":["binary"]}}, defaults: {"operation":"generateHtmlTemplate","sourceData":"json"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["extractHtmlContent"],"sourceData":["json"]}}, defaults: {"operation":"generateHtmlTemplate","sourceData":"json"} }] }),
    ...
    options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ trimValues: booleanOrExpression.optional(), cleanUpText: booleanOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["extractHtmlContent"]}}, defaults: {"operation":"generateHtmlTemplate"} }, { schema: z.object({ capitalize: booleanOrExpression.optional(), customStyling: booleanOrExpression.optional(), caption: stringOrExpression.optional(), tableAttributes: stringOrExpression.optional(), headerAttributes: stringOrExpression.optional(), rowAttributes: stringOrExpression.optional(), cellAttributes: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["convertToHtmlTable"]}}, defaults: {"operation":"generateHtmlTemplate"} }] }),
  });
