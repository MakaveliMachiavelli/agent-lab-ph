...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    specifyBody: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('keypair'), z.literal('json'), expressionSchema]), required: false, displayOptions: {"show":{"sendBody":[true],"contentType":["json"]}}, defaults: {"sendBody":false,"contentType":"json"} }, { schema: z.union([z.literal('keypair'), z.literal('string'), expressionSchema]), required: false, displayOptions: {"show":{"sendBody":[true],"contentType":["form-urlencoded"]}}, defaults: {"sendBody":false,"contentType":"json"} }] }),
    bodyParameters: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ parameters: z.array(z.object({ name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }), required: false, displayOptions: {"show":{"sendBody":[true],"contentType":["json"],"specifyBody":["keypair"]}}, defaults: {"sendBody":false,"contentType":"json","specifyBody":"keypair"} }, { schema: z.object({ parameters: z.array(z.object({ parameterType: z.union([z.literal('formBinaryData'), z.literal('formData'), expressionSchema]).optional(), name: stringOrExpression.optional(), value: stringOrExpression.optional(), inputDataFieldName: stringOrExpression.optional() })).optional() }), required: false, displayOptions: {"show":{"sendBody":[true],"contentType":["multipart-form-data"]}}, defaults: {"sendBody":false,"contentType":"json"} }, { schema: z.object({ parameters: z.array(z.object({ name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }), required: false, displayOptions: {"show":{"sendBody":[true],"contentType":["form-urlencoded"],"specifyBody":["keypair"]}}, defaults: {"sendBody":false,"contentType":"json","specifyBody":"keypair"} }] }),
    ...
    body: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"sendBody":[true],"specifyBody":["string"]}}, defaults: {"sendBody":false,"specifyBody":"keypair"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"sendBody":[true],"contentType":["raw"]}}, defaults: {"sendBody":false,"contentType":"json"} }] }),
    ...
    options: z.object({ batching: z.object({ batch: z.object({ batchSize: numberOrExpression.optional(), batchInterval: numberOrExpression.optional() }).optional() }).optional(), allowUnauthorizedCerts: z.boolean().optional(), queryParameterArrays: z.union([z.literal('repeat'), z.literal('brackets'), z.literal('indices'), expressionSchema]).optional(), lowercaseHeaders: booleanOrExpression.optional(), redirect: z.object({ redirect: z.object({ followRedirects: z.boolean().optional(), maxRedirects: numberOrExpression.optional() }).optional() }).optional(), response: z.object({ response: z.object({ fullResponse: booleanOrExpression.optional(), neverError: booleanOrExpression.optional(), responseFormat: z.union([z.literal('autodetect'), z.literal('file'), z.literal('json'), z.literal('text')]).optional(), outputPropertyName: stringOrExpression.optional() }).optional() }).optional(), pagination: z.object({ pagination: z.object({ paginationMode: z.union([z.literal('off'), z.literal('updateAParameterInEachRequest'), z.literal('responseContainsNextURL'), expressionSchema]).optional(), nextURL: stringOrExpression.optional(), parameters: z.object({ parameters: z.array(z.object({ type: z.union([z.literal('body'), z.literal('headers'), z.literal('qs'), expressionSchema]).optional(), name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), paginationCompleteWhen: z.union([z.literal('responseIsEmpty'), z.literal('receiveSpecificStatusCodes'), z.literal('other'), expressionSchema]).optional(), statusCodesWhenComplete: stringOrExpression.optional(), completeExpression: stringOrExpression.optional(), limitPagesFetched: z.boolean().optional(), maxRequests: numberOrExpression.optional(), requestInterval: numberOrExpression.optional() }).optional() }).optional(), proxy: stringOrExpression.optional(), timeout: numberOrExpression.optional(), sendCredentialsOnCrossOriginRedirect: booleanOrExpression.optional() }).optional(),
