...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      fileName: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"format":["csv","pdf","xml"]}}, defaults: {"format":"json"} }),
      additionalFields: z.object({ lineStyle: z.union([z.literal('COMPACT'), z.literal('FLAT'), expressionSchema]).optional(), range: z.object({ rangeProperties: z.object({ intervalStart: stringOrExpression.optional(), intervalEnd: stringOrExpression.optional() }).optional() }).optional() }).optional(),
    }).optional(),
  });
};