 ...
 * Discriminator: resource=pullRequest, operation=reopen
 */
...
export type GithubV11PullRequestReopenParams = {
...
export type GithubV11PullRequestReopenNode = {
  type: 'n8n-nodes-base.github';
  version: 1.1;
  config: NodeConfig<GithubV11PullRequestReopenParams> & { credentials?: Credentials };
};