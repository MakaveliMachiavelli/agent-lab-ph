 ...
 * Discriminator: resource=pullRequest, operation=get
 */
...
/** Get the data of a single pull request */
export type GithubV11PullRequestGetParams = {
...
export type GithubV11PullRequestGetNode = {
  type: 'n8n-nodes-base.github';
  version: 1.1;
  config: NodeConfig<GithubV11PullRequestGetParams> & { credentials?: Credentials };
};