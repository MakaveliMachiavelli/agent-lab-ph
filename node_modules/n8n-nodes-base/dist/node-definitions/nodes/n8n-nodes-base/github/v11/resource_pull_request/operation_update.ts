...
export type GithubV11PullRequestUpdateParams = {
 ...
 */
     ...
     */
    state?: 'open' | 'closed' | Expression<string>;
    /** The branch you want to merge into (e.g. master)
     */
    base?: string | Expression<string>;
  };
/**
 * Repository Owner
...
export type GithubV11PullRequestUpdateNode = {
  type: 'n8n-nodes-base.github';
  version: 1.1;
  config: NodeConfig<GithubV11PullRequestUpdateParams> & { credentials?: Credentials };
};