...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      authentication: z.union([z.literal('accessToken'), z.literal('oAuth2'), z.literal('githubAppApi'), expressionSchema]).optional(),
      ...
      editFields: z.object({ assignees: z.object({ assignee: stringOrExpression.optional() }).optional(), body: stringOrExpression.optional(), labels: z.object({ label: stringOrExpression.optional() }).optional(), state: z.union([z.literal('closed'), z.literal('open'), expressionSchema]).optional(), state_reason: z.union([z.literal('completed'), z.literal('not_planned'), z.literal('reopened'), expressionSchema]).optional(), title: stringOrExpression.optional() }).optional(),
    }).optional(),
  });
};