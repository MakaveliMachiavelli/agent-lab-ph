 ...
 * Discriminator: resource=pullRequest, operation=getPatch
 */
...
/** Get the raw patch of a pull request */
export type GithubV11PullRequestGetPatchParams = {
...
export type GithubV11PullRequestGetPatchNode = {
  type: 'n8n-nodes-base.github';
  version: 1.1;
  config: NodeConfig<GithubV11PullRequestGetPatchParams> & { credentials?: Credentials };
};