 ...
 * Discriminator: resource=pullRequest, operation=editComment
 */
...
export type GithubV11PullRequestEditCommentParams = {
 ...
 * @default 0
 */
    commentId?: number | Expression<number>;
/**
...
export type GithubV11PullRequestEditCommentNode = {
  type: 'n8n-nodes-base.github';
  version: 1.1;
  config: NodeConfig<GithubV11PullRequestEditCommentParams> & { credentials?: Credentials };
};