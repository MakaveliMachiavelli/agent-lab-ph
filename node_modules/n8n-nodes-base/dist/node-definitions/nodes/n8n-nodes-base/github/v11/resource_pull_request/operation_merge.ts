 ...
 * Discriminator: resource=pullRequest, operation=merge
 */
...
export type GithubV11PullRequestMergeParams = {
 ...
 * @default merge
 */
    mergeMethod?: 'merge' | 'squash' | 'rebase' | Expression<string>;
/**
 * Title for the automatic merge commit
 */
    commitTitle?: string | Expression<string>;
/**
...
export type GithubV11PullRequestMergeNode = {
  type: 'n8n-nodes-base.github';
  version: 1.1;
  config: NodeConfig<GithubV11PullRequestMergeParams> & { credentials?: Credentials };
};