 ...
 * Discriminator: resource=pullRequest, operation=create
 */
...
export type GithubV1PullRequestCreateParams = {
...
export type GithubV1PullRequestCreateNode = {
  type: 'n8n-nodes-base.github';
  version: 1;
  config: NodeConfig<GithubV1PullRequestCreateParams> & { credentials?: Credentials };
};