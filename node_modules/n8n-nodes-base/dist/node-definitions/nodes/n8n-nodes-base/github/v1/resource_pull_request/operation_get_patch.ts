...
export type GithubV1PullRequestGetPatchParams = {
...
export type GithubV1PullRequestGetPatchNode = {
  type: 'n8n-nodes-base.github';
  version: 1;
  config: NodeConfig<GithubV1PullRequestGetPatchParams> & { credentials?: Credentials };
};