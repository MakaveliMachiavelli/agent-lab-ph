 ...
 * Discriminator: resource=pullRequest, operation=update
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      resource: z.literal('pullRequest'),
      ...
      editFields: z.object({ title: stringOrExpression.optional(), body: stringOrExpression.optional(), state: z.union([z.literal('open'), z.literal('closed'), expressionSchema]).optional(), base: stringOrExpression.optional() }).optional(),
