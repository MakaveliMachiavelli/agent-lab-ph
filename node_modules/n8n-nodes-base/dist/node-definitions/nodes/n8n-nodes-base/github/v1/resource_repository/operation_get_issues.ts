...
export type GithubV1RepositoryGetIssuesNode = {
  ...
  version: 1;
  config: NodeConfig<GithubV1RepositoryGetIssuesParams> & { credentials?: Credentials };
