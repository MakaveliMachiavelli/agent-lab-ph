 ...
 */
    ...
    /** Discount
     */
    discount?: string | Expression<string>;
    /** Due Date
     */
    ...
    /** Invoice Number
     */
    invoiceNumber?: string | Expression<string>;
    /** Invoice Status
     * @default 1
     */
    ...
    /** PO Number
     */
    poNumber?: string | Expression<string>;
    /** Private Notes
     */
...
export type InvoiceNinjaV2InvoiceCreateNode = {
  ...
  version: 2;
  config: NodeConfig<InvoiceNinjaV2InvoiceCreateParams> & { credentials?: Credentials };
};