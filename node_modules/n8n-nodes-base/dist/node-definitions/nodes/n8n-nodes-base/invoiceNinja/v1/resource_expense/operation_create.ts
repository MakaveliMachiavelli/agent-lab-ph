 ...
 */
    ...
    /** Custom Value 1
     */
    customValue1?: string | Expression<string>;
    /** Custom Value 2
     */
    customValue2?: string | Expression<string>;
    /** Choose from the list, or specify an ID using an &lt;a href="https://docs.n8n.io/code/expressions/"&gt;expression&lt;/a&gt;
    ...
    /** Private Notes
     */
    privateNotes?: string | Expression<string>;
    /** Public Notes
     */
    publicNotes?: string | Expression<string>;
    /** Tax Name 1
     */
     ...
     */
    transactionReference?: string | Expression<string>;
    /** Choose from the list, or specify an ID using an &lt;a href="https://docs.n8n.io/code/expressions/"&gt;expression&lt;/a&gt;
...
export type InvoiceNinjaV1ExpenseCreateNode = {
  ...
  version: 1;
  config: NodeConfig<InvoiceNinjaV1ExpenseCreateParams> & { credentials?: Credentials };
};