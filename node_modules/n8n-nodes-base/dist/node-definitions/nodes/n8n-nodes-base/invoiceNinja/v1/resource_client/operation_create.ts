 ...
 */
    ...
    /** ID Number
     */
    idNumber?: string | Expression<string>;
    /** Private Notes
     */
    privateNotes?: string | Expression<string>;
    /** VAT Number
     */
    vatNumber?: string | Expression<string>;
    /** Work Phone
     */
    workPhone?: string | Expression<string>;
    /** Website
     */
...
export type InvoiceNinjaV1ClientCreateNode = {
  ...
  version: 1;
  config: NodeConfig<InvoiceNinjaV1ClientCreateParams> & { credentials?: Credentials };
};