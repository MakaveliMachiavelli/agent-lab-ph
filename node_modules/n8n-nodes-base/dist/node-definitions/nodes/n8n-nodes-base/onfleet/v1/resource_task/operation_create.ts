 ...
 */
    ...
    recipientProperties?: {
       ...
       */
      recipientNotes?: string | Expression<string>;
...
export type OnfleetV1TaskCreateNode = {
  ...
  version: 1;
  config: NodeConfig<OnfleetV1TaskCreateParams> & { credentials?: Credentials };
};