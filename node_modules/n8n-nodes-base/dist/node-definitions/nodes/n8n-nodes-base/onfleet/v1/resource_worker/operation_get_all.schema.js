...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      filters: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ radius: numberOrExpression.optional() }), required: false, displayOptions: {"show":{"byLocation":[true]}}, defaults: {"byLocation":false} }, { schema: z.object({ states: z.array(z.union([z.literal(2), z.literal(1), z.literal(0)])).optional(), teams: z.array(z.string()).optional(), phones: z.array(stringOrExpression).optional() }), required: false, displayOptions: {"show":{"byLocation":[false]}}, defaults: {"byLocation":false} }] }),
