...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      containerType: z.union([z.literal('organizations'), z.literal('teams'), z.literal('workers'), expressionSchema]),
      containerId: stringOrExpression,
      type: z.union([z.literal(-1), z.literal(0), z.literal(1), expressionSchema]),
      index: resolveSchema({ parameters, schema: numberOrExpression, required: false, displayOptions: {"show":{"type":[1]}}, defaults: {"type":""} }),
      tasks: z.array(stringOrExpression).optional(),
