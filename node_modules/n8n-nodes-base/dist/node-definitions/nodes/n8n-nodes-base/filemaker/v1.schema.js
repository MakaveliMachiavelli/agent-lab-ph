...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    portals: resolveSchema({ parameters, schema: z.array(stringOrExpression), required: false, displayOptions: {"show":{"action":["record","records","find"],"getPortals":[true]}}, defaults: {"action":"record","getPortals":false} }),
    ...
    queries: resolveSchema({ parameters, schema: z.object({ query: z.array(z.object({ fields: z.object({ field: z.array(z.object({ name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), omit: booleanOrExpression.optional() })).optional() }), required: false, displayOptions: {"show":{"action":["find"]}}, defaults: {"action":"record"} }),
    ...
    scriptBefore: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["find","record","records"],"setScriptBefore":[true]}}, defaults: {"action":"record","setScriptBefore":false} }),
    ...
    scriptSort: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["find","record","records"],"setScriptSort":[true]}}, defaults: {"action":"record","setScriptSort":false} }),
    ...
    scriptAfter: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["find","record","records"],"setScriptAfter":[true]}}, defaults: {"action":"record","setScriptAfter":false} }),
    ...
    script: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"action":["performscript"]}}, defaults: {"action":"record"} }),
