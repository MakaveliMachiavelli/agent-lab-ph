...
export type MongoDbV13DocumentFindOneAndUpdateParams = {
  resource: 'document';
...
export type MongoDbV13DocumentFindOneAndUpdateNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.3;
  config: NodeConfig<MongoDbV13DocumentFindOneAndUpdateParams> & { credentials?: Credentials };
};