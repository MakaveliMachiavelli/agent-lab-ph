...
export type MongoDbV13DocumentFindOneAndReplaceParams = {
  resource: 'document';
...
export type MongoDbV13DocumentFindOneAndReplaceNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.3;
  config: NodeConfig<MongoDbV13DocumentFindOneAndReplaceParams> & { credentials?: Credentials };
};