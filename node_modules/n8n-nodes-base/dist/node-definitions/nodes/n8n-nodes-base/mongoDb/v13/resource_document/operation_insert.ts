...
/** Insert documents */
export type MongoDbV13DocumentInsertParams = {
  resource: 'document';
  operation: 'insert';
/**
 * MongoDB Collection
...
export type MongoDbV13DocumentInsertNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.3;
  config: NodeConfig<MongoDbV13DocumentInsertParams> & { credentials?: Credentials };
};