...
/** Update documents */
export type MongoDbV14DocumentUpdateParams = {
  resource: 'document';
  operation: 'update';
/**
 * MongoDB Collection
...
export type MongoDbV14DocumentUpdateNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.4;
  config: NodeConfig<MongoDbV14DocumentUpdateParams> & { credentials?: Credentials };
};