...
/** Insert documents */
export type MongoDbV14DocumentInsertParams = {
  resource: 'document';
  operation: 'insert';
/**
 * MongoDB Collection
...
export type MongoDbV14DocumentInsertNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.4;
  config: NodeConfig<MongoDbV14DocumentInsertParams> & { credentials?: Credentials };
};