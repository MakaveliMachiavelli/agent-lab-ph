...
export type MongoDbV14DocumentFindOneAndReplaceParams = {
  resource: 'document';
 ...
 */
     ...
     */
    dateFields?: string | Expression<string>;
...
export type MongoDbV14DocumentFindOneAndReplaceNode = {
  type: 'n8n-nodes-base.mongoDb';
  version: 1.4;
  config: NodeConfig<MongoDbV14DocumentFindOneAndReplaceParams> & { credentials?: Credentials };
};