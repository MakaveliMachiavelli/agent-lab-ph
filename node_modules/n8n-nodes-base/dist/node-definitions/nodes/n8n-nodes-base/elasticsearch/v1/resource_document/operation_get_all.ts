 ...
 */
     ...
     */
    docvalue_fields?: string | Expression<string>;
     ...
     */
    routing?: string | Expression<string>;
     ...
     * @default 1m
     */
    timeout?: string | Expression<string>;
...
export type ElasticsearchV1DocumentGetAllNode = {
  ...
  version: 1;
  config: NodeConfig<ElasticsearchV1DocumentGetAllParams> & { credentials?: Credentials };
