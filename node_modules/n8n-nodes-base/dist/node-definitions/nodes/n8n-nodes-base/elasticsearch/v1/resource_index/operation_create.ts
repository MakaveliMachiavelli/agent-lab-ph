 ...
 */
     ...
     * @default 1m
     */
    master_timeout?: string | Expression<string>;
     ...
     * @default 1
     */
    wait_for_active_shards?: string | Expression<string>;
  };
};
...
export type ElasticsearchV1IndexCreateNode = {
  ...
  version: 1;
  config: NodeConfig<ElasticsearchV1IndexCreateParams> & { credentials?: Credentials };
};