...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      couponLinesUi: z.object({ couponLinesValues: z.array(z.object({ code: stringOrExpression.optional(), metadataUi: z.object({ metadataValues: z.array(z.object({ key: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional() })).optional() }).optional(),
      feeLinesUi: z.object({ feeLinesValues: z.array(z.object({ name: stringOrExpression.optional(), taxClass: stringOrExpression.optional(), taxStatus: z.union([z.literal('taxable'), z.literal('none'), expressionSchema]).optional(), total: stringOrExpression.optional(), metadataUi: z.object({ metadataValues: z.array(z.object({ key: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional() })).optional() }).optional(),
      lineItemsUi: z.object({ lineItemsValues: z.array(z.object({ name: stringOrExpression.optional(), productId: numberOrExpression.optional(), variationId: numberOrExpression.optional(), quantity: numberOrExpression.optional(), taxClass: stringOrExpression.optional(), subtotal: stringOrExpression.optional(), total: stringOrExpression.optional(), metadataUi: z.object({ metadataValues: z.array(z.object({ key: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional() })).optional() }).optional(),
      ...
      shippingLinesUi: z.object({ shippingLinesValues: z.array(z.object({ methodTitle: stringOrExpression.optional(), 'method ID': stringOrExpression.optional(), total: stringOrExpression.optional(), metadataUi: z.object({ metadataValues: z.array(z.object({ key: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional() })).optional() }).optional(),
    }).optional(),
  });
};