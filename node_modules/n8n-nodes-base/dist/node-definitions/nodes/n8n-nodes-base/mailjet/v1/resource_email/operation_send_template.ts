 ...
 */
     ...
     */
    trackClicks?: string | Expression<string>;
    /** Enable or disable open tracking on this message
     */
    trackOpens?: string | Expression<string>;
    /** Custom Campaign
     */
    customCampaign?: string | Expression<string>;
...
export type MailjetV1EmailSendTemplateNode = {
  ...
  version: 1;
  config: NodeConfig<MailjetV1EmailSendTemplateParams> & { credentials?: Credentials };
