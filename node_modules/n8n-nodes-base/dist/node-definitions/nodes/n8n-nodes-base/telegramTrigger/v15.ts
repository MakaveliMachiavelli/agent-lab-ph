/**
 * Telegram Trigger Node - Version 1.5
 * Starts the workflow on a Telegram update
 */


export interface TelegramTriggerV15Params {
  ...
  additionalFields?: {
     ...
     */
    chatIds?: string | Expression<string>;
...
export interface TelegramTriggerV15Credentials {
  telegramApi: CredentialReference;
}

interface TelegramTriggerV15NodeBase {
  type: 'n8n-nodes-base.telegramTrigger';
  version: 1.5;
  isTrigger: true;
}

export type TelegramTriggerV15ParamsNode = TelegramTriggerV15NodeBase & {
  config: NodeConfig<TelegramTriggerV15Params> & { credentials?: TelegramTriggerV15Credentials };
};

export type TelegramTriggerV15Node = TelegramTriggerV15ParamsNode;