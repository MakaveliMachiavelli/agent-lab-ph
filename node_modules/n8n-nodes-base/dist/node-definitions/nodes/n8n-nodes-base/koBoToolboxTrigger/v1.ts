...
export type KoBoToolboxTriggerV1ParamsNode = KoBoToolboxTriggerV1NodeBase & {
  config: NodeConfig<KoBoToolboxTriggerV1Params> & { credentials?: KoBoToolboxTriggerV1Credentials };
};
