 ...
 */
     ...
     */
    membershipRule?: string | Expression<string>;
     ...
     */
    preferredDataLocation?: string | Expression<string>;
     ...
     */
    uniqueName?: string | Expression<string>;
...
export type MicrosoftEntraV1GroupUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<MicrosoftEntraV1GroupUpdateParams> & { credentials?: Credentials };
};