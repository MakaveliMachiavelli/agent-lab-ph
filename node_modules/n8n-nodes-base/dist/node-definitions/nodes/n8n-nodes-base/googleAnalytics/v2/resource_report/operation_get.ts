 ...
 */
     ...
     */
    currencyCode?: string | Expression<string>;
    /** Dimensions Filters
     * @default {}
     */
    dimensionFiltersUI?: {
    ...
    betweenFilter?: Array<{
      ...
      /** From Value
       */
      fromValue?: string | Expression<string>;
      /** To Value
       */
      toValue?: string | Expression<string>;
    }>;
        /** Numeric Filter
     */
    numericFilter?: Array<{
...
export type GoogleAnalyticsV2ReportGetNode = {
  ...
  version: 2;
  config: NodeConfig<GoogleAnalyticsV2ReportGetParams> & { credentials?: Credentials };
