...
export type SlackV27MessageSendAndWaitParams = {
  resource: 'message';
...
export type SlackV27MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.7;
  config: NodeConfig<SlackV27MessageSendAndWaitParams> & { credentials?: Credentials };
};