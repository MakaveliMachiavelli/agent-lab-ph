...
export type SlackV27UserGroupUpdateParams = {
  resource: 'userGroup';
  operation: 'update';
...
export type SlackV27UserGroupUpdateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.7;
  config: NodeConfig<SlackV27UserGroupUpdateParams> & { credentials?: Credentials };
};