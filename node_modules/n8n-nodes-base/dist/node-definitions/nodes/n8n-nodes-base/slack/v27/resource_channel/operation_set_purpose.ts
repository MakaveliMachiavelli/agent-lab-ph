...
export type SlackV27ChannelSetPurposeParams = {
  resource: 'channel';
...
export type SlackV27ChannelSetPurposeNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.7;
  config: NodeConfig<SlackV27ChannelSetPurposeParams> & { credentials?: Credentials };
};