...
export type SlackV27MessageScheduleParams = {
  resource: 'message';
  operation: 'schedule';
...
export type SlackV27MessageScheduleNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.7;
  config: NodeConfig<SlackV27MessageScheduleParams> & { credentials?: Credentials };
};