...
export type SlackV27UserGroupGetAllParams = {
  resource: 'userGroup';
  operation: 'getAll';
...
export type SlackV27UserGroupGetAllNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.7;
  config: NodeConfig<SlackV27UserGroupGetAllParams> & { credentials?: Credentials };
};