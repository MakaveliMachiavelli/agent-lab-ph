...
export type SlackV26UserGroupGetAllParams = {
  resource: 'userGroup';
  operation: 'getAll';
...
export type SlackV26UserGroupGetAllNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26UserGroupGetAllParams> & { credentials?: Credentials };
};