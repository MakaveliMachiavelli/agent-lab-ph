...
export type SlackV26UserGroupUpdateParams = {
  resource: 'userGroup';
  operation: 'update';
...
export type SlackV26UserGroupUpdateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26UserGroupUpdateParams> & { credentials?: Credentials };
};