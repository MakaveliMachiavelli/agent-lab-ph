...
export type SlackV26ReactionRemoveParams = {
  resource: 'reaction';
  operation: 'remove';
...
export type SlackV26ReactionRemoveOutput = {
  ok?: boolean;
};

export type SlackV26ReactionRemoveNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26ReactionRemoveParams> & { credentials?: Credentials };
  output?: Items<SlackV26ReactionRemoveOutput>;
};