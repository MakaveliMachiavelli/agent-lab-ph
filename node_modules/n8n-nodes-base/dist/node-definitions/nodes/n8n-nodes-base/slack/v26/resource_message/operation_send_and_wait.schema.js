/**
 * Slack Node - Version 2.6 - Zod Schema
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      captureResponder: resolveSchema({ parameters, schema: booleanOrExpression, required: false, displayOptions: {"show":{"authentication":["accessToken","oAuth2"],"responseType":["approval"]}}, defaults: {"authentication":"accessToken","responseType":"approval"} }),
      approvers: resolveSchema({ parameters, schema: z.array(z.string()), required: false, displayOptions: {"show":{"authentication":["accessToken","oAuth2"],"responseType":["approval"],"captureResponder":[true]}}, defaults: {"authentication":"accessToken","responseType":"approval","captureResponder":false} }),
      unauthorizedReplyText: resolveSchema({ parameters, schema: stringOrExpression, required: false, displayOptions: {"show":{"authentication":["accessToken","oAuth2"],"responseType":["approval"],"captureResponder":[true]}}, defaults: {"authentication":"accessToken","responseType":"approval","captureResponder":false} }),
      postDecisionBehavior: resolveSchema({ parameters, schema: z.union([z.literal('showOutcome'), z.literal('removeButtons'), z.literal('keepMessage'), expressionSchema]), required: false, displayOptions: {"show":{"authentication":["accessToken","oAuth2"],"responseType":["approval"],"captureResponder":[true]}}, defaults: {"authentication":"accessToken","responseType":"approval","captureResponder":false} }),
      options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ limitWaitTime: z.object({ values: z.object({ limitType: z.union([z.literal('afterTimeInterval'), z.literal('atSpecifiedTime'), expressionSchema]).optional(), resumeAmount: numberOrExpression.optional(), resumeUnit: z.union([z.literal('minutes'), z.literal('hours'), z.literal('days'), expressionSchema]).optional(), maxDateAndTime: stringOrExpression.optional() }).optional() }).optional(), appendAttribution: booleanOrExpression.optional(), thread_ts: z.object({ replyValues: z.object({ thread_ts: numberOrExpression.optional(), reply_broadcast: booleanOrExpression.optional() }).optional() }).optional() }), required: false, displayOptions: {"show":{"responseType":["approval"]}}, defaults: {"responseType":"approval"} }, { schema: z.object({ messageButtonLabel: stringOrExpression.optional(), responseFormTitle: stringOrExpression.optional(), responseFormDescription: stringOrExpression.optional(), responseFormButtonLabel: stringOrExpression.optional(), responseFormCustomCss: stringOrExpression.optional(), limitWaitTime: z.object({ values: z.object({ limitType: z.union([z.literal('afterTimeInterval'), z.literal('atSpecifiedTime'), expressionSchema]).optional(), resumeAmount: numberOrExpression.optional(), resumeUnit: z.union([z.literal('minutes'), z.literal('hours'), z.literal('days'), expressionSchema]).optional(), maxDateAndTime: stringOrExpression.optional() }).optional() }).optional(), appendAttribution: booleanOrExpression.optional(), thread_ts: z.object({ replyValues: z.object({ thread_ts: numberOrExpression.optional(), reply_broadcast: booleanOrExpression.optional() }).optional() }).optional() }), required: false, displayOptions: {"show":{"responseType":["freeText","customForm"]}}, defaults: {"responseType":"approval"} }] }),
    }).optional(),
  });
};