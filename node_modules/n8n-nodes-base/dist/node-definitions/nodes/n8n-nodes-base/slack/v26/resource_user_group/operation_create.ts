...
export type SlackV26UserGroupCreateParams = {
  resource: 'userGroup';
  operation: 'create';
...
export type SlackV26UserGroupCreateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26UserGroupCreateParams> & { credentials?: Credentials };
};