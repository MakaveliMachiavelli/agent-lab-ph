...
export type SlackV26UserGroupDisableParams = {
  resource: 'userGroup';
  operation: 'disable';
...
export type SlackV26UserGroupDisableNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26UserGroupDisableParams> & { credentials?: Credentials };
};