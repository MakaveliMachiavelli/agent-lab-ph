...
export type SlackV26UserGroupEnableParams = {
  resource: 'userGroup';
  operation: 'enable';
...
export type SlackV26UserGroupEnableNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26UserGroupEnableParams> & { credentials?: Credentials };
};