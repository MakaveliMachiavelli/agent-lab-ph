...
export type SlackV26MessageSendAndWaitParams = {
  resource: 'message';
 ...
 * @displayOptions.show { authentication: ["accessToken", "oAuth2"], responseType: ["approval"] }
 * @default false
 */
    captureResponder?: boolean | Expression<boolean>;
/**
 ...
 * @displayOptions.show { authentication: ["accessToken", "oAuth2"], responseType: ["approval"], captureResponder: [true] }
 * @default []
 */
    approvers?: string[];
/**
 ...
 */
    unauthorizedReplyText?: string | Expression<string>;
/**
 * What happens to the original message once someone approves or declines
 * @displayOptions.show { authentication: ["accessToken", "oAuth2"], responseType: ["approval"], captureResponder: [true] }
 * @default showOutcome
 */
    postDecisionBehavior?: 'showOutcome' | 'removeButtons' | 'keepMessage' | Expression<string>;
/**
 * Options
 * @displayOptions.show { responseType: ["approval"] }
 * @default {}
 */
     ...
     * @default Respond
     */
    messageButtonLabel?: string | Expression<string>;
    /** Title of the form that the user can access to provide their response
     */
    responseFormTitle?: string | Expression<string>;
    /** Description of the form that the user can access to provide their response
     */
    responseFormDescription?: string | Expression<string>;
    /** Response Form Button Label
     * @default Submit
     */
    responseFormButtonLabel?: string | Expression<string>;
    /** Override default styling of the response form with CSS
     */
    responseFormCustomCss?: string | Expression<string>;
  };
};

export type SlackV26MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26MessageSendAndWaitParams> & { credentials?: Credentials };
};