...
export type SlackV26ChannelOpenParams = {
  resource: 'channel';
  operation: 'open';
...
export type SlackV26ChannelOpenOutput = {
  id?: string;
};

export type SlackV26ChannelOpenNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26ChannelOpenParams> & { credentials?: Credentials };
  output?: Items<SlackV26ChannelOpenOutput>;
};