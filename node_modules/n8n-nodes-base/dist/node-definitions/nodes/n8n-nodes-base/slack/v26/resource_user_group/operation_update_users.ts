...
export type SlackV26UserGroupUpdateUsersParams = {
  resource: 'userGroup';
...
export type SlackV26UserGroupUpdateUsersNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26UserGroupUpdateUsersParams> & { credentials?: Credentials };
};