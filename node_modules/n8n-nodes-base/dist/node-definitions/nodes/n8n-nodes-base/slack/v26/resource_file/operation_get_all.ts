...
export type SlackV26FileGetAllParams = {
  resource: 'file';
  operation: 'getAll';
 ...
 */
     ...
     */
    tsFrom?: string | Expression<string>;
    /** Filter files created before this timestamp (inclusive)
     */
    tsTo?: string | Expression<string>;
...
export type SlackV26FileGetAllNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.6;
  config: NodeConfig<SlackV26FileGetAllParams> & { credentials?: Credentials };
};