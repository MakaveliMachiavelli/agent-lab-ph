...
export type SlackV22MessageScheduleParams = {
  resource: 'message';
  operation: 'schedule';
...
export type SlackV22MessageScheduleNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.2;
  config: NodeConfig<SlackV22MessageScheduleParams> & { credentials?: Credentials };
};