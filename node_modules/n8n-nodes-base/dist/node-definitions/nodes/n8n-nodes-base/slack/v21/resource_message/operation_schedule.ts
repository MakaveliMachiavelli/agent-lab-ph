...
export type SlackV21MessageScheduleParams = {
  resource: 'message';
  operation: 'schedule';
...
export type SlackV21MessageScheduleNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.1;
  config: NodeConfig<SlackV21MessageScheduleParams> & { credentials?: Credentials };
};