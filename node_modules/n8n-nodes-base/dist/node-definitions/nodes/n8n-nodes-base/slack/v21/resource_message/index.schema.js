...
const getDeleteScheduledSchema = require('./operation_delete_scheduled.schema');
const getGetManyScheduledSchema = require('./operation_get_many_scheduled.schema');
const getGetPermalinkSchema = require('./operation_get_permalink.schema');
const getPostSchema = require('./operation_post.schema');
const getScheduleSchema = require('./operation_schedule.schema');
...
module.exports = function getSchema(helpers) {
  ...
  return z.union([
    ...
    getDeleteScheduledSchema({ ...helpers, parameters: effectiveParams }),
    getGetManyScheduledSchema({ ...helpers, parameters: effectiveParams }),
    getGetPermalinkSchema({ ...helpers, parameters: effectiveParams }),
    getPostSchema({ ...helpers, parameters: effectiveParams }),
    getScheduleSchema({ ...helpers, parameters: effectiveParams }),
