...
export type SlackV25UserUpdateProfileParams = {
  resource: 'user';
...
export type SlackV25UserUpdateProfileNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25UserUpdateProfileParams> & { credentials?: Credentials };
};