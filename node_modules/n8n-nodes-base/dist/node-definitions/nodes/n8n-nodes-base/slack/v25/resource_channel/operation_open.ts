...
export type SlackV25ChannelOpenParams = {
  resource: 'channel';
  operation: 'open';
...
export type SlackV25ChannelOpenOutput = {
  id?: string;
};

export type SlackV25ChannelOpenNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25ChannelOpenParams> & { credentials?: Credentials };
  output?: Items<SlackV25ChannelOpenOutput>;
};