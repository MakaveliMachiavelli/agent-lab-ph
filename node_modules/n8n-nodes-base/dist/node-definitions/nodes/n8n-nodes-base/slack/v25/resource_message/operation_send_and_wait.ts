...
export type SlackV25MessageSendAndWaitParams = {
  resource: 'message';
...
export type SlackV25MessageSendAndWaitNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25MessageSendAndWaitParams> & { credentials?: Credentials };
};