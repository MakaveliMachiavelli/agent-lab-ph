...
export type SlackV25ReactionRemoveParams = {
  resource: 'reaction';
  operation: 'remove';
...
export type SlackV25ReactionRemoveOutput = {
  ok?: boolean;
};

export type SlackV25ReactionRemoveNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25ReactionRemoveParams> & { credentials?: Credentials };
  output?: Items<SlackV25ReactionRemoveOutput>;
};