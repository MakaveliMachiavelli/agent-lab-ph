...
export type SlackV25UserGroupDisableParams = {
  resource: 'userGroup';
  operation: 'disable';
...
export type SlackV25UserGroupDisableNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25UserGroupDisableParams> & { credentials?: Credentials };
};