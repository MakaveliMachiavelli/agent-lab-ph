...
export type SlackV25MessageScheduleParams = {
  resource: 'message';
  operation: 'schedule';
...
export type SlackV25MessageScheduleNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25MessageScheduleParams> & { credentials?: Credentials };
};