...
export type SlackV25UserGroupCreateParams = {
  resource: 'userGroup';
  operation: 'create';
...
export type SlackV25UserGroupCreateNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25UserGroupCreateParams> & { credentials?: Credentials };
};