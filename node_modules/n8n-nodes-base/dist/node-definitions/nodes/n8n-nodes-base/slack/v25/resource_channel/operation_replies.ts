...
export type SlackV25ChannelRepliesParams = {
  resource: 'channel';
  operation: 'replies';
...
export type SlackV25ChannelRepliesOutput = {
  app_id?: string;
  blocks?: Array<{
    block_id?: string;
    elements?: Array<{
...
export type SlackV25ChannelRepliesNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25ChannelRepliesParams> & { credentials?: Credentials };
  output?: Items<SlackV25ChannelRepliesOutput>;
};