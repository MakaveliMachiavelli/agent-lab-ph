...
export type SlackV25ChannelInviteParams = {
  resource: 'channel';
  operation: 'invite';
...
export type SlackV25ChannelInviteOutput = {
...
export type SlackV25ChannelInviteNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.5;
  config: NodeConfig<SlackV25ChannelInviteParams> & { credentials?: Credentials };
  output?: Items<SlackV25ChannelInviteOutput>;
};