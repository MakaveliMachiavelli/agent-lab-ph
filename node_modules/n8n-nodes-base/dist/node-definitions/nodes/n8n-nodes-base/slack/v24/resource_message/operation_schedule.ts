...
export type SlackV24MessageScheduleParams = {
  resource: 'message';
  operation: 'schedule';
...
export type SlackV24MessageScheduleNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.4;
  config: NodeConfig<SlackV24MessageScheduleParams> & { credentials?: Credentials };
};