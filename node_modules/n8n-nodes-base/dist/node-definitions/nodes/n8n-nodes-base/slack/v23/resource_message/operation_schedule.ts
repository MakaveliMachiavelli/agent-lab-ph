...
export type SlackV23MessageScheduleParams = {
  resource: 'message';
  operation: 'schedule';
 ...
 */
    postAt: string | Expression<string>;
/**
...
export type SlackV23MessageScheduleNode = {
  type: 'n8n-nodes-base.slack';
  version: 2.3;
  config: NodeConfig<SlackV23MessageScheduleParams> & { credentials?: Credentials };
};