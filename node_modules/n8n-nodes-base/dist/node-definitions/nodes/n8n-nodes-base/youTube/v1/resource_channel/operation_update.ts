 ...
 */
     ...
     * @default []
     */
    featuredChannelsUrls?: Array<string | Expression<string>>;
     ...
     */
    profileColor?: string | Expression<string>;
    ...
    /** Banner External Url
     */
    bannerExternalUrl?: string | Expression<string>;
    /** Tracking Image Url
     */
    trackingImageUrl?: string | Expression<string>;
    /** Watch Icon Image Url
     */
    watchIconImageUrl?: string | Expression<string>;
  };
    };
        /** Status
     */
     ...
     */
    onBehalfOfContentOwner?: string | Expression<string>;
  };
};
...
export type YouTubeV1ChannelUpdateNode = {
  ...
  version: 1;
  config: NodeConfig<YouTubeV1ChannelUpdateParams> & { credentials?: Credentials };
};