...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    incomingAuthentication: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('basicAuth'), z.literal('none'), expressionSchema]), required: false, displayOptions: {"show":{"resume":["form"]}}, defaults: {"resume":"timeInterval"} }, { schema: z.union([z.literal('basicAuth'), z.literal('headerAuth'), z.literal('jwtAuth'), z.literal('none')]), required: false, displayOptions: {"show":{"resume":["webhook"]}}, defaults: {"resume":"timeInterval"} }] }),
    dateTime: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"resume":["specificTime"]}}, defaults: {"resume":"timeInterval"} }),
    ...
    formTitle: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"resume":["form"]}}, defaults: {"resume":"timeInterval"} }),
    ...
    responseMode: resolveOneOfSchemas({ parameters, variants: [{ schema: z.union([z.literal('onReceived'), z.literal('lastNode'), z.literal('responseNode'), expressionSchema]), required: false, displayOptions: {"show":{"resume":["form"]}}, defaults: {"resume":"timeInterval"} }, { schema: z.union([z.literal('onReceived'), z.literal('lastNode'), z.literal('responseNode'), expressionSchema]), required: false, displayOptions: {"show":{"resume":["webhook"]}}, defaults: {"resume":"timeInterval"} }] }),
    ...
    options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ binaryData: booleanOrExpression.optional(), binaryPropertyName: stringOrExpression.optional(), ignoreBots: booleanOrExpression.optional(), onlyRunIf: stringOrExpression.optional(), ipWhitelist: stringOrExpression.optional(), noResponseBody: booleanOrExpression.optional(), rawBody: booleanOrExpression.optional(), responseData: stringOrExpression.optional(), responseContentType: stringOrExpression.optional(), responseHeaders: z.object({ entries: z.array(z.object({ name: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), responsePropertyName: stringOrExpression.optional(), webhookSuffix: z.string().optional() }), required: false, displayOptions: {"show":{"resume":["webhook"]}}, defaults: {"resume":"timeInterval"} }, { schema: z.object({ appendAttribution: booleanOrExpression.optional(), respondWithOptions: z.object({ values: z.object({ respondWith: z.union([z.literal('text'), z.literal('redirect'), expressionSchema]).optional(), formSubmittedText: stringOrExpression.optional(), redirectUrl: stringOrExpression.optional() }).optional() }).optional(), webhookSuffix: z.string().optional() }), required: false, displayOptions: {"show":{"resume":["form"]},"hide":{"responseMode":["responseNode"]}}, defaults: {"resume":"timeInterval","responseMode":"onReceived"} }, { schema: z.object({ appendAttribution: booleanOrExpression.optional(), webhookSuffix: z.string().optional() }), required: false, displayOptions: {"show":{"resume":["form"]},"hide":{"responseMode":["onReceived","lastNode"]}}, defaults: {"resume":"timeInterval","responseMode":"onReceived"} }] }),
  });
