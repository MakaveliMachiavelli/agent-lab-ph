...
export type SalesforceV1LeadDeleteOutput = {
  success?: boolean;
};
...
export type SalesforceV1LeadDeleteNode = {
  ...
  version: 1;
  config: NodeConfig<SalesforceV1LeadDeleteParams> & { credentials?: Credentials };
  output?: Items<SalesforceV1LeadDeleteOutput>;
};