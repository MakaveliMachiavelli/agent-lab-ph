 ...
 */
     ...
     */
    commentBody?: string | Expression<string>;
...
export type SalesforceV1CaseAddCommentOutput = {
  id?: string;
  success?: boolean;
};
...
export type SalesforceV1CaseAddCommentNode = {
  ...
  version: 1;
  config: NodeConfig<SalesforceV1CaseAddCommentParams> & { credentials?: Credentials };
  output?: Items<SalesforceV1CaseAddCommentOutput>;
};