...
export type SalesforceV11ContactGetAllParams = {
  resource: 'contact';
  operation: 'getAll';
/**
...
export type SalesforceV11ContactGetAllOutput = {
  attributes?: {
    type?: string;
    url?: string;
  };
...
export type SalesforceV11ContactGetAllNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11ContactGetAllParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11ContactGetAllOutput>;
};