...
export type SalesforceV11CaseUpdateParams = {
  resource: 'case';
  operation: 'update';
/**
 ...
 */
    ...
    /** The user or queue that owns the case
...
export type SalesforceV11CaseUpdateOutput = {
  success?: boolean;
};

export type SalesforceV11CaseUpdateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11CaseUpdateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11CaseUpdateOutput>;
};