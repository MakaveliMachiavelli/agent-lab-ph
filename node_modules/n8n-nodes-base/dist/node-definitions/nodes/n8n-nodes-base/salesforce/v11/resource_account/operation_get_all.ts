...
export type SalesforceV11AccountGetAllParams = {
  resource: 'account';
  operation: 'getAll';
/**
...
export type SalesforceV11AccountGetAllOutput = {
  attributes?: {
    type?: string;
    url?: string;
  };
...
export type SalesforceV11AccountGetAllNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11AccountGetAllParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11AccountGetAllOutput>;
};