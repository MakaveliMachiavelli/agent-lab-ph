...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      options: z.object({ fields: stringOrExpression.optional(), conditionsUi: z.object({ conditionValues: z.array(z.object({ field: stringOrExpression.optional(), operation: z.union([z.literal('<'), z.literal('<='), z.literal('equal'), z.literal('>'), z.literal('>=')]).optional(), value: stringOrExpression.optional() })).optional() }).optional() }).optional(),
    }).optional(),
  });
};