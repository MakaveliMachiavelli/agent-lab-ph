...
export type SalesforceV11ContactAddNoteParams = {
  resource: 'contact';
  operation: 'addNote';
/**
...
export type SalesforceV11ContactAddNoteNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11ContactAddNoteParams> & { credentials?: Credentials };
};