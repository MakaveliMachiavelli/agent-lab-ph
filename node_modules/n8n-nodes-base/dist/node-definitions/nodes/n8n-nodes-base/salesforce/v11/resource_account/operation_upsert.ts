...
export type SalesforceV11AccountUpsertParams = {
  resource: 'account';
  operation: 'upsert';
/**
...
export type SalesforceV11AccountUpsertOutput = {
  created?: boolean;
  id?: string;
  success?: boolean;
};

export type SalesforceV11AccountUpsertNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11AccountUpsertParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11AccountUpsertOutput>;
};