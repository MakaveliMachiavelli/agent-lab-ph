...
export type SalesforceV11LeadGetAllParams = {
  resource: 'lead';
  operation: 'getAll';
/**
...
export type SalesforceV11LeadGetAllOutput = {
  attributes?: {
    type?: string;
    url?: string;
  };
...
export type SalesforceV11LeadGetAllNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11LeadGetAllParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11LeadGetAllOutput>;
};