...
export type SalesforceV11TaskGetAllParams = {
  resource: 'task';
  operation: 'getAll';
/**
...
export type SalesforceV11TaskGetAllOutput = {
  attributes?: {
    type?: string;
    url?: string;
  };
...
export type SalesforceV11TaskGetAllNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11TaskGetAllParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11TaskGetAllOutput>;
};