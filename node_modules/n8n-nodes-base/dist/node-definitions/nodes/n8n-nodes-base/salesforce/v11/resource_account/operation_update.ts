...
export type SalesforceV11AccountUpdateParams = {
  resource: 'account';
  operation: 'update';
/**
 ...
 */
     ...
     */
    accountNumber?: string | Expression<string>;
     ...
     */
    ownerId?: { __rl: true; mode: 'list' | 'id'; value: string; cachedResultName?: string };
    ...
    /** The website of this account. Maximum of 255 characters.
     */
    website?: string | Expression<string>;
  };
};

export type SalesforceV11AccountUpdateOutput = {
  success?: boolean;
};

export type SalesforceV11AccountUpdateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11AccountUpdateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11AccountUpdateOutput>;
};