...
export type SalesforceV11OpportunityGetAllParams = {
...
export type SalesforceV11OpportunityGetAllOutput = {
  attributes?: {
    type?: string;
    url?: string;
  };
...
export type SalesforceV11OpportunityGetAllNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11OpportunityGetAllParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11OpportunityGetAllOutput>;
};