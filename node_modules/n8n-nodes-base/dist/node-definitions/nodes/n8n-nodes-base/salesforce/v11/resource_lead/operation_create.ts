...
export type SalesforceV11LeadCreateParams = {
  resource: 'lead';
  operation: 'create';
/**
 ...
 */
    ...
    /** Rating of the lead
     */
    rating?: string | Expression<string>;
...
export type SalesforceV11LeadCreateOutput = {
  id?: string;
  success?: boolean;
};

export type SalesforceV11LeadCreateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11LeadCreateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11LeadCreateOutput>;
};