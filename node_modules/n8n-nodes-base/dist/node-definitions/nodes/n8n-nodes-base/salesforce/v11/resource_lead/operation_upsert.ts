...
export type SalesforceV11LeadUpsertParams = {
  resource: 'lead';
  operation: 'upsert';
/**
...
export type SalesforceV11LeadUpsertOutput = {
  created?: boolean;
  id?: string;
  success?: boolean;
};

export type SalesforceV11LeadUpsertNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11LeadUpsertParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11LeadUpsertOutput>;
};