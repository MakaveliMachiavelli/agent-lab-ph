...
export type SalesforceV11AccountGetSummaryParams = {
  resource: 'account';
...
export type SalesforceV11AccountGetSummaryNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11AccountGetSummaryParams> & { credentials?: Credentials };
};