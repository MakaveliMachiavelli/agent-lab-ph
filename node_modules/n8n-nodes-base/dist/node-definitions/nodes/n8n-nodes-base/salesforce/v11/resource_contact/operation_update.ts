...
export type SalesforceV11ContactUpdateParams = {
  resource: 'contact';
  operation: 'update';
/**
...
export type SalesforceV11ContactUpdateOutput = {
  success?: boolean;
};

export type SalesforceV11ContactUpdateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11ContactUpdateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11ContactUpdateOutput>;
};