...
export type SalesforceV11TaskGetSummaryParams = {
  resource: 'task';
...
export type SalesforceV11TaskGetSummaryNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11TaskGetSummaryParams> & { credentials?: Credentials };
};