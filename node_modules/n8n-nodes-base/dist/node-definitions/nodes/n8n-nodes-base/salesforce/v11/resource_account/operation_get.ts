...
export type SalesforceV11AccountGetParams = {
  resource: 'account';
  operation: 'get';
/**
...
export type SalesforceV11AccountGetOutput = {
  attributes?: {
    type?: string;
    url?: string;
  };
...
export type SalesforceV11AccountGetNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11AccountGetParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11AccountGetOutput>;
};