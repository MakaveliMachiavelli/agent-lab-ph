...
export type SalesforceV11TaskUpdateParams = {
  resource: 'task';
  operation: 'update';
/**
 ...
 */
     ...
     */
    callDisposition?: string | Expression<string>;
     ...
     */
    callObject?: string | Expression<string>;
     ...
     */
    recurrenceTimeZoneSidKey?: string | Expression<string>;
     ...
     */
    whatId?: string | Expression<string>;
     ...
     */
    whoId?: string | Expression<string>;
  };
};

export type SalesforceV11TaskUpdateOutput = {
  success?: boolean;
};

export type SalesforceV11TaskUpdateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11TaskUpdateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11TaskUpdateOutput>;
};