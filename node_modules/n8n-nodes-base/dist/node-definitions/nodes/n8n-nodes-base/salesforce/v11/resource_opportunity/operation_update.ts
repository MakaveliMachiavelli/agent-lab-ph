...
export type SalesforceV11OpportunityUpdateParams = {
 ...
 */
     ...
     */
    accountId?: { __rl: true; mode: 'list' | 'id'; value: string; cachedResultName?: string };
     ...
     */
    forecastCategoryName?: string | Expression<string>;
     ...
     */
    nextStep?: string | Expression<string>;
     ...
     */
    pricebook2Id?: string | Expression<string>;
...
export type SalesforceV11OpportunityUpdateOutput = {
  success?: boolean;
};

export type SalesforceV11OpportunityUpdateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11OpportunityUpdateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11OpportunityUpdateOutput>;
};