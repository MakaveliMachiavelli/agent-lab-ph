...
export type SalesforceV11ContactUpsertParams = {
  resource: 'contact';
  operation: 'upsert';
/**
...
export type SalesforceV11ContactUpsertOutput = {
  created?: boolean;
  id?: string;
  success?: boolean;
};

export type SalesforceV11ContactUpsertNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11ContactUpsertParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11ContactUpsertOutput>;
};