...
export type SalesforceV11TaskCreateParams = {
  resource: 'task';
  operation: 'create';
/**
...
export type SalesforceV11TaskCreateOutput = {
  id?: string;
  success?: boolean;
};

export type SalesforceV11TaskCreateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11TaskCreateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11TaskCreateOutput>;
};