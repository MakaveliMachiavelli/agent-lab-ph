...
export type SalesforceV11CaseCreateParams = {
  resource: 'case';
  operation: 'create';
/**
...
export type SalesforceV11CaseCreateOutput = {
  id?: string;
  success?: boolean;
};

export type SalesforceV11CaseCreateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11CaseCreateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11CaseCreateOutput>;
};