...
export type SalesforceV11AccountCreateParams = {
  resource: 'account';
  operation: 'create';
/**
...
export type SalesforceV11AccountCreateOutput = {
  id?: string;
  success?: boolean;
};

export type SalesforceV11AccountCreateNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11AccountCreateParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11AccountCreateOutput>;
};