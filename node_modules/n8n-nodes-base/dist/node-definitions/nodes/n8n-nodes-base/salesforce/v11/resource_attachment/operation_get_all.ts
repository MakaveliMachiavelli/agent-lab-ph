...
export type SalesforceV11AttachmentGetAllParams = {
  resource: 'attachment';
  operation: 'getAll';
/**
...
export type SalesforceV11AttachmentGetAllOutput = {
  attributes?: {
    type?: string;
    url?: string;
  };
...
export type SalesforceV11AttachmentGetAllNode = {
  type: 'n8n-nodes-base.salesforce';
  version: 1.1;
  config: NodeConfig<SalesforceV11AttachmentGetAllParams> & { credentials?: Credentials };
  output?: Items<SalesforceV11AttachmentGetAllOutput>;
};