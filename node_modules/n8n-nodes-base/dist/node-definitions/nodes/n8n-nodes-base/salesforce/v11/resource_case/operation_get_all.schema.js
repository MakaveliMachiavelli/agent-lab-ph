...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      options: z.object({ conditionsUi: z.object({ conditionValues: z.array(z.object({ field: stringOrExpression.optional(), operation: z.union([z.literal('<'), z.literal('<='), z.literal('equal'), z.literal('>'), z.literal('>='), expressionSchema]).optional(), value: stringOrExpression.optional() })).optional() }).optional(), fields: stringOrExpression.optional() }).optional(),
    }).optional(),
  });
};