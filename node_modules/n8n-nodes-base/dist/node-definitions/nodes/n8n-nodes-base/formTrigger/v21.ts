 ...
 */
  ...
  options?: {
    ...
    /** Whether the form submit request headers are shown
     * @default false
     */
    showHeaders?: boolean | Expression<boolean>;
  };
}
...
export type FormTriggerV21ParamsNode = FormTriggerV21NodeBase & {
  config: NodeConfig<FormTriggerV21Params> & { credentials?: FormTriggerV21Credentials };
};
