 ...
 */
    volumePath: string | Expression<string>;
/**
 * Path to directory within the volume (e.g. "folder1" or "folder1/subfolder"). Do not include leading slash.
 */
    directoryPath: string | Expression<string>;
};

export type DatabricksV1FilesCreateDirectoryNode = {
  type: 'n8n-nodes-base.databricks';
  version: 1;
  config: NodeConfig<DatabricksV1FilesCreateDirectoryParams> & { credentials?: Credentials };
};