 ...
 */
    functionName: string | Expression<string>;
/**
 ...
 * @default STRING
 */
    returnType?: string | Expression<string>;
/**
 * The language of the function body
 * @default SQL
 */
    routineBody?: string | Expression<string>;
/**
 * The function body (SQL expression)
 */
    routineDefinition: string | Expression<string>;
};

export type DatabricksV1UnityCatalogCreateFunctionNode = {
  type: 'n8n-nodes-base.databricks';
  version: 1;
  config: NodeConfig<DatabricksV1UnityCatalogCreateFunctionParams> & { credentials?: Credentials };
};