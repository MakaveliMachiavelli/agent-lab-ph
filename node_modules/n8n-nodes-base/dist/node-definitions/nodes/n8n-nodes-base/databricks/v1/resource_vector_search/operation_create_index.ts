 ...
 */
    endpointName: string | Expression<string>;
/**
 * Primary key column of the index
 */
    primaryKey: string | Expression<string>;
/**
...
export type DatabricksV1VectorSearchCreateIndexNode = {
  ...
  version: 1;
  config: NodeConfig<DatabricksV1VectorSearchCreateIndexParams> & { credentials?: Credentials };
};