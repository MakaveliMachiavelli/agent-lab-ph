...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      indexName: stringOrExpression,
      queryType: z.union([z.literal('text'), z.literal('vector'), expressionSchema]).optional(),
      queryText: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"queryType":["text"]}}, defaults: {"queryType":"text"} }),
      ...
      columnsToRerank: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"enableReranking":[true]}}, defaults: {"enableReranking":false} }),
