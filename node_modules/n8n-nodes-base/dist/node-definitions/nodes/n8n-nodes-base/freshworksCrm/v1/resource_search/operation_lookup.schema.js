...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      searchField: z.union([z.literal('email'), z.literal('name'), z.literal('customField'), expressionSchema]),
      customFieldName: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"searchField":["customField"]}}, defaults: {"searchField":""} }),
      customFieldValue: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"searchField":["customField"]}}, defaults: {"searchField":""} }),
      fieldValue: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"searchField":["email","name"]}}, defaults: {"searchField":""} }),
