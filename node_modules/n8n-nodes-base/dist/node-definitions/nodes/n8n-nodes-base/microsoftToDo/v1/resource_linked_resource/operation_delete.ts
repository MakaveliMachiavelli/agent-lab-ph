...
export type MicrosoftToDoV1LinkedResourceDeleteParams = {
  ...
  operation: 'delete';
  authentication?: 'microsoftToDoOAuth2Api' | 'microsoftOAuth2Api' | 'microsoftEntraServicePrincipalApi';
/**
...
export type MicrosoftToDoV1LinkedResourceDeleteNode = {
  ...
  version: 1;
  config: NodeConfig<MicrosoftToDoV1LinkedResourceDeleteParams> & { credentials?: Credentials };
};