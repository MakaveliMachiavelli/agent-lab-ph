...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      calendarId: stringOrExpression,
      startDate: numberOrExpression.optional(),
      endDate: numberOrExpression.optional(),
      additionalFields: z.object({ timezone: stringOrExpression.optional(), userId: stringOrExpression.optional(), userIds: z.object({ userIds: stringOrExpression.optional() }).optional(), enableLookBusy: booleanOrExpression.optional() }).optional(),
