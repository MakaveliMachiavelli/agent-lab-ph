 ...
 */
    ...
    data?: Array<{
       ...
       */
      whatsapp_user_id?: string | Expression<string>;
    }>;
  };
    /** URLs
     * @default {}
     ...
     */
    mediaCaption?: string | Expression<string>;
    /** Whether to display URL previews in text messages
     * @default false
     */
    previewUrl?: boolean | Expression<boolean>;
  };
/**
 * Longitude
...
export type WhatsAppV11MessageSendNode = {
  ...
  version: 1.1;
  config: NodeConfig<WhatsAppV11MessageSendParams> & { credentials?: Credentials };
