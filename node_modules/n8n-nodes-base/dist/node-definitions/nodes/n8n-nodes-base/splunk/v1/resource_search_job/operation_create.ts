 ...
 */
     ...
     */
    remote_server_list?: string | Expression<string>;
     ...
     */
    workload_pool?: string | Expression<string>;
  };
};
...
export type SplunkV1SearchJobCreateNode = {
  ...
  version: 1;
  config: NodeConfig<SplunkV1SearchJobCreateParams> & { credentials?: Credentials };
};