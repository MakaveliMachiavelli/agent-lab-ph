 ...
 */
  ...
  authentication?: 'serviceAccount' | 'triggerOAuth2' | Expression<string>;
...
export type GoogleSheetsTriggerV1ParamsNode = GoogleSheetsTriggerV1NodeBase & {
  config: NodeConfig<GoogleSheetsTriggerV1Params> & { credentials?: GoogleSheetsTriggerV1Credentials };
};
