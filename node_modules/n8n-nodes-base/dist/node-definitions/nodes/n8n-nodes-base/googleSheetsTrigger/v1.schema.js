...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    authentication: z.union([z.literal('serviceAccount'), z.literal('triggerOAuth2'), expressionSchema]).optional(),
    ...
    options: z.object({ columnsToWatch: z.array(z.string()).optional(), dataLocationOnSheet: z.object({ values: z.object({ rangeDefinition: z.union([z.literal('specifyRangeA1'), z.literal('specifyRange'), expressionSchema]).optional(), headerRow: numberOrExpression.optional(), firstDataRow: numberOrExpression.optional(), range: stringOrExpression.optional() }).optional() }).optional(), valueRender: z.union([z.literal('UNFORMATTED_VALUE'), z.literal('FORMATTED_VALUE'), z.literal('FORMULA'), expressionSchema]).optional(), dateTimeRenderOption: z.union([z.literal('SERIAL_NUMBER'), z.literal('FORMATTED_STRING'), expressionSchema]).optional() }).optional(),
  });
