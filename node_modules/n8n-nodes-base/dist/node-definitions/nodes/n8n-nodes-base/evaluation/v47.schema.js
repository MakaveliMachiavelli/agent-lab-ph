...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas, languageModelInstanceSchema }) {
  ...
  const parametersSchema = z.object({
    ...
    actualAnswer: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["correctness","stringSimilarity","categorization"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["helpfulness"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }] }),
    ...
    prompt: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["correctness"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }, { schema: stringOrExpression, required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["helpfulness"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }] }),
    ...
    options: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ metricName: stringOrExpression.optional(), inputPrompt: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["correctness"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }, { schema: z.object({ metricName: stringOrExpression.optional(), inputPrompt: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["helpfulness"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }, { schema: z.object({ metricName: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["categorization"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }, { schema: z.object({ metricName: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["stringSimilarity"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }, { schema: z.object({ metricName: stringOrExpression.optional() }), required: false, displayOptions: {"show":{"operation":["setMetrics"],"metric":["toolsUsed"]}}, defaults: {"operation":"setOutputs","metric":"correctness"} }] }),
  });
