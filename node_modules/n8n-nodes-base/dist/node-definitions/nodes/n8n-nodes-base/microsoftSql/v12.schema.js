/**
 * Microsoft SQL Node - Version 1.2 - Zod Validation Schemas
 *
...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    table: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["insert"]}}, defaults: {"operation":"insert"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["update"]}}, defaults: {"operation":"insert"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["delete"]}}, defaults: {"operation":"insert"} }] }),
