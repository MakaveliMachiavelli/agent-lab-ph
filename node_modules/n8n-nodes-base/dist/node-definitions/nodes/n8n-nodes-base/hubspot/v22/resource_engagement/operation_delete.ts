...
export type HubspotV22EngagementDeleteOutput = {
  deleted?: boolean;
};
...
export type HubspotV22EngagementDeleteNode = {
  ...
  version: 2.2;
  config: NodeConfig<HubspotV22EngagementDeleteParams> & { credentials?: Credentials };
  output?: Items<HubspotV22EngagementDeleteOutput>;
};