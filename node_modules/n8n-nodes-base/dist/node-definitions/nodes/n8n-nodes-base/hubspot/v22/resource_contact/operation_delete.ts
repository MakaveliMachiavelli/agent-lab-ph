...
export type HubspotV22ContactDeleteOutput = {
  deleted?: boolean;
  reason?: string;
  vid?: number;
};
...
export type HubspotV22ContactDeleteNode = {
  ...
  version: 2.2;
  config: NodeConfig<HubspotV22ContactDeleteParams> & { credentials?: Credentials };
  output?: Items<HubspotV22ContactDeleteOutput>;
};