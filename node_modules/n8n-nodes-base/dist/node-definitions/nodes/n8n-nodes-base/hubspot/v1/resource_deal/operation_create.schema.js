...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      stage: stringOrExpression,
      additionalFields: z.object({ amount: stringOrExpression.optional(), associatedCompany: z.array(z.string()).optional(), associatedVids: z.array(z.string()).optional(), closeDate: stringOrExpression.optional(), customPropertiesUi: z.object({ customPropertiesValues: z.array(z.object({ property: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }).optional(), description: stringOrExpression.optional(), dealName: stringOrExpression.optional(), dealType: stringOrExpression.optional(), pipeline: stringOrExpression.optional() }).optional(),
    }).optional(),
  });
};