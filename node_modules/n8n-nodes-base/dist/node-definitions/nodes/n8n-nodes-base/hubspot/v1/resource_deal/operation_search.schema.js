...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  return z.object({
    parameters: z.object({
      ...
      filterGroupsUi: z.object({ filterGroupsValues: z.array(z.object({ filtersUi: z.object({ filterValues: z.array(z.object({ propertyName: stringOrExpression.optional(), operator: z.union([z.literal('CONTAINS_TOKEN'), z.literal('EQ'), z.literal('GT'), z.literal('GTE'), z.literal('HAS_PROPERTY'), z.literal('NOT_HAS_PROPERTY'), z.literal('LT'), z.literal('LTE'), z.literal('NEQ'), expressionSchema]).optional(), value: stringOrExpression.optional() })).optional() }).optional() })).optional() }).optional(),
