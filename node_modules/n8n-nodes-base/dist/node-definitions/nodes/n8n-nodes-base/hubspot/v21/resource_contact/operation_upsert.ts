 ...
 */
    ...
    /** Clicked Facebook Ad
     */
    clickedFacebookAd?: string | Expression<string>;
    ...
    /** Company Size
     */
    companySize?: string | Expression<string>;
     ...
     */
    countryRegionCode?: string | Expression<string>;
    /** Custom Properties
     * @default {}
     */
    customPropertiesUi?: {
    ...
    /** Degree
     */
    degree?: string | Expression<string>;
    ...
    /** Fax Number
     */
    faxNumber?: string | Expression<string>;
     ...
     */
    fieldOfStudy?: string | Expression<string>;
    /** A contact's first name
     */
    firstName?: string | Expression<string>;
    /** Gender
     */
    gender?: string | Expression<string>;
    /** Google Ad Click ID
     */
     ...
     */
    jobFunction?: string | Expression<string>;
    /** A contact's job title
     */
    jobTitle?: string | Expression<string>;
     ...
     */
    linkedinUrl?: string | Expression<string>;
     ...
     */
    maritalStatus?: string | Expression<string>;
    /** Email used to send private content information to members
     */
    memberEmail?: string | Expression<string>;
    /** The notes relating to the contact's content membership
     */
    membershipNote?: string | Expression<string>;
     ...
     */
    militaryStatus?: string | Expression<string>;
    /** A contact's mobile phone number
     */
    mobilePhoneNumber?: string | Expression<string>;
    ...
    /** A contact's persona
     */
    persona?: string | Expression<string>;
    /** A contact's primary phone number
     */
    phoneNumber?: string | Expression<string>;
     ...
     */
    relationshipStatus?: string | Expression<string>;
     ...
     */
    school?: string | Expression<string>;
     ...
     */
    seniority?: string | Expression<string>;
     ...
     */
    stateRegion?: string | Expression<string>;
    /** The contact's state or region code
     */
    stateRegionCode?: string | Expression<string>;
     ...
     */
    twitterUsername?: string | Expression<string>;
    /** The contact's company website
     */
    websiteUrl?: string | Expression<string>;
    /** The phone number associated with the contact’s WhatsApp account
     */
    whatsappPhoneNumber?: string | Expression<string>;
     ...
     */
    workEmail?: string | Expression<string>;
  };
/**
 * Options
 * @default {}
...
export type HubspotV21ContactUpsertNode = {
  ...
  version: 2.1;
  config: NodeConfig<HubspotV21ContactUpsertParams> & { credentials?: Credentials };
