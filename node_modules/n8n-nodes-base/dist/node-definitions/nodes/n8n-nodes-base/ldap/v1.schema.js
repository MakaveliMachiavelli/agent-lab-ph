...
module.exports = function getSchema({ parameters, z, expressionSchema, stringOrExpression, numberOrExpression, booleanOrExpression, resourceLocatorValueSchema, resourceMapperValueSchema, filterValueSchema, assignmentCollectionValueSchema, iDataObjectSchema, resolveSchema, resolveOneOfSchemas }) {
  ...
  const parametersSchema = z.object({
    ...
    dn: resolveOneOfSchemas({ parameters, variants: [{ schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["compare"]}}, defaults: {"operation":"search"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["create"]}}, defaults: {"operation":"search"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["delete"]}}, defaults: {"operation":"search"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["rename"]}}, defaults: {"operation":"search"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["modify"]}}, defaults: {"operation":"search"} }, { schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["update"]}}, defaults: {"operation":"search"} }] }),
    ...
    targetDn: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["rename"]}}, defaults: {"operation":"search"} }),
    attributes: resolveOneOfSchemas({ parameters, variants: [{ schema: z.object({ attribute: z.array(z.object({ id: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }), required: false, displayOptions: {"show":{"operation":["create"]}}, defaults: {"operation":"search"} }, { schema: z.object({ add: z.array(z.object({ id: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional(), replace: z.array(z.object({ id: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional(), 'delete': z.array(z.object({ id: stringOrExpression.optional(), value: stringOrExpression.optional() })).optional() }), required: false, displayOptions: {"show":{"operation":["update"]}}, defaults: {"operation":"search"} }] }),
    baseDN: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["search"]}}, defaults: {"operation":"search"} }),
    ...
    searchText: resolveSchema({ parameters, schema: stringOrExpression, required: true, displayOptions: {"show":{"operation":["search"]},"hide":{"searchFor":["custom"]}}, defaults: {"operation":"search","searchFor":[]} }),
