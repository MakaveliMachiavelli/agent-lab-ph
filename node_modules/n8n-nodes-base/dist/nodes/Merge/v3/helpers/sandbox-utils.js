...
exports.isSandboxMemoryError = isSandboxMemoryError;
exports.resetSandboxCache = resetSandboxCache;
exports.createSandboxContext = createSandboxContext;
exports.withSandboxContext = withSandboxContext;
 ...
 */
function isSandboxMemoryError(error) {
...
async function ensureSandbox(memoryLimitMb) {
    ...
    const alasqlSource = await (0, promises_1.readFile)(alasqlBundlePath, 'utf-8');
...
async function createSandboxContext() {
    const memoryLimitMb = di_1.Container.get(config_1.NodesConfig).mergeSqlSandboxMemoryLimitMb;
 ...
 */
async function withSandboxContext(fn) {
 ...
 */
async function runAlaSqlInSandbox(tableData, query, parameters = []) {
    try {
...
async function executeAlaSql(tableData, query, parameters) {
