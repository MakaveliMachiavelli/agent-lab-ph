...
exports.simplify = exports.returnAllOrLimit = exports.pageLocator = exports.dataSourceLocator = exports.databaseLocator = exports.blockId = void 0;
exports.blockBuilder = blockBuilder;
exports.iconOptions = iconOptions;
exports.searchOptions = searchOptions;
const constants_1 = require("../../shared/constants");
const Blocks_1 = require("../../shared/descriptions/Blocks");
exports.blockId = {
    displayName: 'Block',
    name: 'blockId',
    ...
    modes: [
        {
            ...
            validation: [
                {
                    type: 'regex',
                    properties: {
                        regex: constants_1.databasePageUrlValidationRegexp,
            ...
            extractValue: {
                type: 'regex',
                regex: constants_1.databasePageUrlExtractionRegexp,
            },
        },
        {
            displayName: 'ID',
...
function blockBuilder(resource, operation, extraDisplayOptions = {}) {
    const show = {
        resource: [resource],
        operation: [operation],
    };
    ...
    return (0, Blocks_1.blocks)(resource, operation, {
        displayOptions: { show },
        sortable: true,
    })[0];
}
function iconOptions(resource, operations) {
    return {
        displayName: 'Options',
        name: 'options',
        type: 'collection',
...
function searchOptions(resource, operation) {
    return {
        displayName: 'Options',
        name: 'options',
        type: 'collection',
...
const returnAllOrLimit = (resource, operation) => [
    {
...
exports.returnAllOrLimit = returnAllOrLimit;
const simplify = (resource, operations) => ({
