...
exports.responseCodeOption = exports.responseCodeSelector = exports.optionsProperty = exports.responseBinaryPropertyNameProperty = exports.responseDataProperty = exports.responseModePropertyStreaming = exports.responseModeProperty = exports.responseCodeProperty = exports.httpMethodsProperty = exports.requireExecuteAccessProperty = exports.authenticationProperty = exports.inboundTriggerAuthenticationBuilderHint = exports.credentialsProperty = exports.defaultWebhookDescription = void 0;
...
exports.defaultWebhookDescription = {
    name: 'default',
    isFullPath: true,
    ...(0, n8n_workflow_1.webhookDescriptionFields)({
        httpMethod: (0, n8n_workflow_1.fromParameter)('httpMethod', 'GET'),
        responseCode: (0, n8n_workflow_1.fromFunction)(utils_1.getResponseCode),
        responseMode: (0, n8n_workflow_1.fromParameter)('responseMode'),
        responseData: (0, n8n_workflow_1.fromFunction)(utils_1.getResponseData),
        responseBinaryPropertyName: (0, n8n_workflow_1.fromParameter)('responseBinaryPropertyName'),
        responseContentType: (0, n8n_workflow_1.fromParameter)(['options', 'responseContentType']),
        responsePropertyName: (0, n8n_workflow_1.fromParameter)(['options', 'responsePropertyName']),
        responseHeaders: (0, n8n_workflow_1.fromParameter)(['options', 'responseHeaders']),
        path: (0, n8n_workflow_1.fromParameter)('path'),
    }),
};
...
exports.inboundTriggerAuthenticationBuilderHint = {
...
const requireExecuteAccessProperty = (propertyName = 'authentication') => ({
...
exports.requireExecuteAccessProperty = requireExecuteAccessProperty;
