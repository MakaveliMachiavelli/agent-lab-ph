...
class Webhook extends n8n_workflow_1.Node {
    ...
    description = {
        ...
        properties: [
            ...
            {
                ...(0, description_1.authenticationProperty)(this.authPropertyName, true),
                builderHint: description_1.inboundTriggerAuthenticationBuilderHint,
            },
            (0, description_1.requireExecuteAccessProperty)(this.authPropertyName),
    ...
    async webhook(context) {
        ...
        try {
            ...
            if (context.getNodeParameter('authentication', 'none') === 'n8nOAuth2') {
                ...
                const authResult = await (0, n8n_workflow_1.n8nOAuth2Auth)(context, {
                    realm: 'n8n Webhook',
                    method: req.method,
                });
