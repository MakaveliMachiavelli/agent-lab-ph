...
export declare const inboundTriggerAuthenticationBuilderHint: {
    propertyHint: string;
};
export declare const authenticationProperty: (propertyName?: string, includeN8nOAuth2?: boolean) => INodeProperties;
export declare const requireExecuteAccessProperty: (propertyName?: string) => INodeProperties;
