...
exports.companyFields = [
    {
        ...
        default: '',
        description: 'Company domain to look up. Provide at least one of domain, Linkedin ID, slug or name.',
    },
    {
    ...
    },
    {
        ...
        default: '',
        description: 'Company name. Best-effort match — prefer domain, Linkedin ID or slug for a deterministic result.',
    },
    {
        displayName: 'Enrich',
        name: 'searchEnrich',
        ...
        default: false,
        description: 'Whether to fall back to on-demand enrichment when no cached match is found, and attach a headcount breakdown when possible',
    },
];
