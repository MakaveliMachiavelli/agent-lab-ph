        ...
        for (let i = 0; i < length; i++) {
            try {
                if (resource === 'chat') {
                    ...
                    if (operation === 'get') {
                        const subscriptionsResponse = (await GenericFunctions_1.rocketchatApiRequest.call(this, '/subscriptions', 'GET', 'get', {}));
                        responseData = [
                        ...
                        responseData = await GenericFunctions_1.rocketchatApiRequest.call(this, '/subscriptions', 'POST', 'read', {
                            rid: roomId,
                        });
                    }
                }
                    ...
                    if (operation === 'messages') {
                        ...
                        const qs = { roomId };
                        if (returnAll) {
                            responseData = await GenericFunctions_1.rocketchatApiRequestAllItems.call(this, 'messages', '/dm', 'GET', 'messages', {}, qs);
                        }
                        else {
                            qs.count = this.getNodeParameter('limit', i);
                            const messagesResponse = (await GenericFunctions_1.rocketchatApiRequest.call(this, '/dm', 'GET', 'messages', {}, qs));
