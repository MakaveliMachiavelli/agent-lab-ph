...
export declare const DEFAULT_STRING_OUT_BIND_MAX_SIZE = 4000;
...
export declare function getBindParameters(query: string, parameterList: ExecuteOpBindParam[], options?: Pick<OracleDBNodeOptions, 'stringOutBindMaxSize'>): {
    updatedQuery: string;
