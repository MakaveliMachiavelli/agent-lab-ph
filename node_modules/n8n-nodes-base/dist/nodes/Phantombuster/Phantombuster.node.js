                ...
                if (resource === 'agent') {
                    ...
                    if (operation === 'launch' || operation === 'launchSync') {
                        ...
                        if (operation === 'launch') {
                            ...
                            let containerId;
                            responseData = await GenericFunctions_1.phantombusterStreamingRequest.call(this, { method: 'POST', path: '/agents/launch-sync', body }, (message) => {
                            ...
                            for (let attempt = 0; attempt < MAX_RECONNECTIONS && !responseData && containerId; attempt += 1) {
                                ...
                                responseData = await GenericFunctions_1.phantombusterStreamingRequest.call(this, {
                                    method: 'GET',
