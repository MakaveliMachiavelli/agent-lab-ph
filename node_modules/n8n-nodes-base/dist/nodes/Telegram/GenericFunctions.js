...
exports.addReplyMarkup = addReplyMarkup;
 ...
 * @param {number} index The index of the item
 */
function addReplyMarkup(body, index) {
    const operation = this.getNodeParameter('operation', index);
...
function createSendAndWaitMessageBody(context, chatApproval = false) {
            ...
            inline_keyboard: [
                config.options.map((option) => {
                    if (chatApproval) {
                        ...
                        const hmacSecret = di_1.Container.get(n8n_core_1.InstanceSettings).hmacSignatureSecret;
                        return {
                            text: option.label,
                            callback_data: (0, n8n_core_1.buildHitlCallbackReference)(executionId, option.approved ? 'a' : 'd', hmacSecret),
                        };
                    }
                    return {
                        text: option.label,
