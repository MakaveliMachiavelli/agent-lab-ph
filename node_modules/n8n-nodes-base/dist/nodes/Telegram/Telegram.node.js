...
const descriptions_1 = require("./hitl/descriptions");
const setup_1 = require("./hitl/setup");
const webhook_1 = require("./hitl/webhook");
...
const descriptions_3 = require("../../utils/sendAndWait/descriptions");
...
class Telegram {
    description = {
        ...
        webhooks: descriptions_3.sendAndWaitWebhooksDescription,
        properties: [
            {
            ...
            },
            {
                ...
                options: [
                    ...
                    },
                    {
                        ...
                        description: 'Send a richly formatted message with headings, lists, tables, media and more',
            ...
            // ----------------------------------
            {
                ...
                options: [
                    ...
                    },
                    {
                        ...
                        description: 'Whether to protect the contents of the sent message from forwarding and saving',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        default: false,
                        description: 'Whether to skip automatic detection of entities such as URLs, emails, mentions, hashtags and phone numbers',
                    },
                ],
            },
            ...
            ], 'message', descriptions_1.telegramHitlProperties, {
                noButtonStyle: true,
    ...
    webhook = webhook_1.telegramSendAndWaitWebhook;
    async execute() {
        ...
        if (resource === 'message' && operation === n8n_workflow_1.SEND_AND_WAIT_OPERATION) {
            const chatApproval = await (0, setup_1.prepareChatApproval)(this);
            body = (0, GenericFunctions_1.createSendAndWaitMessageBody)(this, chatApproval);
            try {
            ...
            try {
                ...
                if (resource === 'callback') {
                    ...
                    if (operation === 'editMessageText') {
                        ...
                        if (!draftId) {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Draft ID must be non-zero', {
                                itemIndex: i,
                            });
                        }
                        body.chat_id = this.getNodeParameter('chatId', i);
                        ...
                        const format = this.getNodeParameter('richFormat', i);
                        const content = this.getNodeParameter('richMessageText', i);
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        const { is_rtl, skip_entity_detection } = additionalFields;
                        // InputRichMessage requires exactly one of `html` or `markdown`
                        const richMessage = format === 'html' ? { html: content } : { markdown: content };
                        if (is_rtl !== undefined) {
                        ...
                        if (operation === 'sendRichMessage') {
                            GenericFunctions_1.addReplyMarkup.call(this, body, i);
                        }
                    }
                }
                else {
