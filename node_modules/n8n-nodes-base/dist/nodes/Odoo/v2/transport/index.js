...
exports.bodyToRpcArgs = bodyToRpcArgs;
exports.odooApiRequest = odooApiRequest;
...
async function callJson2(model, method, body) {
    ...
    const db = (0, utils_1.odooGetDBName)(credentials.db, baseUrl);
    if (db)
...
function bodyToRpcArgs(method, body) {
    switch (method) {
        case 'create':
 ...
 */
async function odooApiRequest(model, method, body) {
