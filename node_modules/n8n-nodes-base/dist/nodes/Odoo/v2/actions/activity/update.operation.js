...
const properties = [
    (0, utils_1.recordRLC)('Activity', 'activityId', 'searchActivities', 'Activity to update'),
    {
...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            await transport_1.odooApiRequest.call(this, 'mail.activity', 'write', {
                ids: [activityId],
                vals,
            });
            const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray({ id: activityId, updated: true }), { itemData: { item: i } });
