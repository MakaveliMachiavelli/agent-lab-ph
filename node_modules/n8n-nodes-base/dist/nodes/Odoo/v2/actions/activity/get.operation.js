...
const properties = [
    (0, utils_1.recordRLC)('Activity', 'activityId', 'searchActivities', 'Activity to retrieve'),
    {
        displayName: 'Options',
        name: 'options',
        type: 'collection',
...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            const response = (await transport_1.odooApiRequest.call(this, 'mail.activity', 'read', {
                ids: [activityId],
                fields,
            }));
