...
const properties = [
    ...
    {
        ...(0, utils_1.recordRLC)('Linked Document', 'res_id', 'searchModelRecords', 'Record to attach the activity to'),
        typeOptions: { loadOptionsDependsOn: ['res_model.value'] },
    },
    (0, utils_1.recordRLC)('Activity Type', 'activity_type_id', 'searchActivityTypes', 'Type of activity to schedule'),
    {
...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            const modelRecords = (await transport_1.odooApiRequest.call(this, 'ir.model', 'search_read', {
            ...
            if (res_model_id === undefined) {
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Linked document model "${res_model}" was not found`, {
                    itemIndex: i,
                });
            }
            ...
            const result = (await transport_1.odooApiRequest.call(this, 'mail.activity', 'create', {
                vals_list: [fields],
            }));
