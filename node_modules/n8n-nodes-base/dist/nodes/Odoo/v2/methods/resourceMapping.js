...
exports.getOdooFields = getOdooFields;
exports.getContactFields = getContactFields;
exports.getOpportunityFields = getOpportunityFields;
exports.getActivityFields = getActivityFields;
...
async function getModelRMCFields(model, requiredFields = new Set()) {
    const schema = (await transport_1.odooApiRequest.call(this, model, 'fields_get', {
