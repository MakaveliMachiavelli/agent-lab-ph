...
async function getForms() {
    ...
    if (responseData.items === undefined) {
        throw new n8n_workflow_1.OperationalError('No data got returned', { level: 'warning' });
    }
    const returnData = [];
...
async function getFields(formID) {
    ...
    if (responseData.items === undefined) {
        throw new n8n_workflow_1.OperationalError('No form fields meta data got returned', { level: 'warning' });
    }
