        ...
        for (const job of jobs) {
            ...
            try {
                ...
                if (response?.errors?.length) {
                    ...
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Error(s) ocurring while executing query from item ${job.i.toString()}: ${errorMessages.join(', ')}`, { level: 'warning' });
                }
            }
            catch (error) {
                if (this.continueOnFail()) {
