...
const xlsx_1 = require("@e965/xlsx");
...
class GoogleSheet {
    ...
    async appendEmptyRowsOrColumns(sheetId, rowsToAdd = 1, columnsToAdd = 1) {
        ...
        if (requests.length === 0) {
            throw new n8n_workflow_1.NodeOperationError(this.executeFunctions.getNode(), 'Must specify at least one column or row to add', { level: 'warning' });
        }
