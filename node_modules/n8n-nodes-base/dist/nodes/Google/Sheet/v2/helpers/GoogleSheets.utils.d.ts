...
export declare function addRowNumber(data: SheetRangeData, headerRow: number): (string | number)[][];
export declare function trimToFirstEmptyRow(data: SheetRangeData, includesRowNumber?: boolean): import("./GoogleSheets.types").SheetDataRow[];
...
export declare function getExistingSheetNames(sheet: GoogleSheet): Promise<(IDataObject[] | import("n8n-workflow").GenericValue[] | IDataObject | import("n8n-workflow").GenericValue)[]>;
export declare function mapFields(this: IExecuteFunctions, inputSize: number): IDataObject[];
export declare function autoMapInputData(this: IExecuteFunctions, sheetNameWithRange: string, sheet: GoogleSheet, items: INodeExecutionData[], options: IDataObject, prefetchedColumnNames?: string[]): Promise<IDataObject[]>;
export declare function sortLoadOptions(data: INodePropertyOptions[] | INodeListSearchItems[]): (INodeListSearchItems | INodePropertyOptions)[];
