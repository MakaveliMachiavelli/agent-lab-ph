...
exports.description = [
    ...
    },
    {
        ...
        required: true,
        builderHint: commonDescription_1.upsertColumnsResourceMapperBuilderHint,
        typeOptions: {
            loadOptionsDependsOn: ['sheetName.value'],
            resourceMapper: {
...
async function execute(sheet, sheetName, sheetId) {
    ...
    if (nodeVersion < 4) {
        ...
        if (!Array.isArray(matchingColumns) || matchingColumns.length === 0) {
            throw new n8n_workflow_1.NodeOperationError(this.getNode(), '`columns.matchingColumns` is required for the Append or Update Row operation', {
