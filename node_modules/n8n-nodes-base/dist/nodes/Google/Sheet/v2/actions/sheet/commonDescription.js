...
exports.useAppendOption = exports.handlingExtraData = exports.cellFormat = exports.outputFormatting = exports.locationDefine = exports.dataLocationOnSheet = exports.upsertColumnsResourceMapperBuilderHint = exports.columnsResourceMapperBuilderHint = void 0;
exports.columnsResourceMapperBuilderHint = {
    propertyHint: "Pass the full resourceMapper object: { mappingMode, value, schema }. A bare string like 'autoMapInputData' fails validation. `append` is plain insert \u2014 do NOT add `matchingColumns` here (that is for the `appendOrUpdate` and `update` operations).",
};
exports.upsertColumnsResourceMapperBuilderHint = {
    propertyHint: "Pass the full resourceMapper object: { mappingMode, value, schema, matchingColumns }. `matchingColumns` is REQUIRED for this operation \u2014 it must be a non-empty `string[]` of header names that uniquely identify the row to update; without it the node throws 'Could not get parameter' at runtime. Use the `append` operation instead if there is no key column to match on. A bare string like 'autoMapInputData' silently fails validation; always send the full resourceMapper object.",
};
