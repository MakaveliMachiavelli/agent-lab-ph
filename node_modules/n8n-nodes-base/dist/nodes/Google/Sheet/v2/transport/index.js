...
async function apiRequest(method, resource, body = {}, qs = {}, uri, headers = {}, option = {}, service = 'sheetV2') {
    ...
    try {
        ...
        if (authenticationMethod === 'serviceAccount') {
            ...
            const { access_token } = await GenericFunctions_1.getGoogleAccessToken.call(this, credentials, service);
