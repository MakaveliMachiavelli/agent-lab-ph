...
exports.fetchServiceAccountToken = fetchServiceAccountToken;
...
async function fetchServiceAccountToken() {
    ...
    const { access_token } = await GenericFunctions_1.getGoogleAccessToken.call(this, credentials, 'cloudStorage');
    return access_token;
}
/**
 ...
 */
async function authenticateServiceAccount(requestOptions) {
