...
async function parseJSONBody(requestOptions) {
    if (!requestOptions.body)
        requestOptions.body = {};
    const body = this.getNodeParameter('createBody');
    ...
    if (body.billing) {
        try {
            body.billing = JSON.parse(body.billing);
        }
        catch (error) { }
    }
    if (body.cors) {
        try {
            body.cors = JSON.parse(body.cors);
        }
        catch (error) { }
    }
    if (body.customPlacementConfig) {
        try {
            body.customPlacementConfig = JSON.parse(body.customPlacementConfig);
        }
        catch (error) { }
    }
    if (body.dataLocations) {
        try {
            body.dataLocations = JSON.parse(body.dataLocations);
        }
        catch (error) { }
    }
    if (body.defaultObjectAcl) {
        try {
            body.defaultObjectAcl = JSON.parse(body.defaultObjectAcl);
        }
        catch (error) { }
    }
    if (body.encryption) {
        try {
            body.encryption = JSON.parse(body.encryption);
        }
        catch (error) { }
    }
    if (body.iamConfiguration) {
        try {
            body.iamConfiguration = JSON.parse(body.iamConfiguration);
        }
        catch (error) { }
    }
    if (body.labels) {
    ...
    if (body.lifecycle) {
        try {
            body.lifecycle = JSON.parse(body.lifecycle);
        }
        catch (error) { }
    }
    if (body.logging) {
        try {
            body.logging = JSON.parse(body.logging);
        }
        catch (error) { }
    }
    if (body.retentionPolicy) {
        try {
            body.retentionPolicy = JSON.parse(body.retentionPolicy);
        }
        catch (error) { }
    }
    if (body.versioning) {
        try {
            body.versioning = JSON.parse(body.versioning);
        }
        catch (error) { }
    }
    if (body.website) {
        try {
            body.website = JSON.parse(body.website);
        }
        catch (error) { }
    }
                    ...
                    send: {
                        ...
                        preSend: [
                            async function (requestOptions) {
                                ...
                                if (!returnAll) {
                                    const key = this.getNodeParameter('projection');
