...
class FacebookTrigger {
    ...
    async webhook() {
        ...
        const authType = this.getNodeParameter('authType', 0);
        const credentials = await this.getCredentials(authType === 'oAuth2' ? 'facebookGraphAppOAuth2Api' : 'facebookGraphAppApi');
