...
class Summarize {
    ...
    async execute() {
        ...
        const aggregationResult = (0, utils_1.aggregateAndSplitData)({
        ...
        if (options.outputFormat === 'singleItem') {
            const executionData = {
                json: (0, utils_1.flattenAggregationResultToObject)(aggregationResult),
            ...
            const flatAggregationResults = (0, utils_1.flattenAggregationResultToArray)(aggregationResult);
