    ...
    try {
        ...
        if (statusCode === 403) {
            if (errorMessage === 'The security token included in the request is invalid.') {
                throw new n8n_workflow_1.UserError('The AWS credentials are not valid!', { level: 'warning' });
            }
        ...
        throw new n8n_workflow_1.OperationalError(`AWS error response [${statusCode}]: ${errorMessage}`, {
            level: 'warning',
        });
    }
}
