import type { IExecuteFunctions, IExecuteSingleFunctions, IHookFunctions, ILoadOptionsFunctions, IPollFunctions, IWebhookFunctions, IHttpRequestMethods } from 'n8n-workflow';
import type { AwsAssumeRoleCredentialsType, AwsIamCredentialsType } from '../../credentials/common/aws/types';
export declare function getAwsCredentials(context: IHookFunctions | IExecuteFunctions | IExecuteSingleFunctions | ILoadOptionsFunctions | IPollFunctions | IWebhookFunctions): Promise<{
    credentials: AwsAssumeRoleCredentialsType | AwsIamCredentialsType;
