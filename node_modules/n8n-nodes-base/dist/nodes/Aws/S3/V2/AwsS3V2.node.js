...
class AwsS3V2 {
    ...
    async execute() {
        ...
        const { credentials } = await (0, GenericFunctions_2.getAwsCredentials)(this);
            ...
            try {
                if (resource === 'bucket') {
                    ...
                    if (operation === 'create') {
                        ...
                        if (additionalFields.acl) {
                            headers['x-amz-acl'] = (0, change_case_1.kebabCase)(additionalFields.acl);
                        }
                    ...
                    if (operation === 'search') {
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.awsApiRequestRESTAllItems.call(this, listPropertyName, servicePath, 'GET', basePath, '', qs, {}, {}, region);
                        }
                        else {
                            qs['max-keys'] = this.getNodeParameter('limit', 0);
                            const rawResponse = await GenericFunctions_1.awsApiRequestREST.call(this, servicePath, 'GET', basePath, '', qs, {}, {}, region);
                ...
                if (resource === 'file') {
                    ...
                    if (operation === 'upload') {
                        ...
                        if (additionalFields.acl) {
                            multipartHeaders['x-amz-acl'] = (0, change_case_1.kebabCase)(additionalFields.acl);
                        }
                        if (additionalFields.grantFullControl) {
