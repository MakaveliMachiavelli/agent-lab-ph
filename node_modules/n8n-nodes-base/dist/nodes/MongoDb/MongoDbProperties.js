...
exports.nodeProperties = [
    ...
    // ----------------------------------
    {
        ...
        required: true,
        description: 'MongoDB aggregation pipeline in JSON format. Use $1, $2, and so on as complete values to reference Query Parameters below.',
    },
    // ----------------------------------
    //         delete
    // ----------------------------------
    {
        ...
        required: true,
        description: 'MongoDB delete query in JSON format. Use $1, $2, and so on as complete values to reference Query Parameters below.',
    },
    // ----------------------------------
    //         find
    // ----------------------------------
    ...
    },
    {
        ...
        hint: 'Use query parameters for dynamic values instead of embedding expressions in the query',
        required: true,
        description: 'MongoDB find query in JSON format. Use $1, $2, and so on as complete values to reference Query Parameters below.',
    },
    {
        ...
        validateType: 'array',
        description: 'JSON array of values to use for $1, $2, and so on, in order. Values can be strings, numbers, booleans, null, or arrays of these values. You can also use an expression that returns an array.',
