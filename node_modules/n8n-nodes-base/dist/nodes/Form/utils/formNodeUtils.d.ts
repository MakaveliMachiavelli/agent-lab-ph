...
import { type NodeTypeAndVersion, type IUser, type IWebhookFunctions, type FormFieldsParameter, type IWebhookResponseData } from 'n8n-workflow';
export declare const renderFormNode: (context: IWebhookFunctions, res: Response, trigger: NodeTypeAndVersion, fields: FormFieldsParameter, mode: 'test' | 'production', authedUser?: IUser) => Promise<IWebhookResponseData>;
/**
