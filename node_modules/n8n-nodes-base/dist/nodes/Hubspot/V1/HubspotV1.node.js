    ...
    methods = {
        ...
        loadOptions: {
            ...
            async getContactLeadStatuses() {
                const returnData = [];
                const properties = await GenericFunctions_1.getAllProperties.call(this, 'contacts');
            ...
            async getCompanyIndustries() {
                const returnData = [];
                const properties = await GenericFunctions_1.getAllProperties.call(this, 'companies');
                for (const property of properties) {
            ...
            async getDealProperties() {
                const returnData = [];
                const properties = await GenericFunctions_1.getAllProperties.call(this, 'deals');
                for (const property of properties) {
                    const propertyName = property.label;
                    const propertyId = property.name;
                    returnData.push({
            ...
            async getTicketCategories() {
                const returnData = [];
                const properties = await GenericFunctions_1.getAllProperties.call(this, 'tickets');
                for (const property of properties) {
