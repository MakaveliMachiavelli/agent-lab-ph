...
class RespondToWebhook {
    description = {
        ...
        builderHint: {
            searchHint: 'Only works with webhook node (n8n-nodes-base.webhook) with responseMode set to "responseNode"',
            relatedNodes: [
                {
            ...
            if (respondWith === 'json') {
                ...
                try {
                    ...
                    if (keyType === 'passphrase') {
                        ...
                        secretOrPrivateKey = (0, format_pem_block_1.formatPemBlock)(privateKey);
                    }
