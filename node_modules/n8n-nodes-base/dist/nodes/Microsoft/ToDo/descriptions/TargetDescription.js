...
exports.targetDescription = exports.userTargetRLC = void 0;
/**
...
exports.userTargetRLC = {
    ...
    description: 'The user whose To Do lists and tasks the Service Principal should act on. Evaluated per input item — an expression can target a different user for each item.',
    displayOptions: {
        show: {
...
exports.targetDescription = [exports.userTargetRLC];
