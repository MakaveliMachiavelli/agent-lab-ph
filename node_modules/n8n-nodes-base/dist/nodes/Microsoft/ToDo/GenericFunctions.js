...
exports.getToDoCredentialType = getToDoCredentialType;
 ...
 */
function getToDoCredentialType() {
 ...
 */
function getServicePrincipalResourceRoot(rawId, node) {
...
// not an index.
async function microsoftApiRequest(method, resource, itemIndex, body = {}, qs = {}, uri, option = { json: true }) {
...
async function microsoftApiRequestAllItems(propertyName, method, endpoint, itemIndex, body = {}, query = {}) {
    const returnData = [];
    let responseData;
    let uri;
    query.$top = 100;
