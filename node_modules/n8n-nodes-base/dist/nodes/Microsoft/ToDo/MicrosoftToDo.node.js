    ...
    methods = {
        loadOptions: {
            ...
            async getTaskLists() {
                ...
                const lists = await GenericFunctions_2.microsoftApiRequestAllItems.call(this, 'value', 'GET', '/todo/lists', 0);
            ...
            try {
                if (resource === 'linkedResource') {
                    ...
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'POST', `/todo/lists/${taskListId}/tasks/${taskId}/linkedResources`, i, body, qs);
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'DELETE', `/todo/lists/${taskListId}/tasks/${taskId}/linkedResources/${linkedResourceId}`, i, undefined, qs);
                        ...
                        const taskId = this.getNodeParameter('taskId', i);
                        const linkedResourceId = this.getNodeParameter('linkedResourceId', i);
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', `/todo/lists/${taskListId}/tasks/${taskId}/linkedResources/${linkedResourceId}`, i, undefined, qs);
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_2.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/todo/lists/${taskListId}/tasks/${taskId}/linkedResources`, i, undefined, qs);
                        }
                        else {
                            qs.$top = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', `/todo/lists/${taskListId}/tasks/${taskId}/linkedResources`, i, undefined, qs);
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'PATCH', `/todo/lists/${taskListId}/tasks/${taskId}/linkedResources/${linkedResourceId}`, i, body, qs);
                    }
                    else {
                    ...
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'POST', `/todo/lists/${taskListId}/tasks`, i, body, qs);
                        // https://docs.microsoft.com/en-us/graph/api/todotask-delete?view=graph-rest-1.0&tabs=http
                    }
                    else if (operation === 'delete') {
                        const taskListId = this.getNodeParameter('taskListId', i);
                        const taskId = this.getNodeParameter('taskId', i);
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'DELETE', `/todo/lists/${taskListId}/tasks/${taskId}`, i, undefined, qs);
                        responseData = { success: true };
                        ...
                        const taskListId = this.getNodeParameter('taskListId', i);
                        const taskId = this.getNodeParameter('taskId', i);
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', `/todo/lists/${taskListId}/tasks/${taskId}`, i, undefined, qs);
                        ...
                        const returnAll = this.getNodeParameter('returnAll', i);
                        if (returnAll) {
                            responseData = await GenericFunctions_2.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/todo/lists/${taskListId}/tasks/`, i, undefined, qs);
                        }
                        else {
                            qs.$top = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', `/todo/lists/${taskListId}/tasks/`, i, undefined, qs);
                            responseData = responseData.value;
                        }
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'PATCH', `/todo/lists/${taskListId}/tasks/${taskId}`, i, body, qs);
                    }
                    else {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `The operation "${operation}" is not supported!`, { itemIndex: i });
                    }
                    ...
                    if (operation === 'create') {
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'POST', '/todo/lists/', i, body, qs);
                        // https://docs.microsoft.com/en-us/graph/api/todotasklist-delete?view=graph-rest-1.0&tabs=http
                    }
                    else if (operation === 'delete') {
                        const listId = this.getNodeParameter('listId', i);
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'DELETE', `/todo/lists/${listId}`, i, undefined, qs);
                        responseData = { success: true };
                        //https://docs.microsoft.com/en-us/graph/api/todotasklist-get?view=graph-rest-1.0&tabs=http
                    }
                    else if (operation === 'get') {
                        const listId = this.getNodeParameter('listId', i);
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', `/todo/lists/${listId}`, i, undefined, qs);
                        // https://docs.microsoft.com/en-us/graph/api/todo-list-lists?view=graph-rest-1.0&tabs=http
                    }
                    else if (operation === 'getAll') {
                        const returnAll = this.getNodeParameter('returnAll', i);
                        if (returnAll) {
                            responseData = await GenericFunctions_2.microsoftApiRequestAllItems.call(this, 'value', 'GET', '/todo/lists', i, undefined, qs);
                        }
                        else {
                            qs.$top = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', '/todo/lists', i, undefined, qs);
                            responseData = responseData.value;
                        }
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'PATCH', `/todo/lists/${listId}`, i, body, qs);
                    }
                    else {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `The operation "${operation}" is not supported!`, { itemIndex: i });
                    }
