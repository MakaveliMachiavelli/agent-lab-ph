...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        try {
            ...
            let responseData = await transport_1.microsoftApiRequestAllItemsSkip.call(this, 'value', 'GET', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/tables/${tableId}/rows`, {}, {}, i);
            qs.$select = 'name';
            // TODO: That should probably be cached in the future
            let columns = await transport_1.microsoftApiRequestAllItemsSkip.call(this, 'value', 'GET', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/tables/${tableId}/columns`, {}, qs, i);
