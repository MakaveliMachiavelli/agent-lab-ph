...
async function execute(items) {
    ...
    const worksheetData = await transport_1.microsoftApiRequest.call(this, 'GET', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/usedRange`, undefined, undefined, undefined, undefined, 0);
    let values = [];
    if (dataMode === 'raw') {
    ...
    const responseData = await transport_1.microsoftApiRequest.call(this, 'PATCH', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/range(address='${range}')`, { values }, undefined, undefined, undefined, 0);
