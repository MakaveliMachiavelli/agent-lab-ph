...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        ...
        try {
            ...
            let responseData;
            if (range) {
                responseData = await transport_1.microsoftApiRequest.call(this, 'GET', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/range(address='${range}')`, {}, qs, undefined, undefined, i);
            }
            else {
                responseData = await transport_1.microsoftApiRequest.call(this, 'GET', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/usedRange`, {}, qs, undefined, undefined, i);
            }
            if (!rawData) {
