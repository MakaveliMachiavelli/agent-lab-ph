...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            await transport_1.microsoftApiRequest.call(this, 'DELETE', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}`, undefined, undefined, undefined, undefined, i);
