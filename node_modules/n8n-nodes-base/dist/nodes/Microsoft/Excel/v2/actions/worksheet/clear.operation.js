...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            if (!useRange) {
                await transport_1.microsoftApiRequest.call(this, 'POST', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/range/clear`, { applyTo }, undefined, undefined, undefined, i);
            }
            else {
                const range = this.getNodeParameter('range', i, '');
                await transport_1.microsoftApiRequest.call(this, 'POST', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/range(address='${range}')/clear`, { applyTo }, undefined, undefined, undefined, i);
            }
