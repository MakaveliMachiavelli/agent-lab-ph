...
async function getWorksheetColumnRow() {
    ...
    let columns = [];
    if (range === '') {
        const worksheetData = await transport_1.microsoftApiRequest.call(this, 'GET', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/usedRange`, undefined, { select: 'values' }, undefined, undefined, 0);
        ...
        const worksheetData = await transport_1.microsoftApiRequest.call(this, 'PATCH', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/range(address='${range}')`, { select: 'values' }, undefined, undefined, undefined, 0);
        columns = worksheetData.values[0];
    }
    const returnData = [];
...
async function getTableColumns() {
    ...
    const response = await transport_1.microsoftApiRequest.call(this, 'GET', `/drive/items/${workbookId}/workbook/worksheets/${worksheetId}/tables/${tableId}/columns`, {}, undefined, undefined, undefined, 0);
