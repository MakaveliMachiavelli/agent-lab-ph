...
async function execute(index, _) {
    ...
    const responseData = await transport_1.microsoftApiRequest.call(this, 'POST', `/messages/${messageId}/${action}`, index, body);
    if (additionalFields.attachments) {
        ...
        for (const attachment of data) {
            await transport_1.microsoftApiRequest.call(this, 'POST', `/messages/${responseData.id}/attachments`, index, attachment, {});
        }
    }
    if (!saveAsDraft) {
        await transport_1.microsoftApiRequest.call(this, 'POST', `/messages/${responseData.id}/send`, index);
    }
