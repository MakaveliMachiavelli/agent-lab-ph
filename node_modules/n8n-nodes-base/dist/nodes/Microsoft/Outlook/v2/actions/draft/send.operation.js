...
async function execute(index) {
    ...
    if (to) {
        ...
        if (recipients.length !== 0) {
            await transport_1.microsoftApiRequest.call(this, 'PATCH', `/messages/${draftId}`, index, {
                toRecipients: recipients.map((recipient) => (0, utils_1.makeRecipient)(recipient)),
            });
        }
    }
    await transport_1.microsoftApiRequest.call(this, 'POST', `/messages/${draftId}/send`, index);
