...
exports.properties = [
    ...
    descriptions_1.eventRLC,
    {
        ...
        options: [
            {
                ...descriptions_1.eventAttendeesField,
            ...
            descriptions_1.eventLocationField,
            {
...
async function execute(index) {
    ...
    additionalFields = (0, utils_1.prepareEventFields)(additionalFields);
    ...
    const responseData = await transport_1.microsoftApiRequest.call(this, 'PATCH', endpoint, index, body);
