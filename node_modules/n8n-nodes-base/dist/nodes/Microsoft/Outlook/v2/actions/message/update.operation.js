...
async function execute(index) {
    ...
    if (folderId) {
        ...
        responseData = await transport_1.microsoftApiRequest.call(this, 'POST', `/messages/${messageId}/move`, index, body);
    ...
    responseData = await transport_1.microsoftApiRequest.call(this, 'PATCH', `/messages/${messageId}`, index, body, {});
    const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(responseData), { itemData: { item: index } });
    return executionData;
}
