...
exports.versionDescription = {
    ...
    credentials: [
        ...
        {
            name: transport_1.SERVICE_PRINCIPAL_AUTH,
            required: true,
            displayOptions: {
                show: {
                    authentication: [transport_1.SERVICE_PRINCIPAL_AUTH],
                },
            },
        },
    ],
    ...
    properties: [
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    description: 'Generic Microsoft Graph credential. Add the Teams Graph scopes (e.g. Chat.ReadWrite, ChannelMessage.Read.All, Group.ReadWrite.All) and grant admin consent on the credential. See the docs for the full scope string.',
                },
                {
                    name: 'Service Principal (App-Only)',
                    value: transport_1.SERVICE_PRINCIPAL_AUTH,
                    description: 'App-only access via a Microsoft Entra app registration. App-only Graph cannot act as a signed-in user, so chat actions and chat triggers are unavailable. Grant the relevant application permissions (e.g. Team.ReadBasic.All, Channel.ReadBasic.All, Tasks.ReadWrite.All) and admin consent on the credential.',
                },
            ],
