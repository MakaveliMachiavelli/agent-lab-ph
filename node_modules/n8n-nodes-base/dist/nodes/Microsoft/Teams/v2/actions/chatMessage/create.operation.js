...
const sharedGuard_1 = require("./sharedGuard");
const properties = [
...
async function execute(i, instanceId) {
    ...
    sharedGuard_1.throwIfChatUnsupported.call(this);
    ...
    return await transport_1.microsoftApiRequest.call(this, 'POST', transport_1.buildTeamsPath.call(this, ['/v1.0/chats/', { id: chatId }, '/messages']), body);
}
