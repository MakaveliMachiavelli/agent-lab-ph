                ...
                if (resource === 'channel') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (returnAll) {
                            ...
                            responseData = await GenericFunctions_1.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/v1.0/teams/${teamId}/channels`, {}, {}, limit);
                        }
                    }
                ...
                if (resource === 'channelMessage') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (returnAll) {
                            ...
                            const limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/beta/teams/${teamId}/channels/${channelId}/messages`, {}, { $top: limit }, limit);
                        }
                    }
                }
                if (resource === 'chatMessage') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (returnAll) {
                            ...
                            const limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/v1.0/chats/${chatId}/messages`, {}, { $top: limit }, limit);
                        }
                    }
                }
                if (resource === 'task') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (tasksFor === 'member') {
                            ...
                            if (returnAll) {
                                ...
                                responseData = await GenericFunctions_1.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/v1.0/users/${memberId}/planner/tasks`, {}, {}, limit);
                            }
                        }
                        else {
                            ...
                            if (returnAll) {
                                ...
                                const limit = this.getNodeParameter('limit', i);
                                responseData = await GenericFunctions_1.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/v1.0/planner/plans/${planId}/tasks`, {}, {}, limit);
                            }
                        }
                    }
