...
export declare function executeSqlQueryAndPrepareResults(this: IExecuteFunctions, pool: mssql.ConnectionPool, rawQuery: string, itemIndex: number, queryValues?: Array<string | number | boolean | IDataObject>, nodeVersion?: number): Promise<INodeExecutionData[]>;
