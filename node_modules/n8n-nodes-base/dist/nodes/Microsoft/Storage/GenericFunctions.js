...
async function handleErrorPostReceive(data, response) {
    if (String(response.statusCode).startsWith('4') || String(response.statusCode).startsWith('5')) {
        ...
        const parser = new xml2js_1.Parser({
            explicitArray: false,
            tagNameProcessors: [n8n_workflow_1.sanitizeXmlName, processors_1.firstCharLowerCase],
...
async function parseBlobList(xml) {
    const parser = new xml2js_1.Parser({
        explicitArray: false,
        tagNameProcessors: [n8n_workflow_1.sanitizeXmlName, processors_1.firstCharLowerCase, (name) => name.replace('-', '')],
        attrNameProcessors: [n8n_workflow_1.sanitizeXmlName],
        valueProcessors: [
            function (value, name) {
                if ([
