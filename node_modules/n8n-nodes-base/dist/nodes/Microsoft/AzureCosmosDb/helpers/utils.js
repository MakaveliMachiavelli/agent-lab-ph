...
async function validateQueryParameters(requestOptions) {
    ...
    let parameterValues;
    if (queryParamsJson) {
        const parsed = (0, n8n_workflow_1.jsonParse)(queryParamsJson, {
            errorMessage: 'Query Parameters (JSON) must be a valid JSON array',
        });
        if (!Array.isArray(parsed)) {
            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Query Parameters (JSON) must be a JSON array', {
