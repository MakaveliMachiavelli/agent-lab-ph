...
const TargetDescription_1 = require("./descriptions/TargetDescription");
...
class MicrosoftOneDrive {
    description = {
        ...
        properties: [
            ...
            ...TargetDescription_1.targetDescription,
            {
    ...
    async execute() {
        ...
        const credentialType = GenericFunctions_2.getOneDriveCredentialType.call(this);
        ...
        const resolvedDestinationDriveIds = new Map();
        const resolveDestinationDriveId = async (providedDriveId, itemIndex, driveScopeRoot) => {
            // Explicit destination drive (any auth) wins — supports cross-drive moves.
            if (providedDriveId)
                return providedDriveId;
            ...
            const target = this.getNodeParameter('resourceTarget', itemIndex, 'user');
            if (target === 'drive') {
            ...
            if (resolvedDriveId === undefined) {
                const drive = (await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', '/drive', {}, { $select: 'id' }, undefined, {}, { json: true }, driveScopeRoot));
                const driveId = typeof drive?.id === 'string' ? drive.id : '';
                if (!driveId) {
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Could not resolve a destination Drive ID for the app-only copy/move', {
                        itemIndex,
                        description: "Set a destination Drive ID — app-only Microsoft Graph can't target a personal (/me) drive.",
                    });
                }
        ...
        for (let i = 0; i < length; i++) {
            try {
                ...
                const driveScopeRoot = GenericFunctions_2.resolveDriveScopeRoot.call(this, false, i);
                if (resource === 'file') {
                    ...
                    if (operation === 'copy') {
                        ...
                        if (isServicePrincipal) {
                            const providedDriveId = typeof parentReference?.driveId === 'string' ? parentReference.driveId : '';
                            const destinationDriveId = await resolveDestinationDriveId(providedDriveId, i, driveScopeRoot);
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'POST', `/drive/items/${encodeURIComponent(fileId)}/copy`, body, {}, undefined, {}, { json: true, resolveWithFullResponse: true }, driveScopeRoot);
                    ...
                    if (operation === 'delete') {
                        const fileId = encodeURIComponent(this.getNodeParameter('fileId', i));
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'DELETE', `/drive/items/${fileId}`, {}, {}, undefined, {}, { json: true }, driveScopeRoot);
                    ...
                    if (operation === 'download') {
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', `/drive/items/${fileId}`, {}, {}, undefined, {}, { json: true }, driveScopeRoot);
                        ...
                        try {
                            responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'GET', `/drive/items/${fileId}/content`, {}, {}, undefined, {}, { encoding: null, resolveWithFullResponse: true }, driveScopeRoot);
                        }
                        catch (error) {
                    ...
                    if (operation === 'search') {
                        if (isServicePrincipal) {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Search is not supported with the Service Principal credential', {
                                itemIndex: i,
                                description: 'App-only Microsoft Graph cannot search a drive. Use File: Get, or an OAuth2 credential.',
                            });
                        }
                        const query = this.getNodeParameter('query', i);
                        responseData = await GenericFunctions_2.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/drive/root/search(q='${query}')`);
                    ...
                    if (operation === 'share') {
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'POST', `/drive/items/${fileId}/createLink`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                    ...
                    if (operation === 'upload') {
                        ...
                        if (isBinaryData) {
                            ...
                            (0, GenericFunctions_2.validateOneDriveFileName)(this.getNode(), resolvedFileName, i);
                            ...
                            responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'PUT', `/drive/items/${encodedParentId}:/${encodedFilename}:/content`, body, {}, undefined, { 'Content-Type': binaryData.mimeType, 'Content-length': body.length }, {}, driveScopeRoot);
                            responseData = JSON.parse(responseData);
                        }
                        else {
                            const body = this.getNodeParameter('fileContent', i);
                            (0, GenericFunctions_2.validateOneDriveFileName)(this.getNode(), fileName, i);
                            const encodedFilename = encodeURIComponent(fileName);
                            responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'PUT', `/drive/items/${encodedParentId}:/${encodedFilename}:/content`, body, {}, undefined, { 'Content-Type': 'text/plain' }, { json: true }, driveScopeRoot);
                        }
                    }
                }
                if (resource === 'folder') {
                    ...
                    if (operation === 'create') {
                        ...
                        for (const name of names) {
                            ...
                            if (parentFolderId) {
                                endpoint = `/drive/items/${encodeURIComponent(parentFolderId)}/children`;
                            }
                            responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'POST', endpoint, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                            if (!responseData.id) {
                                break;
                            }
                    ...
                    //https://docs.microsoft.com/en-us/onedrive/developer/rest-api/api/driveitem_delete?view=odsp-graph-online
                    if (operation === 'delete') {
                        const folderId = encodeURIComponent(this.getNodeParameter('folderId', i));
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'DELETE', `/drive/items/${folderId}`, {}, {}, undefined, {}, { json: true }, driveScopeRoot);
                        responseData = { success: true };
                    }
                    //https://docs.microsoft.com/en-us/onedrive/developer/rest-api/api/driveitem_list_children?view=odsp-graph-online
                    if (operation === 'getChildren') {
                        const folderId = encodeURIComponent(this.getNodeParameter('folderId', i));
                        responseData = await GenericFunctions_2.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/drive/items/${folderId}/children`, {}, {}, driveScopeRoot);
                    }
                    //https://docs.microsoft.com/en-us/onedrive/developer/rest-api/api/driveitem_search?view=odsp-graph-online
                    if (operation === 'search') {
                        if (isServicePrincipal) {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Search is not supported with the Service Principal credential', {
                                itemIndex: i,
                                description: 'App-only Microsoft Graph cannot search a drive. Use Folder: Get Children, or an OAuth2 credential.',
                            });
                        }
                        const query = this.getNodeParameter('query', i);
                        responseData = await GenericFunctions_2.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/drive/root/search(q='${query}')`);
                    ...
                    if (operation === 'share') {
                        ...
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'POST', `/drive/items/${folderId}/createLink`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                }
                if (resource === 'file' || resource === 'folder') {
                    if (operation === 'rename') {
                        const itemId = encodeURIComponent(this.getNodeParameter('itemId', i));
                        const newName = this.getNodeParameter('newName', i);
                        const body = { name: newName };
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'PATCH', `/drive/items/${itemId}`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                    ...
                    if (operation === 'move') {
                        ...
                        const itemId = this.getNodeParameter(itemIdParam, i);
                        const destinationFolderId = this.getNodeParameter('destinationFolderId', i);
                        const additionalFields = this.getNodeParameter('additionalFields', i);
                        const renameName = typeof additionalFields.name === 'string' ? additionalFields.name : '';
                        ...
                        if (!destinationFolderId && !renameName) {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Set a Destination Folder ID to move the item (use `root` for the drive root), or a Name to rename it in place.', { itemIndex: i });
                        }
                        ...
                        // any `/ : ? #` in the id from changing which item the URL addresses.
                        responseData = await GenericFunctions_2.microsoftApiRequest.call(this, 'PATCH', `/drive/items/${encodeURIComponent(itemId)}`, body, {}, undefined, {}, { json: true }, driveScopeRoot);
                    }
                }
            }
            catch (error) {
