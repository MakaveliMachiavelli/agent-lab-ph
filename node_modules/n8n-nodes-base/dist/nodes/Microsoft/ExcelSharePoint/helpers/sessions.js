...
exports.withWorkbookSession = withWorkbookSession;
...
async function closeSessionQuietly(workbookRoot, headers) {
    try {
        await transport_1.microsoftApiRequest.call(this, 'POST', `${workbookRoot}/workbook/closeSession`, {}, {}, undefined, headers);
    }
    catch {
 ...
 */
async function withWorkbookSession(workbookRoot, send) {
    const { id } = await (transport_1.microsoftApiRequest).call(this, 'POST', `${workbookRoot}/workbook/createSession`, { persistChanges: true });
