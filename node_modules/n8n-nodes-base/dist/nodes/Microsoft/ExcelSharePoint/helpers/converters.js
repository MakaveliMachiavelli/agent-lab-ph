...
exports.toHttpCode = toHttpCode;
exports.toGraphBaseUrl = toGraphBaseUrl;
exports.unwrapGraphError = unwrapGraphError;
exports.toPermissionKey = toPermissionKey;
...
function toGraphBaseUrl(graphApiBaseUrl) {
    const base = typeof graphApiBaseUrl === 'string' && graphApiBaseUrl !== ''
        ? graphApiBaseUrl
        : constants_1.DEFAULT_GRAPH_BASE_URL;
    return base.replace(/\/+$/, '');
}
/**
 ...
 */
function unwrapGraphError(error) {
...
function toPermissionKey(resource, operation) {
