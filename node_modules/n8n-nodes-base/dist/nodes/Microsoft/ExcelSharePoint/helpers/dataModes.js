...
exports.isEmptyUsedRange = isEmptyUsedRange;
exports.isEmptySheet = isEmptySheet;
exports.columnsFromItem = columnsFromItem;
exports.columnsFromFields = columnsFromFields;
exports.autoMapRow = autoMapRow;
exports.defineRow = defineRow;
/**
 ...
 */
function isEmptyUsedRange(address) {
 ...
 */
function isEmptySheet(address, firstRow) {
...
function autoMapRow(item, columns) {
...
function defineRow(fields, columns) {
    const byColumn = {};
