...
exports.listSearchPage = listSearchPage;
 ...
 * the collection.
 */
async function listSearchPage(endpoint, mapItem, filter, paginationToken) {
    let nextLink = paginationToken;
    let matches = [];
    do {
        const response = nextLink
            ? await (transport_1.microsoftApiRequest).call(this, 'GET', '', {}, {}, nextLink)
            : await (transport_1.microsoftApiRequest).call(this, 'GET', endpoint, {}, { $top: PAGE_SIZE });
