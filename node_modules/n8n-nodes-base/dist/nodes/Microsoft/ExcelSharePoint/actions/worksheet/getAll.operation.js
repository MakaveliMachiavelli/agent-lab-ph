...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            let responseData;
            if (returnAll) {
                responseData = await (transport_1.microsoftApiRequestAllItems).call(this, endpoint, qs);
            }
            else {
                qs.$top = this.getNodeParameter('limit', i);
                const response = await (transport_1.microsoftApiRequest).call(this, 'GET', endpoint, {}, qs);
