...
function getSettings(itemIndex) {
    const worksheetId = (0, utils_2.validatePathSegment)(this.getNode(), 'Sheet', this.getNodeParameter('worksheet', itemIndex, '', { extractValue: true }));
...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            const workbookRoot = await utils_2.resolveWorkbookRoot.call(this, i, workbookRootCache, siteIdCache);
            ...
            const responseData = await (transport_1.microsoftApiRequest).call(this, 'GET', settings.range
            ...
            const preparedData = utils_1.prepareOutput.call(this, this.getNode(), responseData, {
