...
async function getMappingColumns() {
    ...
    const listIdOrTitle = (0, utils_1.assertPathSegment)(this.getNode(), String(this.getNodeParameter('list', '', { extractValue: true })), 'List');
    ...
    const response = (await transport_1.microsoftApiRequest.call(this, 'GET', `/v1.0/sites/${encodeURIComponent(siteId)}/lists/${encodeURIComponent(listIdOrTitle)}/contentTypes`, {}, { expand: 'columns' }));
...
function itemColumns(mode) {
    return {
        ...
        displayOptions: {
            hide: {
                ...index_1.untilSiteSelected,
                ...index_1.untilListSelected,
            },
        },
        typeOptions: {
