...
exports.listRLC = exports.untilListSelected = exports.untilSiteSelected = void 0;
...
async function getLists(filter, paginationToken) {
    ...
    let response;
    if (paginationToken) {
        response = (await transport_1.microsoftApiRequest.call(this, 'GET', '', {}, {}, paginationToken));
    }
    else {
        response = (await transport_1.microsoftApiRequest.call(this, 'GET', `/v1.0/sites/${encodeURIComponent(siteId)}/lists`, {}, { $select: 'id,displayName' }));
    }
