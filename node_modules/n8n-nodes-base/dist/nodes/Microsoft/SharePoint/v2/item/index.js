...
exports.itemRLC = exports.untilListSelected = void 0;
exports.getItems = getItems;
exports.lookupItemIdByColumns = lookupItemIdByColumns;
exports.resolveMatchedItemIds = resolveMatchedItemIds;
exports.resolveItemMapperValues = resolveItemMapperValues;
exports.buildItemFieldsPayload = buildItemFieldsPayload;
exports.updateItemFields = updateItemFields;
const n8n_workflow_1 = require("n8n-workflow");
const graphSearch_1 = require("../helpers/graphSearch");
...
async function getItems(filter, paginationToken) {
    ...
    if (!paginationToken) {
        ...
        const siteId = await site_1.resolveSiteId.call(this, 0);
    ...
    return await graphSearch_1.searchGraphCollection.call(this, {
        endpoint,
 ...
 */
async function lookupItemIdByColumns(siteId, listIdOrTitle, matchingColumns, values) {
    const filter = matchingColumns
        .map((column) => (0, utils_1.odataFieldEqualsClause)(column, values[column]))
        .join(' and ');
    ...
    let rows;
    try {
        rows = (await transport_1.microsoftApiRequestAllItems.call(this, 'value', 'GET', `/v1.0/sites/${encodeURIComponent(siteId)}/lists/${encodeURIComponent(listIdOrTitle)}/items`, {}, { $filter: filter }, 2, utils_1.NON_INDEXED_QUERY_HEADERS));
    }
    catch (error) {
        throw (0, utils_1.nonIndexedFilterThresholdError)(this.getNode(), error, filter) ?? error;
    }
    return rows
 ...
 */
async function resolveMatchedItemIds(siteId, listIdOrTitle, matchingColumns, values) {
 ...
 */
function resolveItemMapperValues(i) {
 ...
 */
function buildItemFieldsPayload(value, schema) {
    const fields = {};
    ...
    for (const [key, fieldValue] of Object.entries(value)) {
        ...
        if (dotIndex > 0 &&
            ...
            (0, n8n_workflow_1.setSafeObjectProperty)(fields, base, folded);
            continue;
        }
        (0, n8n_workflow_1.setSafeObjectProperty)(fields, key, fieldValue);
    }
 ...
 */
async function updateItemFields(siteId, listIdOrTitle, itemId, value, schema) {
    itemId = (0, utils_1.assertPathSegment)(this.getNode(), itemId, 'Item');
    ...
    try {
        await transport_1.microsoftApiRequest.call(this, 'PATCH', `${itemPath}/fields`, fields, {}, undefined, hasHyperlink ? utils_1.HYPERLINK_WRITE_HEADERS : {});
    }
    catch (error) {
        (0, utils_1.addUniqueConstraintHint)(error);
        throw error;
    }
    try {
        return await transport_1.microsoftApiRequest.call(this, 'GET', itemPath, {}, { $expand: 'fields' });
    }
    catch (error) {
        ...
        throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'The item was updated, but reading back the updated item failed', {
