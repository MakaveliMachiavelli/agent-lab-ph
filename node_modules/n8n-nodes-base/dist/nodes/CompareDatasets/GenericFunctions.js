            ...
            default:
                ...
                if (options.nodeVersion >= 2.1 &&
                    ...
                    if (skippedFieldsWithDotNotation.length &&
                        ...
                        throw new n8n_workflow_1.UserError(`The field \'${key}\' in item ${i} is not an object. It is not possible to use dot notation.`, { level: 'warning' });
                    }
...
function findMatches(input1, input2, fieldsToMatch, options) {
    ...
    if (disableDotNotation && skipFields.some((field) => field.includes('.'))) {
        ...
        throw new n8n_workflow_1.UserError(msg, { level: 'warning' });
    }
    const filteredData = {
        matched: [],
        unmatched1: [],
