export declare const COUNTRIES: readonly [{
    ...
    readonly value: 'CD';
    readonly name: 'Congo, Democratic Republic of The';
}, {
    readonly value: 'CK';
    ...
    readonly value: 'TF';
    readonly name: 'French Southern Territories';
}, {
    readonly value: 'GA';
    readonly name: 'Gabon';
}, {
    ...
    readonly value: 'KP';
    readonly name: "Korea, Democratic People's Republic Of";
}, {
    readonly value: 'KR';
    readonly name: 'Korea, Republic Of';
}, {
    readonly value: 'KW';
    ...
    readonly value: 'NL';
    readonly name: 'Netherlands, Kingdom of The';
}, {
    readonly value: 'NC';
    ...
    readonly value: 'PS';
    readonly name: 'Palestine, State Of';
}, {
    readonly value: 'PA';
    ...
    readonly value: 'VE';
    readonly name: 'Venezuela, Bolivarian Republic Of';
}, {
    readonly value: 'VN';
