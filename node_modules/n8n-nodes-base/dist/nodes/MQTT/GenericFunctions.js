...
const createClient = async (credentials) => {
    ...
    if (credentials.ssl) {
        clientOptions.ca = (0, format_pem_block_1.formatPemBlock)(credentials.ca);
        clientOptions.cert = (0, format_pem_block_1.formatPemBlock)(credentials.cert);
        clientOptions.key = (0, format_pem_block_1.formatPemBlock)(credentials.key);
    ...
    return await new Promise((resolve, reject) => {
        ...
        const onError = (error) => {
            ...
            client.end();
            reject(new n8n_workflow_1.OperationalError(error.message));
        };
