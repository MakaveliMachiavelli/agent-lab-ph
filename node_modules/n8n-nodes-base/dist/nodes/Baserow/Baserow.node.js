                ...
                if (operation === 'getAll') {
                    ...
                    if (filters?.fields) {
                        filters.fields.forEach(({ field, operator, value, timezone }) => {
                            const fieldId = (0, GenericFunctions_1.normalizeFilterFieldId)(mapper.setField(field));
                            qs[`filter__field_${fieldId}__${operator}`] = (0, GenericFunctions_1.formatBaserowFilterValue)(operator, value, timezone ?? 'UTC');
                        });
                    }
                    if (filterType) {
