...
exports.TableFieldMapper = exports.toOptions = exports.DEPRECATED_TIMEZONE_ONLY_OPERATORS = exports.DEPRECATED_TIMEZONE_NUMBER_OPERATORS = exports.MULTI_STEP_DATE_OPERATORS = void 0;
exports.formatBaserowFilterValue = formatBaserowFilterValue;
exports.normalizeFilterFieldId = normalizeFilterFieldId;
...
exports.MULTI_STEP_DATE_OPERATORS = new Set([
    'date_is',
    'date_is_not',
    'date_is_before',
...
exports.DEPRECATED_TIMEZONE_NUMBER_OPERATORS = new Set([
    'date_within_days',
    'date_within_weeks',
    'date_within_months',
...
exports.DEPRECATED_TIMEZONE_ONLY_OPERATORS = new Set([
    'date_equals_today',
    'date_before_today',
    'date_after_today',
    'date_equals_week',
 ...
 */
function formatBaserowFilterValue(operator, value, timezone = 'UTC') {
    const trimmed = value.trim();
    if (!trimmed) {
        if (exports.DEPRECATED_TIMEZONE_ONLY_OPERATORS.has(operator)) {
            return timezone;
        }
        return trimmed;
    }
    if (exports.MULTI_STEP_DATE_OPERATORS.has(operator)) {
    ...
    if (exports.DEPRECATED_TIMEZONE_NUMBER_OPERATORS.has(operator)) {
        if (trimmed.includes('?')) {
            return trimmed;
        }
        return `${timezone}?${trimmed}`;
...
function normalizeFilterFieldId(field) {
