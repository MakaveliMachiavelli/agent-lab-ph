...
const create_update_description_1 = require("./create_update.description");
...
exports.description = (0, n8n_workflow_1.updateDisplayOptions)({
    ...
    ...create_update_description_1.DataToSendOption,
    {
    ...
    ...create_update_description_1.RowCreateUpdateOptions,
    {
                ...
                if (fields?.value) {
                    for (const schema of fields.schema.filter((schema) => schema.type === 'array')) {
                        ...
                        try {
                            ...
                            fields.value[schema.id] = (0, helpers_1.JSONSafeParse)(fields.value[schema.id].replace(/'/g, '"'));
                        }
                    }
