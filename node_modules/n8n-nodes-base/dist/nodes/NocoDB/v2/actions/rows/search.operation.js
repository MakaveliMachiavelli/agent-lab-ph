...
async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            if (returnAll) {
                responseData = await transport_1.apiRequestAllItems.call(this, requestMethod, endPoint, {}, qs);
            }
            else {
                qs.limit = this.getNodeParameter('limit', i);
                responseData = await transport_1.apiRequest.call(this, requestMethod, endPoint, {}, qs);
            ...
            if (downloadAttachments) {
                ...
                const response = await transport_1.downloadRecordAttachments.call(this, responseData, downloadFieldNames, [{ item: i }]);
