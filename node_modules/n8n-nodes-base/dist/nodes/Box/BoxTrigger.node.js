...
const BoxTriggerHelpers_1 = require("./BoxTriggerHelpers");
...
class BoxTrigger {
    ...
    webhookMethods = {
        default: {
            async checkExists() {
                ...
                const webhooks = await GenericFunctions_1.boxApiRequestAllItemsMarker.call(this, 'entries', 'GET', endpoint, {});
                for (const webhook of webhooks) {
                    ...
                    const fullWebhook = await GenericFunctions_1.boxApiRequest.call(this, 'GET', `/webhooks/${webhook.id}`);
    ...
    async webhook() {
        const isSignatureValid = await BoxTriggerHelpers_1.verifySignature.call(this);
        if (!isSignatureValid) {
