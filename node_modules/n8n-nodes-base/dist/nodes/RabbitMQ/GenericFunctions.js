...
async function rabbitmqConnect(credentials) {
    ...
    if (credentials.ssl) {
        ...
        optsData.ca = credentials.ca === '' ? undefined : [Buffer.from((0, format_pem_block_1.formatPemBlock)(credentials.ca))];
        if (credentials.passwordless) {
            optsData.cert =
                credentials.cert === '' ? undefined : Buffer.from((0, format_pem_block_1.formatPemBlock)(credentials.cert));
            optsData.key =
                credentials.key === '' ? undefined : Buffer.from((0, format_pem_block_1.formatPemBlock)(credentials.key));
