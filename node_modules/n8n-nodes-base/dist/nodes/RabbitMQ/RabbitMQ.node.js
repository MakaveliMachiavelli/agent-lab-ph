    ...
    methods = {
        credentialTest: {
            async rabbitmqConnectionTest(credential) {
                try {
                    const connection = await (0, GenericFunctions_1.rabbitmqConnect)(credential.data);
            ...
            if (mode === 'queue') {
                ...
                for (let i = 0; i < items.length; i++) {
                    ...
                    queuePromises.push(channel.sendToQueue(queue, Buffer.from(message), {
                        headers,
                        ...(0, GenericFunctions_1.parsePublishArguments)(options),
                    }));
                }
                ...
                const options = this.getNodeParameter('options', 0, {});
                channel = await GenericFunctions_1.rabbitmqConnectExchange.call(this, exchange, options);
                const sendInputData = this.getNodeParameter('sendInputData', 0);
                let message;
