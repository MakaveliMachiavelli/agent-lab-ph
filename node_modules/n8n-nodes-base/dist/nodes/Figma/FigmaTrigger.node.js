...
const FigmaTriggerHelpers_1 = require("./FigmaTriggerHelpers");
...
class FigmaTrigger {
    ...
    webhookMethods = {
        default: {
            ...
            async create() {
                ...
                const passcode = (0, crypto_1.randomBytes)(32).toString('hex');
                const body = {
    ...
    async webhook() {
        if (!FigmaTriggerHelpers_1.verifySignature.call(this)) {
