...
exports.parseAnalyzers = parseAnalyzers;
        ...
        if (optionals[key] !== undefined && optionals[key] !== null && optionals[key] !== '') {
            if (['customFieldsJson', 'customFieldsUi'].indexOf(key) > -1) {
                ...
                try {
                    ...
                    throw new n8n_workflow_1.UserError('Invalid JSON for artifacts', { level: 'warning' });
                }
            }
            else if (key === 'tags') {
    ...
    if (jsonParameters) {
        ...
        if (typeof customFieldsJson === 'string') {
            try {
                ...
                throw new n8n_workflow_1.UserError('Invalid JSON for customFields', { level: 'warning' });
            }
        }
        if (typeof customFieldsJson === 'object') {
            ...
            throw new n8n_workflow_1.UserError('customFieldsJson value is invalid', { level: 'warning' });
        }
    }
