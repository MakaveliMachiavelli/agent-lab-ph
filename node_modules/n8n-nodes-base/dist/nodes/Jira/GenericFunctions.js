...
exports.OAUTH2_SUPPORTED_WEBHOOK_EVENTS = exports.OAUTH2_WEBHOOK_EXPIRY_BUFFER_MS = exports.OAUTH2_WEBHOOK_REFRESH_INTERVAL_MS = exports.allEvents = void 0;
...
exports.refreshJiraWebhook = refreshJiraWebhook;
const n8n_workflow_1 = require("n8n-workflow");
// Module-level cache: normalised domain → cloudId (persists for the life of the n8n process)
const _cloudIdCache = new Map();
async function getCloudId(credentialType, domain) {
    const normalizedDomain = domain.replace(/\/$/, '');
    if (_cloudIdCache.has(normalizedDomain))
        return _cloudIdCache.get(normalizedDomain);
    ...
    if (!site) {
        throw new n8n_workflow_1.NodeOperationError(this.getNode(), `No accessible Jira site found for domain: ${domain}. Make sure the domain matches your Atlassian site URL exactly.`);
    }
...
exports.OAUTH2_WEBHOOK_REFRESH_INTERVAL_MS = 20 * 24 * 60 * 60 * 1000; // 20 days
exports.OAUTH2_WEBHOOK_EXPIRY_BUFFER_MS = 7 * 24 * 60 * 60 * 1000; // 7 days
...
exports.OAUTH2_SUPPORTED_WEBHOOK_EVENTS = new Set([
    'comment_created',
    'comment_updated',
    'comment_deleted',
    'issue_property_set',
...
async function refreshJiraWebhook(endpoint, webhookId) {
