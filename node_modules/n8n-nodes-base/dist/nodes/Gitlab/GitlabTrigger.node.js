...
const GitlabTriggerHelpers_1 = require("./GitlabTriggerHelpers");
const GITLAB_EVENTS = [
    {
        name: 'Comment',
        value: 'note',
...
class GitlabTrigger {
    ...
    webhookMethods = {
        default: {
            ...
            async create() {
                ...
                const webhookSecret = (0, GitlabTriggerHelpers_1.generateWebhookSecret)();
                const body = {
                    url: webhookUrl,
                    ...events,
    ...
    async webhook() {
        if (!GitlabTriggerHelpers_1.verifySignature.call(this)) {
