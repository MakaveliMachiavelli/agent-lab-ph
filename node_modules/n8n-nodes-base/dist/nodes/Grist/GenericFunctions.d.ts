...
import type { GristCredentials, GristDefinedFields, GristFilterProperties, GristSortProperties } from './types';
export declare function gristBaseUrl(credentials: GristCredentials): string;
