        ...
        for (let i = 0; i < length; i++) {
            ...
            if (resource === 'report') {
                if (operation === 'download') {
                    ...
                    let reportUrl;
                    try {
                        reportUrl = (0, GenericFunctions_1.resolveReportDownloadUrl)(reportUrlInput);
                    }
                    catch (error) {
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), error instanceof Error ? error.message : 'Invalid report URL', { itemIndex: i });
                    }
