            ...
            try {
                if (operation === 'sign') {
                    ...
                    if (credentials.keyType === 'passphrase') {
                        ...
                        secretOrPrivateKey = (0, format_pem_block_1.formatPemBlock)(credentials.privateKey);
                    }
                    ...
                    const headerClaims = (0, utils_1.parseJsonParameter)(this.getNodeParameter('headerClaims', itemIndex, {}), this.getNode(), itemIndex);
                ...
                if (operation === 'verify') {
                    ...
                    if (credentials.keyType === 'passphrase') {
                        ...
                        secretOrPublicKey = (0, format_pem_block_1.formatPemBlock)(credentials.publicKey, true);
                    }
