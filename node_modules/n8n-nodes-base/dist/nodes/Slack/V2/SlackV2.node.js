...
const SlackHitlWebhook_1 = require("./SlackHitlWebhook");
...
class SlackV2 {
        ...
        this.description = {
            ...
            properties: [
                ...
                ...(0, utils_1.getSendAndWaitProperties)([
                    { ...MessageDescription_1.sendToSelector, default: 'user', displayOptions: { show: {} } },
                    {
                    ...
                    MessageDescription_1.advancedInteractivityNotice,
                    MessageDescription_1.captureResponderField,
                    MessageDescription_1.approversField,
                    MessageDescription_1.unauthorizedReplyField,
                    MessageDescription_1.postDecisionBehaviorField,
                ], { extraOptions: [MessageDescription_1.replyToMessageField] }).filter((p) => p.name !== 'subject'),
    ...
    methods = {
        listSearch: {
            ...
            async getUsers(filter, paginationToken) {
                ...
                const { data: users, cursor } = await (0, GenericFunctions_1.slackApiRequestAllItemsWithRateLimit)(this, 'members', 'GET', '/users.list', {}, qs, {
                    onFail: 'stop',
                    maxRetries: 2,
                    fallbackDelay: 30_000,
                });
                const results = users
                    .map((c) => ({
                    name: (0, GenericFunctions_1.formatUserLabel)(c),
                    value: c.id,
                }))
        ...
        loadOptions: {
            ...
            async getUsers() {
                const returnData = [];
                const { data: users } = await (0, GenericFunctions_1.slackApiRequestAllItemsWithRateLimit)(this, 'members', 'GET', '/users.list', {}, { limit: 200 }, { onFail: 'stop' });
                for (const user of users) {
                    const userName = (0, GenericFunctions_1.formatUserLabel)(user);
    ...
    webhook = SlackHitlWebhook_1.slackSendAndWaitWebhook;
    async execute() {
            ...
            try {
                ...
                if (resource === 'channel') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        if (filters.types) {
                            qs.types = (0, GenericFunctions_1.toMultiOptionsCsv)(filters.types);
                        }
                    ...
                    if (operation === 'invite') {
                        const channel = this.getNodeParameter('channelId', i, {}, { extractValue: true });
                        const userIds = (0, GenericFunctions_1.toMultiOptionsCsv)(this.getNodeParameter('userIds', i));
                        const body = {
                            channel,
                            users: userIds,
                        };
                    ...
                    if (operation === 'open') {
                        ...
                        if (options.users) {
                            body.users = (0, GenericFunctions_1.toMultiOptionsCsv)(options.users);
                        }
                ...
                if (resource === 'message') {
                    ...
                    if (operation === 'schedule') {
                        ...
                        delete otherOptions.botProfile;
                        Object.assign(body, otherOptions);
                        responseData = await GenericFunctions_1.slackApiRequest.call(this, 'POST', '/chat.scheduleMessage', body, qs);
                    }
                    ...
                    if (operation === 'deleteScheduled') {
                        ...
                        responseData = await GenericFunctions_1.slackApiRequest.call(this, 'POST', '/chat.deleteScheduledMessage', body, qs);
                    }
                    ...
                    if (operation === 'getManyScheduled') {
                        ...
                        if (returnAll) {
                            responseData = await GenericFunctions_1.slackApiRequestAllItems.call(this, 'scheduled_messages', 'GET', '/chat.scheduledMessages.list', {}, qs);
                        }
                        else {
                            qs.limit = this.getNodeParameter('limit', i);
                            responseData = await GenericFunctions_1.slackApiRequest.call(this, 'GET', '/chat.scheduledMessages.list', {}, qs);
                    ...
                    if (operation === 'search') {
                        ...
                        if (nodeVersion >= 2.7) {
                            ...
                            for (const channel of (0, GenericFunctions_1.toMultiOptionsCsv)(options.searchChannel)
                                .split(',')
                                .filter(Boolean)) {
                                query += ` in:${channel}`;
                            }
                            ...
                            const channelTypes = (0, GenericFunctions_1.toMultiOptionsCsv)(options.channelTypes);
                            if (channelTypes) {
                                body.channel_types = channelTypes.split(',');
                            }
                            const timezone = this.getTimezone();
                            if (options.after) {
                                body.after = moment_timezone_1.default.tz(options.after, timezone).unix();
                            }
                            if (options.before) {
                                body.before = moment_timezone_1.default.tz(options.before, timezone).unix();
                            }
                            ...
                            responseData = await GenericFunctions_1.searchContextItems.call(this, body, this.getNodeParameter('limit', i));
                        }
                        else {
                ...
                if (resource === 'file') {
                    ...
                    if (operation === 'upload') {
                        ...
                        if (options.channelIds) {
                            body.channels = (0, GenericFunctions_1.toMultiOptionsCsv)(options.channelIds);
                        }
                        if (options.channelId) {
                ...
                if (resource === 'user') {
                    ...
                    if (operation === 'lookupByEmail') {
                        ...
                        responseData = await GenericFunctions_1.slackApiRequest.call(this, 'GET', '/users.lookupByEmail', {}, qs);
                        responseData = responseData.user;
                    }
