...
exports.messageFields = exports.replyToMessageField = exports.postDecisionBehaviorField = exports.unauthorizedReplyField = exports.approversField = exports.captureResponderField = exports.advancedInteractivityNotice = exports.userRLC = exports.channelRLC = exports.sendToSelector = exports.messageOperations = void 0;
...
exports.advancedInteractivityNotice = {
...
exports.captureResponderField = {
    ...
    description: 'Whether to return the responder\'s identity with the Slack response. Requires additional setup on the Slack app — <a href="https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.slack/approvals#id-1.-create-a-slack-app-and-credential" target="_blank">see docs</a>.',
};
exports.approversField = {
    ...
    description: 'Restrict who can approve or decline: a click from anyone not listed is ignored and they get a private notice. Leave empty to let anyone respond. Choose from the list, or specify IDs using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
};
exports.unauthorizedReplyField = {
    ...
    description: 'Private (ephemeral) message shown to someone who clicks a button but is not in the approver list',
};
exports.postDecisionBehaviorField = {
...
exports.messageFields = [
    ...
    },
    {
        ...
        description: 'When the message should be sent. Must be in the future and within 120 days from now.',
    },
    {
        displayName: 'Options',
        name: 'otherOptions',
        ...
        options: [
            ...
            },
            {
                ...
                ...botProfileField,
                description: 'Set an image or an emoji as the Profile Photo (avatar) of the bot sending the message. Will not be used if sending message as a user. Add chat:write.customize scope on Slack API',
                displayOptions: {
                    show: {
    ...
    {
        displayName: 'Searches are rate limited by Slack. <a target="_blank" href="https://docs.slack.dev/reference/methods/assistant.search.context#rate-limiting">Check the Slack docs for the current limits</a>.',
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                type: 'boolean',
                default: false,
                description: 'Whether to match keywords only. By default Slack also returns semantically similar messages.',
                displayOptions: {
                    show: {
                        '@version': [{ _cnd: { gte: 2.7 } }],
                    },
