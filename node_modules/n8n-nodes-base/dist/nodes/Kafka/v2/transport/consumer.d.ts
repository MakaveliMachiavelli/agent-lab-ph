...
import { type FatalErrorHandler } from './LibraryLogger';
 ...
 */
export declare function createKafkaConsumer(credentials: KafkaCredentials, options: KafkaConsumerOptions, logging?: KafkaConsumerLogging): Promise<KafkaJS.Consumer>;
