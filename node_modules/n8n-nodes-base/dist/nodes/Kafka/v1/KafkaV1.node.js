            ...
            async kafkaConnectionTest(credential) {
                ...
                try {
                    ...
                    const config = {
                        clientId,
                        brokers,
                        ssl: (0, utils_1.resolveKafkaSsl)(credentials),
                    };
    ...
    async execute() {
        ...
        try {
            ...
            if (useSchemaRegistry) {
                const registry = await (0, utils_1.createSchemaRegistry)(this, this.getNodeParameter('schemaRegistryUrl', 0));
                try {
            ...
            for (let i = 0; i < length; i++) {
                ...
                if (schemaRegistry) {
                    ...
                    try {
                        ...
                        throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Message is not valid JSON', {
