...
class KafkaTriggerV1 {
    ...
    async trigger() {
        ...
        const dataEmitter = (0, utils_1.configureDataEmitter)(this, options, nodeVersion, closeSignal);
                ...
                await consumer.run({
                    ...
                    eachBatch: async ({ batch, resolveOffset, heartbeat, isStale, isRunning, commitOffsetsIfNecessary, }) => {
                        ...
                        if (closeSignal.aborted) {
                            throw Object.assign(new n8n_workflow_1.UnexpectedError('Kafka trigger consumer received messages after close'), { retriable: false });
                        }
        ...
        const handleConsumerError = (error) => {
            ...
            if (!closeSignal.aborted) {
                this.emitError((0, utils_1.toUserFacingConsumerError)(this.getNode(), error));
            }
        };
        const listeners = (0, utils_1.connectEventListeners)(consumer, this.logger, handleConsumerError);
        const closeFunction = async () => {
            // Unblock any eachBatch waiting on an in-flight execution.
            closeController.abort();
            (0, utils_1.disconnectEventListeners)(listeners);
            const teardownError = await (0, utils_1.stopAndDisconnectConsumer)(consumer, this.logger, CLOSE_TIMEOUT_MS);
            if (teardownError) {
...
exports.KafkaTriggerV1 = KafkaTriggerV1;
