...
async function createPool(credentials, options) {
    ...
    if (credentials.ssl) {
        ...
        if (credentials.caCertificate) {
            connectionOptions.ssl.ca = (0, format_pem_block_1.formatPemBlock)(credentials.caCertificate);
        }
        if (credentials.clientCertificate || credentials.clientPrivateKey) {
            connectionOptions.ssl.cert = (0, format_pem_block_1.formatPemBlock)(credentials.clientCertificate);
            connectionOptions.ssl.key = (0, format_pem_block_1.formatPemBlock)(credentials.clientPrivateKey);
        }
    }
