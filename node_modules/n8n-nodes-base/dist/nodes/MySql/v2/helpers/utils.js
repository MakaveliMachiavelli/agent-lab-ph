...
exports.getWhereClauses = exports.isWhereClause = exports.splitQueryToStatements = exports.prepareQueryLegacy = exports.prepareQueryAndReplacements = exports.prepareSafeQuery = void 0;
...
const prepareSafeQuery = (rawQuery, replacements) => {
...
exports.prepareSafeQuery = prepareSafeQuery;
const prepareQueryAndReplacements = (rawQuery, nodeVersion, replacements) => {
    if (replacements === undefined) {
        return { query: rawQuery, values: [] };
    }
    if (nodeVersion >= 2.5) {
        return (0, exports.prepareSafeQuery)(rawQuery, replacements);
    }
