...
const templated_auth_1 = require("../../../utils/templated-auth");
...
const error_details_1 = require("./utils/error-details");
            ...
            try {
                ...
                if (authentication === 'genericCredentialType') {
                    ...
                    if (genericCredentialType === 'httpBasicAuth') {
                        ...
                        allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), httpTemplatedCustomAuth);
                    }
                    else if (genericCredentialType === 'oAuth1Api') {
                        oAuth1Api = await this.getCredentials('oAuth1Api', itemIndex);
                        allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), oAuth1Api);
                    }
                    else if (genericCredentialType === 'oAuth2Api') {
                        oAuth2Api = await this.getCredentials('oAuth2Api', itemIndex);
                        allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), oAuth2Api);
                    }
                }
                    ...
                    if (nodeCredentialData) {
                        allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), nodeCredentialData);
                    }
                }
                ...
                url = url.trim();
                if (!url) {
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'URL parameter cannot be empty');
                }
                ...
                if (itemIndex > 0 && batchSize >= 0 && batchInterval > 0) {
                    if (itemIndex % batchSize === 0) {
                        await (0, sleep_1.sleep)(batchInterval);
                    }
                }
                ...
                if (httpTemplatedCustomAuth !== undefined) {
                    const templatedAuth = (0, templated_auth_1.applyTemplatedAuth)(httpTemplatedCustomAuth, requestOptions);
                ...
                if (pagination && pagination.paginationMode !== 'off') {
                    ...
                    if (pagination.paginationMode === 'updateAParameterInEachRequest') {
                        ...
                        pagination.parameters.parameters.forEach((parameter, index) => {
                            ...
                            if (!isPaginationRequestType(parameter.type)) {
                                throw new n8n_workflow_1.NodeOperationError(this.getNode(), `Parameter type must be one of: body, headers, qs for parameter [${index + 1}] in pagination settings`);
                            }
                            ...
                            (0, n8n_workflow_1.setSafeObjectProperty)(paginationData.request[parameter.type], parameterName, parameterValue);
                        });
                    }
                    ...
                    const sanitizedRequest = (0, GenericFunctions_1.sanitizeUiMessage)(requestOptions, authDataKeys);
        ...
        const promisesResponses = await Promise.allSettled(requestPromises.map(async (requestPromise, itemIndex) => await requestPromise
            ...
            try {
                ...
                if (credentialType) {
                    ...
                    secrets = (0, GenericFunctions_1.getSecrets)(credentials);
                }
            ...
            try {
                    ...
                    if (!this.continueOnFail()) {
                        ...
                        returnItems.push({
                            json: {
                                ...
                                ...(nodeVersion >= 4.5
                                    ? {
                                        details: (0, error_details_1.createErrorDetails)(this.getNode(), responseData.reason, itemIndex),
                                    }
                                    : {}),
                            },
                            pairedItem: {
                ...
                for (let [index, response] of Object.entries(responses)) {
                        ...
                        if (responseContentType.includes('application/json')) {
                            ...
                            if (!response.__bodyResolved) {
                                ...
                                response.body = isEmptyResponseBody(data)
                                    ? {}
                                    : (0, n8n_workflow_1.jsonParse)(data, {
                                        ...(neverError
                                            ? { fallbackValue: {} }
                    ...
                    if (responseFormat === 'file') {
                        ...
                        preparedBinaryData.fileName = (0, binaryData_1.setFilename)(preparedBinaryData, 
