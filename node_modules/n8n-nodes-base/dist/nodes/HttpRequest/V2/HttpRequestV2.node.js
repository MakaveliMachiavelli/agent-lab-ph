...
class HttpRequestV2 {
    ...
    async execute() {
        ...
        for (const credential of [
            ...
            if (credential) {
                allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), credential);
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (nodeCredentialType) {
                ...
                if (credentialData) {
                    allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), credentialData);
                    secrets = (0, GenericFunctions_1.getSecrets)(credentialData);
                }
            }
            if (itemIndex > 0 &&
                options.batchSize >= 0 &&
