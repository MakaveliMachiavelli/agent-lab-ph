...
class HttpRequestV1 {
    ...
    async execute() {
        ...
        for (const credential of [
            ...
            if (credential) {
                secrets.push(...(0, GenericFunctions_1.getSecrets)(credential));
            }
        }
        let requestOptions;
        let setUiParameter;
        ...
        for (let itemIndex = 0; itemIndex < items.length; itemIndex++) {
            ...
            if (itemIndex > 0 &&
                ...
                if (itemIndex % batchSize === 0) {
                    await (0, sleep_1.sleep)(options.batchInterval);
                }
            }
            ...
            if (httpBasicAuth !== undefined) {
                ...
                requestOptions.allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), httpBasicAuth);
            }
                ...
                requestOptions.allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), httpHeaderAuth);
            }
                ...
                requestOptions.allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), httpQueryAuth);
            }
                ...
                authDataKeys.auth = ['pass'];
                requestOptions.allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), httpDigestAuth);
            }
            else {
            ...
            try {
                this.sendMessageToUI((0, GenericFunctions_1.sanitizeUiMessage)(requestOptions, authDataKeys, secrets));
            }
            catch (e) { }
            if (!nonOauthCredentialUsed && oAuth1Api) {
                requestOptions.allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), oAuth1Api);
                ...
                requestOptions.allowedDomains = (0, GenericFunctions_1.getAllowedDomains)(this.getNode(), oAuth2Api);
