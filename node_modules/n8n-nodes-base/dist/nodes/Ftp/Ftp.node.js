                ...
                try {
                    if (credentials.privateKey) {
                        await sftp.connect({
                            ...
                            privateKey: (0, format_pem_block_1.formatPemBlock)(credentials.privateKey),
                ...
                try {
                    ...
                    if (protocol === 'sftp') {
                        if (operation === 'list') {
                            ...
                            const executionData = this.helpers.constructExecutionMetaData(this.helpers.returnJsonArray(serializeDates ? json.map((item) => (0, n8n_workflow_1.deepCopy)(item)) : json), { itemData: { item: i } });
