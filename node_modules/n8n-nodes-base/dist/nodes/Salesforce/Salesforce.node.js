...
async function searchOwners(queueSobjectType, filter, paginationToken) {
    ...
    if (queueSobjectType && !paginationToken) {
        ...
        const queueRecords = (await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, {
    ...
    if (paginationToken) {
        ...
        userResponse = (await GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/query/${locator}`));
    }
    else {
        const escapedFilter = filter ? (0, GenericFunctions_1.escapeSoqlString)(filter) : '';
        ...
        userResponse = (await GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/query', {}, { q: `SELECT Id, Name FROM User ${whereClause}ORDER BY Name` }, undefined, { headers: { 'Sforce-Query-Options': `batchSize=${USER_SEARCH_PAGE_SIZE}` } }));
    }
    ...
    methods = {
        loadOptions: {
            ...
            async getRecordTypes() {
                ...
                resource = (0, GenericFunctions_1.escapeSoqlString)(resource);
                const qs = {
        ...
        listSearch: {
            async searchAccounts(filter, paginationToken) {
                ...
                if (paginationToken) {
                    ...
                    const locator = paginationToken.split('/').pop();
                    response = (await GenericFunctions_1.salesforceApiRequest.call(this, 'GET', `/query/${locator}`));
                }
                else {
                    const escapedFilter = filter ? (0, GenericFunctions_1.escapeSoqlString)(filter) : '';
                    const whereClause = escapedFilter ? `WHERE Name LIKE '%${escapedFilter}%' ` : '';
                    ...
                    response = (await GenericFunctions_1.salesforceApiRequest.call(this, 'GET', '/query', {}, qs, undefined, {
            ...
            try {
                if (resource === 'lead') {
                    ...
                    if (operation === 'create' || operation === 'upsert') {
                        ...
                        {
                            const owner = (0, GenericFunctions_1.getResourceLocatorValue)(additionalFields.owner);
                            if (owner !== undefined) {
                                body.OwnerId = owner;
                            }
                        }
                    ...
                    if (operation === 'update') {
                        ...
                        {
                            const owner = (0, GenericFunctions_1.getResourceLocatorValue)(updateFields.owner);
                            if (owner !== undefined) {
                                body.OwnerId = owner;
                            }
                        }
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Lead', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Lead', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                    ...
                    if (operation === 'addNote') {
                        ...
                        {
                            const owner = (0, GenericFunctions_1.getResourceLocatorValue)(options.owner);
                            if (owner !== undefined) {
                                body.OwnerId = owner;
                            }
                        }
                ...
                if (resource === 'contact') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Contact', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Contact', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'customObject') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, customObject, returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, customObject, returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'document') {
                    ...
                    if (operation === 'upload') {
                        ...
                        {
                            const ownerId = (0, GenericFunctions_1.getResourceLocatorValue)(additionalFields.ownerId);
                ...
                if (resource === 'opportunity') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Opportunity', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Opportunity', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'account') {
                    ...
                    if (operation === 'update') {
                        ...
                        {
                            const ownerId = (0, GenericFunctions_1.getResourceLocatorValue)(updateFields.ownerId);
                            if (ownerId !== undefined) {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Account', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Account', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                    ...
                    if (operation === 'addNote') {
                        ...
                        {
                            const ownerId = (0, GenericFunctions_1.getResourceLocatorValue)(options.ownerId);
                            if (ownerId !== undefined) {
                                body.OwnerId = ownerId;
                            }
                        }
                ...
                if (resource === 'case') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Case', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Case', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'task') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Task', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Task', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'attachment') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Attachment', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'Attachment', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
                ...
                if (resource === 'user') {
                    ...
                    if (operation === 'getAll') {
                        ...
                        try {
                            if (returnAll) {
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'User', returnAll, 0, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                            else {
                                const limit = this.getNodeParameter('limit', i);
                                qs.q = (0, GenericFunctions_1.getQuery)(options, 'User', returnAll, limit, nodeVersion);
                                responseData = await GenericFunctions_1.salesforceApiRequestAllItems.call(this, 'records', 'GET', '/query', {}, qs);
                            }
                        }
                        catch (error) {
