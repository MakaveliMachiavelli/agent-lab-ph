...
class SalesforceTrigger {
    ...
    async poll() {
        ...
        try {
            ...
            try {
                if (this.getMode() === 'manual') {
                    qs.q = (0, GenericFunctions_1.getQuery)(options, triggerResource, false, 1, nodeVersion);
                }
                else {
                    qs.q = (0, GenericFunctions_1.getQuery)(options, triggerResource, true, 0, nodeVersion);
                }
            ...
            const { newItems, updatedProcessedIds } = (0, GenericFunctions_1.filterAndManageProcessedItems)(responseData, processedIds, changeType === 'Created' ? 'Created' : 'Updated');
