...
async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            body.done = (0, helpers_1.coerceToBoolean)(this.getNodeParameter('done', i));
            ...
            if (body.due_date) {
                body.due_date = (0, helpers_1.toDateOnly)(body.due_date);
            }
            if (customProperties) {
                (0, helpers_1.encodeCustomFieldsV2)(customProperties, body);
            }
            const responseData = await transport_1.pipedriveApiRequest.call(this, 'POST', '/activities', body);
