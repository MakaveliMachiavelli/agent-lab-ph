...
async function execute() {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            let responseData;
            if (returnAll) {
                responseData = await transport_1.pipedriveApiRequestAllItemsCursor.call(this, 'GET', '/activities', {}, qs);
            }
            else {
                responseData = await transport_1.pipedriveApiRequest.call(this, 'GET', '/activities', {}, qs);
            }
