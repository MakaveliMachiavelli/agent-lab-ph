            ...
            try {
                ...
                if (resource === 'file') {
                    ...
                    if (operation === 'create') {
                        ...
                        body.title = this.getNodeParameter('title', i);
                        body.body = this.getNodeParameter('body', i, '');
                        body.head = this.getNodeParameter('head', i); // owner:branch supported
                        body.base = this.getNodeParameter('base', i);
                        body.draft = this.getNodeParameter('draft', i, false);
                        ...
                        if (editFields.title !== undefined)
                            body.title = editFields.title;
                        if (editFields.body !== undefined)
                            body.body = editFields.body;
                        if (editFields.state !== undefined)
                            body.state = editFields.state;
                        if (editFields.base !== undefined)
                            body.base = editFields.base;
                        ...
                        const responseText = await GenericFunctions_1.githubApiRequest.call(this, 'GET', `/repos/${owner}/${repository}/pulls/${pullRequestNumber}`, {}, {}, options);
                        ...
                        requestMethod = 'PUT';
                        const pullRequestNumber = this.getNodeParameter('pullRequestNumber', i);
                        const mergeMethod = this.getNodeParameter('mergeMethod', i, 'merge');
                        const commitTitle = this.getNodeParameter('commitTitle', i, '').trim();
                        const commitMessage = this.getNodeParameter('commitMessage', i, '').trim();
