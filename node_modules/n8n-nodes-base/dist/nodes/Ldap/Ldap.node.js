            ...
            try {
                if (operation === 'compare') {
                    ...
                    if (searchFor === 'custom') {
                        ...
                        const resolvables = (0, utilities_1.getResolvables)(searchText);
                        for (const resolvable of resolvables) {
                            const resolvedValue = (0, Helpers_1.escapeValue)(String(this.evaluateExpression(`${resolvable}`, itemIndex)));
                            searchText = searchText.replace(resolvable, resolvedValue);
                        }
                        const attribute = (0, Helpers_1.escapeValue)(this.getNodeParameter('attribute', itemIndex));
