 ...
 */
export declare const adjustProductDetailsOnUpdate: (allFields: AllFields) => {
    product: {
        id: string;
    };
    quantity: number;
}[] | AllFields;
declare const adjustCustomFields: (allFields: AllFields) => {
    [key: string]: IDataObject[] | import("n8n-workflow").GenericValue[] | IDataObject | import("n8n-workflow").GenericValue;
    Account?: {
        subfields: {
            id: string;
            name: string;
...
export declare const adjustProductPayload: typeof adjustCustomFields;
/**
