...
exports.runQueriesAndHandleErrors = exports.getWhereClauses = exports.isWhereClause = exports.convertArraysToPostgresFormat = exports.configureTableSchemaUpdater = exports.isSelectQuery = void 0;
...
const isEStringPrefix = (query, quoteIndex) => {
    if (quoteIndex === 0)
        return false;
...
const stripStringsAndComments = (query) => {
...
const splitStatements = (stripped) => stripped
    .split(';')
    .map((s) => s.trim())
    .filter((s) => s.length > 0);
...
const findTopLevelCommand = (statement) => {
            ...
            try {
                ...
                if (!returnData.length) {
                    ...
                    if (options?.nodeVersion < 2.3) {
                        ...
                        returnData = queries.every((query) => (0, exports.isSelectQuery)(query.query))
                            ? []
                    ...
                    try {
                        ...
                        if (!transactionResults.length) {
                            if (options?.nodeVersion < 2.3) {
                                ...
                                transactionResults = (0, exports.isSelectQuery)(query) ? [] : [{ success: true }];
                            }
                        }
