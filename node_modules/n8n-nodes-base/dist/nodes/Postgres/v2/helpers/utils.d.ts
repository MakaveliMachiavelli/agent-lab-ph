...
export declare const isSelectQuery: (query: string) => boolean;
export declare function configureQueryRunner(this: IExecuteFunctions, node: INode, continueOnFail: boolean, pgp: PgpClient, db: PgpDatabase): QueriesRunner;
