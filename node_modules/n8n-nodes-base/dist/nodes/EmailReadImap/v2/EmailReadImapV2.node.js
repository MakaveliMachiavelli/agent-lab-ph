                ...
                onMail: async (numEmails) => {
                    ...
                    if (connection) {
                        ...
                        if (staticData.lastMessageUid !== undefined) {
                             ...
                             */
                            currentSearchCriteria.push(['UID', `${staticData.lastMessageUid}:*`]);
                        }
            ...
            return await (0, imap_1.connect)(config).then((conn) => {
                ...
                conn.on('close', (_hadError) => {
                    if (isCurrentlyReconnecting) {
                        ...
                        this.emitError(new n8n_workflow_1.NodeOperationError(this.getNode(), 'IMAP connection closed unexpectedly', {
                ...
                conn.on('error', (error) => {
                    const errorCode = error.code?.toUpperCase() ?? 'UNKNOWN';
