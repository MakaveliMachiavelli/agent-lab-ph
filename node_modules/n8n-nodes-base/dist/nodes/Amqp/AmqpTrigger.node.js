...
class AmqpTrigger {
    ...
    async trigger() {
        ...
        const processMessage = async (context) => {
            ...
            inFlightMessages++;
            try {
                return await handleMessage_1.handleMessage.call(this, context, {
        ...
        const manualTriggerFunction = async () => {
            await new Promise((resolve, reject) => {
                ...
                const timeoutHandler = setTimeout(() => {
                    ...
                    container.removeAllListeners('message');
                    connection.close();
                    reject(new n8n_workflow_1.NodeOperationError(this.getNode(), 'Aborted because no message was received within 15 seconds', {
