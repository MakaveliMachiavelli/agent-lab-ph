...
exports.SlackOAuth2Api = exports.userScopes = void 0;
...
class SlackOAuth2Api {
    ...
    properties = [
        ...
        },
        {
            ...
            default: exports.userScopes.join(' '),
        ...
        //https://api.slack.com/scopes
        {
            ...
            type: 'hidden',
            default: `={{$self["customScopes"] ? "user_scope=" + $self["userScope"] : "user_scope=${exports.userScopes.join(' ')}"}}`,
        },
        {
