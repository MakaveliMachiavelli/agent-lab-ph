...
class AwsAssumeRole {
    ...
    properties = [
        descriptions_1.awsRegionProperty,
        {
            ...
            description: 'Use system credentials (environment variables, container role, etc.) to call STS.AssumeRole. Access to AWS system credentials is disabled by default and must be explicitly enabled. See <a href="https://docs.n8n.io/integrations/builtin/credentials/aws/">documentation</a> for more information.',
            type: 'boolean',
            default: false,
            displayOptions: {
    ...
    async authenticate(decryptedCredentials, requestOptions) {
        ...
        try {
            ...
            throw new n8n_workflow_1.UserError(`Failed to assume role: ${error instanceof Error ? error.message : 'Unknown error'}`);
        }
        ...
        return await (0, utils_1.signOptions)(requestOptions, signOpts, securityHeaders, url, method);
    }
