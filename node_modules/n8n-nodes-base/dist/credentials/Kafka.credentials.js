...
class Kafka {
    ...
    properties = [
        ...
        },
        {
            ...
            description: 'PEM-encoded CA certificate(s) used to verify the broker. Leave empty to use the system CAs.',
        },
        {
            ...
            description: 'PEM-encoded client certificate for mutual TLS (mTLS). Provide together with the client private key.',
        },
        {
            ...
            description: 'PEM-encoded client private key for mutual TLS (mTLS). Provide together with the client certificate.',
        },
        {
            ...
            description: 'Whether to connect even when SSL certificate validation fails (e.g. a self-signed or hostname-mismatched broker certificate)',
        },
        {
