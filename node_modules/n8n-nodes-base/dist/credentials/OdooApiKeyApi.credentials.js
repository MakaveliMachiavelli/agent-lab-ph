...
class OdooApiKeyApi {
    ...
    test = {
        request: {
            ...
            method: 'POST',
            headers: {
                'X-Odoo-Database': '={{$credentials.db || $credentials.url.replace(/\\/$/, "").split(".")[0].split("//")[1]}}',
            },
            body: {
                domain: [],
                fields: ['id'],
...
exports.OdooApiKeyApi = OdooApiKeyApi;
//# sourceMappingURL=OdooApiKeyApi.credentials.js.map