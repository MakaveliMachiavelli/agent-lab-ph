...
`,r.type===`normal`){let e=s===``,t=o.trim()===``,n=o.trim().startsWith(`#`);(e&&t||e&&n)&&a()}}return a(),t}function E(e){return!e||e.status!==`waiting`?!1:e.content.some(e=>e.type===`with-buttons`&&e.blockUserInput)}function D(e,t){let n=[],r=[],i=0;for(let a of e)i+a.size>t&&r.length>0&&(n.push(r),r=[],i=0),r.push(a),i+=a.size;return r.length>0&&n.push(r),n}export{T as C,y as E,v as S,o as T,p as _,_ as a,w as b,g as c,i as d,n as f,S as g,C as h,b as i,a as l,h as m,D as n,x as o,r as p,d as r,s,f as t,l as u,m as v,c as w,E as x,u as y};
//# sourceMappingURL=chat.utils-BMoeN4kN.js.map