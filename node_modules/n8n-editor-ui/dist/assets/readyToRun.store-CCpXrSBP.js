(function(){try{var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{};e.SENTRY_RELEASE={id:`n8n@2.35.5`}}catch{}})();try{(function(){var e=typeof window<`u`?window:typeof global<`u`?global:typeof globalThis<`u`?globalThis:typeof self<`u`?self:{},t=new e.Error().stack;t&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[t]=`1d29551e-def6-4a65-ab48-b2ff9b438070`,e._sentryDebugIdIdentifier=`sentry-dbid-1d29551e-def6-4a65-ab48-b2ff9b438070`)})()}catch{}import{It as e,Nt as t,Pt as n,S as r,gt as i}from"./vue.runtime.esm-bundler-BWTWxblN.js";import{x as a}from"./_MapCache-eqkTVReK.js";import{y as o}from"./dist-CJDEkJ8I.js";import{_ as s,g as c}from"./htmlUtils-C2msaoWR.js";import{cn as l,t as u,xt as d}from"./workflows.store-lUYso6E4.js";import{dr as f}from"./useRootStore-Dhaz2bEl.js";import{t as p}from"./constants2-UYbnAUNK.js";import{Gi as m,ci as h}from"./src-2e7EPKm5.js";import{t as g}from"./settings.store-CA57ceNo.js";import{t as _}from"./users.store-Dw9ePnm-.js";import{t as v}from"./useTelemetry-DtwU5R7Z.js";import{t as y}from"./cloudPlan.store-DiQmSDZE.js";import{t as b}from"./posthog.store-Fxz62n-R.js";import{t as x}from"./views-ChNLOOFJ.js";import{n as S}from"./useToast-B_ifhbfM.js";import{Xa as C}from"./constants-D4Eg7jAB.js";import{t as w}from"./dataTable.store-CPkuK1Kq.js";import{t as T}from"./folders.store-VNqO2YA9.js";import{n as E}from"./constants-BMKUnfeI.js";var D={name:`AI Agent workflow`,meta:{templateId:`ready-to-run-ai-workflow`},nodes:[{parameters:{url:`https://www.theverge.com/rss/index.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[128,448],id:`a26f16ce-82a5-4392-a032-622467e0098f`,name:`Get Tech News`},{parameters:{toolDescription:`Reads the news`,url:`=https://feeds.bbci.co.uk/news/world/rss.xml`,options:{}},type:`n8n-nodes-base.rssFeedReadTool`,typeVersion:1.2,position:[272,448],id:`91d1a929-b913-4399-977a-4306fe8349c7`,name:`Get World News`},{parameters:{model:{__rl:!0,mode:`list`,value:`gpt-5.6-luna`},responsesApiEnabled:!0,options:{}},type:`@n8n/n8n-nodes-langchain.lmChatOpenAi`,typeVersion:1.3,position:[-144,448],id:`482c5e90-74ea-424c-9ec3-1dc14dd460f9`,name:`OpenAI Model`,notesInFlow:!0,credentials:{},notes:`Free n8n credits `},{parameters:{promptType:`define`,text:`=Provide a summary of world and tech news from the last 24 hours. 
...
Today is {{ $today }}
`}},type:`@n8n/n8n-nodes-langchain.agent`,typeVersion:3,position:[192,64],id:`ce5dd204-b9d3-4455-ab0c-0c2ce314ad52`,name:`AI Agent`}],pinData:{},connections:{"When chat message received":{main:[[{node:`AI Agent`,type:`main`,index:0}]]},"OpenAI Model":{ai_languageModel:[[{node:`AI Agent`,type:`ai_languageModel`,index:0}]]},"Simple Memory":{ai_memory:[[{node:`AI Agent`,type:`ai_memory`,index:0}]]},Hackernews:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},TheVerge:{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"BBC News":{ai_tool:[[{node:`AI Agent`,type:`ai_tool`,index:0}]]},"Google Sheets":{ai_tool:[[]]}}},M=f(p.EXPERIMENT_READY_TO_RUN_WORKFLOWS_V2,()=>{let e=b(),t=y(),n=r(()=>e.getVariant(C.name)),i=r(()=>n.value===C.variant5),a=r(()=>n.value===C.variant6),o=r(()=>t.userIsTrialing&&(i.value||a.value));return{currentVariant:n,getWorkflowForVariant:()=>{if(o.value){if(i.value)return A;if(a.value)return j}},isFeatureEnabled:o}}),N=`N8N_READY_TO_RUN_OPENAI_CREDENTIAL_ID`,P=f(p.READY_TO_RUN,()=>{let n=[`ready-to-run-ai-workflow`,`ready-to-run-ai-workflow-v5`,`ready-to-run-ai-workflow-v6`],c=v(),l=a(),f=S(),p=s(),y=d(),b=_(),C=g(),w=u(),T=M(),E=o(N,``),O=e(!1),A=r(()=>!!y.allCredentials.filter(e=>e.type===m).length),j=r(()=>!!b.currentUser?.settings?.userClaimedAiCredits),P=336*60*60*1e3,F=e(Date.now()),I,L=()=>{I!==void 0&&(clearTimeout(I),I=void 0)},R=()=>{let e=b.currentUser?.createdAt;if(!e)return;let t=new Date(e).getTime();return Number.isFinite(t)?t:void 0},z=()=>{L();let e=R();if(e===void 0)return;let t=e+P-Date.now();t<=0||(I=setTimeout(()=>{F.value=Date.now(),I=void 0},t))};i(()=>b.currentUser?.createdAt,()=>{F.value=Date.now(),z()},{immediate:!0}),t(()=>{L()});let B=()=>{let e=R();return e===void 0?!1:F.value-e<P},V=r(()=>C.isAiCreditsEnabled&&!A.value&&!j.value),H=e=>{c.track(`User executed ready to run AI workflow`,{status:e})},U=()=>{c.track(`User executed ready to run AI workflow successfully`)},W=async e=>{O.value=!0;try{let t=await y.claimFreeAiCredits(e);return E.value=t.id,c.track(`User claimed OpenAI credits`),t}catch(e){throw f.showError(e,l.baseText(`freeAi.credits.showError.claim.title`),{message:l.baseText(`freeAi.credits.showError.claim.message`)}),e}finally{O.value=!1}},G=()=>T.getWorkflowForVariant()??D,K=async(e,t)=>{c.track(`User opened ready to run AI workflow`,{source:e});try{let e={...G(),parentFolderId:t},n=E.value;if(n&&e.nodes){let t=h(e),r=t.nodes?.find(e=>e.name===`OpenAI Model`);r&&(r.credentials??={},r.credentials[m]={id:n,name:``}),e=t}let r=await w.createNewWorkflow(e);return await p.push({name:x.WORKFLOW,params:{workflowId:r.id}}),r}catch(e){throw f.showError(e,l.baseText(`generic.error`)),e}},q=async(e,t,n)=>{await W(n),await K(e,t),b?.currentUser?.settings&&(b.currentUser.settings.userClaimedAiCredits=!0)},J=(e,t)=>V.value&&!t&&e,Y=(e,t,n)=>V.value&&!n&&t&&e&&B(),{isTrulyEmpty:X}=k();return{claimingCredits:O,userCanClaimOpenAiCredits:V,claimFreeAiCredits:W,createAndOpenAiWorkflow:K,claimCreditsAndOpenWorkflow:q,getCardVisibility:J,getButtonVisibility:Y,getSimplifiedLayoutVisibility:e=>X(e),trackExecuteAiWorkflow:H,trackExecuteAiWorkflowSuccess:U,isReadyToRunTemplateId:e=>!!e&&n.includes(e)}});export{D as a,O as i,A as n,k as r,P as t};
//# sourceMappingURL=readyToRun.store-CCpXrSBP.js.map