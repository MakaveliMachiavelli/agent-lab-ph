 ...
 * @internal
 */
export declare function validateFD(fd: number): void;
/**
 * Whether an error means the path does not resolve to an entry. Used for `throwIfNoEntry`.
 * @internal @hidden
 */
export declare function _isNoEntry(e: unknown): boolean;
/**
 ...
 * @internal @hidden
 */
export declare function _temporal(): typeof Temporal;
