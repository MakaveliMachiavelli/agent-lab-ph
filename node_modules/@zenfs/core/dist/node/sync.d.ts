...
export declare function statSync(this: V_Context, path: fs.PathLike, options?: fs.StatOptions & {
    bigint?: false;
    throwIfNoEntry?: true;
}): Stats;
export declare function statSync(this: V_Context, path: fs.PathLike, options: fs.StatOptions & {
...
export declare function statSync(this: V_Context, path: fs.PathLike, options?: fs.StatOptions): Stats | BigIntStats | undefined;
/**
 * Synchronous `lstat`.
 * `lstat()` is identical to `stat()`, except that if path is a symbolic link,
 * then the link itself is stat-ed, not the file that it refers to.
 */
export declare function lstatSync(this: V_Context, path: fs.PathLike, options?: fs.StatOptions & {
    bigint?: false;
    throwIfNoEntry?: true;
}): Stats;
export declare function lstatSync(this: V_Context, path: fs.PathLike, options: fs.StatOptions & {
...
export declare function lstatSync(this: V_Context, path: fs.PathLike, options?: fs.StatOptions): Stats | BigIntStats | undefined;
...
export declare function readSync(this: V_Context, fd: number, buffer: ArrayBufferView, options?: fs.ReadOptions): number;
 ...
 */
export declare function globSync(this: V_Context, pattern: string | readonly string[]): string[];
export declare function globSync(this: V_Context, pattern: string | readonly string[], options: fs.GlobOptionsWithFileTypes): Dirent[];
export declare function globSync(this: V_Context, pattern: string | readonly string[], options: fs.GlobOptionsWithoutFileTypes): string[];
export declare function globSync(this: V_Context, pattern: string | readonly string[], options: fs.GlobOptions): Dirent[] | string[];
