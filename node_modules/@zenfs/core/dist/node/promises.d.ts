...
export declare class FileHandle implements promises.FileHandle {
    ...
    pull(...args: [...transforms: Transform[], options: promises.PullOptions]): ByteReadableStream;
    /**
     * Return a `node:stream/iter` writer backed by this file handle.
     * @experimental
     */
    writer(options?: promises.WriterOptions): Writer;
}
...
export declare function stat(this: V_Context, path: fs.PathLike, options: fs.BigIntOptions & {
    throwIfNoEntry?: true;
}): Promise<BigIntStats>;
export declare function stat(this: V_Context, path: fs.PathLike, options?: fs.StatOptions & {
    bigint?: false;
    throwIfNoEntry?: true;
}): Promise<Stats>;
export declare function stat(this: V_Context, path: fs.PathLike, options: fs.StatOptions & {
...
export declare function stat(this: V_Context, path: fs.PathLike, options?: fs.StatOptions): Promise<Stats | BigIntStats | undefined>;
/**
 * `lstat`.
 ...
 */
export declare function appendFile(this: V_Context, path: fs.PathLike | promises.FileHandle, data: FileContents | Iterable<string | ArrayBufferView> | AsyncIterable<string | ArrayBufferView>, _options?: BufferEncoding | (fs.EncodingOption & {
    mode?: fs.Mode;
    flag?: fs.OpenMode;
}) | null): Promise<void>;
