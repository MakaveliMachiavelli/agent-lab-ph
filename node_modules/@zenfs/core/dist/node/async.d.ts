...
}, callback: Callback<[Stats | undefined]>): void;
export declare function stat(this: V_Context, path: fs.PathLike, options: {
    bigint: true;
    throwIfNoEntry: false;
}, callback: Callback<[BigIntStats | undefined]>): void;
export declare function stat(this: V_Context, path: fs.PathLike, options: fs.StatOptions, callback: Callback<[Stats | BigIntStats | undefined]>): void;
/**
 * Asynchronous `lstat`.
