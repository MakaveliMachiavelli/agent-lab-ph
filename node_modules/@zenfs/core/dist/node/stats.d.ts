...
export declare abstract class StatsCommon<T extends number | bigint> implements Node.StatsBase<T>, StatsLike {
    ...
    get atimeInstant(): Temporal.Instant;
    set atimeInstant(value: Temporal.Instant);
    /**
     * Time of last modification, since epoch
     */
    mtimeMs: T;
    ...
    get mtimeInstant(): Temporal.Instant;
    set mtimeInstant(value: Temporal.Instant);
    /**
     * Time of last time file status was changed, since epoch
     */
    ctimeMs: T;
    ...
    get ctimeInstant(): Temporal.Instant;
    set ctimeInstant(value: Temporal.Instant);
    /**
     * Time of file creation, since epoch
     */
    birthtimeMs: T;
    ...
    get birthtimeInstant(): Temporal.Instant;
    set birthtimeInstant(value: Temporal.Instant);
    /**
     * Size of the item in bytes.
     * For directories/symlinks, this is normally the size of the struct that represents the item.
     */
