import { AdapterPostableMessage, CardElement, FileUpload, Attachment, ButtonElement, TableElement } from 'chat';
...
declare function extractPostableAttachments(message: AdapterPostableMessage): Attachment[];
...
declare function replaceBareMentions(text: string, replacer: MentionReplacer): string;

export { AdapterError, AdapterRateLimitError, AuthenticationError, BUTTON_STYLE_MAPPINGS, type EncryptedTokenData, type FallbackTextOptions, type FileDataInput, type MentionReplacer, NetworkError, PermissionError, type PlatformName, ResourceNotFoundError, type ToBufferOptions, ValidationError, bufferToDataUri, cardToFallbackText, createEmojiConverter, decodeKey, decryptToken, encryptToken, escapeTableCell, extractCard, extractFiles, extractPostableAttachments, isEncryptedTokenData, mapButtonStyle, renderGfmTable, replaceBareMentions, toBuffer, toBufferSync };
