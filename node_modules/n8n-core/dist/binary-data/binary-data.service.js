...
const blob_manager_1 = require("./blob.manager");
...
let BinaryDataService = class BinaryDataService {
    ...
    async init() {
        ...
        const fsByteStore = new blob_storage_1.FsByteStore({
            storagePath: config.localStoragePath,
            reportError: (error) => this.errorReporter.error(error),
        });
        this.managers.filesystem = new blob_manager_1.BinaryDataBlobManager(fsByteStore, this.errorReporter);
...
exports.BinaryDataService = BinaryDataService = __decorate([
    (0, di_1.Service)(),
    __metadata("design:paramtypes", [binary_data_config_1.BinaryDataConfig, errors_1.ErrorReporter, backend_common_1.Logger])
], BinaryDataService);
