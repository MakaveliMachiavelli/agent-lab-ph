...
exports.BINARY_DATA_MODES = ['default', 'filesystem', 's3', 'azure', 'database'];
...
let BinaryDataConfig = class BinaryDataConfig {
    ...
    async initialize(repo) {
        ...
        if (winner)
            this.signingSecret = winner.value;
    }
};
...
exports.BinaryDataConfig = BinaryDataConfig = __decorate([
    config_1.Config,
    __metadata("design:paramtypes", [instance_settings_1.InstanceSettings, config_1.ExecutionsConfig, storage_config_1.StorageConfig])
], BinaryDataConfig);
