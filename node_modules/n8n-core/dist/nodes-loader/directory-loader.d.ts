...
import type { ICredentialType, ICredentialTypeData, INodeCredentialDescription, INodeType, INodeTypeData, INodeTypeDescription, INodeTypeNameVersion, IVersionedNodeType, KnownNodesAndCredentials, NodeLoader } from 'n8n-workflow';
export type Types = {
    nodes: INodeTypeDescription[];
    credentials: ICredentialType[];
};
export declare abstract class DirectoryLoader implements NodeLoader {
    ...
    private unloadAll;
    private getSymlinkedPackageRoots;
    private resolveSymlinkedRoots;
    private pushResolvedRoot;
}
