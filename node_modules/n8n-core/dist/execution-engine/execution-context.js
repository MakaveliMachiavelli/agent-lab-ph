...
const establishExecutionContext = async (workflow, runExecutionData, additionalData, mode) => {
    ...
    if (runExecutionData.parentExecution) {
        ...
        if (subExecutionStartItem) {
            executionData.runtimeData = await di_1.Container.get(execution_context_service_1.ExecutionContextService).augmentSubExecutionContext(workflow, subExecutionStartItem, executionData.runtimeData);
        }
        return;
    }
