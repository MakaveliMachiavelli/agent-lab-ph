...
class ExecuteContext extends base_execute_context_1.BaseExecuteContext {
    ...
    async getRuntimeCredential(alias) {
    ...
    logNodeOutput(...args) {
        ...
        if (process.env.CODE_ENABLE_STDOUT === 'true') {
            console.log(`[Workflow "${this.getWorkflow().id}"][Node "${this.node.name}"]`, ...this.redactedConsoleArgs(args));
        }
    }
    ...
    addInputData() {
        throw new n8n_workflow_1.UnexpectedError('addInputData should not be called on IExecuteFunctions');
    }
    addOutputData() {
        throw new n8n_workflow_1.UnexpectedError('addOutputData should not be called on IExecuteFunctions');
    }
