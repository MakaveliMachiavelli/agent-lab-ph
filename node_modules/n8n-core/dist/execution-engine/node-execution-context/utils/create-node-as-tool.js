...
function createTool(options) {
    ...
    const resolveToolDescription = context && typeof itemIndex === 'number'
        ? () => context.getNodeParameter('toolDescription', itemIndex, '')
        : undefined;
    const description = n8n_workflow_1.NodeHelpers.getToolDescriptionForNode(node, nodeType, resolveToolDescription);
