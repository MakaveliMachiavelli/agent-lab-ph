...
const throwOnEmit = () => {
    throw new n8n_workflow_1.UnexpectedError('Overwrite PollContext.__emit function');
};
const throwOnEmitError = () => {
    throw new n8n_workflow_1.UnexpectedError('Overwrite PollContext.__emitError function');
};
