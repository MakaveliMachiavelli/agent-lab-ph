...
const legacy_request_adapter_1 = require("./utils/request-helpers/legacy-request-adapter");
    ...
    constructor(additionalData) {
        this.helpers = {
            ...
            request: async (uriOrObject, options) => {
                return await (0, legacy_request_adapter_1.proxyRequestToAxios)(undefined, additionalData, undefined, uriOrObject, options);
            },
        };
    }
    get logger() {
