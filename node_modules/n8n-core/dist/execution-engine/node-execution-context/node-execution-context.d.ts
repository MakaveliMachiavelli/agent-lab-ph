...
export declare abstract class NodeExecutionContext implements Omit<FunctionsBase, 'getCredentials'> {
    ...
    getExecutionContext(): {
        ...
        source: "agent" | "chat" | "cli" | "error" | "evaluation" | "integrated" | "internal" | "manual" | "retry" | "trigger" | "webhook";
        triggerNode?: {
            name: string;
            type: string;
        } | undefined;
        ...
        redaction?: {
            version: 1;
            policy: "all" | "manual-only" | "non-manual" | "none";
        } | {
            version: 2;
            production: boolean;
            manual: boolean;
            source?: "instance" | "workflow" | undefined;
        } | undefined;
        executedByUserId?: string | undefined;
    } | undefined;
    ...
    getMode(): "agent" | "chat" | "cli" | "error" | "evaluation" | "integrated" | "internal" | "manual" | "retry" | "trigger" | "webhook";
    ...
    private assertCredentialUsableByNode;
