import type { ICredentialDataDecryptedObject, INode, ITriggerFunctions, IWorkflowExecuteAdditionalData, SchedulingFunctions, Workflow, WorkflowActivateMode, WorkflowExecuteMode } from 'n8n-workflow';
...
export declare class TriggerContext extends NodeExecutionContext implements ITriggerFunctions {
    ...
    constructor(workflow: Workflow, node: INode, additionalData: IWorkflowExecuteAdditionalData, mode: WorkflowExecuteMode, activation: WorkflowActivateMode, emit?: ITriggerFunctions['emit'], emitError?: ITriggerFunctions['emitError'], saveFailedExecution?: ITriggerFunctions['saveFailedExecution'], schedulingFunctions?: SchedulingFunctions);
