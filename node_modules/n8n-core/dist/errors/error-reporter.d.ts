...
export declare function normalizeFrameFilename(filename: string): string;
export declare class ErrorReporter {
    ...
    init({ beforeSendFilter, dsn, serverType, release, environment, serverName, releaseDate, withEventLoopBlockDetection, eventLoopBlockThreshold, eventLoopBlockMaxEventsPerHour, profilesSampleRate, tracesSampleRate, slowSpanThresholdMs, webhookEndpoint, webhookTracesSampleRate, eligibleIntegrations, healthEndpoint, }: ErrorReporterInitOptions): Promise<void>;
    beforeSend(event: ErrorEvent, hint: EventHint): Promise<ErrorEvent | null>;
    error(e: unknown, options?: ErrorReportingOptions): void;
